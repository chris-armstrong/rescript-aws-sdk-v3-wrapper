...
type badRequestReason = [@as("InvalidConfiguration") #InvalidConfiguration]
type arn = string
type validatorTypeList = array<validatorType>
@ocaml.doc("<p>A validator provides a syntactic or semantic check to ensure the configuration that you
         ...
         valid.</p>")
type validator = {
  @ocaml.doc("<p>Either the JSON Schema content or the Amazon Resource Name (ARN) of an Lambda
         function.</p>")
  @as("Content")
...
type monitor = {
  ...
  @ocaml.doc("<p>Amazon Resource Name (ARN) of the Amazon CloudWatch alarm.</p>") @as("AlarmArn")
  alarmArn: stringWithLengthBetween1And2048,
}
@ocaml.doc("<p>Detailed information about the bad request exception error when creating a hosted
         configuration version.</p>")
type invalidConfigurationDetail = {
  @ocaml.doc("<p>The type of error for an invalid configuration.</p>") @as("Type")
  type_: option<string_>,
  @ocaml.doc("<p>The reason for an invalid configuration error.</p>") @as("Reason")
  reason: option<string_>,
  @ocaml.doc("<p>Location of the validation constraint in the configuration JSON schema that failed
         validation.</p>")
  @as("Location")
  location: option<string_>,
  @ocaml.doc("<p>The invalid or out-of-range validation constraint in your JSON schema that failed
         validation.</p>")
  @as("Constraint")
  constraint_: option<string_>,
}
...
type deploymentSummary = {
  ...
  @ocaml.doc("<p>The amount of time that AppConfig monitors for alarms before considering the deployment
...
type deploymentStrategy = {
  ...
  @ocaml.doc("<p>The amount of time that AppConfig monitored for alarms before considering the deployment
         to be complete and no longer eligible for automatic rollback.</p>")
  @as("FinalBakeTimeInMinutes")
  finalBakeTimeInMinutes: option<minutesBetween0And24Hours>,
...
type deploymentEvent = {
  ...
  @as("Description")
  description: option<description>,
  @ocaml.doc("<p>The entity that triggered the deployment event. Events can be triggered by a user,
...
type invalidConfigurationDetailList = array<invalidConfigurationDetail>
...
type configurationProfileSummary = {
  @ocaml.doc("<p>The type of configurations contained in the profile. AppConfig supports <code>feature
  ...
  @as("Type")
  type_: option<configurationProfileType>,
...
type badRequestDetails = {
  ...
  invalidConfiguration: option<invalidConfigurationDetailList>,
}
module BadRequestDetails = {
  type t = InvalidConfiguration(invalidConfigurationDetailList)
  exception BadRequestDetailsUnspecified
  let classify = value =>
    switch value {
    | {invalidConfiguration: Some(x)} => InvalidConfiguration(x)
    | _ => raise(BadRequestDetailsUnspecified)
    }

  let make = value =>
    switch value {
    | InvalidConfiguration(x) => {invalidConfiguration: Some(x)}
    }
}
type environmentList = array<environment>
@ocaml.doc("<p>Use AppConfig, a capability of Amazon Web Services Systems Manager, to create, manage, and quickly deploy
...
module UpdateDeploymentStrategy = {
  type t
  type request = {
    @ocaml.doc("<p>The algorithm used to define how percentage grows over time. AppConfig supports the
...
module ListDeployments = {
  type t
  type request = {
    @ocaml.doc("<p>The token returned by a prior call to this operation indicating the next set of results
         to be returned. If not specified, the operation will return the first set of
         results.</p>")
    @as("NextToken")
    nextToken: option<nextToken>,
    @ocaml.doc("<p>The maximum number of items that may be returned for this call. If there are items that
...
module ListConfigurationProfiles = {
  type t
  type request = {
    @ocaml.doc("<p>A filter based on the type of configurations that the configuration profile contains. A
...
module ListApplications = {
  type t
  type request = {
    @ocaml.doc("<p>A token to start the list. Next token is a pagination token generated by AppConfig to
...
module GetEnvironment = {
  type t
  type request = {
    @ocaml.doc("<p>The ID of the environment that you want to get.</p>") @as("EnvironmentId")
    environmentId: id,
...
module GetConfigurationProfile = {
  type t
  type request = {
    @ocaml.doc("<p>The ID of the configuration profile that you want to get.</p>")
    @as("ConfigurationProfileId")
    configurationProfileId: id,
...
module GetConfiguration = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The clientId parameter in the following command is a unique, user-specified ID to
  ...
  type response = {
    ...
    configurationVersion: option<version>,
    @ocaml.doc("<p>The content of the configuration or the configuration data.</p>
         <important>
...
module DeleteEnvironment = {
  type t
  type request = {
    @ocaml.doc("<p>The ID of the environment that you want to delete.</p>") @as("EnvironmentId")
    environmentId: id,
    @ocaml.doc("<p>The application ID that includes the environment that you want to delete.</p>")
    @as("ApplicationId")
    applicationId: id,
  }
  type response = {.}
...
module CreateConfigurationProfile = {
  ...
  type request = {
    ...
    @as("RetrievalRoleArn")
    retrievalRoleArn: option<roleArn>,
    @ocaml.doc("<p>A URI to locate the configuration. You can specify the AppConfig hosted configuration
