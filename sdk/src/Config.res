...
@ocaml.doc("<p>AWS Systems Manager (SSM) specific remediation controls.</p>")
type ssmControls = {
...
@ocaml.doc("<p>Provides the source and the message types that trigger AWS
			...
			custom rules. </p>")
type sourceDetail = {
  @ocaml.doc("<p>The frequency at which you want AWS Config to run evaluations
  ...
  @ocaml.doc("<p>The type of notification that triggers AWS Config to run an
  ...
  @ocaml.doc("<p>The source of the event, such as an AWS service, that triggers
...
type retentionConfiguration = {
  @ocaml.doc("<p>Number of days AWS Config stores your historical information.</p>
		       <note>
...
@ocaml.doc("<p>The details that identify a resource within AWS Config, including
...
@ocaml.doc("<p>The details that identify a resource that is discovered by AWS
...
type resourceCountFilters = {
  ...
  accountId: option<accountId>,
  @ocaml.doc("<p>The type of the AWS resource.</p>") @as("ResourceType")
...
type remediationException = {
  ...
  @ocaml.doc("<p>The name of the AWS Config rule.</p>") @as("ConfigRuleName")
...
type externalEvaluation = {
  ...
  @ocaml.doc("<p>The evaluated compliance resource ID. AWS Config accepts only AWS account ID.</p>")
...
@ocaml.doc("<p>Identifies an AWS Config rule that evaluated an AWS resource,
			and provides the type and ID of the resource that the rule
			evaluated.</p>")
type evaluationResultQualifier = {
  @ocaml.doc("<p>The ID of the evaluated AWS resource.</p>") @as("ResourceId")
  resourceId: option<baseResourceId>,
  @ocaml.doc("<p>The type of AWS resource that was evaluated.</p>") @as("ResourceType")
  resourceType: option<stringWithCharLimit256>,
  @ocaml.doc("<p>The name of the AWS Config rule that was used in the
			evaluation.</p>")
  @as("ConfigRuleName")
  configRuleName: option<configRuleName>,
}
@ocaml.doc("<p>Identifies an AWS resource and indicates whether it complies
			with the AWS Config rule that it was evaluated against.</p>")
type evaluation = {
  @ocaml.doc("<p>The time of the event in AWS Config that triggered the
  ...
  @as("Annotation")
  annotation: option<stringWithCharLimit256>,
  @ocaml.doc("<p>Indicates whether the AWS resource complies with the AWS Config
  ...
  @as("ComplianceType")
  complianceType: complianceType,
  @ocaml.doc("<p>The ID of the AWS resource that was evaluated.</p>") @as("ComplianceResourceId")
  complianceResourceId: baseResourceId,
  @ocaml.doc("<p>The type of AWS resource that was evaluated.</p>") @as("ComplianceResourceType")
  complianceResourceType: stringWithCharLimit256,
}
...
type conformancePackStatusDetail = {
  ...
  @ocaml.doc("<p>Amazon Resource Name (ARN) of AWS CloudFormation stack. </p>") @as("StackArn")
  stackArn: stackArn,
...
@ocaml.doc("<p>Provides options for how often AWS Config delivers
...
type configSnapshotDeliveryProperties = {
  @ocaml.doc("<p>The frequency with which AWS Config delivers configuration
			snapshots.</p>")
  deliveryFrequency: option<maximumExecutionFrequency>,
}
type configRuleNames = array<configRuleName>
@ocaml.doc("<p>Status information for your AWS managed Config rules. The
...
type configRuleEvaluationStatus = {
  @ocaml.doc("<p>Indicates whether AWS Config has evaluated your resources
  ...
  @ocaml.doc("<p>The error message that AWS Config returned when the rule last
			failed.</p>")
  @as("LastErrorMessage")
  lastErrorMessage: option<string_>,
  @ocaml.doc("<p>The error code that AWS Config returned when the rule last
			failed.</p>")
  @as("LastErrorCode")
  lastErrorCode: option<string_>,
  @ocaml.doc("<p>The time that you last turned off the AWS Config rule.</p>")
  @as("LastDeactivatedTime")
  lastDeactivatedTime: option<date>,
  @ocaml.doc("<p>The time that you first activated the AWS Config
			rule.</p>")
  @as("FirstActivatedTime")
  firstActivatedTime: option<date>,
  @ocaml.doc("<p>The time that AWS Config last failed to evaluate your AWS
			resources against the rule.</p>")
  @as("LastFailedEvaluationTime")
  lastFailedEvaluationTime: option<date>,
  @ocaml.doc("<p>The time that AWS Config last successfully evaluated your AWS
			resources against the rule.</p>")
  @as("LastSuccessfulEvaluationTime")
  lastSuccessfulEvaluationTime: option<date>,
  @ocaml.doc("<p>The time that AWS Config last failed to invoke the AWS Config
			rule to evaluate your AWS resources.</p>")
  @as("LastFailedInvocationTime")
  lastFailedInvocationTime: option<date>,
  @ocaml.doc("<p>The time that AWS Config last successfully invoked the AWS
			Config rule to evaluate your AWS resources.</p>")
  @as("LastSuccessfulInvocationTime")
  lastSuccessfulInvocationTime: option<date>,
  @ocaml.doc("<p>The ID of the AWS Config rule.</p>") @as("ConfigRuleId")
  configRuleId: option<string_>,
  @ocaml.doc("<p>The Amazon Resource Name (ARN) of the AWS Config
			rule.</p>")
  @as("ConfigRuleArn")
...
@ocaml.doc("<p>The number of AWS resources or AWS Config rules responsible for
...
type aggregatedSourceStatus = {
  ...
  @as("LastErrorMessage")
  lastErrorMessage: option<string_>,
  @ocaml.doc("<p>The error code that AWS Config returned when the source account
...
type aggregateResourceIdentifier = {
  @ocaml.doc("<p>The name of the AWS resource.</p>") @as("ResourceName")
  resourceName: option<resourceName>,
  @ocaml.doc("<p>The type of the AWS resource.</p>") @as("ResourceType") resourceType: resourceType,
  @ocaml.doc("<p>The ID of the AWS resource.</p>") @as("ResourceId") resourceId: resourceId,
...
type aggregateConformancePackComplianceSummaryFilters = {
  @ocaml.doc("<p>The source AWS Region from where the data is aggregated.</p>") @as("AwsRegion")
  awsRegion: option<awsRegion>,
  @ocaml.doc("<p>The 12-digit AWS account ID of the source account.</p>") @as("AccountId")
  accountId: option<accountId>,
}
@ocaml.doc(
...
type aggregateConformancePackCompliance = {
  ...
  @ocaml.doc("<p>The number of noncompliant AWS Config Rules.</p>") @as("NonCompliantRuleCount")
  nonCompliantRuleCount: option<integer_>,
  @ocaml.doc("<p>The number of compliant AWS Config Rules.</p>") @as("CompliantRuleCount")
...
@ocaml.doc("<p>Defines which resources trigger an evaluation for an AWS Config
...
type scope = {
  @ocaml.doc("<p>The ID of the only AWS resource that you want to trigger an
  ...
  @ocaml.doc("<p>The tag value applied to only those AWS resources that you want
  ...
  @ocaml.doc("<p>The tag key that is applied to only those AWS resources that
			you want to trigger an evaluation for the rule.</p>")
  @as("TagKey")
  tagKey: option<stringWithCharLimit128>,
  @ocaml.doc("<p>The resource types of only those AWS resources that you want to
...
@ocaml.doc("<p>Specifies the types of AWS resource for which AWS Config
...
type recordingGroup = {
  @ocaml.doc("<p>A comma-separated list that specifies the types of AWS
  ...
  @ocaml.doc("<p>Specifies whether AWS Config includes all supported types of
  ...
  @ocaml.doc("<p>Specifies whether AWS Config records configuration changes for
...
@ocaml.doc("<p>An object that specifies organization managed rule metadata such as resource type and ID of AWS resource along with the rule identifier. 
...
type organizationManagedRuleMetadata = {
  ...
  @ocaml.doc("<p>The ID of the AWS resource that was evaluated.</p>") @as("ResourceIdScope")
  resourceIdScope: option<stringWithCharLimit768>,
  @ocaml.doc("<p>The type of the AWS resource that was evaluated.</p>") @as("ResourceTypesScope")
  resourceTypesScope: option<resourceTypesScope>,
  @ocaml.doc("<p>The maximum frequency with which AWS Config runs evaluations for a rule. You are using an AWS managed rule that is triggered at a periodic frequency.</p>
		       <note>
  ...
  @ocaml.doc("<p>The description that you provide for organization config rule.</p>")
  @as("Description")
  description: option<stringWithCharLimit256Min0>,
}
@ocaml.doc("<p>An object that specifies organization custom rule metadata such as resource type, resource ID of AWS resource, Lamdba function ARN, 
...
type organizationCustomRuleMetadata = {
  ...
  @ocaml.doc("<p>The type of the AWS resource that was evaluated.</p>") @as("ResourceTypesScope")
  resourceTypesScope: option<resourceTypesScope>,
  @ocaml.doc("<p>The maximum frequency with which AWS Config runs evaluations for a rule. 
  ...
  @as("InputParameters")
  inputParameters: option<stringWithCharLimit2048>,
  @ocaml.doc("<p>The type of notification that triggers AWS Config to run an evaluation for a rule. You can specify the following notification types:</p>
...
type organizationAggregationSource = {
  @ocaml.doc("<p>If true, aggregate existing AWS Config regions and future
			regions.</p>")
  @as("AllAwsRegions")
  ...
  @ocaml.doc("<p>ARN of the IAM role used to retrieve AWS Organization details
...
@ocaml.doc("<p>The controls that AWS Config uses for executing remediations.</p>")
...
type evaluationResultIdentifier = {
  @ocaml.doc("<p>The time of the event that triggered the evaluation of your AWS
  ...
  @ocaml.doc("<p>Identifies an AWS Config rule used to evaluate an AWS resource,
...
@ocaml.doc("<p>The channel through which AWS Config delivers notifications and
			updated configuration states.</p>")
type deliveryChannel = {
  @ocaml.doc("<p>The options for how often AWS Config delivers configuration
  ...
  @ocaml.doc("<p>The Amazon Resource Name (ARN) of the AWS Key Management Service (KMS) customer managed key (CMK) used to encrypt objects delivered by AWS Config.
  ...
  @ocaml.doc("<p>The name of the Amazon S3 bucket to which AWS Config delivers
  ...
  @ocaml.doc("<p>The name of the delivery channel. By default, AWS Config
...
type conformancePackRuleCompliance = {
  ...
  @ocaml.doc("<p>Compliance of the AWS Config rule.</p>
...
type conformancePackEvaluationFilters = {
  ...
  @as("ComplianceType")
  complianceType: option<conformancePackComplianceType>,
  @ocaml.doc("<p>Filters the results by AWS Config rule names.</p>") @as("ConfigRuleNames")
...
@ocaml.doc("<p>Filters the conformance pack by compliance types and AWS Config rule names.</p>")
...
@ocaml.doc("<p>The number of AWS Config rules or AWS resources that are
			compliant and noncompliant.</p>")
type complianceSummary = {
  @ocaml.doc("<p>The time that AWS Config created the compliance
			summary.</p>")
...
@ocaml.doc("<p>Indicates whether an AWS resource or AWS Config rule is
			compliant and provides the number of contributors that affect the
			compliance.</p>")
type compliance = {
  @ocaml.doc("<p>The number of AWS resources or AWS Config rules that cause a
...
type baseConfigurationItem = {
  @ocaml.doc("<p>Configuration attributes that AWS Config returns for certain
  ...
  resourceId: option<resourceId>,
  @ocaml.doc("<p>The type of AWS resource.</p>") resourceType: option<resourceType>,
  ...
  @ocaml.doc("<p>The 12-digit AWS account ID associated with the resource.</p>")
  accountId: option<accountId>,
...
type aggregateConformancePackComplianceSummary = {
  @ocaml.doc("<p>Groups the result based on AWS Account ID or AWS Region.</p>") @as("GroupName")
...
@ocaml.doc("<p>Provides the AWS Config rule owner (AWS or customer), the rule
			identifier, and the events that trigger the evaluation of your AWS
			resources.</p>")
type source = {
  @ocaml.doc("<p>Provides the source and type of the event that causes AWS
			Config to evaluate your AWS resources.</p>")
  @as("SourceDetails")
  sourceDetails: option<sourceDetails>,
  @ocaml.doc("<p>For AWS Config managed rules, a predefined identifier from a
			list. For example, <code>IAM_PASSWORD_POLICY</code> is a managed
			rule. To reference a managed rule, see <a href=\"https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html\">Using AWS Managed Config Rules</a>.</p>
  ...
  @ocaml.doc("<p>Indicates whether AWS or the customer owns and manages the AWS
			Config rule.</p>")
  @as("Owner")
  owner: owner,
}
...
type organizationConformancePack = {
  ...
  @ocaml.doc("<p>Amazon S3 bucket where AWS Config stores conformance pack templates.  </p>
		       <note>
            <p>This field is optional.</p>
         </note>")
  @as("DeliveryS3Bucket")
...
@ocaml.doc("<p>The details of an AWS Config evaluation. Provides the AWS
			resource that was evaluated, the compliance of the resource, related
			time stamps, and supplementary information.</p>")
type evaluationResult = {
  @ocaml.doc("<p>An encrypted token that associates an evaluation with an AWS
  ...
  @as("Annotation")
  annotation: option<stringWithCharLimit256>,
  @ocaml.doc("<p>The time when the AWS Config rule evaluated the AWS
			resource.</p>")
  @as("ConfigRuleInvokedTime")
  configRuleInvokedTime: option<date>,
  @ocaml.doc("<p>The time when AWS Config recorded the evaluation
			result.</p>")
...
type conformancePackEvaluationResult = {
  ...
  @ocaml.doc("<p>The time when AWS Config recorded the evaluation result. </p>")
  @as("ResultRecordedTime")
  resultRecordedTime: date,
  @ocaml.doc("<p>The time when AWS Config rule evaluated AWS resource.</p>")
  @as("ConfigRuleInvokedTime")
...
type conformancePackDetail = {
  @ocaml.doc("<p>AWS service that created the conformance pack.</p>") @as("CreatedBy")
...
type configurationRecorder = {
  @ocaml.doc("<p>Specifies the types of AWS resources for which AWS Config
			records configuration changes.</p>")
  ...
  @ocaml.doc("<p>The name of the recorder. By default, AWS Config automatically
...
type configurationItem = {
  ...
  @ocaml.doc("<p>The description of the resource configuration.</p>")
  configuration: option<configuration>,
  @ocaml.doc("<p>A list of related AWS resources.</p>") relationships: option<relationshipList>,
  ...
  @ocaml.doc("<p>The time when the configuration recording was
			initiated.</p>")
  configurationItemCaptureTime: option<configurationItemCaptureTime>,
  @ocaml.doc("<p>The 12-digit AWS account ID associated with the
			resource.</p>")
  accountId: option<accountId>,
  @ocaml.doc("<p>The version number of the resource configuration.</p>") version: option<version>,
}
@ocaml.doc("<p>The number of AWS resources of a specific type that are
			compliant or noncompliant, up to a maximum of 100 for
			each.</p>")
type complianceSummaryByResourceType = {
  @ocaml.doc("<p>The number of AWS resources that are compliant or noncompliant,
			up to a maximum of 100 for each.</p>")
  @as("ComplianceSummary")
  complianceSummary: option<complianceSummary>,
  @ocaml.doc("<p>The type of AWS resource.</p>") @as("ResourceType")
  resourceType: option<stringWithCharLimit256>,
}
@ocaml.doc("<p>Indicates whether an AWS resource that is evaluated according
...
type complianceByResource = {
  @ocaml.doc("<p>Indicates whether the AWS resource complies with all of the AWS
			Config rules that evaluated it.</p>")
  @as("Compliance")
  compliance: option<compliance>,
  @ocaml.doc("<p>The ID of the AWS resource that was evaluated.</p>") @as("ResourceId")
  resourceId: option<baseResourceId>,
  @ocaml.doc("<p>The type of the AWS resource that was evaluated.</p>") @as("ResourceType")
  resourceType: option<stringWithCharLimit256>,
}
@ocaml.doc("<p>Indicates whether an AWS Config rule is compliant. A rule is
...
type complianceByConfigRule = {
  @ocaml.doc("<p>Indicates whether the AWS Config rule is compliant.</p>") @as("Compliance")
  compliance: option<compliance>,
  @ocaml.doc("<p>The name of the AWS Config rule.</p>") @as("ConfigRuleName")
  configRuleName: option<stringWithCharLimit64>,
}
type baseConfigurationItems = array<baseConfigurationItem>
@ocaml.doc("<p>The details of an AWS Config evaluation for an account ID and
...
type aggregateEvaluationResult = {
  ...
  @as("ConfigRuleInvokedTime")
  configRuleInvokedTime: option<date>,
  @ocaml.doc("<p>The time when AWS Config recorded the aggregate evaluation
			result.</p>")
  @as("ResultRecordedTime")
  resultRecordedTime: option<date>,
...
type aggregateComplianceCount = {
  @ocaml.doc("<p>The number of compliant and noncompliant AWS Config
			rules.</p>")
  @as("ComplianceSummary")
  complianceSummary: option<complianceSummary>,
...
@ocaml.doc("<p>Indicates whether an AWS Config rule is compliant based on
...
type configurationAggregator = {
  @ocaml.doc("<p>AWS service that created the configuration aggregator.</p>") @as("CreatedBy")
  createdBy: option<stringWithCharLimit256>,
...
@ocaml.doc("<p>An AWS Config rule represents an AWS Lambda function that you
...
type configRule = {
  ...
  @as("CreatedBy")
  createdBy: option<stringWithCharLimit256>,
  @ocaml.doc("<p>Indicates whether the AWS Config rule is active or is currently
  ...
  @ocaml.doc("<p>The maximum frequency with which AWS Config runs evaluations
  ...
  @as("MaximumExecutionFrequency")
  maximumExecutionFrequency: option<maximumExecutionFrequency>,
  @ocaml.doc("<p>A string, in JSON format, that is passed to the AWS Config rule
			Lambda function.</p>")
  @as("InputParameters")
  inputParameters: option<stringWithCharLimit1024>,
  @ocaml.doc("<p>Provides the rule owner (AWS or customer), the rule identifier,
  ...
  @as("Scope")
  scope: option<scope>,
  @ocaml.doc("<p>The description that you provide for the AWS Config
			rule.</p>")
  @as("Description")
  ...
  @ocaml.doc("<p>The name that you assign to the AWS Config rule. The name is
...
type remediationConfiguration = {
  ...
  @ocaml.doc("<p>Maximum time in seconds that AWS Config runs auto-remediation. If you do not select a number, the default is 60 seconds. </p>
...
@ocaml.doc("<fullname>AWS Config</fullname>
...
module DeleteEvaluationResults = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>The name of the AWS Config rule for which you want to delete
...
module DeleteConfigRule = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>The name of the AWS Config rule that you want to
			delete.</p>")
    @as("ConfigRuleName")
    configRuleName: configRuleName,
  }
...
module StartConfigRulesEvaluation = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>The list of names of AWS Config rules that you want to run
			evaluations for.</p>")
    @as("ConfigRuleNames")
...
module PutRetentionConfiguration = {
  type t
  type request = {
    @ocaml.doc("<p>Number of days AWS Config stores your historical
			information.</p>
		       <note>
...
module PutResourceConfig = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The configuration object of the resource in valid JSON format. It must match the schema registered with AWS CloudFormation.</p>
		       <note>
    ...
    @ocaml.doc("<p>The type of the resource. The custom resource type must be registered with AWS CloudFormation. </p>
		       <note>
...
module PutEvaluations = {
  ...
  type request = {
    ...
    @as("ResultToken")
    resultToken: string_,
    @ocaml.doc("<p>The assessments that the AWS Lambda function performs. Each
...
module ListDiscoveredResources = {
  ...
  type request = {
    @ocaml.doc("<p>The <code>nextToken</code> string returned on a previous page
			...
			response.</p>")
    nextToken: option<nextToken>,
    @ocaml.doc("<p>Specifies whether AWS Config includes deleted resources in the
    ...
    limit: option<limit>,
    @ocaml.doc("<p>The custom name of only those resources that you want AWS
			...
			it has discovered.</p>")
    resourceName: option<resourceName>,
    @ocaml.doc("<p>The IDs of only those resources that you want AWS Config to
    ...
    @ocaml.doc("<p>The type of resources that you want AWS Config to list in the
			response.</p>")
    resourceType: resourceType,
  }
  @ocaml.doc("<p></p>")
...
module ListAggregateDiscoveredResources = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The type of resources that you want AWS Config to list in the response.</p>")
    @as("ResourceType")
    resourceType: resourceType,
    @ocaml.doc("<p>The name of the configuration aggregator. </p>")
    @as("ConfigurationAggregatorName")
...
module GetDiscoveredResourceCounts = {
  ...
  type response = {
    ...
    @ocaml.doc("<p>The total number of resources that AWS Config is recording in
...
module GetComplianceSummaryByConfigRule = {
  ...
  @ocaml.doc("<p></p>")
  type response = {
    @ocaml.doc("<p>The number of AWS Config rules that are compliant and the
...
module DescribeConfigRuleEvaluationStatus = {
  ...
  type request = {
    ...
    @as("NextToken")
    nextToken: option<string_>,
    @ocaml.doc("<p>The name of the AWS managed Config rules for which you want
  ...
  type response = {
    ...
    @as("NextToken")
    nextToken: option<string_>,
    @ocaml.doc("<p>Status information about your AWS managed Config
			rules.</p>")
...
module GetAggregateConformancePackComplianceSummary = {
  ...
  type request = {
    ...
    @as("Limit")
    limit: option<limit>,
    @ocaml.doc("<p>Groups the result based on AWS Account ID or AWS Region.</p>") @as("GroupByKey")
...
module GetComplianceDetailsByResource = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The ID of the AWS resource for which you want compliance
			information.</p>")
    @as("ResourceId")
    resourceId: baseResourceId,
    @ocaml.doc("<p>The type of the AWS resource for which you want compliance
			information.</p>")
    @as("ResourceType")
    resourceType: stringWithCharLimit256,
  }
  ...
  type response = {
    ...
    @as("NextToken")
    nextToken: option<string_>,
    @ocaml.doc("<p>Indicates whether the specified AWS resource complies each AWS
			Config rule.</p>")
...
module GetComplianceDetailsByConfigRule = {
  ...
  type request = {
    ...
    @as("ComplianceTypes")
    complianceTypes: option<complianceTypes>,
    @ocaml.doc("<p>The name of the AWS Config rule for which you want compliance
			information.</p>")
    @as("ConfigRuleName")
    configRuleName: stringWithCharLimit64,
  }
  ...
  type response = {
    ...
    @as("NextToken")
    nextToken: option<nextToken>,
    @ocaml.doc("<p>Indicates whether the AWS resource complies with the specified
			AWS Config rule.</p>")
    @as("EvaluationResults")
    evaluationResults: option<evaluationResults>,
  }
...
module DescribeRemediationExecutionStatus = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>A list of AWS Config rule names.</p>") @as("ConfigRuleName")
    configRuleName: configRuleName,
  }
  type response = {
    @ocaml.doc(
...
module DescribeComplianceByResource = {
  ...
  type request = {
    ...
    @as("ResourceId")
    resourceId: option<baseResourceId>,
    @ocaml.doc("<p>The types of AWS resources for which you want compliance
  ...
  type response = {
    ...
    @as("NextToken")
    nextToken: option<nextToken>,
    @ocaml.doc("<p>Indicates whether the specified AWS resource complies with all
...
module DescribeComplianceByConfigRule = {
  ...
  type request = {
    ...
    @as("ComplianceTypes")
    complianceTypes: option<complianceTypes>,
    @ocaml.doc("<p>Specify one or more AWS Config rule names to filter the results
			by rule.</p>")
    @as("ConfigRuleNames")
    configRuleNames: option<configRuleNames>,
  }
  ...
  type response = {
    ...
    @as("NextToken")
    nextToken: option<string_>,
    @ocaml.doc("<p>Indicates whether each of the specified AWS Config rules is
			compliant.</p>")
...
module DescribeConfigRules = {
  ...
  type request = {
    ...
    @as("NextToken")
    nextToken: option<string_>,
    @ocaml.doc("<p>The names of the AWS Config rules for which you want details.
  ...
  type response = {
    ...
    @as("NextToken")
    nextToken: option<string_>,
    @ocaml.doc("<p>The details about your AWS Config rules.</p>") @as("ConfigRules")
