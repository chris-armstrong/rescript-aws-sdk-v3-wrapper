...
type propagateTags = [
  | @as("NONE") #NONE
  | @as("SERVICE") #SERVICE
  | @as("TASK_DEFINITION") #TASK_DEFINITION
]
...
type osfamily = [
  | @as("LINUX") #LINUX
  | @as("WINDOWS_SERVER_20H2_CORE") #WINDOWS_SERVER_20H2_CORE
  | @as("WINDOWS_SERVER_2022_FULL") #WINDOWS_SERVER_2022_FULL
  | @as("WINDOWS_SERVER_2022_CORE") #WINDOWS_SERVER_2022_CORE
  | @as("WINDOWS_SERVER_2004_CORE") #WINDOWS_SERVER_2004_CORE
  | @as("WINDOWS_SERVER_2016_FULL") #WINDOWS_SERVER_2016_FULL
  | @as("WINDOWS_SERVER_2019_CORE") #WINDOWS_SERVER_2019_CORE
  | @as("WINDOWS_SERVER_2019_FULL") #WINDOWS_SERVER_2019_FULL
]
type networkMode = [
  | @as("none") #None
  | @as("awsvpc") #Awsvpc
...
type integer_ = int
type instanceHealthCheckType = [@as("CONTAINER_RUNTIME") #CONTAINER_RUNTIME]
...
type containerInstanceField = [
  | @as("CONTAINER_INSTANCE_HEALTH") #CONTAINER_INSTANCE_HEALTH
  | @as("TAGS") #TAGS
]
...
type cpuarchitecture = [@as("ARM64") #ARM64 | @as("X86_64") #X86_64]
...
type volumeFrom = {
  ...
  @ocaml.doc("<p>The name of another container within the same task definition to mount volumes
			from.</p>")
...
@ocaml.doc("<p>The Docker and Amazon ECS container agent version information about a container
			instance.</p>")
type versionInfo = {
  @ocaml.doc("<p>The Docker version that's running on the container instance.</p>")
...
type systemControl = {
  @ocaml.doc("<p>The value for the namespaced kernel parameter that's specified in
				<code>namespace</code>.</p>")
  value: option<string_>,
  @ocaml.doc("<p>The namespaced kernel parameter to set a <code>value</code> for.</p>")
...
type setting = {
  @ocaml.doc("<p>The ARN of the principal. It can be an IAM user, IAM role, or the root user. If this
			field is omitted, the authenticated user is assumed.</p>")
  principalArn: option<string_>,
  @ocaml.doc("<p>Determines whether the account setting is enabled or disabled for the specified
			resource.</p>")
  value: option<string_>,
  @ocaml.doc("<p>The Amazon ECS resource name.</p>") name: option<settingName>,
}
@ocaml.doc("<p>The details for the execute command session.</p>")
type session = {
  @ocaml.doc("<p>An encrypted token value containing session and caller information. It's used to
...
@ocaml.doc("<p>The details for the service registry.</p>
...
type serviceRegistry = {
  @ocaml.doc("<p>The port value to be used for your service discovery service. It's already specified
  ...
  @ocaml.doc("<p>The container name value to be used for your service discovery service. It's already
...
@ocaml.doc("<p>The details for an event that's associated with a service.</p>")
type serviceEvent = {
  @ocaml.doc("<p>The event message.</p>") message: option<string_>,
  @ocaml.doc("<p>The Unix timestamp for the time when the event was triggered.</p>")
  createdAt: option<timestamp_>,
  @ocaml.doc("<p>The ID string for the event.</p>") id: option<string_>,
}
...
@ocaml.doc("<p>Information about the platform for the Amazon ECS service or task.</p>
...
type runtimePlatform = {
  @ocaml.doc("<p>The operating system.</p>") operatingSystemFamily: option<osfamily>,
  @ocaml.doc("<p>The CPU architecture.</p>
  ...
  cpuArchitecture: option<cpuarchitecture>,
}
...
type portMapping = {
  ...
  @ocaml.doc("<p>The port number on the container that's bound to the user-specified or automatically
...
@ocaml.doc("<p>The devices that are available on the container instance. The only supported device
			type is a GPU.</p>")
type platformDevice = {
  @ocaml.doc("<p>The type of device that's available on the container instance. The only supported
			value is <code>GPU</code>.</p>")
  @as("type")
  type_: platformDeviceType,
  @ocaml.doc("<p>The ID for the GPUs on the container instance. The available GPU IDs can also be
...
type placementConstraint = {
  @ocaml.doc("<p>A cluster query language expression to apply to the constraint. The expression can
...
type networkBinding = {
  ...
  protocol: option<transportProtocol>,
  @ocaml.doc("<p>The port number on the host that's used with the network binding.</p>")
  hostPort: option<boxedInteger>,
  @ocaml.doc("<p>The port number on the container that's used with the network binding.</p>")
  containerPort: option<boxedInteger>,
  @ocaml.doc("<p>The IP address that the container is bound to on the container instance.</p>")
  bindIP: option<string_>,
}
@ocaml.doc("<p>Details for a volume mount point that's used in a container definition.</p>")
type mountPoint = {
  @ocaml.doc("<p>If this value is <code>true</code>, the container has read-only access to the volume.
			If this value is <code>false</code>, then the container can write to the volume. The
			default value is <code>false</code>.</p>")
...
type managedScaling = {
  ...
  @ocaml.doc("<p>The maximum number of container instances that Amazon ECS scales in or scales out at one
  ...
  @ocaml.doc("<p>The minimum number of container instances that Amazon ECS scales in or scales out at one
  ...
  @ocaml.doc("<p>Determines whether to use managed scaling for the capacity provider.</p>")
...
type managedAgentStateChange = {
  ...
  @ocaml.doc("<p>The name of the container that's associated with the managed agent.</p>")
...
type managedAgent = {
  ...
  @ocaml.doc("<p>The Unix timestamp for the time when the managed agent was last started.</p>")
...
@ocaml.doc("<p>An object representing the result of a container instance health status check.</p>")
type instanceHealthCheckResult = {
  ...
  @ocaml.doc("<p>The Unix timestamp for when the container instance health status was last
			updated.</p>")
  lastUpdated: option<timestamp_>,
  @ocaml.doc("<p>The container instance health status.</p>")
  status: option<instanceHealthCheckState>,
  @ocaml.doc("<p>The type of container instance health status that was verified.</p>") @as("type")
  type_: option<instanceHealthCheckType>,
}
...
@ocaml.doc("<p>Details on an Elastic Inference accelerator. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-inference.html\">Working with Amazon Elastic Inference on
...
type fsxWindowsFileServerAuthorizationConfig = {
  @ocaml.doc("<p>A fully qualified domain name hosted by an <a href=\"https://docs.aws.amazon.com/directoryservice/latest/admin-guide/directory_microsoft_ad.html\">Directory Service</a> Managed Microsoft AD (Active Directory) or self-hosted AD on
			Amazon EC2.</p>")
  domain: string_,
...
type executeCommandLogConfiguration = {
  ...
  @ocaml.doc("<p>Determines whether to use encryption on the S3 logs. If not specified, encryption is
			not used.</p>")
  ...
  @ocaml.doc("<p>Determines whether to use encryption on the CloudWatch logs. If not specified,
...
type efsauthorizationConfig = {
  @ocaml.doc("<p>Determines whether to use the Amazon ECS task IAM role defined in a task definition when
...
type deploymentCircuitBreaker = {
  @ocaml.doc("<p>Determines whether to configure Amazon ECS to roll back the service if a service deployment
  ...
  rollback: boolean_,
  @ocaml.doc("<p>Determines whether to use the deployment circuit breaker logic for the
			service.</p>")
  enable: boolean_,
}
...
@ocaml.doc("<p>The settings to use when creating a cluster. This parameter is used to turn on CloudWatch
...
@ocaml.doc("<p>An attribute is a name-value pair that's associated with an Amazon ECS object. Use attributes
...
type attribute = {
  ...
  @ocaml.doc("<p>The type of the target to attach the attribute with. This parameter is required if you
...
type resource = {
  ...
  @ocaml.doc("<p>The type of the resource. Valid values: <code>INTEGER</code>, <code>DOUBLE</code>,
...
type instanceHealthCheckResultList = array<instanceHealthCheckResult>
...
type healthCheck = {
  @ocaml.doc("<p>The optional grace period to provide containers time to bootstrap before failed health
...
@ocaml.doc("<p>This parameter is specified when you're using <a href=\"https://docs.aws.amazon.com/fsx/latest/WindowsGuide/what-is.html\">Amazon FSx for Windows File Server</a> file system for task
			storage.</p>
		       <p>For more information and the input format, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/wfsx-volumes.html\">Amazon FSx for Windows File Server Volumes</a>
			in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>")
...
type executeCommandConfiguration = {
  ...
  @ocaml.doc("<p>Specify an Key Management Service key ID to encrypt the data between the local client
			and the container.</p>")
  kmsKeyId: option<string_>,
}
type environmentVariables = array<keyValuePair>
type environmentFiles = array<environmentFile>
@ocaml.doc("<p>This parameter is specified when you're using an Amazon Elastic File System file system for task
...
type efsvolumeConfiguration = {
  ...
  @ocaml.doc("<p>Determines whether to use encryption for Amazon EFS data in transit between the Amazon ECS
...
@ocaml.doc("<p>This parameter is specified when you're using Docker volumes. Docker volumes are only
...
type dockerVolumeConfiguration = {
  ...
  @ocaml.doc("<p>If this value is <code>true</code>, the Docker volume is created if it doesn't already
			exist.</p>
		       <note>
...
type awsVpcConfiguration = {
  ...
  @ocaml.doc("<p>The IDs of the security groups associated with the task or service. If you don't
  ...
  @ocaml.doc("<p>The IDs of the subnets associated with the task or service. There's a limit of 16
...
@ocaml.doc("<p>A data volume that's used in a task definition. For tasks that use the Amazon Elastic
			...
			more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_data_volumes.html\">Using Data Volumes in
				Tasks</a>.</p>")
type volume = {
  @ocaml.doc("<p>This parameter is specified when you use Amazon FSx for Windows File Server file system for task
			storage.</p>")
  fsxWindowsFileServerVolumeConfiguration: option<fsxWindowsFileServerVolumeConfiguration>,
  @ocaml.doc("<p>This parameter is specified when you use an Amazon Elastic File System file system for task
			storage.</p>")
  efsVolumeConfiguration: option<efsvolumeConfiguration>,
  @ocaml.doc("<p>This parameter is specified when you use Docker volumes.</p>
  ...
  @ocaml.doc("<p>This parameter is specified when you use bind mount host volumes. The contents of the
...
type networkConfiguration = {
  @ocaml.doc("<p>The VPC subnets and security groups that are associated with a task.</p>
		       <note>
...
@ocaml.doc("<p>An object that represents a change in state for a container.</p>")
type containerStateChange = {
  ...
  @ocaml.doc("<p>Any network bindings that are associated with the container.</p>")
...
@ocaml.doc("<p>The overrides that are sent to a container. An empty container override can be passed
...
@ocaml.doc("<p>An object representing the health status of the container instance.</p>")
type containerInstanceHealthStatus = {
  @ocaml.doc("<p>An array of objects representing the details of the container instance health
			status.</p>")
  details: option<instanceHealthCheckResultList>,
  @ocaml.doc("<p>The overall health status of the container instance. This is an aggregate status of
			all container instance health checks.</p>")
  overallStatus: option<instanceHealthCheckState>,
}
@ocaml.doc("<p>A Docker container that's part of a task.</p>")
type container = {
  ...
  @ocaml.doc("<p>The number of CPU units set for the container. The value is <code>0</code> if no value
  ...
  @ocaml.doc("<p>The health status of the container. If health checks aren't configured for this
...
@ocaml.doc("<p>The details for a capacity provider.</p>")
...
@ocaml.doc("<p>Information about a set of Amazon ECS tasks in either an CodeDeploy or an <code>EXTERNAL</code>
...
type taskSet = {
  ...
  tags: option<tags>,
  @ocaml.doc("<p>The Unix timestamp for the time when the task set stability status was
			retrieved.</p>")
  stabilityStatusAt: option<timestamp_>,
  @ocaml.doc("<p>The stability status. This indicates whether the task set has reached a steady state.
  ...
  @ocaml.doc("<p>A floating-point percentage of your desired number of tasks to place and keep running
			in the task set.</p>")
  scale: option<scale>,
  @ocaml.doc("<p>The details for the service discovery registries to assign to this task set. For more
			information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-discovery.html\">Service
				discovery</a>.</p>")
  serviceRegistries: option<serviceRegistries>,
  @ocaml.doc("<p>Details on a load balancer that are used with a task set.</p>")
  ...
  @ocaml.doc("<p>The operating system that your tasks in the set are running on. A platform family is
			specified only for tasks that use the Fargate launch type. </p>
		       <p> All tasks in the set must have the same value.</p>")
  platformFamily: option<string_>,
  @ocaml.doc("<p>The Fargate platform version where the tasks in the task set are running. A platform
  ...
  @ocaml.doc("<p>The capacity provider strategy that are associated with the task set.</p>")
  ...
  @ocaml.doc("<p>The Unix timestamp for the time when the task set was last updated.</p>")
  updatedAt: option<timestamp_>,
  @ocaml.doc("<p>The Unix timestamp for the time when the task set was created.</p>")
  createdAt: option<timestamp_>,
  ...
  @ocaml.doc("<p>The task definition that the task set is using.</p>")
  ...
  @ocaml.doc("<p>The tag specified when a task set is started. If an CodeDeploy deployment created the task
...
type deployment = {
  ...
  networkConfiguration: option<networkConfiguration>,
  @ocaml.doc("<p>The operating system that your tasks in the service, or tasks are running on. A
			...
			LINUX.</code>.</p>")
  platformFamily: option<string_>,
  @ocaml.doc("<p>The platform version that your tasks in the service run on. A platform version is only
  ...
  capacityProviderStrategy: option<capacityProviderStrategy>,
  @ocaml.doc("<p>The Unix timestamp for the time when the service deployment was last updated.</p>")
  updatedAt: option<timestamp_>,
  @ocaml.doc("<p>The Unix timestamp for the time when the service deployment was created.</p>")
  createdAt: option<timestamp_>,
...
@ocaml.doc("<p>The overrides that are associated with a task.</p>")
type taskOverride = {
  ...
  @ocaml.doc("<p>The Amazon Resource Name (ARN) of the task execution IAM role override for the task. For more
  ...
  @ocaml.doc("<p>One or more container overrides that are sent to a task.</p>")
  containerOverrides: option<containerOverrides>,
}
type deployments = array<deployment>
@ocaml.doc("<p>An EC2 instance that's running the Amazon ECS agent and has been registered with a
			cluster.</p>")
type containerInstance = {
  @ocaml.doc("<p>An object representing the health status of the container instance.</p>")
  healthStatus: option<containerInstanceHealthStatus>,
  ...
  @ocaml.doc("<p>The Unix timestamp for the time when the container instance was registered.</p>")
  ...
  @ocaml.doc("<p>The status of the most recent agent update. If an update wasn't ever requested, this
  ...
  @ocaml.doc("<p>The version counter for the container instance. Every time a container instance
			...
			current.</p>")
  version: option<long>,
  @ocaml.doc("<p>The capacity provider that's associated with the container instance.</p>")
...
type containerDefinition = {
  ...
  @ocaml.doc("<p>When this parameter is <code>true</code>, you can deploy containerized applications
  ...
  @ocaml.doc("<p>The working directory to run commands inside the container in. This parameter maps to
  ...
  environment: option<environmentVariables>,
  @ocaml.doc("<p>The command that's passed to the container. This parameter maps to <code>Cmd</code> in
  ...
  @ocaml.doc("<p>The name of a container. If you're linking multiple containers together in a task
...
@ocaml.doc("<p>A regional grouping of one or more container instances where you can run task
...
type cluster = {
  ...
  tags: option<tags>,
  @ocaml.doc("<p>Additional information about your clusters that are separated by launch type. They
  ...
  @ocaml.doc("<p>The status of the cluster. The following are the possible states that are
			returned.</p>
		       <dl>
            <dt>ACTIVE</dt>
            <dd>
...
type task = {
  ...
  ephemeralStorage: option<ephemeralStorage>,
  @ocaml.doc("<p>The version counter for the task. Every time a task experiences a change that starts a
  ...
  @ocaml.doc("<p>The metadata that you apply to the task to help you categorize and organize the task.
  ...
  tags: option<tags>,
  @ocaml.doc("<p>The Unix timestamp for the time when the task stops. More specifically, it's for the
  ...
  @ocaml.doc("<p>The Unix timestamp for the time when the task was stopped. More specifically, it's for
			the time when the task transitioned from the <code>RUNNING</code> state to the
				<code>STOPPED</code> state.</p>")
  stoppedAt: option<timestamp_>,
  @ocaml.doc("<p>The stop code indicating why a task was stopped. The <code>stoppedReason</code> might
  ...
  @ocaml.doc("<p>The tag specified when a task is started. If an Amazon ECS service started the task, the
				<code>startedBy</code> parameter contains the deployment ID of that service.</p>")
  startedBy: option<string_>,
  @ocaml.doc("<p>The Unix timestamp for the time when the task started. More specifically, it's for the
  ...
  @ocaml.doc("<p>The Unix timestamp for the time when the container image pull completed.</p>")
  pullStoppedAt: option<timestamp_>,
  @ocaml.doc("<p>The Unix timestamp for the time when the container image pull began.</p>")
  pullStartedAt: option<timestamp_>,
  @ocaml.doc("<p>The operating system that your tasks are running on. A platform family is specified
			only for tasks that use the Fargate launch type. </p>
		       <p> All tasks that run as part of this service must use the same
				<code>platformFamily</code> value as the service (for example,
			<code>LINUX.</code>).</p>")
  platformFamily: option<string_>,
  @ocaml.doc("<p>The platform version where your task runs on. A platform version is only specified for
  ...
  @ocaml.doc("<p>The amount of memory (in MiB) that the task uses as expressed in a task definition. It
  ...
  memory: option<string_>,
  @ocaml.doc("<p>The infrastructure where your task runs on. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html\">Amazon ECS
				launch types</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>")
  launchType: option<launchType>,
  @ocaml.doc("<p>The last known status for the task. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-lifecycle.html\">Task
				Lifecycle</a>.</p>")
  lastStatus: option<string_>,
  @ocaml.doc("<p>The Elastic Inference accelerator that's associated with the task.</p>")
  inferenceAccelerators: option<inferenceAccelerators>,
  @ocaml.doc("<p>The health status for the task. It's determined by the health of the essential
  ...
  healthStatus: option<healthStatus>,
  @ocaml.doc("<p>The name of the task group that's associated with the task.</p>")
  group: option<string_>,
  @ocaml.doc("<p>The Unix timestamp for the time when the task execution stopped.</p>")
  executionStoppedAt: option<timestamp_>,
  @ocaml.doc("<p>Determines whether execute command functionality is enabled for this task. If
  ...
  @ocaml.doc("<p>The Unix timestamp for the time when the task was created. More specifically, it's for
  ...
  cpu: option<string_>,
  @ocaml.doc("<p>The containers that's associated with the task.</p>")
  containers: option<containers>,
  @ocaml.doc("<p>The ARN of the container instances that host the task.</p>")
  containerInstanceArn: option<string_>,
  @ocaml.doc("<p>The Unix timestamp for the time when the task last went into <code>CONNECTED</code>
			status.</p>")
  ...
  @ocaml.doc("<p>The capacity provider that's associated with the task.</p>")
  capacityProviderName: option<string_>,
  @ocaml.doc("<p>The Availability Zone for the task.</p>") availabilityZone: option<string_>,
  @ocaml.doc("<p>The attributes of the task</p>") attributes: option<attributes>,
  @ocaml.doc("<p>The Elastic Network Adapter that's associated with the task if the task uses the
				<code>awsvpc</code> network mode.</p>")
  attachments: option<attachments>,
}
@ocaml.doc("<p>Details on a service within a cluster</p>")
type service = {
  @ocaml.doc("<p>Determines whether the execute command functionality is enabled for the service. If
				<code>true</code>, the execute command functionality is enabled for all containers
			in tasks as part of the service.</p>")
  enableExecuteCommand: option<boolean_>,
  @ocaml.doc("<p>Determines whether to propagate the tags from the task definition or the service to
			the task. If no value is specified, the tags aren't propagated.</p>")
  propagateTags: option<propagateTags>,
  @ocaml.doc("<p>Determines whether to use Amazon ECS managed tags for the tasks in the service. For more
  ...
  @ocaml.doc("<p>The Unix timestamp for the time when the service was created.</p>")
  createdAt: option<timestamp_>,
  @ocaml.doc("<p>The event stream for your service. A maximum of 100 of the latest events are
			displayed.</p>")
  events: option<serviceEvents>,
  @ocaml.doc("<p>The ARN of the IAM role that's associated with the service. It allows the Amazon ECS
  ...
  @ocaml.doc("<p>The task definition to use for tasks in the service. This value is specified when the
			service is created with <a>CreateService</a>, and it can be modified with
				<a>UpdateService</a>.</p>")
  taskDefinition: option<string_>,
  @ocaml.doc("<p>The operating system that your tasks in the service run on. A platform family is
			specified only for tasks using the Fargate launch type. </p>
		       <p> All tasks that run as part of this service must use the same
				<code>platformFamily</code> value as the service (for example,
			<code>LINUX</code>).</p>")
  platformFamily: option<string_>,
  @ocaml.doc("<p>The platform version to run your service on. A platform version is only specified for
  ...
  platformVersion: option<string_>,
  @ocaml.doc("<p>The capacity provider strategy the service uses. When using the DescribeServices API,
			this field is omitted if the service was created using a launch type.</p>")
  capacityProviderStrategy: option<capacityProviderStrategy>,
  @ocaml.doc("<p>The launch type the service is using. When using the DescribeServices API, this field
  ...
  status: option<string_>,
  @ocaml.doc("<p>The details for the service discovery registries to assign to this service. For more
			information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-discovery.html\">Service
				Discovery</a>.</p>")
  serviceRegistries: option<serviceRegistries>,
  @ocaml.doc("<p>A list of Elastic Load Balancing load balancer objects. It contains the load balancer name, the
...
type taskDefinition = {
  ...
  @ocaml.doc("<p>The Unix timestamp for the time when the task definition was deregistered.</p>")
  deregisteredAt: option<timestamp_>,
  @ocaml.doc("<p>The Unix timestamp for the time when the task definition was registered.</p>")
  registeredAt: option<timestamp_>,
  @ocaml.doc("<p>The configuration details for the App Mesh proxy.</p>
		       <p>Your Amazon ECS container instances require at least version 1.26.0 of the container agent
  ...
  memory: option<string_>,
  @ocaml.doc("<p>The number of <code>cpu</code> units used by the task. If you use the EC2 launch type,
  ...
  @ocaml.doc("<p>The operating system that your task definitions are running on. A platform family is
			specified only for tasks using the Fargate launch type. </p>
		       <p>When you specify a task in a service, this value must match the
				<code>runtimePlatform</code> value of the service.</p>")
  runtimePlatform: option<runtimePlatform>,
  ...
  @ocaml.doc("<p>The Amazon Resource Name (ARN) of the task execution role that grants the Amazon ECS container agent
            ...
            depending on the requirements of your task. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_execution_IAM_role.html\">Amazon ECS task
                execution IAM role</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>")
  executionRoleArn: option<string_>,
  @ocaml.doc("<p>The short name or full Amazon Resource Name (ARN) of the Identity and Access Management role that grants containers in the
  ...
  taskRoleArn: option<string_>,
  @ocaml.doc("<p>The name of a family that this task definition is registered to. Up to 255 characters
...
module DiscoverPollEndpoint = {
  type t
  type request = {
    @ocaml.doc("<p>The short name or full Amazon Resource Name (ARN) of the cluster that the container instance belongs
			to.</p>")
...
module UntagResource = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The Amazon Resource Name (ARN) of the resource to delete tags from. Currently, the supported resources
...
module ListTasks = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The name of the service to use when filtering the <code>ListTasks</code> results.
			...
			service.</p>")
    serviceName: option<string_>,
    @ocaml.doc("<p>The <code>startedBy</code> value to filter the task results with. Specifying a
				<code>startedBy</code> value limits the results to tasks that were started with that
			value.</p>")
    startedBy: option<string_>,
    @ocaml.doc("<p>The maximum number of task results that <code>ListTasks</code> returned in paginated
...
module ListTaskDefinitions = {
  type t
  type request = {
    @ocaml.doc("<p>The maximum number of task definition results that <code>ListTaskDefinitions</code>
    ...
    nextToken: option<string_>,
    @ocaml.doc("<p>The order to sort the results in. Valid values are <code>ASC</code> and
    ...
    @ocaml.doc("<p>The task definition status to filter the <code>ListTaskDefinitions</code> results
    ...
    @ocaml.doc("<p>The full family name to filter the <code>ListTaskDefinitions</code> results with.
...
module ListTaskDefinitionFamilies = {
  type t
  type request = {
    @ocaml.doc("<p>The maximum number of task definition family results that
    ...
    nextToken: option<string_>,
    @ocaml.doc("<p>The task definition family status to filter the
    ...
    @ocaml.doc("<p>The <code>familyPrefix</code> is a string that's used to filter the results of
...
module ListServices = {
  ...
  type request = {
    ...
    launchType: option<launchType>,
    @ocaml.doc("<p>The maximum number of service results that <code>ListServices</code> returned in
  ...
  type response = {
    @ocaml.doc("<p>The <code>nextToken</code> value to include in a future <code>ListServices</code>
			...
			return.</p>")
    nextToken: option<string_>,
    @ocaml.doc("<p>The list of full ARN entries for each service that's associated with the specified
			cluster.</p>")
...
module ListContainerInstances = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The maximum number of container instance results that
...
module ListClusters = {
  type t
  type request = {
    @ocaml.doc("<p>The maximum number of cluster results that <code>ListClusters</code> returned in
  ...
  type response = {
    @ocaml.doc("<p>The <code>nextToken</code> value to include in a future <code>ListClusters</code>
			...
			return.</p>")
    nextToken: option<string_>,
    @ocaml.doc("<p>The list of full Amazon Resource Name (ARN) entries for each cluster that's associated with your
			account.</p>")
...
module ExecuteCommand = {
  ...
  type response = {
    ...
    @ocaml.doc("<p>Determines whether the execute command session is running in interactive mode. Amazon ECS
...
module DeleteAccountSetting = {
  type t
  type request = {
    @ocaml.doc("<p>The Amazon Resource Name (ARN) of the principal. It can be an IAM user, IAM role, or
    ...
    principalArn: option<string_>,
    @ocaml.doc("<p>The resource name to disable the account setting for. If
				<code>serviceLongArnFormat</code> is specified, the ARN for your Amazon ECS services is
			affected. If <code>taskLongArnFormat</code> is specified, the ARN and resource ID for
			your Amazon ECS tasks is affected. If <code>containerInstanceLongArnFormat</code> is
			specified, the ARN and resource ID for your Amazon ECS container instances is affected. If
...
module TagResource = {
  ...
  type request = {
    ...
    tags: tags,
    @ocaml.doc("<p>The Amazon Resource Name (ARN) of the resource to add tags to. Currently, the supported resources are
...
module SubmitContainerStateChange = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The exit code that's returned for the state change request.</p>")
    exitCode: option<boxedInteger>,
...
module ListTagsForResource = {
  type t
  type request = {
    @ocaml.doc("<p>The Amazon Resource Name (ARN) that identifies the resource to list the tags for. Currently, the
...
module ListAttributes = {
  type t
  type request = {
    @ocaml.doc("<p>The maximum number of cluster results that <code>ListAttributes</code> returned in
    ...
    nextToken: option<string_>,
    @ocaml.doc("<p>The value of the attribute to filter results with. You must also specify an attribute
			name to use this parameter.</p>")
    attributeValue: option<string_>,
    @ocaml.doc("<p>The name of the attribute to filter the results with. </p>")
    attributeName: option<string_>,
    @ocaml.doc("<p>The type of the target to list attributes with.</p>") targetType: targetType,
...
module ListAccountSettings = {
  ...
  type request = {
    ...
    nextToken: option<string_>,
    @ocaml.doc("<p>Determines whether to return the effective settings. If <code>true</code>, the account
    ...
    principalArn: option<string_>,
    @ocaml.doc("<p>The value of the account settings to filter results with. You must also specify an
...
module DeleteAttributes = {
  type t
  type request = {
    @ocaml.doc("<p>The attributes to delete from your resource. You can specify up to 10 attributes for
...
module UpdateCapacityProvider = {
  type t
  type request = {
    @ocaml.doc("<p>An object that represent the parameters to update for the Auto Scaling group capacity
			provider.</p>")
...
module CreateCapacityProvider = {
  type t
  type request = {
    @ocaml.doc("<p>The metadata that you apply to the capacity provider to categorize and organize them
    ...
    @ocaml.doc("<p>The name of the capacity provider. Up to 255 characters are allowed. They include
...
module SubmitTaskStateChange = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The Unix timestamp for the time when the container image pull completed.</p>")
    pullStoppedAt: option<timestamp_>,
    @ocaml.doc("<p>The Unix timestamp for the time when the container image pull started.</p>")
    pullStartedAt: option<timestamp_>,
    @ocaml.doc("<p>The details for the managed agent that's associated with the task.</p>")
    managedAgents: option<managedAgentStateChanges>,
    @ocaml.doc("<p>Any attachments associated with the state change request.</p>")
    attachments: option<attachmentStateChanges>,
    @ocaml.doc("<p>Any containers that's associated with the state change request.</p>")
...
module DeleteTaskSet = {
  type t
  type request = {
    @ocaml.doc("<p>If <code>true</code>, you can delete a task set even if it hasn't been scaled down to
			zero.</p>")
...
module CreateTaskSet = {
  ...
  type request = {
    ...
    tags: option<tags>,
    @ocaml.doc("<p>The identifier that you provide to ensure the idempotency of the request. It's case
			sensitive and must be unique. It can be up to 32 ASCII characters are allowed.</p>")
    clientToken: option<string_>,
    @ocaml.doc("<p>A floating-point percentage of the desired number of tasks to place and keep running
			in the task set.</p>")
    scale: option<scale>,
    @ocaml.doc("<p>The platform version that the tasks in the task set uses. A platform version is
    ...
    capacityProviderStrategy: option<capacityProviderStrategy>,
    @ocaml.doc("<p>The launch type that new tasks in the task set uses. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html\">Amazon ECS
				Launch Types</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
  ...
  type response = {
    @ocaml.doc("<p>Information about a set of Amazon ECS tasks in either an CodeDeploy or an
...
module UpdateContainerAgent = {
  type t
  type request = {
    @ocaml.doc("<p>The container instance ID or full ARN entries for the container instance where you
  ...
  type response = {
    @ocaml.doc("<p>The container instance that the container agent was updated for.</p>")
...
module UpdateClusterSettings = {
  type t
  type request = {
    @ocaml.doc("<p>The setting to use by default for a cluster. This parameter is used to turn on CloudWatch
...
module RegisterContainerInstance = {
  ...
  type request = {
    ...
    containerInstanceArn: option<string_>,
    @ocaml.doc("<p>The version information for the Amazon ECS container agent and Docker daemon that runs on
    ...
    @ocaml.doc("<p>The short name or full Amazon Resource Name (ARN) of the cluster to register your container instance
...
module DeregisterContainerInstance = {
  type t
  type request = {
    @ocaml.doc("<p>Forces the container instance to be deregistered. If you have tasks running on the
...
module CreateCluster = {
  type t
  type request = {
    @ocaml.doc("<p>The capacity provider strategy to set as the default for the cluster. After a default
    ...
    @ocaml.doc("<p>The short name of one or more capacity providers to associate with the cluster. A
			...
			list of available capacity providers for a cluster after the cluster is created.</p>")
    capacityProviders: option<stringList>,
    @ocaml.doc("<p>The <code>execute</code> command configuration for the cluster.</p>")
    configuration: option<clusterConfiguration>,
    @ocaml.doc("<p>The setting to use when creating a cluster. This parameter is used to turn on CloudWatch
			Container Insights for a cluster. If this value is specified, it overrides the
				<code>containerInsights</code> value set with <a>PutAccountSetting</a> or
				<a>PutAccountSettingDefault</a>.</p>")
    settings: option<clusterSettings>,
    ...
    tags: option<tags>,
    @ocaml.doc("<p>The name of your cluster. If you don't specify a name for your cluster, you create a
...
module UpdateService = {
  ...
  type request = {
    ...
    loadBalancers: option<loadBalancers>,
    @ocaml.doc("<p>Determines whether to turn on Amazon ECS managed tags for the tasks in the service. For more
			information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-using-tags.html\">Tagging Your Amazon ECS
				Resources</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
		       <p>Only tasks launched after the update will reflect the update. To update the tags on
			all tasks, set <code>forceNewDeployment</code> to <code>true</code>, so that Amazon ECS
			starts new tasks with the updated tags.</p>")
    enableECSManagedTags: option<boxedBoolean>,
    ...
    @ocaml.doc("<p>The period of time, in seconds, that the Amazon ECS service scheduler ignores unhealthy
			...
			up.</p>")
    healthCheckGracePeriodSeconds: option<boxedInteger>,
    @ocaml.doc("<p>Determines whether to force a new deployment of the service. By default, deployments
    ...
    @ocaml.doc("<p>The short name or full Amazon Resource Name (ARN) of the cluster that your service runs on.
			If you do not specify a cluster, the default cluster is assumed.</p>")
    cluster: option<string_>,
  }
  type response = {
...
module UpdateContainerInstancesState = {
  type t
  type request = {
    @ocaml.doc("<p>The container instance state to update the container instance with. The only valid
    ...
    @ocaml.doc("<p>A list of up to 10 container instance IDs or full ARN entries.</p>")
...
module StopTask = {
  type t
  type request = {
    @ocaml.doc("<p>An optional message specified when a task is stopped. For example, if you're using a
...
module DescribeClusters = {
  type t
  type request = {
    @ocaml.doc("<p>Determines whether to include additional information about the clusters in the
...
module DeleteService = {
  type t
  type request = {
    @ocaml.doc("<p>If <code>true</code>, allows you to delete a service even if it wasn't scaled down to
...
module CreateService = {
  ...
  type request = {
    ...
    propagateTags: option<propagateTags>,
    @ocaml.doc("<p>Specifies whether to turn on Amazon ECS managed tags for the tasks within the service. For
    ...
    @ocaml.doc("<p>The capacity provider strategy to use for the service.</p>
			...
			parameter must be omitted. If no <code>capacityProviderStrategy</code> or
		       ...
		       <p>A capacity provider strategy may contain a maximum of 6 capacity providers.</p>")
    capacityProviderStrategy: option<capacityProviderStrategy>,
    @ocaml.doc("<p>The infrastructure that you run your service on. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html\">Amazon ECS
				launch types</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
			...
			parameter must be omitted.</p>")
    launchType: option<launchType>,
    @ocaml.doc("<p>An identifier that you provide to ensure the idempotency of the request. It must be
    ...
    @ocaml.doc("<p>The name of your service. Up to 255 letters (uppercase and lowercase), numbers, underscores, and hyphens are allowed. Service names must be unique within
			...
			Region or across multiple Regions.</p>")
    serviceName: string_,
    @ocaml.doc("<p>The short name or full Amazon Resource Name (ARN) of the cluster that you run your service on.
			If you do not specify a cluster, the default cluster is assumed.</p>")
    cluster: option<string_>,
  }
  type response = {
...
module StartTask = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>Whether or not the execute command functionality is enabled for the task. If
			...
			the task.</p>")
    enableExecuteCommand: option<boolean_>,
    @ocaml.doc("<p>Specifies whether to use Amazon ECS managed tags for the task. For more information, see
				<a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-using-tags.html\">Tagging Your Amazon ECS
				Resources</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>")
    enableECSManagedTags: option<boolean_>,
    @ocaml.doc("<p>The container instance IDs or full ARN entries for the container instances where you
			would like to place your task. You can specify up to 10 container instances.</p>")
    containerInstances: stringList,
    @ocaml.doc("<p>The short name or full Amazon Resource Name (ARN) of the cluster where to start your task.
			If you do not specify a cluster, the default cluster is assumed.</p>")
    cluster: option<string_>,
  }
  type response = {
...
module RunTask = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>An optional tag specified when a task is started. For example, if you automatically
			...
			contains the deployment ID of the service that starts it.</p>")
    startedBy: option<string_>,
    @ocaml.doc("<p>The reference ID to use for the task. The reference ID can have a maximum length of
			1024 characters.</p>")
    ...
    propagateTags: option<propagateTags>,
    @ocaml.doc("<p>The platform version the task uses. A platform version is only specified for tasks
			hosted on Fargate. If one isn't specified, the <code>LATEST</code>
			platform version is used. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html\">Fargate platform
				versions</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>")
    platformVersion: option<string_>,
    @ocaml.doc("<p>The placement strategy objects to use for the task. You can specify a maximum of 5
    ...
    @ocaml.doc("<p>The network configuration for the task. This parameter is required for task
			...
			in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>")
    networkConfiguration: option<networkConfiguration>,
    @ocaml.doc("<p>The infrastructure to run your standalone task on. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html\">Amazon ECS
				launch types</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
		       <p>The <code>FARGATE</code> launch type runs your tasks on Fargate On-Demand
			infrastructure.</p>
		       <note>
    ...
    group: option<string_>,
    @ocaml.doc("<p>Determines whether to use the execute command functionality for the containers in
    ...
    @ocaml.doc("<p>The short name or full Amazon Resource Name (ARN) of the cluster to run your task on.
			If you do not specify a cluster, the default cluster is assumed.</p>")
    cluster: option<string_>,
...
module RegisterTaskDefinition = {
  type t
  type request = {
    @ocaml.doc("<p>The operating system that your tasks definitions run on. A platform family is
			specified only for tasks using the Fargate launch type. </p>
    ...
    cpu: option<string_>,
    @ocaml.doc("<p>The task launch type that Amazon ECS validates the task definition against. A client
    ...
    placementConstraints: option<taskDefinitionPlacementConstraints>,
    @ocaml.doc("<p>A list of volume definitions in JSON format that containers in your task might
			use.</p>")
    volumes: option<volumeList>,
    @ocaml.doc("<p>A list of container definitions in JSON format that describe the different containers
    ...
    taskRoleArn: option<string_>,
    @ocaml.doc("<p>You must specify a <code>family</code> for a task definition. You can use it track
...
module DescribeTaskDefinition = {
  type t
  type request = {
    @ocaml.doc("<p>Determines whether to see the resource tags for the task definition. If
  ...
  type response = {
    @ocaml.doc("<p>The metadata that's applied to the task definition to help you categorize and organize
...
module DescribeServices = {
  type t
  type request = {
    @ocaml.doc("<p>Determines whether you want to see the resource tags for the service. If
				<code>TAGS</code> is specified, the tags are included in the response. If this field
			is omitted, tags aren't included in the response.</p>")
    @as("include")
