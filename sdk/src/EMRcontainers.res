...
type eksInfo = {
  @ocaml.doc("<p>The namespaces of the EKS cluster.</p>") namespace: option<string256>,
}
@ocaml.doc(
...
type containerProvider = {
  ...
  @ocaml.doc("<p>The ID of the container cluster.</p>") id: string256,
...
type endpoint = {
  ...
  configurationOverrides: option<configurationOverrides>,
  @ocaml.doc("<p>The certificate ARN of the endpoint.</p>") certificateArn: option<acmcertArn>,
...
module CreateManagedEndpoint = {
  ...
  type request = {
    ...
    configurationOverrides: option<configurationOverrides>,
    @ocaml.doc("<p>The certificate ARN of the managed endpoint.</p>") certificateArn: acmcertArn,
