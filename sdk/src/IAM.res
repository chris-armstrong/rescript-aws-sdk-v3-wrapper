...
@ocaml.doc("<p>The Amazon Resource Name (ARN). ARNs are unique identifiers for AWS resources.</p>
...
@ocaml.doc("<p>Contains details about the most recent attempt to access an action within the service.</p>
...
type roleLastUsed = {
  @ocaml.doc("<p>The name of the AWS Region in which the role was last used.</p>") @as("Region")
...
type passwordPolicy = {
  @ocaml.doc("<p>Specifies whether IAM users are prevented from setting a new password after their
  ...
  @ocaml.doc("<p>Specifies whether IAM users are allowed to change their own password.</p>")
  ...
  @ocaml.doc("<p>Specifies whether IAM user passwords must contain at least one of the following symbols:</p>
         <p>! @ # $ % ^ & * ( ) _ + - = [ ] { } | '</p>")
  @as("RequireSymbols")
...
type loginProfile = {
  ...
  createDate: dateType,
  @ocaml.doc("<p>The name of the user, which can be used for signing in to the AWS Management
         Console.</p>")
  @as("UserName")
  userName: userNameType,
}
...
@ocaml.doc("<p>Contains information about an AWS access key, without its secret key.</p>
...
@ocaml.doc("<p>Contains information about the last time an AWS access key was used since IAM began
...
type accessKeyLastUsed = {
  @ocaml.doc("<p>The AWS Region where this access key was most recently used. The value for this field is
  ...
  @as("Region")
  region: stringType,
  @ocaml.doc("<p>The name of the AWS service with which this access key was most recently used. The value
...
@ocaml.doc("<p>Contains information about an AWS access key.</p>
...
@ocaml.doc("<p>An object that contains details about when a principal in the reported AWS Organizations entity
...
@ocaml.doc("<fullname>AWS Identity and Access Management</fullname>
...
module UpdateAccountPasswordPolicy = {
  type t
  type request = {
    @ocaml.doc("<p>Prevents IAM users from setting a new password after their password has expired. The
    ...
    @as("MaxPasswordAge")
    maxPasswordAge: option<maxPasswordAgeType>,
    @ocaml.doc("<p> Allows all IAM users in your account to use the AWS Management Console to change their own
...
module SetSecurityTokenServicePreferences = {
  type t
  type request = {
    @ocaml.doc("<p>The version of the global endpoint token. Version 1 tokens are valid only in AWS
...
module GenerateOrganizationsAccessReport = {
  type t
  type request = {
    @ocaml.doc("<p>The identifier of the AWS Organizations service control policy (SCP). This parameter is
            optional.</p>
    ...
    @ocaml.doc("<p>The path of the AWS Organizations entity (root, OU, or account). You can build an entity path using
...
module ChangePassword = {
  type t
  type request = {
    @ocaml.doc("<p>The new password. The new password must conform to the AWS account's password
...
module ListAccountAliases = {
  ...
  type response = {
    ...
    @as("IsTruncated")
    isTruncated: option<booleanType>,
    @ocaml.doc("<p>A list of aliases associated with the account. AWS supports only one alias per
            account.</p>")
    @as("AccountAliases")
...
module GetLoginProfile = {
  ...
  type response = {
    @ocaml.doc("<p>A structure containing the user name and password create date for the user.</p>")
    @as("LoginProfile")
...
module GetAccessKeyLastUsed = {
  ...
  type response = {
    ...
    @ocaml.doc("<p>The name of the AWS IAM user that owns this access key.</p>
        <p></p>")
    @as("UserName")
    userName: option<existingUserNameType>,
  }
...
module CreateServiceSpecificCredential = {
  type t
  type request = {
    @ocaml.doc("<p>The name of the AWS service that is to be associated with the credentials. The
...
module ListUserTags = {
  type t
  type request = {
    @ocaml.doc("<p>(Optional) Use this only when paginating results to indicate the 
...
module ListServiceSpecificCredentials = {
  type t
  type request = {
    @ocaml.doc("<p>Filters the returned results to only those for the specified AWS service. If not
...
module ListSAMLProviders = {
  ...
  type response = {
    @ocaml.doc("<p>The list of SAML provider resource objects defined in IAM for this AWS
            account.</p>")
    @as("SAMLProviderList")
...
module ListOpenIDConnectProviders = {
  ...
  @ocaml.doc("<p>Contains the response to a successful <a>ListOpenIDConnectProviders</a>
      request. </p>")
  type response = {
    @ocaml.doc("<p>The list of IAM OIDC provider resource objects defined in the AWS account.</p>")
...
module CreateOpenIDConnectProvider = {
  ...
  type request = {
   ...
   fails and the resource is not created.</p>
    ...
    @as("ThumbprintList")
    thumbprintList: thumbprintListType,
    @ocaml.doc("<p>A list of client IDs (also known as audiences). When a mobile or web app registers
...
module GetServiceLastAccessedDetailsWithEntities = {
  ...
  type request = {
    ...
    @as("MaxItems")
    maxItems: option<maxItemsType>,
    @ocaml.doc("<p>The service namespace for an AWS service. Provide the service namespace to learn
...
module CreateServiceLinkedRole = {
  ...
  type request = {
    ...
    description: option<roleDescriptionType>,
    @ocaml.doc("<p>The service principal for the AWS service to which this role is attached. You use a
...
module ListPoliciesGrantingServiceAccess = {
  type t
  type request = {
    @ocaml.doc("<p>The service namespace for the AWS services whose policies you want to list.</p>
        <p>To learn the service namespace for a service, see <a href=\"https://docs.aws.amazon.com/service-authorization/latest/reference/reference_policies_actions-resources-contextkeys.html\">Actions, resources, and condition keys for AWS services</a> in the
                <i>IAM User Guide</i>. Choose the name of the service to view
            details for that service. In the first paragraph, find the service prefix. For example,
                <code>(service prefix: a4b)</code>. For more information about service namespaces,
...
module SimulatePrincipalPolicy = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>An AWS account ID that specifies the owner of any simulated resource that does not
    ...
    @ocaml.doc("<p>A list of ARNs of AWS resources to include in the simulation. If this parameter is
...
module SimulateCustomPolicy = {
  ...
  type request = {
    ...
    @as("CallerArn")
    callerArn: option<resourceNameType>,
    @ocaml.doc("<p>An ARN representing the AWS account ID that specifies the owner of any simulated
