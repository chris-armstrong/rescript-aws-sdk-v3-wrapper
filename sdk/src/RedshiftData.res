...
@ocaml.doc("<p>Information about an SQL statement.</p>")
type subStatementData = {
  ...
  @ocaml.doc("<p>The identifier of the SQL statement. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API. 
...
type statementStringList = array<statementString>
@ocaml.doc("<p>A parameter used in a SQL statement.</p>")
type sqlParameter = {
  @ocaml.doc("<p>The value of the parameter. 
  ...
  @ocaml.doc("<p>The name of the parameter.</p>") name: parameterName,
}
type sqlList = array<statementString>
...
type subStatementList = array<subStatementData>
...
type statementData = {
  @ocaml.doc("<p>A value that indicates whether the statement is a batch query request.</p>")
  @as("IsBatchStatement")
  isBatchStatement: option<baseBoolean>,
  @ocaml.doc("<p>The parameters used in a SQL statement.</p>") @as("QueryParameters")
  queryParameters: option<sqlParametersList>,
  @ocaml.doc("<p>The date and time (UTC) that the statement metadata was last updated.</p>")
  @as("UpdatedAt")
  updatedAt: option<baseTimestamp>,
  @ocaml.doc("<p>The date and time (UTC) the statement was created. </p>") @as("CreatedAt")
  ...
  @as("QueryStrings")
  queryStrings: option<statementStringList>,
...
module BatchExecuteStatement = {
  ...
  type request = {
    ...
    @as("ClusterIdentifier")
    clusterIdentifier: option<location>,
    @ocaml.doc("<p>One or more SQL statements to run. </p>") @as("Sqls") sqls: sqlList,
  }
  type response = {
...
module ExecuteStatement = {
  type t
  type request = {
    @ocaml.doc("<p>The parameters for the SQL statement.</p>") @as("Parameters")
...
module DescribeStatement = {
  ...
  type response = {
    @ocaml.doc("<p>The SQL statements from a multiple statement run.</p>") @as("SubStatements")
    subStatements: option<subStatementList>,
    @ocaml.doc("<p>The parameters for the SQL statement.</p>") @as("QueryParameters")
    queryParameters: option<sqlParametersList>,
    ...
    @ocaml.doc("<p>The SQL statement text. </p>") @as("QueryString")
    queryString: option<statementString>,
    @ocaml.doc("<p>A value that indicates whether the statement has a result set. The result set can be empty. The value is true for an empty result set.
...
module ListStatements = {
  ...
  type request = {
    ...
    @as("Status")
    status: option<statusString>,
    @ocaml.doc("<p>The name of the SQL statement specified as input to <code>BatchExecuteStatement</code> or <code>ExecuteStatement</code> to identify the query. 
