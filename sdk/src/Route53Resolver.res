...
type resolverQueryLogConfig = {
  ...
  @ocaml.doc("<p>An indication of whether the query logging configuration is shared with other AWS accounts, or was shared with the current account by another 
...
type firewallRuleGroupMetadata = {
  @ocaml.doc("<p>Whether the rule group is shared with other AWS accounts, or was shared with the current account by another 
              AWS account. Sharing is configured through AWS Resource Access Manager (AWS RAM).</p>")
  @as("ShareStatus")
  shareStatus: option<shareStatus>,
  ...
  @as("CreatorRequestId")
  creatorRequestId: option<creatorRequestId>,
  @ocaml.doc("<p>The AWS account ID for the account that created the rule group. When a rule group is shared with your account,
...
type firewallRuleGroupAssociation = {
  ...
  @ocaml.doc("<p>The owner of the association, used only for associations that are not managed by you. If you use AWS Firewall Manager to 
...
module PutResolverRulePolicy = {
  type t
  type request = {
    @ocaml.doc("<p>An AWS Identity and Access Management policy statement that lists the rules that you want to share with another AWS account and the operations that you want the account 
...
module PutResolverQueryLogConfigPolicy = {
  type t
  type request = {
    @ocaml.doc("<p>An AWS Identity and Access Management policy statement that lists the query logging configurations that you want to share with another AWS account 
...
module GetFirewallRuleGroupPolicy = {
  ...
  type response = {
    @ocaml.doc("<p>The AWS Identity and Access Management (AWS IAM) policy for sharing the specified rule
...
module ListResolverRuleAssociations = {
  ...
  type response = {
    @ocaml.doc("<p>The associations that were created between Resolver rules and VPCs using the current AWS account, and that match the 
...
module ListResolverDnssecConfigs = {
  ...
  type request = {
    ...
    filters: option<filters>,
    @ocaml.doc("<p>(Optional) If the current AWS account has more than <code>MaxResults</code> DNSSEC configurations, use <code>NextToken</code> 
  ...
  type response = {
    ...
    @ocaml.doc("<p>If a response includes the last of the DNSSEC configurations that are associated with the current AWS account, 
