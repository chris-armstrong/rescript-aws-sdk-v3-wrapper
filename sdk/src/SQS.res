...
@ocaml.doc("<p>Encloses a <code>MessageId</code> for a successfully-enqueued message in a <code>
...
attribute to verify that Amazon SQS received the message correctly. Amazon SQS URL-decodes the message before creating the MD5 digest. For information about MD5, see <a href=\"https://www.ietf.org/rfc/rfc1321.txt\">RFC1321</a>.</p>")
  ...
  @ocaml.doc("<p>An identifier for the message.</p>") @as("MessageId") messageId: string_,
  @ocaml.doc("<p>An identifier for the message in this batch.</p>") @as("Id") id: string_,
}
...
@ocaml.doc("<p>Encloses the <code>Id</code> of an entry in <code>
               <a>DeleteMessageBatch</a>.</code>
         </p>")
type deleteMessageBatchResultEntry = {
  @ocaml.doc("<p>Represents a successfully deleted message.</p>") @as("Id") id: string_,
}
@ocaml.doc("<p>Encloses a receipt handle and an identifier for it.</p>")
type deleteMessageBatchRequestEntry = {
  @ocaml.doc("<p>A receipt handle.</p>") @as("ReceiptHandle") receiptHandle: string_,
  @ocaml.doc("<p>An identifier for this particular receipt handle. This is used to communicate the result.</p>
         <note>
...
type changeMessageVisibilityBatchResultEntry = {
  @ocaml.doc("<p>Represents a message whose visibility timeout has been changed successfully.</p>")
  @as("Id")
  id: string_,
}
@ocaml.doc("<p>Encloses a receipt handle and an entry id for each message in <code>
               <a>ChangeMessageVisibilityBatch</a>.</code>
         </p>
         <important>
...
type changeMessageVisibilityBatchRequestEntry = {
  @ocaml.doc("<p>The new value (in seconds) for the message's visibility timeout.</p>")
  @as("VisibilityTimeout")
  visibilityTimeout: option<integer_>,
  @ocaml.doc("<p>A receipt handle.</p>") @as("ReceiptHandle") receiptHandle: string_,
  @ocaml.doc("<p>An identifier for this particular receipt handle used to communicate the result.</p>
         <note>
            <p>The <code>Id</code>s of a batch request need to be unique within a request.</p>
            <p>This identifier can have up to 80 characters. The following characters are accepted: alphanumeric characters, hyphens(-), and underscores (_).</p>
         </note>")
...
@ocaml.doc("<p>Gives a detailed description of the result of an action on each entry in the
            request.</p>")
...
@ocaml.doc("<p>The user-specified message system attribute value. For string data types, the <code>Value</code> attribute has the same restrictions on the content as the message body. For more information, see <code>
...
type messageSystemAttributeValue = {
  ...
  @ocaml.doc("<p>Not implemented. Reserved for future use.</p>") @as("StringListValues")
...
@ocaml.doc("<p>The user-specified message attribute value. For string data types, the <code>Value</code> attribute has the same restrictions on the content as the message body. For more information, see <code>
               <a>SendMessage</a>.</code>
         </p>    
         <p>
...
message attributes</a> in the <i>Amazon SQS Developer Guide</i>.</p>")
  ...
  @ocaml.doc("<p>The body of the message.</p>") @as("MessageBody") messageBody: string_,
  @ocaml.doc("<p>An identifier for a message in this batch used to communicate the result.</p>
         <note>
            <p>The <code>Id</code>s of a batch request need to be unique within a request.</p>
            <p>This identifier can have up to 80 characters. The following characters are accepted: alphanumeric characters, hyphens(-), and underscores (_).</p>
         </note>")
...
message attributes</a> in the <i>Amazon SQS Developer Guide</i>.</p>")
  ...
  @as("MD5OfMessageAttributes")
  md5OfMessageAttributes: option<string_>,
  @ocaml.doc("<p>A map of the attributes requested in <code>
               <a>ReceiveMessage</a>
  ...
  @ocaml.doc("<p>The message's contents (not URL-encoded).</p>") @as("Body") body: option<string_>,
  @ocaml.doc("<p>An MD5 digest of the non-URL-encoded message body string.</p>") @as("MD5OfBody")
...
module RemovePermission = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>The identification of the permission to remove. This is the label added using the <code>
               <a>AddPermission</a>
            </code> action.</p>")
    @as("Label")
    label: string_,
    @ocaml.doc("<p>The URL of the Amazon SQS queue from which permissions are removed.</p>
...
module PurgeQueue = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>The URL of the queue from which the <code>PurgeQueue</code> action deletes messages.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
...
module DeleteQueue = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>The URL of the Amazon SQS queue to delete.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
...
module DeleteMessage = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>The receipt handle associated with the message to delete.</p>")
    @as("ReceiptHandle")
    receiptHandle: string_,
    @ocaml.doc("<p>The URL of the Amazon SQS queue from which messages are deleted.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
...
module ChangeMessageVisibility = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The receipt handle associated with the message whose visibility timeout is changed. This parameter is returned by the <code>
               <a>ReceiveMessage</a>
            </code> action.</p>")
    @as("ReceiptHandle")
    receiptHandle: string_,
    @ocaml.doc("<p>The URL of the Amazon SQS queue whose message's visibility is changed.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
...
module UntagQueue = {
  type t
  type request = {
    @ocaml.doc("<p>The list of tags to be removed from the specified queue.</p>") @as("TagKeys")
    tagKeys: tagKeyList,
...
module TagQueue = {
  type t
  type request = {
    @ocaml.doc("<p>The list of tags to be added to the specified queue.</p>") @as("Tags")
    tags: tagMap,
    @ocaml.doc("<p>The URL of the queue.</p>") @as("QueueUrl") queueUrl: string_,
  }
  type response = {.}
...
module SetQueueAttributes = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>A map of attributes to set.</p>
...
module ListQueues = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>Maximum number of results to include in the response. Value range is 1 to 1000. 
    ...
    @ocaml.doc("<p>Pagination token to request the next set of results.</p>") @as("NextToken")
    nextToken: option<token>,
    @ocaml.doc("<p>A string to use for filtering the list results. Only those queues whose name begins with the specified string are returned.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueNamePrefix")
  ...
  type response = {
    ...
    @ocaml.doc("<p>Pagination token to include in the next request. Token value is <code>null</code> if there are no additional
...
module ListQueueTags = {
  ...
  type response = {
    @ocaml.doc("<p>The list of all tags added to the specified queue.</p>") @as("Tags")
    tags: option<tagMap>,
  }
...
module ListDeadLetterSourceQueues = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>Pagination token to request the next set of results.</p>") @as("NextToken")
    nextToken: option<token>,
    @ocaml.doc("<p>The URL of a dead-letter queue.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
...
for FIFO queues</a>:</p> 
  ...
  type response = {
    @ocaml.doc("<p>A map of attributes to their respective values.</p>") @as("Attributes")
...
cross-account permissions to a role and a user name</a> in the <i>Amazon SQS Developer Guide</i>.</p>
  ...
  @ocaml.doc("<p>Returns the <code>QueueUrl</code> attribute of the created queue.</p>")
  type response = {
    @ocaml.doc("<p>The URL of the created Amazon SQS queue.</p>") @as("QueueUrl")
...
module AddPermission = {
  ...
  type request = {
    ...
    @as("Label")
    label: string_,
    @ocaml.doc("<p>The URL of the Amazon SQS queue to which permissions are added.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
...
module DeleteMessageBatch = {
  ...
  @ocaml.doc("<p></p>")
  type request = {
    @ocaml.doc("<p>A list of receipt handles for the messages to be deleted.</p>") @as("Entries")
  ...
  @ocaml.doc("<p>For each message in the batch, the response contains a  <code>
...
module ChangeMessageVisibilityBatch = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The URL of the Amazon SQS queue whose messages' visibility is changed.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
...
message attributes</a> in the <i>Amazon SQS Developer Guide</i>.</p>")
    ...
    @as("DelaySeconds")
    delaySeconds: option<integer_>,
    @ocaml.doc("<p>The message to send. The minimum size is one character. The maximum size is 256 KB.</p>
         <important>
    ...
    @as("MessageBody")
    messageBody: string_,
    @ocaml.doc("<p>The URL of the Amazon SQS queue to which a message is sent.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
  @ocaml.doc("<p>The <code>MD5OfMessageBody</code> and <code>MessageId</code> elements.</p>")
  type response = {
    @ocaml.doc("<p>This parameter applies only to FIFO (first-in-first-out) queues.</p>
         <p>The large, non-consecutive number that Amazon SQS assigns to each message.</p>
...
module SendMessageBatch = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The URL of the Amazon SQS queue to which batched messages are sent.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
...
module ReceiveMessage = {
  ...
  type request = {
    ...
    @as("MaxNumberOfMessages")
    maxNumberOfMessages: option<integer_>,
    @ocaml.doc("<p>The name of the message attribute, where <i>N</i> is the index.</p>
         <ul>
            <li>
    ...
    @as("MessageAttributeNames")
    messageAttributeNames: option<messageAttributeNameList>,
    @ocaml.doc("<p>A list of attributes that need to be returned along with each message. These attributes
            include:</p>
         <ul>
            <li>
               <p>
    ...
    @as("AttributeNames")
    attributeNames: option<attributeNameList>,
    @ocaml.doc("<p>The URL of the Amazon SQS queue from which messages are received.</p>
         <p>Queue URLs and names are case-sensitive.</p>")
    @as("QueueUrl")
    queueUrl: string_,
  }
  ...
  type response = {
    @ocaml.doc("<p>A list of messages.</p>") @as("Messages") messages: option<messageList>,
  }
