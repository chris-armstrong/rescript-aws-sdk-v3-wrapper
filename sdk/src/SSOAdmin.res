...
@ocaml.doc("<p>A set of key-value pairs that are used to manage the resource. Tags can only be applied to permission sets and cannot be applied to corresponding roles
...
Names (ARNs) and AWS Service Namespaces</a> in the <i>AWS General Reference</i>.</p>")
  ...
  @ocaml.doc("<p>The identifier of the AWS account from which to list the assignments.</p>")
  @as("AccountId")
...
type instanceMetadata = {
  ...
  @ocaml.doc("<p>The ARN of the SSO instance under which the operation will be executed.
...
@ocaml.doc("<p>The assignment that indicates a principal's limited access to a specified AWS account
...
Names (ARNs) and AWS Service Namespaces</a> in the <i>AWS General Reference</i>.</p>")
  @as("PermissionSetArn")
  permissionSetArn: option<permissionSetArn>,
  @ocaml.doc("<p>The identifier of the AWS account.</p>") @as("AccountId")
  accountId: option<accountId>,
}
...
type accessControlAttributeValue = {
  @ocaml.doc("<p>The identity source to use when mapping a specified attribute to AWS SSO.</p>")
  @as("Source")
...
Names (ARNs) and AWS Service Namespaces</a> in the <i>AWS General Reference</i>.</p>")
  ...
  type response = {
    @ocaml.doc("<p>Defines the level of access that an AWS account has.</p>") @as("PermissionSets")
...
Names (ARNs) and AWS Service Namespaces</a> in the <i>AWS General Reference</i>.</p>")
  ...
  type response = {
    ...
    @as("NextToken")
    nextToken: option<token>,
    @ocaml.doc("<p>Defines the level of access on an AWS account.</p>") @as("PermissionSets")
    permissionSets: option<permissionSetList>,
  }
...
module ListAccountsForProvisionedPermissionSet = {
  ...
  type request = {
    ...
    @as("MaxResults")
    maxResults: option<maxResults>,
    @ocaml.doc("<p>The permission set provisioning status for an AWS account.</p>")
    @as("ProvisioningStatus")
    provisioningStatus: option<provisioningStatus>,
    @ocaml.doc("<p>The ARN of the <a>PermissionSet</a> from which the associated AWS accounts
      will be listed.</p>")
    @as("PermissionSetArn")
    permissionSetArn: permissionSetArn,
    @ocaml.doc("<p>The ARN of the SSO instance under which the operation will be executed.
...
Names (ARNs) and AWS Service Namespaces</a> in the <i>AWS General Reference</i>.</p>")
  ...
  type response = {
    ...
    @as("NextToken")
    nextToken: option<token>,
    @ocaml.doc("<p>The list of AWS <code>AccountIds</code>.</p>") @as("AccountIds")
...
Names (ARNs) and AWS Service Namespaces</a> in the <i>AWS General Reference</i>.</p>")
  ...
  type response = {
    @ocaml.doc("<p>Describes the level of access on an AWS account.</p>") @as("PermissionSet")
...
module ListManagedPoliciesInPermissionSet = {
  ...
  type request = {
    ...
    @as("MaxResults")
    maxResults: option<maxResults>,
    @ocaml.doc("<p>The ARN of the <a>PermissionSet</a> whose managed policies will be listed.</p>")
    @as("PermissionSetArn")
    permissionSetArn: permissionSetArn,
    @ocaml.doc("<p>The ARN of the SSO instance under which the operation will be executed.
      For more information about ARNs, see <a href=\"/general/latest/gr/aws-arns-and-namespaces.html\">Amazon Resource
...
Names (ARNs) and AWS Service Namespaces</a> in the <i>AWS General Reference</i>.</p>")
  ...
  type response = {
    @ocaml.doc("<p>Defines the level of access on an AWS account.</p>") @as("PermissionSet")
    permissionSet: option<permissionSet>,
  }
