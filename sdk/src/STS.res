...
@ocaml.doc("<p>Amazon Web Services credentials for API authentication.</p>")
type credentials = {
...
@ocaml.doc("<fullname>Security Token Service</fullname>
...
module GetCallerIdentity = {
  ...
  type response = {
    @ocaml.doc("<p>The Amazon Web Services ARN associated with the calling entity.</p>") @as("Arn")
    arn: option<arnType>,
    @ocaml.doc("<p>The Amazon Web Services account ID number of the account that owns or contains the calling
         entity.</p>")
    @as("Account")
  ...
  @module("@aws-sdk/client-sts") @new external new: request => t = "GetCallerIdentityCommand"
...
module GetAccessKeyInfo = {
  ...
  type response = {
    @ocaml.doc("<p>The number used to identify the Amazon Web Services account.</p>") @as("Account")
    account: option<accountType>,
  }
...
module DecodeAuthorizationMessage = {
  ...
  type response = {
    @ocaml.doc("<p>The API returns a response with the decoded message.</p>") @as("DecodedMessage")
...
module GetSessionToken = {
  ...
  type request = {
    ...
    @ocaml.doc("<p>The duration, in seconds, that the credentials should remain valid. Acceptable durations
...
module AssumeRoleWithWebIdentity = {
  ...
  type request = {
    ...
    @as("PolicyArns")
    policyArns: option<policyDescriptorListType>,
    @ocaml.doc("<p>The fully qualified host component of the domain name of the OAuth 2.0 identity
...
module AssumeRole = {
  ...
  type request = {
    ...
    @as("Tags")
    tags: option<tagListType>,
    @ocaml.doc("<p>The duration, in seconds, of the role session. The value specified can range from 900
