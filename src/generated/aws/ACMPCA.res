...
@as("CrlConfiguration") crlConfiguration: option<crlConfiguration>
}
...
@as("CertificateAuthorityArn") certificateAuthorityArn: arn
  ...
  type response = {
@as("CertificateAuthority") certificateAuthority: option<certificateAuthority>
}
