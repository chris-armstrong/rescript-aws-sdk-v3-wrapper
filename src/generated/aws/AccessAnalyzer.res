...
type resourceType = [@as("AWS::SecretsManager::Secret") #AWS_SecretsManager_Secret | @as("AWS::KMS::Key") #AWS_KMS_Key | @as("AWS::Lambda::LayerVersion") #AWS_Lambda_LayerVersion | @as("AWS::Lambda::Function") #AWS_Lambda_Function | @as("AWS::SQS::Queue") #AWS_SQS_Queue | @as("AWS::IAM::Role") #AWS_IAM_Role | @as("AWS::S3::Bucket") #AWS_S3_Bucket]
