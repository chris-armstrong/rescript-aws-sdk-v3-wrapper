...
type engineVersion = {@as("Name") name: option<__string>}
...
type availabilityZone = {@as("Name") name: option<__string>}
...
module RebootBroker = {
  type t
  type request = {@as("BrokerId") brokerId: __string}
  type response = unit
...
module DeleteBroker = {
  type t
  type request = {@as("BrokerId") brokerId: __string}
  type response = {@as("BrokerId") brokerId: option<__string>}
...
module DescribeConfiguration = {
  type t
  type request = {@as("ConfigurationId") configurationId: __string}
  type response = {
    @as("Tags") tags: option<__mapOf__string>,
    @as("Name") name: option<__string>,
    @as("LatestRevision") latestRevision: option<configurationRevision>,
...
module DescribeBrokerInstanceOptions = {
  ...
  @module("@aws-sdk/client-mq") @new
  external new_: request => t = "DescribeBrokerInstanceOptionsCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module DescribeBrokerEngineTypes = {
  ...
  @module("@aws-sdk/client-mq") @new
  external new_: request => t = "DescribeBrokerEngineTypesCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
