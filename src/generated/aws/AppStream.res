...
type userStackAssociationErrorCode = [@as("INTERNAL_ERROR") #INTERNALERROR | @as("DIRECTORY_NOT_FOUND") #DIRECTORYNOTFOUND | @as("USER_NAME_NOT_FOUND") #USERNAMENOTFOUND | @as("STACK_NOT_FOUND") #STACKNOTFOUND]
type userId = string
type userAttributeValue = string
type usageReportSchedule = [@as("DAILY") #DAILY]
type usageReportExecutionErrorCode = [@as("INTERNAL_SERVICE_ERROR") #INTERNALSERVICEERROR | @as("ACCESS_DENIED") #ACCESSDENIED | @as("RESOURCE_NOT_FOUND") #RESOURCENOTFOUND]
...
type storageConnectorType = [@as("ONE_DRIVE") #ONEDRIVE | @as("GOOGLE_DRIVE") #GOOGLEDRIVE | @as("HOMEFOLDERS") #HOMEFOLDERS]
type stackErrorCode = [@as("INTERNAL_SERVICE_ERROR") #INTERNALSERVICEERROR | @as("STORAGE_CONNECTOR_ERROR") #STORAGECONNECTORERROR]
type stackAttribute = [@as("ACCESS_ENDPOINTS") #ACCESSENDPOINTS | @as("IAM_ROLE_ARN") #IAMROLEARN | @as("EMBED_HOST_DOMAINS") #EMBEDHOSTDOMAINS | @as("USER_SETTINGS") #USERSETTINGS | @as("THEME_NAME") #THEMENAME | @as("FEEDBACK_URL") #FEEDBACKURL | @as("REDIRECT_URL") #REDIRECTURL | @as("STORAGE_CONNECTOR_ONE_DRIVE") #STORAGECONNECTORONEDRIVE | @as("STORAGE_CONNECTOR_GOOGLE_DRIVE") #STORAGECONNECTORGOOGLEDRIVE | @as("STORAGE_CONNECTOR_HOMEFOLDERS") #STORAGECONNECTORHOMEFOLDERS | @as("STORAGE_CONNECTORS") #STORAGECONNECTORS]
type settingsGroup = string
type sessionState = [@as("EXPIRED") #EXPIRED | @as("PENDING") #PENDING | @as("ACTIVE") #ACTIVE]
type sessionConnectionState = [@as("NOT_CONNECTED") #NOTCONNECTED | @as("CONNECTED") #CONNECTED]
type resourceIdentifier = string
type regionName = string
type redirectURL = string
type platformType = [@as("WINDOWS_SERVER_2019") #WINDOWSSERVER2019 | @as("WINDOWS_SERVER_2016") #WINDOWSSERVER2016 | @as("WINDOWS") #WINDOWS]
...
type long = float
type integer_ = int
type imageStateChangeReasonCode = [@as("IMAGE_COPY_FAILURE") #IMAGECOPYFAILURE | @as("IMAGE_BUILDER_NOT_AVAILABLE") #IMAGEBUILDERNOTAVAILABLE | @as("INTERNAL_ERROR") #INTERNALERROR]
...
type imageBuilderStateChangeReasonCode = [@as("IMAGE_UNAVAILABLE") #IMAGEUNAVAILABLE | @as("INTERNAL_ERROR") #INTERNALERROR]
type imageBuilderState = [@as("PENDING_QUALIFICATION") #PENDINGQUALIFICATION | @as("UPDATING") #UPDATING | @as("FAILED") #FAILED | @as("DELETING") #DELETING | @as("SNAPSHOTTING") #SNAPSHOTTING | @as("REBOOTING") #REBOOTING | @as("STOPPED") #STOPPED | @as("STOPPING") #STOPPING | @as("RUNNING") #RUNNING | @as("UPDATING_AGENT") #UPDATINGAGENT | @as("PENDING") #PENDING]
type fleetType = [@as("ON_DEMAND") #ONDEMAND | @as("ALWAYS_ON") #ALWAYSON]
type fleetState = [@as("STOPPED") #STOPPED | @as("STOPPING") #STOPPING | @as("RUNNING") #RUNNING | @as("STARTING") #STARTING]
type fleetErrorCode = [@as("DOMAIN_JOIN_INTERNAL_SERVICE_ERROR") #DOMAINJOININTERNALSERVICEERROR | @as("DOMAIN_JOIN_NERR_PASSWORD_EXPIRED") #DOMAINJOINNERRPASSWORDEXPIRED | @as("DOMAIN_JOIN_ERROR_DS_MACHINE_ACCOUNT_QUOTA_EXCEEDED") #DOMAINJOINERRORDSMACHINEACCOUNTQUOTAEXCEEDED | @as("DOMAIN_JOIN_NERR_WORKSTATION_NOT_STARTED") #DOMAINJOINNERRWORKSTATIONNOTSTARTED | @as("DOMAIN_JOIN_NERR_INVALID_WORKGROUP_NAME") #DOMAINJOINNERRINVALIDWORKGROUPNAME | @as("DOMAIN_JOIN_ERROR_NOT_SUPPORTED") #DOMAINJOINERRORNOTSUPPORTED | @as("DOMAIN_JOIN_ERROR_NO_SUCH_DOMAIN") #DOMAINJOINERRORNOSUCHDOMAIN | @as("DOMAIN_JOIN_ERROR_MORE_DATA") #DOMAINJOINERRORMOREDATA | @as("DOMAIN_JOIN_ERROR_INVALID_PARAMETER") #DOMAINJOINERRORINVALIDPARAMETER | @as("DOMAIN_JOIN_ERROR_LOGON_FAILURE") #DOMAINJOINERRORLOGONFAILURE | @as("DOMAIN_JOIN_ERROR_ACCESS_DENIED") #DOMAINJOINERRORACCESSDENIED | @as("DOMAIN_JOIN_ERROR_FILE_NOT_FOUND") #DOMAINJOINERRORFILENOTFOUND | @as("FLEET_INSTANCE_PROVISIONING_FAILURE") #FLEETINSTANCEPROVISIONINGFAILURE | @as("FLEET_STOPPED") #FLEETSTOPPED | @as("IAM_SERVICE_ROLE_MISSING_DESCRIBE_SECURITY_GROUPS_ACTION") #IAMSERVICEROLEMISSINGDESCRIBESECURITYGROUPSACTION | @as("IGW_NOT_ATTACHED") #IGWNOTATTACHED | @as("SECURITY_GROUPS_NOT_FOUND") #SECURITYGROUPSNOTFOUND | @as("INVALID_SUBNET_CONFIGURATION") #INVALIDSUBNETCONFIGURATION | @as("IMAGE_NOT_FOUND") #IMAGENOTFOUND | @as("SUBNET_NOT_FOUND") #SUBNETNOTFOUND | @as("IAM_SERVICE_ROLE_MISSING_DESCRIBE_SUBNET_ACTION") #IAMSERVICEROLEMISSINGDESCRIBESUBNETACTION | @as("SUBNET_HAS_INSUFFICIENT_IP_ADDRESSES") #SUBNETHASINSUFFICIENTIPADDRESSES | @as("STS_DISABLED_IN_REGION") #STSDISABLEDINREGION | @as("MACHINE_ROLE_IS_MISSING") #MACHINEROLEISMISSING | @as("IAM_SERVICE_ROLE_IS_MISSING") #IAMSERVICEROLEISMISSING | @as("INTERNAL_SERVICE_ERROR") #INTERNALSERVICEERROR | @as("NETWORK_INTERFACE_LIMIT_EXCEEDED") #NETWORKINTERFACELIMITEXCEEDED | @as("IAM_SERVICE_ROLE_MISSING_ENI_DELETE_ACTION") #IAMSERVICEROLEMISSINGENIDELETEACTION | @as("IAM_SERVICE_ROLE_MISSING_ENI_CREATE_ACTION") #IAMSERVICEROLEMISSINGENICREATEACTION | @as("IAM_SERVICE_ROLE_MISSING_ENI_DESCRIBE_ACTION") #IAMSERVICEROLEMISSINGENIDESCRIBEACTION]
type fleetAttribute = [@as("IAM_ROLE_ARN") #IAMROLEARN | @as("DOMAIN_JOIN_INFO") #DOMAINJOININFO | @as("VPC_CONFIGURATION_SECURITY_GROUP_IDS") #VPCCONFIGURATIONSECURITYGROUPIDS | @as("VPC_CONFIGURATION") #VPCCONFIGURATION]
...
type action = [@as("DOMAIN_SMART_CARD_SIGNIN") #DOMAINSMARTCARDSIGNIN | @as("DOMAIN_PASSWORD_SIGNIN") #DOMAINPASSWORDSIGNIN | @as("PRINTING_TO_LOCAL_DEVICE") #PRINTINGTOLOCALDEVICE | @as("FILE_DOWNLOAD") #FILEDOWNLOAD | @as("FILE_UPLOAD") #FILEUPLOAD | @as("CLIPBOARD_COPY_TO_LOCAL_DEVICE") #CLIPBOARDCOPYTOLOCALDEVICE | @as("CLIPBOARD_COPY_FROM_LOCAL_DEVICE") #CLIPBOARDCOPYFROMLOCALDEVICE]
...
type domainJoinInfo = {
@as("OrganizationalUnitDistinguishedName") organizationalUnitDistinguishedName: option<organizationalUnitDistinguishedName>,
...
@as("DesiredInstances") desiredInstances: integer_
}
...
@module("@aws-sdk/client-appstream") @new external createClient: unit => awsServiceClient = "AppStreamClient";
module StopFleet = {
  type t;
  type request = {
@as("Name") name: string_
...
module ExpireSession = {
  type t;
  type request = {
@as("SessionId") sessionId: string_
}
  type response = unit
...
module DeleteUsageReportSubscription = {
  ...
  type request = unit
  type response = unit
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "DeleteUsageReportSubscriptionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Name") name: name
  ...
  type response = unit
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "DeleteImagePermissionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("DirectoryName") directoryName: directoryName
  ...
  type response = unit
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "DeleteDirectoryConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("S3BucketName") s3BucketName: option<string_>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "CreateUsageReportSubscriptionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StreamingURL") streamingURL: option<string_>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "CreateStreamingURLCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StreamingURL") streamingURL: option<string_>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "CreateImageBuilderStreamingURLCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Name") name: name
  ...
  type response = unit
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "UpdateImagePermissionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Tags") tags: option<tags>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "ListTagsForResourceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Names") names: option<stringList>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "ListAssociatedStacksCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Names") names: option<stringList>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "ListAssociatedFleetsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("DirectoryName") directoryName: directoryName
  ...
  type response = {
@as("DirectoryConfig") directoryConfig: option<directoryConfig>
}
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "UpdateDirectoryConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("UserStackAssociations") userStackAssociations: option<userStackAssociationList>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "DescribeUserStackAssociationsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("DirectoryConfig") directoryConfig: option<directoryConfig>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "CreateDirectoryConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Name") name: string_
  ...
  type response = {
@as("ImageBuilder") imageBuilder: option<imageBuilder>
}
...
@as("Name") name: name
  ...
  type response = {
@as("NextToken") nextToken: option<string_>,
@as("SharedImagePermissionsList") sharedImagePermissionsList: option<sharedImagePermissionsList>,
@as("Name") name: option<name>
}
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "DescribeImagePermissionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("DirectoryConfigs") directoryConfigs: option<directoryConfigList>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "DescribeDirectoryConfigsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ImageBuilder") imageBuilder: option<imageBuilder>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "DeleteImageBuilderCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ImageBuilder") imageBuilder: option<imageBuilder>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "CreateImageBuilderCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
errors: option<userStackAssociationErrorList>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "BatchDisassociateUserStackCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
errors: option<userStackAssociationErrorList>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "BatchAssociateUserStackCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("UsageReportSubscriptions") usageReportSubscriptions: option<usageReportSubscriptionList>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "DescribeUsageReportSubscriptionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ImageBuilders") imageBuilders: option<imageBuilderList>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "DescribeImageBuildersCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
image: option<image>
  ...
  @module("@aws-sdk/client-appstream") @new external new_: (request) => t = "CreateUpdatedImageCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
