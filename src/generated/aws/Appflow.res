...
type veevaConnectorOperator = [@as("NO_OP") #NOOP | @as("VALIDATE_NUMERIC") #VALIDATENUMERIC | @as("VALIDATE_NON_NEGATIVE") #VALIDATENONNEGATIVE | @as("VALIDATE_NON_ZERO") #VALIDATENONZERO | @as("VALIDATE_NON_NULL") #VALIDATENONNULL | @as("MASK_LAST_N") #MASKLASTN | @as("MASK_FIRST_N") #MASKFIRSTN | @as("MASK_ALL") #MASKALL | @as("SUBTRACTION") #SUBTRACTION | @as("DIVISION") #DIVISION | @as("MULTIPLICATION") #MULTIPLICATION | @as("ADDITION") #ADDITION | @as("NOT_EQUAL_TO") #NOTEQUALTO | @as("EQUAL_TO") #EQUALTO | @as("GREATER_THAN_OR_EQUAL_TO") #GREATERTHANOREQUALTO | @as("LESS_THAN_OR_EQUAL_TO") #LESSTHANOREQUALTO | @as("BETWEEN") #BETWEEN | @as("CONTAINS") #CONTAINS | @as("GREATER_THAN") #GREATERTHAN | @as("LESS_THAN") #LESSTHAN | @as("PROJECTION") #PROJECTION]
type value = string
...
type trendmicroConnectorOperator = [@as("NO_OP") #NOOP | @as("VALIDATE_NUMERIC") #VALIDATENUMERIC | @as("VALIDATE_NON_NEGATIVE") #VALIDATENONNEGATIVE | @as("VALIDATE_NON_ZERO") #VALIDATENONZERO | @as("VALIDATE_NON_NULL") #VALIDATENONNULL | @as("MASK_LAST_N") #MASKLASTN | @as("MASK_FIRST_N") #MASKFIRSTN | @as("MASK_ALL") #MASKALL | @as("SUBTRACTION") #SUBTRACTION | @as("DIVISION") #DIVISION | @as("MULTIPLICATION") #MULTIPLICATION | @as("ADDITION") #ADDITION | @as("EQUAL_TO") #EQUALTO | @as("PROJECTION") #PROJECTION]
...
type string_ = string
type stage = string
type slackConnectorOperator = [@as("NO_OP") #NOOP | @as("VALIDATE_NUMERIC") #VALIDATENUMERIC | @as("VALIDATE_NON_NEGATIVE") #VALIDATENONNEGATIVE | @as("VALIDATE_NON_ZERO") #VALIDATENONZERO | @as("VALIDATE_NON_NULL") #VALIDATENONNULL | @as("MASK_LAST_N") #MASKLASTN | @as("MASK_FIRST_N") #MASKFIRSTN | @as("MASK_ALL") #MASKALL | @as("SUBTRACTION") #SUBTRACTION | @as("DIVISION") #DIVISION | @as("MULTIPLICATION") #MULTIPLICATION | @as("ADDITION") #ADDITION | @as("EQUAL_TO") #EQUALTO | @as("GREATER_THAN_OR_EQUAL_TO") #GREATERTHANOREQUALTO | @as("LESS_THAN_OR_EQUAL_TO") #LESSTHANOREQUALTO | @as("BETWEEN") #BETWEEN | @as("GREATER_THAN") #GREATERTHAN | @as("LESS_THAN") #LESSTHAN | @as("PROJECTION") #PROJECTION]
type singularMetadata = unit
type singularConnectorProfileProperties = unit
type singularConnectorOperator = [@as("NO_OP") #NOOP | @as("VALIDATE_NUMERIC") #VALIDATENUMERIC | @as("VALIDATE_NON_NEGATIVE") #VALIDATENONNEGATIVE | @as("VALIDATE_NON_ZERO") #VALIDATENONZERO | @as("VALIDATE_NON_NULL") #VALIDATENONNULL | @as("MASK_LAST_N") #MASKLASTN | @as("MASK_FIRST_N") #MASKFIRSTN | @as("MASK_ALL") #MASKALL | @as("SUBTRACTION") #SUBTRACTION | @as("DIVISION") #DIVISION | @as("MULTIPLICATION") #MULTIPLICATION | @as("ADDITION") #ADDITION | @as("EQUAL_TO") #EQUALTO | @as("PROJECTION") #PROJECTION]
...
type prefixType = [@as("PATH_AND_FILENAME") #PATHANDFILENAME | @as("PATH") #PATH | @as("FILENAME") #FILENAME]
...
type operator = [@as("NO_OP") #NOOP | @as("VALIDATE_NUMERIC") #VALIDATENUMERIC | @as("VALIDATE_NON_NEGATIVE") #VALIDATENONNEGATIVE | @as("VALIDATE_NON_ZERO") #VALIDATENONZERO | @as("VALIDATE_NON_NULL") #VALIDATENONNULL | @as("MASK_LAST_N") #MASKLASTN | @as("MASK_FIRST_N") #MASKFIRSTN | @as("MASK_ALL") #MASKALL | @as("SUBTRACTION") #SUBTRACTION | @as("DIVISION") #DIVISION | @as("MULTIPLICATION") #MULTIPLICATION | @as("ADDITION") #ADDITION | @as("NOT_EQUAL_TO") #NOTEQUALTO | @as("EQUAL_TO") #EQUALTO | @as("GREATER_THAN_OR_EQUAL_TO") #GREATERTHANOREQUALTO | @as("LESS_THAN_OR_EQUAL_TO") #LESSTHANOREQUALTO | @as("BETWEEN") #BETWEEN | @as("CONTAINS") #CONTAINS | @as("GREATER_THAN") #GREATERTHAN | @as("LESS_THAN") #LESSTHAN | @as("PROJECTION") #PROJECTION]
...
type inforNexusConnectorOperator = [@as("NO_OP") #NOOP | @as("VALIDATE_NUMERIC") #VALIDATENUMERIC | @as("VALIDATE_NON_NEGATIVE") #VALIDATENONNEGATIVE | @as("VALIDATE_NON_ZERO") #VALIDATENONZERO | @as("VALIDATE_NON_NULL") #VALIDATENONNULL | @as("MASK_LAST_N") #MASKLASTN | @as("MASK_FIRST_N") #MASKFIRSTN | @as("MASK_ALL") #MASKALL | @as("SUBTRACTION") #SUBTRACTION | @as("DIVISION") #DIVISION | @as("MULTIPLICATION") #MULTIPLICATION | @as("ADDITION") #ADDITION | @as("EQUAL_TO") #EQUALTO | @as("BETWEEN") #BETWEEN | @as("PROJECTION") #PROJECTION]
...
type dynatraceConnectorOperator = [@as("NO_OP") #NOOP | @as("VALIDATE_NUMERIC") #VALIDATENUMERIC | @as("VALIDATE_NON_NEGATIVE") #VALIDATENONNEGATIVE | @as("VALIDATE_NON_ZERO") #VALIDATENONZERO | @as("VALIDATE_NON_NULL") #VALIDATENONNULL | @as("MASK_LAST_N") #MASKLASTN | @as("MASK_FIRST_N") #MASKFIRSTN | @as("MASK_ALL") #MASKALL | @as("SUBTRACTION") #SUBTRACTION | @as("DIVISION") #DIVISION | @as("MULTIPLICATION") #MULTIPLICATION | @as("ADDITION") #ADDITION | @as("EQUAL_TO") #EQUALTO | @as("BETWEEN") #BETWEEN | @as("PROJECTION") #PROJECTION]
...
type datadogConnectorOperator = [@as("NO_OP") #NOOP | @as("VALIDATE_NUMERIC") #VALIDATENUMERIC | @as("VALIDATE_NON_NEGATIVE") #VALIDATENONNEGATIVE | @as("VALIDATE_NON_ZERO") #VALIDATENONZERO | @as("VALIDATE_NON_NULL") #VALIDATENONNULL | @as("MASK_LAST_N") #MASKLASTN | @as("MASK_FIRST_N") #MASKFIRSTN | @as("MASK_ALL") #MASKALL | @as("SUBTRACTION") #SUBTRACTION | @as("DIVISION") #DIVISION | @as("MULTIPLICATION") #MULTIPLICATION | @as("ADDITION") #ADDITION | @as("EQUAL_TO") #EQUALTO | @as("BETWEEN") #BETWEEN | @as("PROJECTION") #PROJECTION]
