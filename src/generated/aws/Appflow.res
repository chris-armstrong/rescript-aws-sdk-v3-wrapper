...
type arn = string
type zendeskSourceProperties = {@as("object") object_: object_}
type zendeskConnectorProfileProperties = {instanceUrl: instanceUrl}
type veevaSourceProperties = {@as("object") object_: object_}
type veevaConnectorProfileProperties = {instanceUrl: instanceUrl}
type veevaConnectorProfileCredentials = {
  password: password,
  username: username,
}
type triggerTypeList = array<triggerType>
type trendmicroSourceProperties = {@as("object") object_: object_}
type trendmicroConnectorProfileCredentials = {apiSecretKey: apiSecretKey}
...
type slackSourceProperties = {@as("object") object_: object_}
type slackConnectorProfileProperties = {instanceUrl: instanceUrl}
type singularSourceProperties = {@as("object") object_: object_}
type singularConnectorProfileCredentials = {apiKey: apiKey}
type serviceNowSourceProperties = {@as("object") object_: object_}
type serviceNowConnectorProfileProperties = {instanceUrl: instanceUrl}
...
type marketoSourceProperties = {@as("object") object_: object_}
type marketoConnectorProfileProperties = {instanceUrl: instanceUrl}
type inforNexusSourceProperties = {@as("object") object_: object_}
type inforNexusConnectorProfileProperties = {instanceUrl: instanceUrl}
...
type incrementalPullConfig = {datetimeTypeFieldName: option<datetimeTypeFieldName>}
type idFieldNameList = array<name>
type googleAnalyticsSourceProperties = {@as("object") object_: object_}
...
type dynatraceSourceProperties = {@as("object") object_: object_}
type dynatraceConnectorProfileProperties = {instanceUrl: instanceUrl}
type dynatraceConnectorProfileCredentials = {apiToken: apiToken}
type datadogSourceProperties = {@as("object") object_: object_}
type datadogConnectorProfileProperties = {instanceUrl: instanceUrl}
...
type amplitudeSourceProperties = {@as("object") object_: object_}
type amplitudeConnectorProfileCredentials = {
  secretKey: secretKey,
  apiKey: apiKey,
}
type aggregationConfig = {aggregationType: option<aggregationType>}
type zendeskMetadata = {oAuthScopes: option<oauthScopeList>}
...
type triggerProperties = {@as("Scheduled") scheduled: option<scheduledTriggerProperties>}
type task = {
...
type snowflakeMetadata = {supportedRegions: option<regionList>}
...
type slackMetadata = {oAuthScopes: option<oauthScopeList>}
...
type salesforceMetadata = {oAuthScopes: option<oauthScopeList>}
...
type honeycodeMetadata = {oAuthScopes: option<oauthScopeList>}
...
type googleAnalyticsMetadata = {oAuthScopes: option<oauthScopeList>}
...
type supportedFieldTypeDetails = {v1: fieldTypeDetails}
...
module StopFlow = {
  type t
  type request = {flowName: flowName}
  type response = {
    flowStatus: option<flowStatus>,
    flowArn: option<flowArn>,
  }
