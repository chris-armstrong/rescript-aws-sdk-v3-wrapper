...
type licensing = {osByol: option<baseBoolean>}
type launchStatus = [
...
type os = {fullString: option<boundedString>}
type lifeCycleLastTestReverted = {apiCallDateTime: option<iso8601DatetimeString>}
type lifeCycleLastTestInitiated = {
  jobID: option<jobID>,
  apiCallDateTime: option<iso8601DatetimeString>,
}
type lifeCycleLastTestFinalized = {apiCallDateTime: option<iso8601DatetimeString>}
type lifeCycleLastCutoverReverted = {apiCallDateTime: option<iso8601DatetimeString>}
type lifeCycleLastCutoverInitiated = {
  jobID: option<jobID>,
  apiCallDateTime: option<iso8601DatetimeString>,
}
type lifeCycleLastCutoverFinalized = {apiCallDateTime: option<iso8601DatetimeString>}
