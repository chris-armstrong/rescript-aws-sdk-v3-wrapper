...
@as("ColumnInfo") columnInfo: option<columnInfoList>
}
type queryExecution = {
@as("EngineVersion") engineVersion: option<engineVersion>,
  @as("WorkGroup") workGroup: option<workGroupName>,
...
@as("NamedQueryId") namedQueryId: namedQueryId
  ...
  type response = {
@as("NamedQuery") namedQuery: option<namedQuery>
}
...
@as("Name") name: catalogNameString
  ...
  type response = {
@as("DataCatalog") dataCatalog: option<dataCatalog>
}
...
@as("QueryExecutionId") queryExecutionId: queryExecutionId
  ...
  type response = {
@as("QueryExecution") queryExecution: option<queryExecution>
}
