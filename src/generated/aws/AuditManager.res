...
type manualEvidence = {s3ResourcePath: option<s3Url>}
...
type createAssessmentFrameworkControl = {id: option<uuid>}
...
type awsservice = {serviceName: option<awsserviceName>}
type awsaccount = {
...
module ValidateAssessmentReportIntegrity = {
  type t
  type request = {s3RelativePath: s3Url}
  type response = {
...
module RegisterOrganizationAdminAccount = {
  type t
  type request = {adminAccountId: accountId}
  type response = {
