...
type processType = {@as("ProcessName") processName: xmlStringMaxLen255}
...
type metricGranularityType = {@as("Granularity") granularity: option<xmlStringMaxLen255>}
type metricDimension = {
  @as("Value") value: metricDimensionValue,
  @as("Name") name: metricDimensionName,
}
type metricCollectionType = {@as("Metric") metric: option<xmlStringMaxLen255>}
...
type instanceMonitoring = {@as("Enabled") enabled: option<monitoringEnabled>}
...
type adjustmentType = {@as("AdjustmentType") adjustmentType: option<xmlStringMaxLen255>}
...
module DescribeAutoScalingNotificationTypes = {
  ...
  type response = {
    @as("AutoScalingNotificationTypes")
