...
type thresholdType = [@as("ABSOLUTE_VALUE") #ABSOLUTEVALUE | @as("PERCENTAGE") #PERCENTAGE]
...
type executionType = [@as("RESET_BUDGET_ACTION") #RESETBUDGETACTION | @as("REVERSE_BUDGET_ACTION") #REVERSEBUDGETACTION | @as("RETRY_BUDGET_ACTION") #RETRYBUDGETACTION | @as("APPROVE_BUDGET_ACTION") #APPROVEBUDGETACTION]
type eventType = [@as("EXECUTE_ACTION") #EXECUTEACTION | @as("UPDATE_ACTION") #UPDATEACTION | @as("DELETE_ACTION") #DELETEACTION | @as("CREATE_ACTION") #CREATEACTION | @as("SYSTEM") #SYSTEM]
type comparisonOperator = [@as("EQUAL_TO") #EQUALTO | @as("LESS_THAN") #LESSTHAN | @as("GREATER_THAN") #GREATERTHAN]
type budgetType = [@as("SAVINGS_PLANS_COVERAGE") #SAVINGSPLANSCOVERAGE | @as("SAVINGS_PLANS_UTILIZATION") #SAVINGSPLANSUTILIZATION | @as("RI_COVERAGE") #RICOVERAGE | @as("RI_UTILIZATION") #RIUTILIZATION | @as("COST") #COST | @as("USAGE") #USAGE]
type budgetName = string
type approvalModel = [@as("MANUAL") #MANUAL | @as("AUTOMATIC") #AUTOMATIC]
type actionType = [@as("RUN_SSM_DOCUMENTS") #RUNSSMDOCUMENTS | @as("APPLY_SCP_POLICY") #APPLYSCPPOLICY | @as("APPLY_IAM_POLICY") #APPLYIAMPOLICY]
type actionSubType = [@as("STOP_RDS_INSTANCES") #STOPRDSINSTANCES | @as("STOP_EC2_INSTANCES") #STOPEC2INSTANCES]
type actionStatus = [@as("RESET_FAILURE") #RESETFAILURE | @as("RESET_IN_PROGRESS") #RESETINPROGRESS | @as("REVERSE_FAILURE") #REVERSEFAILURE | @as("REVERSE_SUCCESS") #REVERSESUCCESS | @as("REVERSE_IN_PROGRESS") #REVERSEINPROGRESS | @as("EXECUTION_FAILURE") #EXECUTIONFAILURE | @as("EXECUTION_SUCCESS") #EXECUTIONSUCCESS | @as("EXECUTION_IN_PROGRESS") #EXECUTIONINPROGRESS | @as("PENDING") #PENDING | @as("STANDBY") #STANDBY]
