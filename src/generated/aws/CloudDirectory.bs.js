...
var TypedAttributeValueUnspecified = /* @__PURE__ */Caml_exceptions.create("CloudDirectory-AwsSdkV3.TypedAttributeValue.TypedAttributeValueUnspecified");

function classify(value) {
  var x = value.DatetimeValue;
  if (x !== undefined) {
    return {
            TAG: /* DatetimeValue */0,
  ...
  throw {
        RE_EXN_ID: TypedAttributeValueUnspecified,
        Error: new Error()
      };
}
...
function make(value) {
  switch (value.TAG | 0) {
    case /* DatetimeValue */0 :
        return {
                DatetimeValue: Caml_option.some(value._0),
    ...
    case /* BinaryValue */3 :
        return {
                ...
                NumberValue: undefined,
                BooleanValue: undefined,
                BinaryValue: Caml_option.some(value._0),
                StringValue: undefined
              };
    case /* StringValue */4 :
        return {
...
var TypedAttributeValue = {
  TypedAttributeValueUnspecified: TypedAttributeValueUnspecified,
  classify: classify,
  make: make
};
