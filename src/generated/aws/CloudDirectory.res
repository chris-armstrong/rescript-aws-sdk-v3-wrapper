...
type long = float
type version = string
type updateActionType = [@as("DELETE") #DELETE | @as("CREATE_OR_UPDATE") #CREATEORUPDATE]
...
type ruleType = [@as("STRING_LENGTH") #STRINGLENGTH | @as("STRING_FROM_SET") #STRINGFROMSET | @as("NUMBER_COMPARISON") #NUMBERCOMPARISON | @as("BINARY_LENGTH") #BINARYLENGTH]
type ruleParameterValue = string
type ruleParameterKey = string
type ruleKey = string
type requiredAttributeBehavior = [@as("NOT_REQUIRED") #NOTREQUIRED | @as("REQUIRED_ALWAYS") #REQUIREDALWAYS]
type rangeMode = [@as("EXCLUSIVE") #EXCLUSIVE | @as("INCLUSIVE") #INCLUSIVE | @as("LAST_BEFORE_MISSING_VALUES") #LASTBEFOREMISSINGVALUES | @as("LAST") #LAST | @as("FIRST") #FIRST]
type policyType = string
type pathString = string
type objectType = [@as("INDEX") #INDEX | @as("POLICY") #POLICY | @as("LEAF_NODE") #LEAFNODE | @as("NODE") #NODE]
