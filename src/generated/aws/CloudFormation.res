...
type parameterConstraints = {@as("AllowedValues") allowedValues: option<allowedValues>}
...
module DescribeTypeRegistration = {
  type t
  type request = {@as("RegistrationToken") registrationToken: registrationToken}
  type response = {
...
module DescribeStackDriftDetectionStatus = {
  type t
  type request = {@as("StackDriftDetectionId") stackDriftDetectionId: stackDriftDetectionId}
  type response = {
    @as("Timestamp") timestamp_: timestamp_,
