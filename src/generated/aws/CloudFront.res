...
@module("@aws-sdk/client-cloudfront") @new external createClient: unit => awsServiceClient = "CloudFrontClient";
...
@as("RealtimeMetricsSubscriptionStatus") realtimeMetricsSubscriptionStatus: realtimeMetricsSubscriptionStatus
}
...
type tagKeys = {
@as("Items") items: option<tagKeyList>
}
type statusCodes = {
...
@as("RealtimeMetricsSubscriptionConfig") realtimeMetricsSubscriptionConfig: option<realtimeMetricsSubscriptionConfig>
}
...
type tags = {
@as("Items") items: option<tagList_>
}
...
type restrictions = {
@as("GeoRestriction") geoRestriction: geoRestriction
}
...
@as("ParametersInCacheKeyAndForwardedToOrigin") parametersInCacheKeyAndForwardedToOrigin: option<parametersInCacheKeyAndForwardedToOrigin>,
...
@as("CloudFrontOriginAccessIdentityConfig") cloudFrontOriginAccessIdentityConfig: cloudFrontOriginAccessIdentityConfig,
  ...
  type response = {
@as("ETag") etag: option<string_>,
  @as("CloudFrontOriginAccessIdentity") cloudFrontOriginAccessIdentity: option<cloudFrontOriginAccessIdentity>
}
...
@as("OriginRequestPolicyId") originRequestPolicyId: string_,
  ...
  type response = {
@as("DistributionIdList") distributionIdList: option<distributionIdList>
}
...
@as("EventObject") eventObject: functionEventObject,
  ...
  type response = {
@as("TestResult") testResult: option<testResult>
}
...
@as("MaxItems") maxItems: option<baseInteger>,
  ...
  type response = {
@as("InvalidationList") invalidationList: option<invalidationList>
}
...
@as("MaxItems") maxItems: option<baseInteger>,
  ...
  type response = {
@as("CloudFrontOriginAccessIdentityList") cloudFrontOriginAccessIdentityList: option<cloudFrontOriginAccessIdentityList>
}
...
@as("SamplingRate") samplingRate: option<long>,
  ...
  type response = {
@as("RealtimeLogConfig") realtimeLogConfig: option<realtimeLogConfig>
}
...
@as("Stage") stage: option<functionStage>,
  ...
  type response = {
@as("FunctionList") functionList: option<functionList>
}
...
@as("Marker") marker: option<string_>,
  ...
  type response = {
@as("RealtimeLogConfigs") realtimeLogConfigs: option<realtimeLogConfigs>
}
...
@as("MaxItems") maxItems: option<baseInteger>,
  ...
  type response = {
@as("KeyGroupList") keyGroupList: option<keyGroupList>
}
...
module CreateStreamingDistributionWithTags = {
  type t;
  type request = {
@as("StreamingDistributionConfigWithTags") streamingDistributionConfigWithTags: streamingDistributionConfigWithTags
}
  type response = {
@as("ETag") etag: option<string_>,
  @as("Location") location: option<string_>,
...
@as("FieldLevelEncryptionProfileConfig") fieldLevelEncryptionProfileConfig: fieldLevelEncryptionProfileConfig,
  ...
  type response = {
@as("ETag") etag: option<string_>,
  @as("FieldLevelEncryptionProfile") fieldLevelEncryptionProfile: option<fieldLevelEncryptionProfile>
}
...
@as("MaxItems") maxItems: option<baseInteger>,
  ...
  type response = {
@as("FieldLevelEncryptionProfileList") fieldLevelEncryptionProfileList: option<fieldLevelEncryptionProfileList>
}
...
@as("MaxItems") maxItems: option<baseInteger>,
  ...
  type response = {
@as("CachePolicyList") cachePolicyList: option<cachePolicyList>
}
...
@as("WebACLId") webACLId: string_,
  ...
  type response = {
@as("DistributionList") distributionList: option<distributionList>
}
