...
@as("InsightType") insightType: option<insightType>
}
...
type eventSelector = {
@as("ExcludeManagementEventSources") excludeManagementEventSources: option<excludeManagementEventSources>,
...
@module("@aws-sdk/client-cloudtrail") @new external createClient: unit => awsServiceClient = "CloudTrailClient";
module UpdateTrail = {
  type t;
  type request = {
@as("IsOrganizationTrail") isOrganizationTrail: option<boolean_>,
