...
type stateValue = [@as("INSUFFICIENT_DATA") #INSUFFICIENTDATA | @as("ALARM") #ALARM | @as("OK") #OK]
...
type metricStreamOutputFormat = [@as("opentelemetry0.7") #Opentelemetry07 | @as("json") #Json]
...
type anomalyDetectorStateValue = [@as("TRAINED") #TRAINED | @as("TRAINED_INSUFFICIENT_DATA") #TRAINEDINSUFFICIENTDATA | @as("PENDING_TRAINING") #PENDINGTRAINING]
...
type labelOptions = {
@as("Timezone") timezone: option<getMetricDataLabelTimezone>
}
...
@as("EvaluateLowSampleCountPercentile") evaluateLowSampleCountPercentile: option<evaluateLowSampleCountPercentile>,
...
@module("@aws-sdk/client-monitoring") @new external createClient: unit => awsServiceClient = "CloudWatchClient";
...
@as("MetricWidget") metricWidget: metricWidget
  ...
  type response = {
@as("MetricWidgetImage") metricWidgetImage: option<metricWidgetImage>
}
...
module StopMetricStreams = {
  type t;
  type request = {
@as("Names") names: metricStreamNames
}
  type response = unit
...
module DeleteDashboards = {
  type t;
  type request = {
@as("DashboardNames") dashboardNames: dashboardNames
}
  type response = unit
...
@as("DashboardName") dashboardName: dashboardName
  ...
  type response = {
@as("DashboardValidationMessages") dashboardValidationMessages: option<dashboardValidationMessages>
}
...
module EnableInsightRules = {
  type t;
  type request = {
@as("RuleNames") ruleNames: insightRuleNames
}
  type response = {
@as("Failures") failures: option<batchFailures>
}
