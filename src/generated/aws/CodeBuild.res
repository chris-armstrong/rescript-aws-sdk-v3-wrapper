...
type reportFilter = {status: option<reportStatusType>}
...
type gitSubmodulesConfig = {fetchSubmodules: wrapperBoolean}
...
type buildBatchFilter = {status: option<statusType>}
type buildArtifacts = {
  bucketOwnerAccess: option<bucketOwnerAccess>,
  artifactIdentifier: option<string_>,
  encryptionDisabled: option<wrapperBoolean>,
...
module BatchGetReports = {
  type t
  type request = {reportArns: reportArns}
  type response = {
...
module BatchGetReportGroups = {
  type t
  type request = {reportGroupArns: reportGroupArns}
  type response = {
...
module BatchGetProjects = {
  type t
  type request = {names: projectNames}
  type response = {
...
module BatchGetBuildBatches = {
  type t
  type request = {ids: buildBatchIds}
  type response = {
