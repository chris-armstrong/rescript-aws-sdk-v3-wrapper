...
type repositoryHeadSourceCodeType = {@as("BranchName") branchName: branchName}
...
type codeCommitRepository = {@as("Name") name: name}
type sourceCodeType = {
...
type repositoryAnalysis = {@as("RepositoryHead") repositoryHead: repositoryHeadSourceCodeType}
type repository = {
...
type codeReviewType = {@as("RepositoryAnalysis") repositoryAnalysis: repositoryAnalysis}
...
module DisassociateRepository = {
  type t
  type request = {@as("AssociationArn") associationArn: associationArn}
  type response = {
