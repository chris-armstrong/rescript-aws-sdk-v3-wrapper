...
type platform = [@as("ADM") #ADM | @as("GCM") #GCM | @as("APNS_SANDBOX") #APNSSANDBOX | @as("APNS") #APNS]
...
type bulkPublishStatus = [@as("SUCCEEDED") #SUCCEEDED | @as("FAILED") #FAILED | @as("IN_PROGRESS") #INPROGRESS | @as("NOT_STARTED") #NOTSTARTED]
type boolean_ = bool
...
@module("@aws-sdk/client-cognito-sync") @new external createClient: unit => awsServiceClient = "CognitoSyncClient";
...
@as("IdentityPoolId") identityPoolId: identityPoolId
  ...
  type response = {
@as("IdentityUsage") identityUsage: option<identityUsage>
}
...
@as("IdentityPoolId") identityPoolId: identityPoolId
  ...
  type response = {
@as("IdentityPoolUsage") identityPoolUsage: option<identityPoolUsage>
}
...
@as("DatasetDeletedAfterRequestedSyncCount") datasetDeletedAfterRequestedSyncCount: option<boolean_>,
