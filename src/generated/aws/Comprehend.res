...
type entityTypesListItem = {@as("Type") type_: entityTypeName}
...
type entityRecognizerEntityList = {@as("S3Uri") s3Uri: s3Uri}
type entityRecognizerDocuments = {@as("S3Uri") s3Uri: s3Uri}
type entityRecognizerAnnotations = {@as("S3Uri") s3Uri: s3Uri}
type entityLabel = {
  @as("Score") score: option<float_>,
...
module ListTagsForResource = {
  type t
  type request = {@as("ResourceArn") resourceArn: comprehendArn}
  type response = {
...
module BatchDetectDominantLanguage = {
  type t
  type request = {@as("TextList") textList: customerInputStringList}
  type response = {
    @as("ErrorList") errorList: batchItemErrorList,
