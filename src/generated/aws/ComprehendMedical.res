...
type rxNormEntityType = [@as("GENERIC_NAME") #GENERICNAME | @as("BRAND_NAME") #BRANDNAME]
type rxNormEntityCategory = [@as("MEDICATION") #MEDICATION]
type rxNormAttributeType = [@as("STRENGTH") #STRENGTH | @as("ROUTE_OR_MODE") #ROUTEORMODE | @as("RATE") #RATE | @as("FREQUENCY") #FREQUENCY | @as("FORM") #FORM | @as("DURATION") #DURATION | @as("DOSAGE") #DOSAGE]
type relationshipType = [@as("SYSTEM_ORGAN_SITE") #SYSTEMORGANSITE | @as("DIRECTION") #DIRECTION | @as("TEST_UNITS") #TESTUNITS | @as("TEST_VALUE") #TESTVALUE | @as("ACUITY") #ACUITY | @as("RATE") #RATE | @as("STRENGTH") #STRENGTH | @as("DURATION") #DURATION | @as("FREQUENCY") #FREQUENCY | @as("FORM") #FORM | @as("ROUTE_OR_MODE") #ROUTEORMODE | @as("DOSAGE") #DOSAGE | @as("OVERLAP") #OVERLAP | @as("NEGATIVE") #NEGATIVE | @as("FOR") #FOR | @as("ADMINISTERED_VIA") #ADMINISTEREDVIA | @as("WITH_DOSAGE") #WITHDOSAGE | @as("EVERY") #EVERY]
...
type kmskey = string
type jobStatus = [@as("STOPPED") #STOPPED | @as("STOP_REQUESTED") #STOPREQUESTED | @as("FAILED") #FAILED | @as("PARTIAL_SUCCESS") #PARTIALSUCCESS | @as("COMPLETED") #COMPLETED | @as("IN_PROGRESS") #INPROGRESS | @as("SUBMITTED") #SUBMITTED]
type jobName = string
type jobId = string
type integer_ = int
type iamRoleArn = string
type icd10CMTraitName = [@as("SYMPTOM") #SYMPTOM | @as("SIGN") #SIGN | @as("DIAGNOSIS") #DIAGNOSIS | @as("NEGATION") #NEGATION]
type icd10CMRelationshipType = [@as("SYSTEM_ORGAN_SITE") #SYSTEMORGANSITE | @as("OVERLAP") #OVERLAP]
type icd10CMEntityType = [@as("TIME_EXPRESSION") #TIMEEXPRESSION | @as("DX_NAME") #DXNAME]
type icd10CMEntityCategory = [@as("MEDICAL_CONDITION") #MEDICALCONDITION]
type icd10CMAttributeType = [@as("TIME_EXPRESSION") #TIMEEXPRESSION | @as("TIME_TO_DX_NAME") #TIMETODXNAME | @as("QUANTITY") #QUANTITY | @as("QUALITY") #QUALITY | @as("SYSTEM_ORGAN_SITE") #SYSTEMORGANSITE | @as("DIRECTION") #DIRECTION | @as("ACUITY") #ACUITY]
type float_ = float
type entityType = [@as("TIME_EXPRESSION") #TIMEEXPRESSION | @as("ANATOMY") #ANATOMY | @as("TEST_TREATMENT_PROCEDURE") #TESTTREATMENTPROCEDURE | @as("PROTECTED_HEALTH_INFORMATION") #PROTECTEDHEALTHINFORMATION | @as("MEDICAL_CONDITION") #MEDICALCONDITION | @as("MEDICATION") #MEDICATION]
type entitySubType = [@as("TIME_TO_TREATMENT_NAME") #TIMETOTREATMENTNAME | @as("TIME_TO_PROCEDURE_NAME") #TIMETOPROCEDURENAME | @as("TIME_TO_TEST_NAME") #TIMETOTESTNAME | @as("TIME_TO_DX_NAME") #TIMETODXNAME | @as("TIME_TO_MEDICATION_NAME") #TIMETOMEDICATIONNAME | @as("TIME_EXPRESSION") #TIMEEXPRESSION | @as("QUANTITY") #QUANTITY | @as("QUALITY") #QUALITY | @as("DIRECTION") #DIRECTION | @as("SYSTEM_ORGAN_SITE") #SYSTEMORGANSITE | @as("PROFESSION") #PROFESSION | @as("ADDRESS") #ADDRESS | @as("URL") #URL | @as("IDENTIFIER") #IDENTIFIER | @as("EMAIL") #EMAIL | @as("CONTACT_POINT") #CONTACTPOINT | @as("AGE") #AGE | @as("DATE") #DATE | @as("TREATMENT_NAME") #TREATMENTNAME | @as("PROCEDURE_NAME") #PROCEDURENAME | @as("TEST_UNITS") #TESTUNITS | @as("TEST_VALUE") #TESTVALUE | @as("TEST_NAME") #TESTNAME | @as("ACUITY") #ACUITY | @as("RATE") #RATE | @as("STRENGTH") #STRENGTH | @as("BRAND_NAME") #BRANDNAME | @as("GENERIC_NAME") #GENERICNAME | @as("DURATION") #DURATION | @as("FREQUENCY") #FREQUENCY | @as("FORM") #FORM | @as("ROUTE_OR_MODE") #ROUTEORMODE | @as("DOSAGE") #DOSAGE | @as("NAME") #NAME]
...
@module("@aws-sdk/client-comprehendmedical") @new external createClient: unit => awsServiceClient = "ComprehendMedicalClient";
...
@as("JobId") jobId: jobId
  ...
  type response = {
@as("ComprehendMedicalAsyncJobProperties") comprehendMedicalAsyncJobProperties: option<comprehendMedicalAsyncJobProperties>
}
...
@as("Filter") filter: option<comprehendMedicalAsyncJobFilter>
  ...
  type response = {
@as("NextToken") nextToken: option<string_>,
@as("ComprehendMedicalAsyncJobPropertiesList") comprehendMedicalAsyncJobPropertiesList: option<comprehendMedicalAsyncJobPropertiesList>
}
