...
type resourceType = [@as("AWS::SSM::FileData") #AWS_SSM_FileData | @as("AWS::SNS::Topic") #AWS_SNS_Topic | @as("AWS::SecretsManager::Secret") #AWS_SecretsManager_Secret | @as("AWS::QLDB::Ledger") #AWS_QLDB_Ledger | @as("AWS::KMS::Key") #AWS_KMS_Key | @as("AWS::SQS::Queue") #AWS_SQS_Queue | @as("AWS::ServiceCatalog::Portfolio") #AWS_ServiceCatalog_Portfolio | @as("AWS::ServiceCatalog::CloudFormationProduct") #AWS_ServiceCatalog_CloudFormationProduct | @as("AWS::ServiceCatalog::CloudFormationProvisionedProduct") #AWS_ServiceCatalog_CloudFormationProvisionedProduct | @as("AWS::CodePipeline::Pipeline") #AWS_CodePipeline_Pipeline | @as("AWS::ApiGatewayV2::Api") #AWS_ApiGatewayV2_Api | @as("AWS::ApiGatewayV2::Stage") #AWS_ApiGatewayV2_Stage | @as("AWS::ApiGateway::RestApi") #AWS_ApiGateway_RestApi | @as("AWS::ApiGateway::Stage") #AWS_ApiGateway_Stage | @as("AWS::Config::ResourceCompliance") #AWS_Config_ResourceCompliance | @as("AWS::Config::ConformancePackCompliance") #AWS_Config_ConformancePackCompliance | @as("AWS::ShieldRegional::Protection") #AWS_ShieldRegional_Protection | @as("AWS::Shield::Protection") #AWS_Shield_Protection | @as("AWS::SSM::PatchCompliance") #AWS_SSM_PatchCompliance | @as("AWS::SSM::AssociationCompliance") #AWS_SSM_AssociationCompliance | @as("AWS::XRay::EncryptionConfig") #AWS_XRay_EncryptionConfig | @as("AWS::WAFv2::ManagedRuleSet") #AWS_WAFv2_ManagedRuleSet | @as("AWS::WAFv2::RegexPatternSet") #AWS_WAFv2_RegexPatternSet | @as("AWS::WAFv2::IPSet") #AWS_WAFv2_IPSet | @as("AWS::WAFv2::RuleGroup") #AWS_WAFv2_RuleGroup | @as("AWS::WAFv2::WebACL") #AWS_WAFv2_WebACL | @as("AWS::ElasticBeanstalk::Environment") #AWS_ElasticBeanstalk_Environment | @as("AWS::ElasticBeanstalk::ApplicationVersion") #AWS_ElasticBeanstalk_ApplicationVersion | @as("AWS::ElasticBeanstalk::Application") #AWS_ElasticBeanstalk_Application | @as("AWS::NetworkFirewall::RuleGroup") #AWS_NetworkFirewall_RuleGroup | @as("AWS::NetworkFirewall::FirewallPolicy") #AWS_NetworkFirewall_FirewallPolicy | @as("AWS::NetworkFirewall::Firewall") #AWS_NetworkFirewall_Firewall | @as("AWS::Lambda::Function") #AWS_Lambda_Function | @as("AWS::CloudFront::StreamingDistribution") #AWS_CloudFront_StreamingDistribution | @as("AWS::CloudFront::Distribution") #AWS_CloudFront_Distribution | @as("AWS::WAFRegional::WebACL") #AWS_WAFRegional_WebACL | @as("AWS::WAFRegional::RuleGroup") #AWS_WAFRegional_RuleGroup | @as("AWS::WAFRegional::Rule") #AWS_WAFRegional_Rule | @as("AWS::WAFRegional::RateBasedRule") #AWS_WAFRegional_RateBasedRule | @as("AWS::WAF::WebACL") #AWS_WAF_WebACL | @as("AWS::WAF::RuleGroup") #AWS_WAF_RuleGroup | @as("AWS::WAF::Rule") #AWS_WAF_Rule | @as("AWS::WAF::RateBasedRule") #AWS_WAF_RateBasedRule | @as("AWS::CodeBuild::Project") #AWS_CodeBuild_Project | @as("AWS::DynamoDB::Table") #AWS_DynamoDB_Table | @as("AWS::AutoScaling::ScheduledAction") #AWS_AutoScaling_ScheduledAction | @as("AWS::AutoScaling::ScalingPolicy") #AWS_AutoScaling_ScalingPolicy | @as("AWS::AutoScaling::LaunchConfiguration") #AWS_AutoScaling_LaunchConfiguration | @as("AWS::AutoScaling::AutoScalingGroup") #AWS_AutoScaling_AutoScalingGroup | @as("AWS::ElasticLoadBalancing::LoadBalancer") #AWS_ElasticLoadBalancing_LoadBalancer | @as("AWS::CloudFormation::Stack") #AWS_CloudFormation_Stack | @as("AWS::CloudWatch::Alarm") #AWS_CloudWatch_Alarm | @as("AWS::SSM::ManagedInstanceInventory") #AWS_SSM_ManagedInstanceInventory | @as("AWS::Redshift::EventSubscription") #AWS_Redshift_EventSubscription | @as("AWS::Redshift::ClusterSubnetGroup") #AWS_Redshift_ClusterSubnetGroup | @as("AWS::Redshift::ClusterSecurityGroup") #AWS_Redshift_ClusterSecurityGroup | @as("AWS::Redshift::ClusterParameterGroup") #AWS_Redshift_ClusterParameterGroup | @as("AWS::Redshift::ClusterSnapshot") #AWS_Redshift_ClusterSnapshot | @as("AWS::Redshift::Cluster") #AWS_Redshift_Cluster | @as("AWS::S3::AccountPublicAccessBlock") #AWS_S3_AccountPublicAccessBlock | @as("AWS::S3::Bucket") #AWS_S3_Bucket | @as("AWS::RDS::EventSubscription") #AWS_RDS_EventSubscription | @as("AWS::RDS::DBClusterSnapshot") #AWS_RDS_DBClusterSnapshot | @as("AWS::RDS::DBCluster") #AWS_RDS_DBCluster | @as("AWS::RDS::DBSnapshot") #AWS_RDS_DBSnapshot | @as("AWS::RDS::DBSecurityGroup") #AWS_RDS_DBSecurityGroup | @as("AWS::RDS::DBSubnetGroup") #AWS_RDS_DBSubnetGroup | @as("AWS::RDS::DBInstance") #AWS_RDS_DBInstance | @as("AWS::ACM::Certificate") #AWS_ACM_Certificate | @as("AWS::ElasticLoadBalancingV2::LoadBalancer") #AWS_ElasticLoadBalancingV2_LoadBalancer | @as("AWS::IAM::User") #AWS_IAM_User | @as("AWS::IAM::Role") #AWS_IAM_Role | @as("AWS::IAM::Policy") #AWS_IAM_Policy | @as("AWS::IAM::Group") #AWS_IAM_Group | @as("AWS::Elasticsearch::Domain") #AWS_Elasticsearch_Domain | @as("AWS::EC2::VPCPeeringConnection") #AWS_EC2_VPCPeeringConnection | @as("AWS::EC2::FlowLog") #AWS_EC2_FlowLog | @as("AWS::EC2::VPCEndpointService") #AWS_EC2_VPCEndpointService | @as("AWS::EC2::VPCEndpoint") #AWS_EC2_VPCEndpoint | @as("AWS::EC2::EgressOnlyInternetGateway") #AWS_EC2_EgressOnlyInternetGateway | @as("AWS::EC2::NatGateway") #AWS_EC2_NatGateway | @as("AWS::EC2::RegisteredHAInstance") #AWS_EC2_RegisteredHAInstance | @as("AWS::EC2::VPNGateway") #AWS_EC2_VPNGateway | @as("AWS::EC2::VPNConnection") #AWS_EC2_VPNConnection | @as("AWS::EC2::VPC") #AWS_EC2_VPC | @as("AWS::EC2::Volume") #AWS_EC2_Volume | @as("AWS::CloudTrail::Trail") #AWS_CloudTrail_Trail | @as("AWS::EC2::Subnet") #AWS_EC2_Subnet | @as("AWS::EC2::SecurityGroup") #AWS_EC2_SecurityGroup | @as("AWS::EC2::RouteTable") #AWS_EC2_RouteTable | @as("AWS::EC2::NetworkInterface") #AWS_EC2_NetworkInterface | @as("AWS::EC2::NetworkAcl") #AWS_EC2_NetworkAcl | @as("AWS::EC2::InternetGateway") #AWS_EC2_InternetGateway | @as("AWS::EC2::Instance") #AWS_EC2_Instance | @as("AWS::EC2::Host") #AWS_EC2_Host | @as("AWS::EC2::EIP") #AWS_EC2_EIP | @as("AWS::EC2::CustomerGateway") #AWS_EC2_CustomerGateway]
