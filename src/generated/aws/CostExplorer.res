...
type ec2Specification = {@as("OfferingClass") offeringClass: option<offeringClass>}
...
type coverageCost = {@as("OnDemandCost") onDemandCost: option<onDemandCost>}
...
type serviceSpecification = {@as("EC2Specification") ec2Specification: option<ec2Specification>}
...
type resourceDetails = {@as("EC2ResourceDetails") ec2ResourceDetails: option<ec2ResourceDetails>}
...
module DeleteCostCategoryDefinition = {
  type t
  type request = {@as("CostCategoryArn") costCategoryArn: arn}
  type response = {
    @as("EffectiveEnd") effectiveEnd: option<zonedDateTime>,
    @as("CostCategoryArn") costCategoryArn: option<arn>,
  }
