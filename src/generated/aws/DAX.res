...
type string_ = string
type sourceType = [@as("SUBNET_GROUP") #SUBNETGROUP | @as("PARAMETER_GROUP") #PARAMETERGROUP | @as("CLUSTER") #CLUSTER]
type ssestatus = [@as("DISABLED") #DISABLED | @as("DISABLING") #DISABLING | @as("ENABLED") #ENABLED | @as("ENABLING") #ENABLING]
type sseenabled = bool
type parameterType = [@as("NODE_TYPE_SPECIFIC") #NODETYPESPECIFIC | @as("DEFAULT") #DEFAULT]
type isModifiable = [@as("CONDITIONAL") #CONDITIONAL | @as("FALSE") #FALSE | @as("TRUE") #TRUE]
type integerOptional = int
type integer_ = int
type exceptionMessage = string
type changeType = [@as("REQUIRES_REBOOT") #REQUIRESREBOOT | @as("IMMEDIATE") #IMMEDIATE]
...
@as("SubnetGroupName") subnetGroupName: string_
  ...
  type response = {
@as("DeletionMessage") deletionMessage: option<string_>
}
...
@as("ParameterGroupName") parameterGroupName: string_
  ...
  type response = {
@as("ParameterGroup") parameterGroup: option<parameterGroup>
}
...
@as("SubnetGroupName") subnetGroupName: string_
  ...
  type response = {
@as("SubnetGroup") subnetGroup: option<subnetGroup>
}
