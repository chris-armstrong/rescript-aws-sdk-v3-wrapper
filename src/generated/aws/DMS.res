...
type dynamoDbSettings = {@as("ServiceAccessRoleArn") serviceAccessRoleArn: string_}
type docDbSettings = {
  @as("SecretsManagerSecretId") secretsManagerSecretId: option<string_>,
  @as("SecretsManagerAccessRoleArn") secretsManagerAccessRoleArn: option<string_>,
  @as("KmsKeyId") kmsKeyId: option<string_>,
...
module DescribeReplicationTaskAssessmentResults = {
  ...
  type response = {
    @as("ReplicationTaskAssessmentResults")
...
module DeleteReplicationTaskAssessmentRun = {
  type t
  type request = {@as("ReplicationTaskAssessmentRunArn") replicationTaskAssessmentRunArn: string_}
  type response = {
    @as("ReplicationTaskAssessmentRun")
    replicationTaskAssessmentRun: option<replicationTaskAssessmentRun>,
  }
