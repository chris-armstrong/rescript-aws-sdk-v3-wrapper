...
type source = [@as("DATABASE") #DATABASE | @as("DATA-CATALOG") #DATACATALOG | @as("S3") #S3]
...
type sampleType = [@as("RANDOM") #RANDOM | @as("LAST_N") #LASTN | @as("FIRST_N") #FIRSTN]
type sampleSize = int
type sampleMode = [@as("CUSTOM_ROWS") #CUSTOMROWS | @as("FULL_DATASET") #FULLDATASET]
type result = string
...
type orderedBy = [@as("LAST_MODIFIED_DATE") #LASTMODIFIEDDATE]
...
type encryptionMode = [@as("SSE-S3") #SSES3 | @as("SSE-KMS") #SSEKMS]
