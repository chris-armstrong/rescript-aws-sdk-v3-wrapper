...
type name = string
type maxResults = int
type limitName = [@as("Concurrent in progress jobs to export assets to a signed URL") #Concurrent_In_Progress_Jobs_To_Export_Assets_To_A_Signed_URL | @as("Concurrent in progress jobs to export assets to Amazon S3") #Concurrent_In_Progress_Jobs_To_Export_Assets_To_Amazon_S3 | @as("Concurrent in progress jobs to import assets from a signed URL") #Concurrent_In_Progress_Jobs_To_Import_Assets_From_A_Signed_URL | @as("Concurrent in progress jobs to import assets from Amazon S3") #Concurrent_In_Progress_Jobs_To_Import_Assets_From_Amazon_S3 | @as("Asset size in GB") #Asset_Size_In_GB | @as("Asset per export job from Amazon S3") #Asset_Per_Export_Job_From_Amazon_S3 | @as("Assets per import job from Amazon S3") #Assets_Per_Import_Job_From_Amazon_S3 | @as("Assets per revision") #Assets_Per_Revision | @as("Revisions per data set") #Revisions_Per_Data_Set | @as("Data sets per product") #Data_Sets_Per_Product | @as("Data sets per account") #Data_Sets_Per_Account | @as("Products per account") #Products_Per_Account]
type jobErrorResourceTypes = [@as("ASSET") #ASSET | @as("REVISION") #REVISION]
type jobErrorLimitName = [@as("Asset size in GB") #Asset_Size_In_GB | @as("Assets per revision") #Assets_Per_Revision]
type id = string
