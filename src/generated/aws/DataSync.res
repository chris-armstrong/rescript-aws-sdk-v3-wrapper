...
type verifyMode = [@as("NONE") #NONE | @as("ONLY_FILES_TRANSFERRED") #ONLYFILESTRANSFERRED | @as("POINT_IN_TIME_CONSISTENT") #POINTINTIMECONSISTENT]
type uid = [@as("BOTH") #BOTH | @as("NAME") #NAME | @as("INT_VALUE") #INTVALUE | @as("NONE") #NONE]
...
type smbSecurityDescriptorCopyFlags = [@as("OWNER_DACL_SACL") #OWNERDACLSACL | @as("OWNER_DACL") #OWNERDACL | @as("NONE") #NONE]
type smbPassword = string
type smbDomain = string
type serverHostname = string
type scheduleExpressionCron = string
type s3Subdirectory = string
type s3StorageClass = [@as("OUTPOSTS") #OUTPOSTS | @as("DEEP_ARCHIVE") #DEEPARCHIVE | @as("GLACIER") #GLACIER | @as("INTELLIGENT_TIERING") #INTELLIGENTTIERING | @as("ONEZONE_IA") #ONEZONEIA | @as("STANDARD_IA") #STANDARDIA | @as("STANDARD") #STANDARD]
...
type nfsVersion = [@as("NFS4_1") #NFS41 | @as("NFS4_0") #NFS40 | @as("NFS3") #NFS3 | @as("AUTOMATIC") #AUTOMATIC]
...
type gid = [@as("BOTH") #BOTH | @as("NAME") #NAME | @as("INT_VALUE") #INTVALUE | @as("NONE") #NONE]
type fsxWindowsSubdirectory = string
type fsxFilesystemArn = string
type filterValue = string
type filterType = [@as("SIMPLE_PATTERN") #SIMPLEPATTERN]
type filterAttributeValue = string
type endpointType = [@as("FIPS") #FIPS | @as("PRIVATE_LINK") #PRIVATELINK | @as("PUBLIC") #PUBLIC]
...
type atime = [@as("BEST_EFFORT") #BESTEFFORT | @as("NONE") #NONE]
type agentStatus = [@as("OFFLINE") #OFFLINE | @as("ONLINE") #ONLINE]
type agentArn = string
type activationKey = string
type taskSchedule = {
@as("ScheduleExpression") scheduleExpression: scheduleExpressionCron
}
type taskListEntry = {
...
@as("Version") version: option<smbVersion>
}
type s3Config = {
@as("BucketAccessRoleArn") bucketAccessRoleArn: iamRoleArn
}
type plsubnetArnList = array<ec2SubnetArn>
type plsecurityGroupArnList = array<ec2SecurityGroupArn>
type options = {
@as("SecurityDescriptorCopyFlags") securityDescriptorCopyFlags: option<smbSecurityDescriptorCopyFlags>,
...
@as("Version") version: option<nfsVersion>
}
...
@module("@aws-sdk/client-datasync") @new external createClient: unit => awsServiceClient = "DataSyncClient";
module UpdateAgent = {
  type t;
  type request = {
@as("Name") name: option<tagValue>,
...
@as("Excludes") excludes: option<filterList>,
@as("Options") options: option<options>,
@as("DestinationNetworkInterfaceArns") destinationNetworkInterfaceArns: option<destinationNetworkInterfaceArns>,
@as("SourceNetworkInterfaceArns") sourceNetworkInterfaceArns: option<sourceNetworkInterfaceArns>,
@as("CloudWatchLogGroupArn") cloudWatchLogGroupArn: option<logGroupArn>,
