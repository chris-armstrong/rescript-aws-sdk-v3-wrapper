...
@as("StackNames") stackNames: option<updateStackNames>
}
type serviceResourceCosts = array<serviceResourceCost>
type serviceIntegrationConfig = {
@as("OpsCenter") opsCenter: option<opsCenterIntegration>
}
type serviceHealth = {
...
@as("StackNames") stackNames: option<stackNames>
}
...
@as("CloudFormation") cloudFormation: option<cloudFormationCollection>
}
...
module UpdateServiceIntegration = {
  type t;
  type request = {
@as("ServiceIntegration") serviceIntegration: updateServiceIntegrationConfig
}
  type response = unit
...
module PutFeedback = {
  type t;
  type request = {
@as("InsightFeedback") insightFeedback: option<insightFeedback>
}
  type response = unit
...
module DescribeServiceIntegration = {
  ...
  type request = unit
  type response = {
@as("ServiceIntegration") serviceIntegration: option<serviceIntegrationConfig>
}
