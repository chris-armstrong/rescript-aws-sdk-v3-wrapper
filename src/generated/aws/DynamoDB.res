...
@module("@aws-sdk/client-dynamodb") @new external createClient: unit => awsServiceClient = "DynamoDBClient";
...
type timeToLiveStatus = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED | @as("DISABLING") #DISABLING | @as("ENABLING") #ENABLING]
...
type tableStatus = [@as("ARCHIVED") #ARCHIVED | @as("ARCHIVING") #ARCHIVING | @as("INACCESSIBLE_ENCRYPTION_CREDENTIALS") #INACCESSIBLE_ENCRYPTION_CREDENTIALS | @as("ACTIVE") #ACTIVE | @as("DELETING") #DELETING | @as("UPDATING") #UPDATING | @as("CREATING") #CREATING]
...
type string_ = string
type streamViewType = [@as("KEYS_ONLY") #KEYS_ONLY | @as("NEW_AND_OLD_IMAGES") #NEW_AND_OLD_IMAGES | @as("OLD_IMAGE") #OLD_IMAGE | @as("NEW_IMAGE") #NEW_IMAGE]
type streamEnabled = bool
type streamArn = string
type select = [@as("COUNT") #COUNT | @as("SPECIFIC_ATTRIBUTES") #SPECIFIC_ATTRIBUTES | @as("ALL_PROJECTED_ATTRIBUTES") #ALL_PROJECTED_ATTRIBUTES | @as("ALL_ATTRIBUTES") #ALL_ATTRIBUTES]
...
type ssestatus = [@as("UPDATING") #UPDATING | @as("DISABLED") #DISABLED | @as("DISABLING") #DISABLING | @as("ENABLED") #ENABLED | @as("ENABLING") #ENABLING]
...
type returnValue = [@as("UPDATED_NEW") #UPDATED_NEW | @as("ALL_NEW") #ALL_NEW | @as("UPDATED_OLD") #UPDATED_OLD | @as("ALL_OLD") #ALL_OLD | @as("NONE") #NONE]
...
type replicaStatus = [@as("INACCESSIBLE_ENCRYPTION_CREDENTIALS") #INACCESSIBLE_ENCRYPTION_CREDENTIALS | @as("REGION_DISABLED") #REGION_DISABLED | @as("ACTIVE") #ACTIVE | @as("DELETING") #DELETING | @as("UPDATING") #UPDATING | @as("CREATION_FAILED") #CREATION_FAILED | @as("CREATING") #CREATING]
...
type integer_ = int
type indexStatus = [@as("ACTIVE") #ACTIVE | @as("DELETING") #DELETING | @as("UPDATING") #UPDATING | @as("CREATING") #CREATING]
type indexName = string
type globalTableStatus = [@as("UPDATING") #UPDATING | @as("DELETING") #DELETING | @as("ACTIVE") #ACTIVE | @as("CREATING") #CREATING]
...
type exportStatus = [@as("FAILED") #FAILED | @as("COMPLETED") #COMPLETED | @as("IN_PROGRESS") #IN_PROGRESS]
...
type double = float
type destinationStatus = [@as("ENABLE_FAILED") #ENABLE_FAILED | @as("DISABLED") #DISABLED | @as("DISABLING") #DISABLING | @as("ACTIVE") #ACTIVE | @as("ENABLING") #ENABLING]
type date = Js.Date.t;
type contributorInsightsStatus = [@as("FAILED") #FAILED | @as("DISABLED") #DISABLED | @as("DISABLING") #DISABLING | @as("ENABLED") #ENABLED | @as("ENABLING") #ENABLING]
...
type comparisonOperator = [@as("BEGINS_WITH") #BEGINS_WITH | @as("NOT_CONTAINS") #NOT_CONTAINS | @as("CONTAINS") #CONTAINS | @as("NULL") #NULL | @as("NOT_NULL") #NOT_NULL | @as("BETWEEN") #BETWEEN | @as("GT") #GT | @as("GE") #GE | @as("LT") #LT | @as("LE") #LE | @as("IN") #IN | @as("NE") #NE | @as("EQ") #EQ]
type code = string
...
type batchStatementErrorCodeEnum = [@as("DuplicateItem") #DuplicateItem | @as("AccessDenied") #AccessDenied | @as("ResourceNotFound") #ResourceNotFound | @as("InternalServerError") #InternalServerError | @as("ThrottlingError") #ThrottlingError | @as("TransactionConflict") #TransactionConflict | @as("ProvisionedThroughputExceeded") #ProvisionedThroughputExceeded | @as("ValidationError") #ValidationError | @as("RequestLimitExceeded") #RequestLimitExceeded | @as("ItemCollectionSizeLimitExceeded") #ItemCollectionSizeLimitExceeded | @as("ConditionalCheckFailed") #ConditionalCheckFailed]
type backupsInputLimit = int
type backupTypeFilter = [@as("ALL") #ALL | @as("AWS_BACKUP") #AWS_BACKUP | @as("SYSTEM") #SYSTEM | @as("USER") #USER]
type backupType = [@as("AWS_BACKUP") #AWS_BACKUP | @as("SYSTEM") #SYSTEM | @as("USER") #USER]
type backupStatus = [@as("AVAILABLE") #AVAILABLE | @as("DELETED") #DELETED | @as("CREATING") #CREATING]
...
@as("ProvisionedThroughputOverride") provisionedThroughputOverride: option<provisionedThroughputOverride>,
  @as("IndexName") indexName: option<indexName>
}
...
@as("PointInTimeRecoveryDescription") pointInTimeRecoveryDescription: option<pointInTimeRecoveryDescription>,
...
@as("TargetTrackingScalingPolicyConfiguration") targetTrackingScalingPolicyConfiguration: autoScalingTargetTrackingScalingPolicyConfigurationUpdate,
  @as("PolicyName") policyName: option<autoScalingPolicyName>
}
type autoScalingPolicyDescription = {
@as("TargetTrackingScalingPolicyConfiguration") targetTrackingScalingPolicyConfiguration: option<autoScalingTargetTrackingScalingPolicyConfigurationDescription>,
  @as("PolicyName") policyName: option<autoScalingPolicyName>
}
...
@as("ProvisionedReadCapacityAutoScalingSettingsUpdate") provisionedReadCapacityAutoScalingSettingsUpdate: option<autoScalingSettingsUpdate>,
...
@as("ProvisionedReadCapacityAutoScalingUpdate") provisionedReadCapacityAutoScalingUpdate: option<autoScalingSettingsUpdate>,
  @as("IndexName") indexName: option<indexName>
}
type replicaDescription = {
@as("ReplicaInaccessibleDateTime") replicaInaccessibleDateTime: option<date>,
  @as("GlobalSecondaryIndexes") globalSecondaryIndexes: option<replicaGlobalSecondaryIndexDescriptionList>,
  @as("ProvisionedThroughputOverride") provisionedThroughputOverride: option<provisionedThroughputOverride>,
  @as("KMSMasterKeyId") kmsmasterKeyId: option<kmsmasterKeyId>,
  @as("ReplicaStatusPercentProgress") replicaStatusPercentProgress: option<replicaStatusPercentProgress>,
...
@as("ProvisionedWriteCapacityAutoScalingSettingsUpdate") provisionedWriteCapacityAutoScalingSettingsUpdate: option<autoScalingSettingsUpdate>,
...
@as("ProvisionedWriteCapacityAutoScalingUpdate") provisionedWriteCapacityAutoScalingUpdate: option<autoScalingSettingsUpdate>,
  @as("IndexName") indexName: option<indexName>
}
...
type replicaGlobalSecondaryIndexSettingsUpdateList = array<replicaGlobalSecondaryIndexSettingsUpdate>
type replicaGlobalSecondaryIndexSettingsDescription = {
@as("ProvisionedWriteCapacityAutoScalingSettings") provisionedWriteCapacityAutoScalingSettings: option<autoScalingSettingsDescription>,
  @as("ProvisionedWriteCapacityUnits") provisionedWriteCapacityUnits: option<positiveLongObject>,
  @as("ProvisionedReadCapacityAutoScalingSettings") provisionedReadCapacityAutoScalingSettings: option<autoScalingSettingsDescription>,
  @as("ProvisionedReadCapacityUnits") provisionedReadCapacityUnits: option<positiveLongObject>,
  @as("IndexStatus") indexStatus: option<indexStatus>,
  @as("IndexName") indexName: indexName
}
type replicaGlobalSecondaryIndexAutoScalingUpdateList = array<replicaGlobalSecondaryIndexAutoScalingUpdate>
...
type globalTableGlobalSecondaryIndexSettingsUpdateList = array<globalTableGlobalSecondaryIndexSettingsUpdate>
...
@as("ReplicaGlobalSecondaryIndexSettingsUpdate") replicaGlobalSecondaryIndexSettingsUpdate: option<replicaGlobalSecondaryIndexSettingsUpdateList>,
  @as("ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate") replicaProvisionedReadCapacityAutoScalingSettingsUpdate: option<autoScalingSettingsUpdate>,
  @as("ReplicaProvisionedReadCapacityUnits") replicaProvisionedReadCapacityUnits: option<positiveLongObject>,
  @as("RegionName") regionName: regionName
}
type replicaGlobalSecondaryIndexSettingsDescriptionList = array<replicaGlobalSecondaryIndexSettingsDescription>
type replicaGlobalSecondaryIndexAutoScalingDescriptionList = array<replicaGlobalSecondaryIndexAutoScalingDescription>
type replicaAutoScalingUpdate = {
@as("ReplicaProvisionedReadCapacityAutoScalingUpdate") replicaProvisionedReadCapacityAutoScalingUpdate: option<autoScalingSettingsUpdate>,
  @as("ReplicaGlobalSecondaryIndexUpdates") replicaGlobalSecondaryIndexUpdates: option<replicaGlobalSecondaryIndexAutoScalingUpdateList>,
  @as("RegionName") regionName: regionName
}
...
@as("ReplicaGlobalSecondaryIndexSettings") replicaGlobalSecondaryIndexSettings: option<replicaGlobalSecondaryIndexSettingsDescriptionList>,
  @as("ReplicaProvisionedWriteCapacityAutoScalingSettings") replicaProvisionedWriteCapacityAutoScalingSettings: option<autoScalingSettingsDescription>,
  @as("ReplicaProvisionedWriteCapacityUnits") replicaProvisionedWriteCapacityUnits: option<nonNegativeLongObject>,
  @as("ReplicaProvisionedReadCapacityAutoScalingSettings") replicaProvisionedReadCapacityAutoScalingSettings: option<autoScalingSettingsDescription>,
  @as("ReplicaProvisionedReadCapacityUnits") replicaProvisionedReadCapacityUnits: option<nonNegativeLongObject>,
...
@as("ReplicaStatus") replicaStatus: option<replicaStatus>,
  @as("ReplicaProvisionedWriteCapacityAutoScalingSettings") replicaProvisionedWriteCapacityAutoScalingSettings: option<autoScalingSettingsDescription>,
  @as("ReplicaProvisionedReadCapacityAutoScalingSettings") replicaProvisionedReadCapacityAutoScalingSettings: option<autoScalingSettingsDescription>,
  @as("GlobalSecondaryIndexes") globalSecondaryIndexes: option<replicaGlobalSecondaryIndexAutoScalingDescriptionList>,
  @as("RegionName") regionName: option<regionName>
}
...
} and mapAttributeValue = Js.Dict.t<attributeValue> and listAttributeValue = array<attributeValue>
...
type update = {
@as("ReturnValuesOnConditionCheckFailure") returnValuesOnConditionCheckFailure: option<returnValuesOnConditionCheckFailure>,
...
@as("ContributorInsightsStatus") contributorInsightsStatus: option<contributorInsightsStatus>,
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "UpdateContributorInsightsCommand";
...
@as("DestinationStatus") destinationStatus: option<destinationStatus>,
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "EnableKinesisStreamingDestinationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("DestinationStatus") destinationStatus: option<destinationStatus>,
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "DisableKinesisStreamingDestinationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ExportFormat") exportFormat: option<exportFormat>,
  ...
  type response = {
@as("ExportDescription") exportDescription: option<exportDescription>
}
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "ExportTableToPointInTimeCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
module DescribeExport = {
  type t;
  type request = {
@as("ExportArn") exportArn: exportArn
}
  type response = {
@as("ExportDescription") exportDescription: option<exportDescription>
}
...
@as("FailureException") failureException: option<failureException>,
  ...
  @as("ContributorInsightsStatus") contributorInsightsStatus: option<contributorInsightsStatus>,
  @as("ContributorInsightsRuleList") contributorInsightsRuleList: option<contributorInsightsRuleList>,
  @as("IndexName") indexName: option<indexName>,
  @as("TableName") tableName: option<tableName>
}
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "DescribeContributorInsightsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
module UpdateContinuousBackups = {
  type t;
  type request = {
@as("PointInTimeRecoverySpecification") pointInTimeRecoverySpecification: pointInTimeRecoverySpecification,
  @as("TableName") tableName: tableName
}
  type response = {
@as("ContinuousBackupsDescription") continuousBackupsDescription: option<continuousBackupsDescription>
}
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "UpdateContinuousBackupsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("MaxResults") maxResults: option<listContributorInsightsLimit>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextTokenString>,
  @as("ContributorInsightsSummaries") contributorInsightsSummaries: option<contributorInsightsSummaries>
}
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "ListContributorInsightsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TableName") tableName: tableName
  ...
  type response = {
@as("KinesisDataStreamDestinations") kinesisDataStreamDestinations: option<kinesisDataStreamDestinations>,
  @as("TableName") tableName: option<tableName>
}
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "DescribeKinesisStreamingDestinationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ContinuousBackupsDescription") continuousBackupsDescription: option<continuousBackupsDescription>
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "DescribeContinuousBackupsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ReplicaUpdates") replicaUpdates: option<replicationGroupUpdateList>,
  ...
  @as("StreamSpecification") streamSpecification: option<streamSpecification>,
  @as("GlobalSecondaryIndexUpdates") globalSecondaryIndexUpdates: option<globalSecondaryIndexUpdateList>,
  @as("ProvisionedThroughput") provisionedThroughput: option<provisionedThroughput>,
  @as("BillingMode") billingMode: option<billingMode>,
  @as("TableName") tableName: tableName,
  @as("AttributeDefinitions") attributeDefinitions: option<attributeDefinitions>
  ...
  type response = {
@as("TableDescription") tableDescription: option<tableDescription>
}
...
@as("SSESpecificationOverride") ssespecificationOverride: option<ssespecification>,
  @as("ProvisionedThroughputOverride") provisionedThroughputOverride: option<provisionedThroughput>,
  @as("LocalSecondaryIndexOverride") localSecondaryIndexOverride: option<localSecondaryIndexList>,
  @as("GlobalSecondaryIndexOverride") globalSecondaryIndexOverride: option<globalSecondaryIndexList>,
...
@as("TableDescription") tableDescription: option<tableDescription>
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "RestoreTableToPointInTimeCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TableDescription") tableDescription: option<tableDescription>
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "RestoreTableFromBackupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TableName") tableName: tableName
  ...
  type response = {
@as("Table") table: option<tableDescription>
}
...
@as("GlobalTableDescription") globalTableDescription: option<globalTableDescription>
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "DescribeGlobalTableCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("BackupArn") backupArn: backupArn
  ...
  type response = {
@as("BackupDescription") backupDescription: option<backupDescription>
}
...
@as("ReplicaSettingsUpdate") replicaSettingsUpdate: option<replicaSettingsUpdateList>,
  @as("GlobalTableGlobalSecondaryIndexSettingsUpdate") globalTableGlobalSecondaryIndexSettingsUpdate: option<globalTableGlobalSecondaryIndexSettingsUpdateList>,
  @as("GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate") globalTableProvisionedWriteCapacityAutoScalingSettingsUpdate: option<autoScalingSettingsUpdate>,
  @as("GlobalTableProvisionedWriteCapacityUnits") globalTableProvisionedWriteCapacityUnits: option<positiveLongObject>,
...
@as("ReplicaSettings") replicaSettings: option<replicaSettingsDescriptionList>,
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "UpdateGlobalTableSettingsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ReplicaSettings") replicaSettings: option<replicaSettingsDescriptionList>,
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "DescribeGlobalTableSettingsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ReplicaUpdates") replicaUpdates: option<replicaAutoScalingUpdateList>,
  @as("ProvisionedWriteCapacityAutoScalingUpdate") provisionedWriteCapacityAutoScalingUpdate: option<autoScalingSettingsUpdate>,
  @as("TableName") tableName: tableName,
  @as("GlobalSecondaryIndexUpdates") globalSecondaryIndexUpdates: option<globalSecondaryIndexAutoScalingUpdateList>
}
  type response = {
@as("TableAutoScalingDescription") tableAutoScalingDescription: option<tableAutoScalingDescription>
}
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "UpdateTableReplicaAutoScalingCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TableAutoScalingDescription") tableAutoScalingDescription: option<tableAutoScalingDescription>
  ...
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "DescribeTableReplicaAutoScalingCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ExpressionAttributeValues") expressionAttributeValues: option<expressionAttributeValueMap>,
  ...
  @as("ReturnItemCollectionMetrics") returnItemCollectionMetrics: option<returnItemCollectionMetrics>,
  @as("ReturnConsumedCapacity") returnConsumedCapacity: option<returnConsumedCapacity>,
...
module BatchExecuteStatement = {
  type t;
  type request = {
@as("Statements") statements: partiQLBatchRequest
}
  type response = {
@as("Responses") responses: option<partiQLBatchResponse>
}
  @module("@aws-sdk/client-dynamodb") @new external new_: (request) => t = "BatchExecuteStatementCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
