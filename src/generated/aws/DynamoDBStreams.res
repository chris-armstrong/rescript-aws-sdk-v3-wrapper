...
@module("@aws-sdk/client-dynamodb") @new external createClient: unit => awsServiceClient = "DynamoDBStreamsClient";
...
type streamStatus = [@as("DISABLED") #DISABLED | @as("DISABLING") #DISABLING | @as("ENABLED") #ENABLED | @as("ENABLING") #ENABLING]
type streamArn = string
type shardIteratorType = [@as("AFTER_SEQUENCE_NUMBER") #AFTER_SEQUENCE_NUMBER | @as("AT_SEQUENCE_NUMBER") #AT_SEQUENCE_NUMBER | @as("LATEST") #LATEST | @as("TRIM_HORIZON") #TRIM_HORIZON]
