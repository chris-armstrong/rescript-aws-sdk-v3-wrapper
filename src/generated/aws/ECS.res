...
type repositoryCredentials = {credentialsParameter: string_}
type portMapping = {
...
type hostVolumeProperties = {sourcePath: option<string_>}
type hostEntry = {
  ipAddress: string_,
  hostname: string_,
}
...
type ephemeralStorage = {sizeInGiB: integer_}
...
type deploymentController = {@as("type") type_: deploymentControllerType}
...
type clusterConfiguration = {executeCommandConfiguration: option<executeCommandConfiguration>}
