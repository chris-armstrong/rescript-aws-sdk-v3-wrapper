...
type provider = {keyArn: option<string_>}
type oidc = {issuer: option<string_>}
...
type kubernetesNetworkConfigResponse = {serviceIpv4Cidr: option<string_>}
type kubernetesNetworkConfigRequest = {serviceIpv4Cidr: option<string_>}
type identityProviderConfig = {
  name: string_,
  @as("type") type_: string_,
}
type fargateProfileLabel = Js.Dict.t<string_>
type certificate = {data: option<string_>}
type autoScalingGroup = {name: option<string_>}
...
type identity = {oidc: option<oidc>}
...
type identityProviderConfigResponse = {oidc: option<oidcIdentityProviderConfig>}
...
type nodegroupHealth = {issues: option<issueList>}
type logging = {clusterLogging: option<logSetups>}
type fargateProfile = {
  tags: option<tagMap>,
...
type addonHealth = {issues: option<addonIssueList>}
type nodegroup = {
  tags: option<tagMap>,
