...
@module("@aws-sdk/client-elasticmapreduce") @new external createClient: unit => awsServiceClient = "EMRClient";
...
type unit_ = [@as("COUNT_PER_SECOND") #COUNT_PER_SECOND | @as("TERA_BITS_PER_SECOND") #TERA_BITS_PER_SECOND | @as("GIGA_BITS_PER_SECOND") #GIGA_BITS_PER_SECOND | @as("MEGA_BITS_PER_SECOND") #MEGA_BITS_PER_SECOND | @as("KILO_BITS_PER_SECOND") #KILO_BITS_PER_SECOND | @as("BITS_PER_SECOND") #BITS_PER_SECOND | @as("TERA_BYTES_PER_SECOND") #TERA_BYTES_PER_SECOND | @as("GIGA_BYTES_PER_SECOND") #GIGA_BYTES_PER_SECOND | @as("MEGA_BYTES_PER_SECOND") #MEGA_BYTES_PER_SECOND | @as("KILO_BYTES_PER_SECOND") #KILO_BYTES_PER_SECOND | @as("BYTES_PER_SECOND") #BYTES_PER_SECOND | @as("COUNT") #COUNT | @as("PERCENT") #PERCENT | @as("TERA_BITS") #TERA_BITS | @as("GIGA_BITS") #GIGA_BITS | @as("MEGA_BITS") #MEGA_BITS | @as("KILO_BITS") #KILO_BITS | @as("BITS") #BITS | @as("TERA_BYTES") #TERA_BYTES | @as("GIGA_BYTES") #GIGA_BYTES | @as("MEGA_BYTES") #MEGA_BYTES | @as("KILO_BYTES") #KILO_BYTES | @as("BYTES") #BYTES | @as("MILLI_SECONDS") #MILLI_SECONDS | @as("MICRO_SECONDS") #MICRO_SECONDS | @as("SECONDS") #SECONDS | @as("NONE") #NONE]
type string_ = string
type stepStateChangeReasonCode = [@as("NONE") #NONE]
type stepState = [@as("INTERRUPTED") #INTERRUPTED | @as("FAILED") #FAILED | @as("CANCELLED") #CANCELLED | @as("COMPLETED") #COMPLETED | @as("RUNNING") #RUNNING | @as("CANCEL_PENDING") #CANCEL_PENDING | @as("PENDING") #PENDING]
type stepId = string
type stepExecutionState = [@as("INTERRUPTED") #INTERRUPTED | @as("FAILED") #FAILED | @as("CANCELLED") #CANCELLED | @as("COMPLETED") #COMPLETED | @as("CONTINUE") #CONTINUE | @as("RUNNING") #RUNNING | @as("PENDING") #PENDING]
type stepCancellationOption = [@as("TERMINATE_PROCESS") #TERMINATE_PROCESS | @as("SEND_INTERRUPT") #SEND_INTERRUPT]
type statistic = [@as("MAXIMUM") #MAXIMUM | @as("MINIMUM") #MINIMUM | @as("SUM") #SUM | @as("AVERAGE") #AVERAGE | @as("SAMPLE_COUNT") #SAMPLE_COUNT]
type spotProvisioningTimeoutAction = [@as("TERMINATE_CLUSTER") #TERMINATE_CLUSTER | @as("SWITCH_TO_ON_DEMAND") #SWITCH_TO_ON_DEMAND]
type spotProvisioningAllocationStrategy = [@as("capacity-optimized") #Capacity_Optimized]
type scaleDownBehavior = [@as("TERMINATE_AT_TASK_COMPLETION") #TERMINATE_AT_TASK_COMPLETION | @as("TERMINATE_AT_INSTANCE_HOUR") #TERMINATE_AT_INSTANCE_HOUR]
type resourceId = string
type repoUpgradeOnBoot = [@as("NONE") #NONE | @as("SECURITY") #SECURITY]
type port = int
type placementGroupStrategy = [@as("NONE") #NONE | @as("CLUSTER") #CLUSTER | @as("PARTITION") #PARTITION | @as("SPREAD") #SPREAD]
type optionalArnType = string
type onDemandProvisioningAllocationStrategy = [@as("lowest-price") #Lowest_Price]
type onDemandCapacityReservationUsageStrategy = [@as("use-capacity-reservations-first") #Use_Capacity_Reservations_First]
type onDemandCapacityReservationPreference = [@as("none") #None | @as("open") #Open]
type notebookExecutionStatus = [@as("STOPPED") #STOPPED | @as("STOPPING") #STOPPING | @as("STOP_PENDING") #STOP_PENDING | @as("FAILED") #FAILED | @as("FAILING") #FAILING | @as("FINISHED") #FINISHED | @as("FINISHING") #FINISHING | @as("RUNNING") #RUNNING | @as("STARTING") #STARTING | @as("START_PENDING") #START_PENDING]
type nonNegativeDouble = float
type marketType = [@as("SPOT") #SPOT | @as("ON_DEMAND") #ON_DEMAND]
type marker = string
type long = float
type jobFlowExecutionState = [@as("FAILED") #FAILED | @as("COMPLETED") #COMPLETED | @as("TERMINATED") #TERMINATED | @as("SHUTTING_DOWN") #SHUTTING_DOWN | @as("WAITING") #WAITING | @as("RUNNING") #RUNNING | @as("BOOTSTRAPPING") #BOOTSTRAPPING | @as("STARTING") #STARTING]
type integer_ = int
type instanceType = string
type instanceStateChangeReasonCode = [@as("CLUSTER_TERMINATED") #CLUSTER_TERMINATED | @as("BOOTSTRAP_FAILURE") #BOOTSTRAP_FAILURE | @as("INSTANCE_FAILURE") #INSTANCE_FAILURE | @as("VALIDATION_ERROR") #VALIDATION_ERROR | @as("INTERNAL_ERROR") #INTERNAL_ERROR]
type instanceState = [@as("TERMINATED") #TERMINATED | @as("RUNNING") #RUNNING | @as("BOOTSTRAPPING") #BOOTSTRAPPING | @as("PROVISIONING") #PROVISIONING | @as("AWAITING_FULFILLMENT") #AWAITING_FULFILLMENT]
...
type instanceGroupStateChangeReasonCode = [@as("CLUSTER_TERMINATED") #CLUSTER_TERMINATED | @as("INSTANCE_FAILURE") #INSTANCE_FAILURE | @as("VALIDATION_ERROR") #VALIDATION_ERROR | @as("INTERNAL_ERROR") #INTERNAL_ERROR]
type instanceGroupState = [@as("ENDED") #ENDED | @as("SHUTTING_DOWN") #SHUTTING_DOWN | @as("ARRESTED") #ARRESTED | @as("TERMINATED") #TERMINATED | @as("TERMINATING") #TERMINATING | @as("SUSPENDED") #SUSPENDED | @as("RESIZING") #RESIZING | @as("RECONFIGURING") #RECONFIGURING | @as("RUNNING") #RUNNING | @as("BOOTSTRAPPING") #BOOTSTRAPPING | @as("PROVISIONING") #PROVISIONING]
type instanceGroupId = string
type instanceFleetType = [@as("TASK") #TASK | @as("CORE") #CORE | @as("MASTER") #MASTER]
type instanceFleetStateChangeReasonCode = [@as("CLUSTER_TERMINATED") #CLUSTER_TERMINATED | @as("INSTANCE_FAILURE") #INSTANCE_FAILURE | @as("VALIDATION_ERROR") #VALIDATION_ERROR | @as("INTERNAL_ERROR") #INTERNAL_ERROR]
type instanceFleetState = [@as("TERMINATED") #TERMINATED | @as("TERMINATING") #TERMINATING | @as("SUSPENDED") #SUSPENDED | @as("RESIZING") #RESIZING | @as("RUNNING") #RUNNING | @as("BOOTSTRAPPING") #BOOTSTRAPPING | @as("PROVISIONING") #PROVISIONING]
type instanceFleetId = string
type instanceCollectionType = [@as("INSTANCE_GROUP") #INSTANCE_GROUP | @as("INSTANCE_FLEET") #INSTANCE_FLEET]
type identityType = [@as("GROUP") #GROUP | @as("USER") #USER]
type executionEngineType = [@as("EMR") #EMR]
type errorMessage = string
type errorCode = string
type date = Js.Date.t;
type computeLimitsUnitType = [@as("VCPU") #VCPU | @as("Instances") #Instances | @as("InstanceFleetUnits") #InstanceFleetUnits]
type comparisonOperator = [@as("LESS_THAN_OR_EQUAL") #LESS_THAN_OR_EQUAL | @as("LESS_THAN") #LESS_THAN | @as("GREATER_THAN") #GREATER_THAN | @as("GREATER_THAN_OR_EQUAL") #GREATER_THAN_OR_EQUAL]
type clusterStateChangeReasonCode = [@as("ALL_STEPS_COMPLETED") #ALL_STEPS_COMPLETED | @as("STEP_FAILURE") #STEP_FAILURE | @as("USER_REQUEST") #USER_REQUEST | @as("BOOTSTRAP_FAILURE") #BOOTSTRAP_FAILURE | @as("INSTANCE_FLEET_TIMEOUT") #INSTANCE_FLEET_TIMEOUT | @as("INSTANCE_FAILURE") #INSTANCE_FAILURE | @as("VALIDATION_ERROR") #VALIDATION_ERROR | @as("INTERNAL_ERROR") #INTERNAL_ERROR]
type clusterState = [@as("TERMINATED_WITH_ERRORS") #TERMINATED_WITH_ERRORS | @as("TERMINATED") #TERMINATED | @as("TERMINATING") #TERMINATING | @as("WAITING") #WAITING | @as("RUNNING") #RUNNING | @as("BOOTSTRAPPING") #BOOTSTRAPPING | @as("STARTING") #STARTING]
type clusterId = string
type cancelStepsRequestStatus = [@as("FAILED") #FAILED | @as("SUBMITTED") #SUBMITTED]
type booleanObject = bool
type boolean_ = bool
type autoScalingPolicyStateChangeReasonCode = [@as("CLEANUP_FAILURE") #CLEANUP_FAILURE | @as("PROVISION_FAILURE") #PROVISION_FAILURE | @as("USER_REQUEST") #USER_REQUEST]
type autoScalingPolicyState = [@as("FAILED") #FAILED | @as("DETACHED") #DETACHED | @as("DETACHING") #DETACHING | @as("ATTACHED") #ATTACHED | @as("ATTACHING") #ATTACHING | @as("PENDING") #PENDING]
type authMode = [@as("IAM") #IAM | @as("SSO") #SSO]
type arnType = string
type adjustmentType = [@as("EXACT_CAPACITY") #EXACT_CAPACITY | @as("PERCENT_CHANGE_IN_CAPACITY") #PERCENT_CHANGE_IN_CAPACITY | @as("CHANGE_IN_CAPACITY") #CHANGE_IN_CAPACITY]
type actionOnFailure = [@as("CONTINUE") #CONTINUE | @as("CANCEL_AND_WAIT") #CANCEL_AND_WAIT | @as("TERMINATE_CLUSTER") #TERMINATE_CLUSTER | @as("TERMINATE_JOB_FLOW") #TERMINATE_JOB_FLOW]
...
@as("CapacityReservationResourceGroupArn") capacityReservationResourceGroupArn: option<xmlStringMaxLen256>,
  @as("CapacityReservationPreference") capacityReservationPreference: option<onDemandCapacityReservationPreference>,
...
@as("ADDomainJoinPassword") addomainJoinPassword: option<xmlStringMaxLen256>,
  ...
  @as("CrossRealmTrustPrincipalPassword") crossRealmTrustPrincipalPassword: option<xmlStringMaxLen256>,
...
type scalingAction = {
@as("SimpleScalingPolicyConfiguration") simpleScalingPolicyConfiguration: simpleScalingPolicyConfiguration,
...
@as("CapacityReservationOptions") capacityReservationOptions: option<onDemandCapacityReservationOptions>,
...
@as("ComputeLimits") computeLimits: option<computeLimits>
}
...
@as("AdditionalSlaveSecurityGroups") additionalSlaveSecurityGroups: option<stringList>,
  ...
  @as("RequestedEc2AvailabilityZones") requestedEc2AvailabilityZones: option<xmlStringMaxLen256List>,
...
@as("Tags") tags: option<tagList_>,
  @as("NotebookInstanceSecurityGroupId") notebookInstanceSecurityGroupId: option<xmlStringMaxLen256>,
  @as("LastStateChangeReason") lastStateChangeReason: option<xmlString>,
...
type rec configurationList = array<configuration> and configuration = {
@as("Properties") properties: option<stringMap>,
...
@as("EbsOptimized") ebsOptimized: option<booleanObject>,
  ...
  @as("Configurations") configurations: option<configurationList>,
  @as("BidPriceAsPercentageOfOnDemandPrice") bidPriceAsPercentageOfOnDemandPrice: option<nonNegativeDouble>,
  @as("BidPrice") bidPrice: option<xmlStringMaxLen256>,
...
@as("AutoScalingPolicy") autoScalingPolicy: option<autoScalingPolicyDescription>,
  ...
  @as("EbsOptimized") ebsOptimized: option<booleanObject>,
  @as("EbsBlockDevices") ebsBlockDevices: option<ebsBlockDeviceList>,
  @as("LastSuccessfullyAppliedConfigurationsVersion") lastSuccessfullyAppliedConfigurationsVersion: option<long>,
  @as("LastSuccessfullyAppliedConfigurations") lastSuccessfullyAppliedConfigurations: option<configurationList>,
...
@as("Properties") properties: option<stringMap>,
  @as("Configurations") configurations: option<configurationList>,
  @as("Classification") classification: option<string_>,
  @as("PermittedPublicSecurityGroupRuleRanges") permittedPublicSecurityGroupRuleRanges: option<portRanges>,
...
type instanceFleet = {
@as("LaunchSpecifications") launchSpecifications: option<instanceFleetProvisioningSpecifications>,
  @as("InstanceTypeSpecifications") instanceTypeSpecifications: option<instanceTypeSpecificationList>,
...
@as("SessionPolicyArn") sessionPolicyArn: xmlStringMaxLen256,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "UpdateStudioSessionMappingCommand";
...
module StopNotebookExecution = {
  type t;
  type request = {
@as("NotebookExecutionId") notebookExecutionId: xmlStringMaxLen256
}
  
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "StopNotebookExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("ClusterId") clusterId: clusterId
  ...
  type response = unit
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "RemoveManagedScalingPolicyCommand";
...
@as("InstanceGroupId") instanceGroupId: instanceGroupId,
  ...
  type response = unit
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "RemoveAutoScalingPolicyCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StepConcurrencyLevel") stepConcurrencyLevel: option<integer_>
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ModifyClusterCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CreationDateTime") creationDateTime: option<date>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "DescribeSecurityConfigurationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("IdentityType") identityType: identityType,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "DeleteStudioSessionMappingCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("StudioId") studioId: xmlStringMaxLen256
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "DeleteStudioCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("Name") name: xmlString
  ...
  type response = unit
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "DeleteSecurityConfigurationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("SessionPolicyArn") sessionPolicyArn: xmlStringMaxLen256,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "CreateStudioSessionMappingCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("CreationDateTime") creationDateTime: date,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "CreateSecurityConfigurationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("DefaultS3Location") defaultS3Location: option<xmlString>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "UpdateStudioCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("JobFlowIds") jobFlowIds: xmlStringList
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "TerminateJobFlowsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("VisibleToAllUsers") visibleToAllUsers: boolean_,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "SetVisibleToAllUsersCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("TerminationProtected") terminationProtected: boolean_,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "SetTerminationProtectionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("InstanceFleet") instanceFleet: instanceFleetModifyConfig,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ModifyInstanceFleetCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("IdentityType") identityType: identityType,
  ...
  type response = {
@as("SessionMapping") sessionMapping: option<sessionMappingDetail>
}
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "GetStudioSessionMappingCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NotebookExecutionId") notebookExecutionId: option<xmlStringMaxLen256>
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "StartNotebookExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ManagedScalingPolicy") managedScalingPolicy: managedScalingPolicy,
  ...
  type response = unit
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "PutManagedScalingPolicyCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Marker") marker: option<marker>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ListStudiosCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Marker") marker: option<marker>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ListStudioSessionMappingsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Marker") marker: option<marker>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ListSecurityConfigurationsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Marker") marker: option<marker>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ListNotebookExecutionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ManagedScalingPolicy") managedScalingPolicy: option<managedScalingPolicy>
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "GetManagedScalingPolicyCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Url") url: option<xmlString>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "CreateStudioCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StepCancellationOption") stepCancellationOption: option<stepCancellationOption>,
  ...
  type response = {
@as("CancelStepsInfoList") cancelStepsInfoList: option<cancelStepsInfoList>
}
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "CancelStepsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Marker") marker: option<marker>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ListBootstrapActionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StudioId") studioId: xmlStringMaxLen256
  ...
  type response = {
@as("Studio") studio: option<studio>
}
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "DescribeStudioCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StepId") stepId: stepId,
  ...
  type response = {
@as("Step") step: option<step>
}
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "DescribeStepCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NotebookExecutionId") notebookExecutionId: xmlStringMaxLen256
  ...
  type response = {
@as("NotebookExecution") notebookExecution: option<notebookExecution>
}
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "DescribeNotebookExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Marker") marker: option<marker>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ListInstancesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Marker") marker: option<marker>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ListClustersCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Steps") steps: stepConfigList,
  ...
  type response = {
@as("StepIds") stepIds: option<stepIdsList>
}
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "AddJobFlowStepsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ClusterArn") clusterArn: option<arnType>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "PutAutoScalingPolicyCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("JobFlowStates") jobFlowStates: option<jobFlowExecutionStateList>,
  ...
  type response = {
@as("JobFlows") jobFlows: option<jobFlowDetailList>
}
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "DescribeJobFlowsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
module PutBlockPublicAccessConfiguration = {
  type t;
  type request = {
@as("BlockPublicAccessConfiguration") blockPublicAccessConfiguration: blockPublicAccessConfiguration
}
  type response = unit
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "PutBlockPublicAccessConfigurationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
module GetBlockPublicAccessConfiguration = {
  ...
  type request = unit
  type response = {
@as("BlockPublicAccessConfigurationMetadata") blockPublicAccessConfigurationMetadata: blockPublicAccessConfigurationMetadata,
  @as("BlockPublicAccessConfiguration") blockPublicAccessConfiguration: blockPublicAccessConfiguration
}
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "GetBlockPublicAccessConfigurationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Cluster") cluster: option<cluster>
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "DescribeClusterCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("InstanceGroups") instanceGroups: option<instanceGroupModifyConfigList>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ModifyInstanceGroupsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("Marker") marker: option<marker>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ListInstanceGroupsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ClusterArn") clusterArn: option<arnType>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "AddInstanceGroupsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ClusterArn") clusterArn: option<arnType>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "AddInstanceFleetCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Marker") marker: option<marker>,
  ...
  @module("@aws-sdk/client-elasticmapreduce") @new external new_: (request) => t = "ListInstanceFleetsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
