...
@module("@aws-sdk/client-emr-containers") @new external createClient: unit => awsServiceClient = "EMRcontainersClient";
type baseString = string
type baseBoolean = bool
type baseInteger = int
type baseTimestamp = Js.Date.t;
type baseLong = float
type virtualClusterState = [@as("ARRESTED") #ARRESTED | @as("TERMINATED") #TERMINATED | @as("TERMINATING") #TERMINATING | @as("RUNNING") #RUNNING]
...
type jobRunState = [@as("COMPLETED") #COMPLETED | @as("CANCEL_PENDING") #CANCEL_PENDING | @as("CANCELLED") #CANCELLED | @as("FAILED") #FAILED | @as("RUNNING") #RUNNING | @as("SUBMITTED") #SUBMITTED | @as("PENDING") #PENDING]
type jobArn = string
type javaInteger = int
type iamroleArn = string
type failureReason = [@as("CLUSTER_UNAVAILABLE") #CLUSTER_UNAVAILABLE | @as("VALIDATION_ERROR") #VALIDATION_ERROR | @as("USER_ERROR") #USER_ERROR | @as("INTERNAL_ERROR") #INTERNAL_ERROR]
type entryPointPath = string
type entryPointArgument = string
type endpointType = string
type endpointState = [@as("TERMINATED_WITH_ERRORS") #TERMINATED_WITH_ERRORS | @as("TERMINATED") #TERMINATED | @as("TERMINATING") #TERMINATING | @as("ACTIVE") #ACTIVE | @as("CREATING") #CREATING]
...
id: option<resourceIdString>
  ...
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "DeleteVirtualClusterCommand";
...
virtualClusterId: option<resourceIdString>,
  ...
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "DeleteManagedEndpointCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
tagKeys: tagKeyList,
  ...
  type response = unit
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "UntagResourceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
tags: option<tagMap>
  ...
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "ListTagsForResourceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
arn: option<virtualClusterArn>,
  ...
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "CreateVirtualClusterCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
virtualCluster: option<virtualCluster>
  ...
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "DescribeVirtualClusterCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "ListVirtualClustersCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
virtualClusterId: option<resourceIdString>,
  ...
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "CreateManagedEndpointCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
endpoint: option<endpoint>
  ...
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "DescribeManagedEndpointCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
virtualClusterId: resourceIdString,
  ...
  type response = {
jobRun: option<jobRun>
}
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "DescribeJobRunCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-emr-containers") @new external new_: (request) => t = "ListManagedEndpointsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
