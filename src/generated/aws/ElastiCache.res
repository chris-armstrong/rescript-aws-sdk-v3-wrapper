...
type updateActionStatus = [@as("not-applicable") #NotApplicable | @as("scheduled") #Scheduled | @as("scheduling") #Scheduling | @as("complete") #Complete | @as("stopped") #Stopped | @as("stopping") #Stopping | @as("in-progress") #InProgress | @as("waiting-to-start") #WaitingToStart | @as("not-applied") #NotApplied]
type tstamp = Js.Date.t;
type string_ = string
type sourceType = [@as("user-group") #UserGroup | @as("user") #User | @as("replication-group") #ReplicationGroup | @as("cache-subnet-group") #CacheSubnetGroup | @as("cache-security-group") #CacheSecurityGroup | @as("cache-parameter-group") #CacheParameterGroup | @as("cache-cluster") #CacheCluster]
type slaMet = [@as("n/a") #NA | @as("no") #No | @as("yes") #Yes]
type serviceUpdateType = [@as("security-update") #SecurityUpdate]
...
type outpostMode = [@as("cross-outpost") #CrossOutpost | @as("single-outpost") #SingleOutpost]
type nodeUpdateStatus = [@as("complete") #Complete | @as("stopped") #Stopped | @as("stopping") #Stopping | @as("in-progress") #InProgress | @as("waiting-to-start") #WaitingToStart | @as("not-applied") #NotApplied]
...
type logType = [@as("slow-log") #SlowLog]
...
type double = float
type destinationType = [@as("kinesis-firehose") #KinesisFirehose | @as("cloudwatch-logs") #CloudwatchLogs]
type changeType = [@as("requires-reboot") #RequiresReboot | @as("immediate") #Immediate]
...
type authenticationType = [@as("no-password") #NoPassword | @as("password") #Password]
...
type azmode = [@as("cross-az") #CrossAz | @as("single-az") #SingleAz]
...
type subnetOutpost = {
@as("SubnetOutpostArn") subnetOutpostArn: option<string_>
}
...
@as("AutoUpdateAfterRecommendedApplyByDate") autoUpdateAfterRecommendedApplyByDate: option<booleanOptional>,
...
@as("DeliveryStream") deliveryStream: option<string_>
}
...
@as("LogGroup") logGroup: option<string_>
}
...
@as("SlotMigration") slotMigration: option<slotMigration>
}
...
@as("PreferredAvailabilityZones") preferredAvailabilityZones: option<preferredAvailabilityZoneList>,
...
@as("NodeGroupMemberUpdateStatus") nodeGroupMemberUpdateStatus: option<nodeGroupMemberUpdateStatusList>,
@as("NodeGroupId") nodeGroupId: option<string_>
}
...
@as("ChangeType") changeType: option<changeType>,
@as("CacheNodeTypeSpecificValues") cacheNodeTypeSpecificValues: option<cacheNodeTypeSpecificValueList>,
@as("MinimumEngineVersion") minimumEngineVersion: option<string_>,
@as("IsModifiable") isModifiable: option<boolean_>,
@as("AllowedValues") allowedValues: option<string_>,
@as("DataType") dataType: option<string_>,
...
@as("LogDeliveryConfigurations") logDeliveryConfigurations: option<pendingLogDeliveryConfigurationList>,
...
type engineDefaults = {
@as("CacheNodeTypeSpecificParameters") cacheNodeTypeSpecificParameters: option<cacheNodeTypeSpecificParametersList>,
...
@as("ARN") arn: option<string_>,
@as("KmsKeyId") kmsKeyId: option<string_>,
@as("MemberClustersOutpostArns") memberClustersOutpostArns: option<replicationGroupOutpostArnList>,
@as("AtRestEncryptionEnabled") atRestEncryptionEnabled: option<booleanOptional>,
@as("TransitEncryptionEnabled") transitEncryptionEnabled: option<booleanOptional>,
...
@module("@aws-sdk/client-elasticache") @new external createClient: unit => awsServiceClient = "ElastiCacheClient";
...
@as("CacheParameterGroupName") cacheParameterGroupName: string_
  ...
  type response = {
@as("CacheParameterGroup") cacheParameterGroup: option<cacheParameterGroup>
}
...
@as("CacheSecurityGroupName") cacheSecurityGroupName: string_
  ...
  type response = {
@as("CacheSecurityGroup") cacheSecurityGroup: option<cacheSecurityGroup>
}
...
@as("ReservedCacheNodesOfferingId") reservedCacheNodesOfferingId: string_
  ...
  type response = {
@as("ReservedCacheNode") reservedCacheNode: option<reservedCacheNode>
}
...
@as("CacheSubnetGroupName") cacheSubnetGroupName: string_
  ...
  type response = {
@as("CacheSubnetGroup") cacheSubnetGroup: option<cacheSubnetGroup>
}
...
@as("ReservedCacheNodesOfferingId") reservedCacheNodesOfferingId: option<string_>
  ...
  type response = {
@as("ReservedCacheNodesOfferings") reservedCacheNodesOfferings: option<reservedCacheNodesOfferingList>,
@as("Marker") marker: option<string_>
}
...
@as("ReplicationGroupId") replicationGroupId: string_
  ...
  type response = {
@as("ReplicationGroup") replicationGroup: option<replicationGroup>
}
...
@as("CacheClusterId") cacheClusterId: string_
  ...
  type response = {
@as("CacheCluster") cacheCluster: option<cacheCluster>
}
...
module ModifyReplicationGroup = {
  type t;
  type request = {
@as("LogDeliveryConfigurations") logDeliveryConfigurations: option<logDeliveryConfigurationRequestList>,
...
module DescribeCacheClusters = {
  type t;
  type request = {
@as("ShowCacheClustersNotInReplicationGroups") showCacheClustersNotInReplicationGroups: option<booleanOptional>,
