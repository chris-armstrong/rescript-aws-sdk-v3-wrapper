...
type nodeToNodeEncryptionOptions = {@as("Enabled") enabled: option<boolean_>}
...
type domainInfo = {@as("DomainName") domainName: option<domainName>}
...
type coldStorageOptions = {@as("Enabled") enabled: boolean_}
type cognitoOptions = {
