...
type codeGenerationStatus = [@as("CREATE_FAILED") #CREATEFAILED | @as("CREATE_COMPLETE") #CREATECOMPLETE | @as("CREATE_IN_PROGRESS") #CREATEINPROGRESS]
...
@module("@aws-sdk/client-schemas") @new external createClient: unit => awsServiceClient = "EventSchemasClient";
