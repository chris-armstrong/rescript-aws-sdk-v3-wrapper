...
type sqsParameters = {@as("MessageGroupId") messageGroupId: option<messageGroupId>}
...
type kinesisParameters = {@as("PartitionKeyPath") partitionKeyPath: targetPartitionKeyPath}
...
type deadLetterConfig = {@as("Arn") arn: option<resourceArn>}
...
type batchRetryStrategy = {@as("Attempts") attempts: option<integer_>}
type batchArrayProperties = {@as("Size") size: option<integer_>}
type archive = {
  @as("CreationTime") creationTime: option<timestamp_>,
...
type networkConfiguration = {awsvpcConfiguration: option<awsVpcConfiguration>}
...
type runCommandParameters = {@as("RunCommandTargets") runCommandTargets: runCommandTargets}
type ecsParameters = {
...
module DescribeEventBus = {
  type t
  type request = {@as("Name") name: option<eventBusNameOrArn>}
  type response = {
    @as("Policy") policy: option<string_>,
    @as("Arn") arn: option<string_>,
    @as("Name") name: option<string_>,
...
module DeleteConnection = {
  type t
  type request = {@as("Name") name: connectionName}
  type response = {
    @as("LastAuthorizedTime") lastAuthorizedTime: option<timestamp_>,
    @as("LastModifiedTime") lastModifiedTime: option<timestamp_>,
    @as("CreationTime") creationTime: option<timestamp_>,
...
module CancelReplay = {
  type t
  type request = {@as("ReplayName") replayName: replayName}
  type response = {
    @as("StateReason") stateReason: option<replayStateReason>,
    @as("State") state: option<replayState>,
...
module PutPartnerEvents = {
  type t
  type request = {@as("Entries") entries: putPartnerEventsRequestEntryList}
  type response = {
...
module PutEvents = {
  type t
  type request = {@as("Entries") entries: putEventsRequestEntryList}
  type response = {
