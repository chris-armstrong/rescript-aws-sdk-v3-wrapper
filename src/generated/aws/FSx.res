...
type baseLong = float
type windowsDeploymentType = [@as("SINGLE_AZ_2") #SINGLE_AZ_2 | @as("SINGLE_AZ_1") #SINGLE_AZ_1 | @as("MULTI_AZ_1") #MULTI_AZ_1]
...
type status = [@as("UPDATED_OPTIMIZING") #UPDATED_OPTIMIZING | @as("COMPLETED") #COMPLETED | @as("PENDING") #PENDING | @as("IN_PROGRESS") #IN_PROGRESS | @as("FAILED") #FAILED]
type startTime = Js.Date.t;
type sourceBackupId = string
type serviceLimit = [@as("TOTAL_IN_PROGRESS_COPY_BACKUPS") #TOTAL_IN_PROGRESS_COPY_BACKUPS | @as("TOTAL_USER_TAGS") #TOTAL_USER_TAGS | @as("TOTAL_USER_INITIATED_BACKUPS") #TOTAL_USER_INITIATED_BACKUPS | @as("TOTAL_STORAGE") #TOTAL_STORAGE | @as("TOTAL_THROUGHPUT_CAPACITY") #TOTAL_THROUGHPUT_CAPACITY | @as("FILE_SYSTEM_COUNT") #FILE_SYSTEM_COUNT]
...
type lustreDeploymentType = [@as("PERSISTENT_1") #PERSISTENT_1 | @as("SCRATCH_2") #SCRATCH_2 | @as("SCRATCH_1") #SCRATCH_1]
type lastUpdatedTime = Js.Date.t;
type kmsKeyId = string
type ipAddress = string
type flag = bool
type filterValue = string
type filterName = [@as("file-system-type") #File_System_Type | @as("backup-type") #Backup_Type | @as("file-system-id") #File_System_Id]
...
type fileSystemLifecycle = [@as("UPDATING") #UPDATING | @as("MISCONFIGURED") #MISCONFIGURED | @as("DELETING") #DELETING | @as("FAILED") #FAILED | @as("CREATING") #CREATING | @as("AVAILABLE") #AVAILABLE]
...
type dataRepositoryTaskLifecycle = [@as("CANCELING") #CANCELING | @as("CANCELED") #CANCELED | @as("SUCCEEDED") #SUCCEEDED | @as("FAILED") #FAILED | @as("EXECUTING") #EXECUTING | @as("PENDING") #PENDING]
type dataRepositoryTaskFilterValue = string
type dataRepositoryTaskFilterName = [@as("task-lifecycle") #Task_Lifecycle | @as("file-system-id") #File_System_Id]
type dataRepositoryLifecycle = [@as("DELETING") #DELETING | @as("UPDATING") #UPDATING | @as("MISCONFIGURED") #MISCONFIGURED | @as("AVAILABLE") #AVAILABLE | @as("CREATING") #CREATING]
type dataCompressionType = [@as("LZ4") #LZ4 | @as("NONE") #NONE]
type dailyTime = string
type dnsname = string
type creationTime = Js.Date.t;
type clientRequestToken = string
type backupType = [@as("AWS_BACKUP") #AWS_BACKUP | @as("USER_INITIATED") #USER_INITIATED | @as("AUTOMATIC") #AUTOMATIC]
type backupLifecycle = [@as("COPYING") #COPYING | @as("PENDING") #PENDING | @as("FAILED") #FAILED | @as("DELETED") #DELETED | @as("TRANSFERRING") #TRANSFERRING | @as("CREATING") #CREATING | @as("AVAILABLE") #AVAILABLE]
...
type aliasLifecycle = [@as("DELETE_FAILED") #DELETE_FAILED | @as("CREATE_FAILED") #CREATE_FAILED | @as("DELETING") #DELETING | @as("CREATING") #CREATING | @as("AVAILABLE") #AVAILABLE]
type administrativeActionType = [@as("FILE_SYSTEM_ALIAS_DISASSOCIATION") #FILE_SYSTEM_ALIAS_DISASSOCIATION | @as("FILE_SYSTEM_ALIAS_ASSOCIATION") #FILE_SYSTEM_ALIAS_ASSOCIATION | @as("STORAGE_OPTIMIZATION") #STORAGE_OPTIMIZATION | @as("FILE_SYSTEM_UPDATE") #FILE_SYSTEM_UPDATE]
type activeDirectoryFullyQualifiedName = string
type activeDirectoryErrorType = [@as("INVALID_DOMAIN_STAGE") #INVALID_DOMAIN_STAGE | @as("WRONG_VPC") #WRONG_VPC | @as("INCOMPATIBLE_DOMAIN_MODE") #INCOMPATIBLE_DOMAIN_MODE | @as("DOMAIN_NOT_FOUND") #DOMAIN_NOT_FOUND]
...
@as("DataCompressionType") dataCompressionType: option<dataCompressionType>,
  ...
  @as("AutomaticBackupRetentionDays") automaticBackupRetentionDays: option<automaticBackupRetentionDays>,
...
@as("DnsIps") dnsIps: dnsIps,
  ...
  @as("FileSystemAdministratorsGroup") fileSystemAdministratorsGroup: option<fileSystemAdministratorsGroupName>,
...
@as("Aliases") aliases: option<aliases>,
  ...
  @as("DailyAutomaticBackupStartTime") dailyAutomaticBackupStartTime: option<dailyTime>,
  @as("WeeklyMaintenanceStartTime") weeklyMaintenanceStartTime: option<weeklyTime>,
  @as("MaintenanceOperationsInProgress") maintenanceOperationsInProgress: option<fileSystemMaintenanceOperations>,
  ...
  @as("SelfManagedActiveDirectoryConfiguration") selfManagedActiveDirectoryConfiguration: option<selfManagedActiveDirectoryAttributes>,
  @as("ActiveDirectoryId") activeDirectoryId: option<directoryId>
}
type updateFileSystemWindowsConfiguration = {
@as("SelfManagedActiveDirectoryConfiguration") selfManagedActiveDirectoryConfiguration: option<selfManagedActiveDirectoryConfigurationUpdates>,
  @as("ThroughputCapacity") throughputCapacity: option<megabytesPerSecond>,
  @as("AutomaticBackupRetentionDays") automaticBackupRetentionDays: option<automaticBackupRetentionDays>,
  @as("DailyAutomaticBackupStartTime") dailyAutomaticBackupStartTime: option<dailyTime>,
  @as("WeeklyMaintenanceStartTime") weeklyMaintenanceStartTime: option<weeklyTime>
...
@as("DataCompressionType") dataCompressionType: option<dataCompressionType>,
  ...
  @as("PerUnitStorageThroughput") perUnitStorageThroughput: option<perUnitStorageThroughput>,
  @as("DeploymentType") deploymentType: option<lustreDeploymentType>,
  @as("DataRepositoryConfiguration") dataRepositoryConfiguration: option<dataRepositoryConfiguration>,
  @as("WeeklyMaintenanceStartTime") weeklyMaintenanceStartTime: option<weeklyTime>
}
...
@as("Aliases") aliases: option<alternateDNSNames>,
  ...
  @as("PreferredSubnetId") preferredSubnetId: option<subnetId>,
  @as("DeploymentType") deploymentType: option<windowsDeploymentType>,
  @as("SelfManagedActiveDirectoryConfiguration") selfManagedActiveDirectoryConfiguration: option<selfManagedActiveDirectoryConfiguration>,
  @as("ActiveDirectoryId") activeDirectoryId: option<directoryId>
}
...
} and administrativeActions = array<administrativeAction> and administrativeAction = {
...
@as("TaskId") taskId: option<taskId>,
  ...
  @module("@aws-sdk/client-fsx") @new external new_: (request) => t = "CancelDataRepositoryTaskCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Aliases") aliases: option<aliases>
  ...
  @module("@aws-sdk/client-fsx") @new external new_: (request) => t = "DisassociateFileSystemAliasesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-fsx") @new external new_: (request) => t = "DescribeFileSystemAliasesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Aliases") aliases: option<aliases>
  ...
  @module("@aws-sdk/client-fsx") @new external new_: (request) => t = "AssociateFileSystemAliasesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Tags") tags: option<tags>,
  ...
  type response = {
@as("DataRepositoryTask") dataRepositoryTask: option<dataRepositoryTask>
}
  @module("@aws-sdk/client-fsx") @new external new_: (request) => t = "CreateDataRepositoryTaskCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-fsx") @new external new_: (request) => t = "DescribeDataRepositoryTasksCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("LustreConfiguration") lustreConfiguration: option<updateFileSystemLustreConfiguration>,
  ...
  type response = {
@as("FileSystem") fileSystem: option<fileSystem>
}
...
@as("FileSystem") fileSystem: option<fileSystem>
  ...
  @module("@aws-sdk/client-fsx") @new external new_: (request) => t = "CreateFileSystemFromBackupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
