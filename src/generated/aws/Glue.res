...
type workerType = [@as("G.2X") #G2X | @as("G.1X") #G1X | @as("Standard") #Standard]
...
type updateBehavior = [@as("UPDATE_IN_DATABASE") #UPDATEINDATABASE | @as("LOG") #LOG]
type uri = string
type typeString = string
type triggerType = [@as("ON_DEMAND") #ONDEMAND | @as("CONDITIONAL") #CONDITIONAL | @as("SCHEDULED") #SCHEDULED]
...
type transformType = [@as("FIND_MATCHES") #FINDMATCHES]
type transformStatusType = [@as("DELETING") #DELETING | @as("READY") #READY | @as("NOT_READY") #NOTREADY]
type transformSortColumnType = [@as("LAST_MODIFIED") #LASTMODIFIED | @as("CREATED") #CREATED | @as("STATUS") #STATUS | @as("TRANSFORM_TYPE") #TRANSFORMTYPE | @as("NAME") #NAME]
type totalSegmentsInteger = int
type token = string
type timestampValue = Js.Date.t;
type timestamp_ = Js.Date.t;
type timeout = int
type taskType = [@as("FIND_MATCHES") #FINDMATCHES | @as("EXPORT_LABELS") #EXPORTLABELS | @as("IMPORT_LABELS") #IMPORTLABELS | @as("LABELING_SET_GENERATION") #LABELINGSETGENERATION | @as("EVALUATION") #EVALUATION]
...
type taskRunSortColumnType = [@as("STARTED") #STARTED | @as("STATUS") #STATUS | @as("TASK_RUN_TYPE") #TASKRUNTYPE]
...
type schemaDiffType = [@as("SYNTAX_DIFF") #SYNTAXDIFF]
type schemaDefinitionString = string
type schemaDefinitionDiff = string
type schemaCheckpointNumber = float
type scheduleState = [@as("TRANSITIONING") #TRANSITIONING | @as("NOT_SCHEDULED") #NOTSCHEDULED | @as("SCHEDULED") #SCHEDULED]
type scalaCode = string
type s3EncryptionMode = [@as("SSE-S3") #SSES3 | @as("SSE-KMS") #SSEKMS | @as("DISABLED") #DISABLED]
type runId = string
type rowTag = string
...
type recrawlBehavior = [@as("CRAWL_NEW_FOLDERS_ONLY") #CRAWLNEWFOLDERSONLY | @as("CRAWL_EVERYTHING") #CRAWLEVERYTHING]
...
type permission = [@as("DATA_LOCATION_ACCESS") #DATALOCATIONACCESS | @as("CREATE_TABLE") #CREATETABLE | @as("CREATE_DATABASE") #CREATEDATABASE | @as("INSERT") #INSERT | @as("DELETE") #DELETE | @as("DROP") #DROP | @as("ALTER") #ALTER | @as("SELECT") #SELECT | @as("ALL") #ALL]
type path = string
...
type mluserDataEncryptionModeString = [@as("SSE-KMS") #SSEKMS | @as("DISABLED") #DISABLED]
type long = float
...
type jobName = string
type jobBookmarksEncryptionMode = [@as("CSE-KMS") #CSEKMS | @as("DISABLED") #DISABLED]
...
type existCondition = [@as("NONE") #NONE | @as("NOT_EXIST") #NOTEXIST | @as("MUST_EXIST") #MUSTEXIST]
...
type deleteBehavior = [@as("DEPRECATE_IN_DATABASE") #DEPRECATEINDATABASE | @as("DELETE_FROM_DATABASE") #DELETEFROMDATABASE | @as("LOG") #LOG]
...
type connectionPropertyKey = [@as("CONNECTOR_CLASS_NAME") #CONNECTORCLASSNAME | @as("CONNECTOR_TYPE") #CONNECTORTYPE | @as("CONNECTOR_URL") #CONNECTORURL | @as("SECRET_ID") #SECRETID | @as("ENCRYPTED_KAFKA_CLIENT_KEY_PASSWORD") #ENCRYPTEDKAFKACLIENTKEYPASSWORD | @as("ENCRYPTED_KAFKA_CLIENT_KEYSTORE_PASSWORD") #ENCRYPTEDKAFKACLIENTKEYSTOREPASSWORD | @as("KAFKA_CLIENT_KEY_PASSWORD") #KAFKACLIENTKEYPASSWORD | @as("KAFKA_CLIENT_KEYSTORE_PASSWORD") #KAFKACLIENTKEYSTOREPASSWORD | @as("KAFKA_CLIENT_KEYSTORE") #KAFKACLIENTKEYSTORE | @as("KAFKA_SKIP_CUSTOM_CERT_VALIDATION") #KAFKASKIPCUSTOMCERTVALIDATION | @as("KAFKA_CUSTOM_CERT") #KAFKACUSTOMCERT | @as("KAFKA_SSL_ENABLED") #KAFKASSLENABLED | @as("KAFKA_BOOTSTRAP_SERVERS") #KAFKABOOTSTRAPSERVERS | @as("CONNECTION_URL") #CONNECTIONURL | @as("CUSTOM_JDBC_CERT_STRING") #CUSTOMJDBCCERTSTRING | @as("SKIP_CUSTOM_JDBC_CERT_VALIDATION") #SKIPCUSTOMJDBCCERTVALIDATION | @as("CUSTOM_JDBC_CERT") #CUSTOMJDBCCERT | @as("JDBC_ENFORCE_SSL") #JDBCENFORCESSL | @as("JDBC_CONNECTION_URL") #JDBCCONNECTIONURL | @as("INSTANCE_ID") #INSTANCEID | @as("CONFIG_FILES") #CONFIGFILES | @as("JDBC_ENGINE_VERSION") #JDBCENGINEVERSION | @as("JDBC_ENGINE") #JDBCENGINE | @as("JDBC_DRIVER_CLASS_NAME") #JDBCDRIVERCLASSNAME | @as("JDBC_DRIVER_JAR_URI") #JDBCDRIVERJARURI | @as("ENCRYPTED_PASSWORD") #ENCRYPTEDPASSWORD | @as("PASSWORD") #PASSWORD | @as("USERNAME") #USERNAME | @as("PORT") #PORT | @as("HOST") #HOST]
type connectionName = string
type compatibility = [@as("FULL_ALL") #FULLALL | @as("FULL") #FULL | @as("FORWARD_ALL") #FORWARDALL | @as("FORWARD") #FORWARD | @as("BACKWARD_ALL") #BACKWARDALL | @as("BACKWARD") #BACKWARD | @as("DISABLED") #DISABLED | @as("NONE") #NONE]
type comparator = [@as("LESS_THAN_EQUALS") #LESSTHANEQUALS | @as("GREATER_THAN_EQUALS") #GREATERTHANEQUALS | @as("LESS_THAN") #LESSTHAN | @as("GREATER_THAN") #GREATERTHAN | @as("EQUALS") #EQUALS]
...
type cloudWatchEncryptionMode = [@as("SSE-KMS") #SSEKMS | @as("DISABLED") #DISABLED]
type classification = string
type catalogIdString = string
type catalogGetterPageSize = int
type catalogEncryptionMode = [@as("SSE-KMS") #SSEKMS | @as("DISABLED") #DISABLED]
type booleanValue = bool
type booleanNullable = bool
type boolean_ = bool
type blob = NodeJs.Buffer.t
type backfillErrorCode = [@as("UNSUPPORTED_PARTITION_CHARACTER_ERROR") #UNSUPPORTEDPARTITIONCHARACTERERROR | @as("MISSING_PARTITION_VALUE_ERROR") #MISSINGPARTITIONVALUEERROR | @as("INVALID_PARTITION_TYPE_DATA_ERROR") #INVALIDPARTITIONTYPEDATAERROR | @as("INTERNAL_ERROR") #INTERNALERROR | @as("ENCRYPTED_PARTITION_ERROR") #ENCRYPTEDPARTITIONERROR]
...
type recrawlPolicy = {
@as("RecrawlBehavior") recrawlBehavior: option<recrawlBehavior>
}
...
@as("NotifyDelayAfter") notifyDelayAfter: option<notifyDelayAfter>
}
...
@as("MaxConcurrentRuns") maxConcurrentRuns: option<maxConcurrentRuns>
}
type errorDetails = {
...
@as("FindMatchesTaskRunProperties") findMatchesTaskRunProperties: option<findMatchesTaskRunProperties>,
@as("LabelingSetGenerationTaskRunProperties") labelingSetGenerationTaskRunProperties: option<labelingSetGenerationTaskRunProperties>,
@as("ExportLabelsTaskRunProperties") exportLabelsTaskRunProperties: option<exportLabelsTaskRunProperties>,
@as("ImportLabelsTaskRunProperties") importLabelsTaskRunProperties: option<importLabelsTaskRunProperties>,
...
@as("ZeppelinRemoteSparkInterpreterPort") zeppelinRemoteSparkInterpreterPort: option<integerValue>,
...
@as("ConnectionPasswordEncryption") connectionPasswordEncryption: option<connectionPasswordEncryption>,
...
@as("Connections") connections: option<orchestrationStringList>
}
...
@as("Crawls") crawls: option<crawlList>
}
type connectionInput = {
@as("PhysicalConnectionRequirements") physicalConnectionRequirements: option<physicalConnectionRequirements>,
...
@as("DecimalColumnStatisticsData") decimalColumnStatisticsData: option<decimalColumnStatisticsData>,
@as("DateColumnStatisticsData") dateColumnStatisticsData: option<dateColumnStatisticsData>,
@as("BooleanColumnStatisticsData") booleanColumnStatisticsData: option<booleanColumnStatisticsData>,
...
@as("Trigger") trigger: option<trigger>
}
...
type crawler = {
@as("CrawlerSecurityConfiguration") crawlerSecurityConfiguration: option<crawlerSecurityConfiguration>,
...
@as("JobName") jobName: jobName
  ...
  type response = {
@as("JobBookmarkEntry") jobBookmarkEntry: option<jobBookmarkEntry>
}
...
@as("SchemaId") schemaId: schemaId
  ...
  type response = {
@as("Diff") diff: option<schemaDefinitionDiff>
}
...
@as("CatalogId") catalogId: option<catalogIdString>
  ...
  type response = {
@as("ImportStatus") importStatus: option<catalogImportStatus>
}
...
@as("NextToken") nextToken: option<token>
  ...
  type response = {
@as("NextToken") nextToken: option<token>,
@as("GetResourcePoliciesResponseList") getResourcePoliciesResponseList: option<getResourcePoliciesResponseList>
}
...
@as("EndpointName") endpointName: genericString
  ...
  type response = {
@as("DevEndpoint") devEndpoint: option<devEndpoint>
}
...
@as("CatalogId") catalogId: option<catalogIdString>
  ...
  type response = {
@as("UserDefinedFunction") userDefinedFunction: option<userDefinedFunction>
}
...
@as("JobName") jobName: nameString
  ...
  type response = {
@as("JobRun") jobRun: option<jobRun>
}
...
@as("Name") name: nameString
  ...
  type response = {
@as("Classifier") classifier: option<classifier>
}
...
@as("SchemaId") schemaId: schemaId
  ...
  type response = {
@as("SchemaVersionErrors") schemaVersionErrors: option<schemaVersionErrorList>
}
...
@as("SuccessfulSubmissions") successfulSubmissions: option<batchStopJobRunSuccessfulSubmissionList>
}
...
module BatchGetDevEndpoints = {
  type t;
  type request = {
@as("DevEndpointNames") devEndpointNames: devEndpointNames
}
  type response = {
...
@as("CatalogId") catalogId: option<catalogIdString>
  ...
  type response = {
@as("Errors") errors: option<tableVersionErrors>
}
...
@as("CatalogId") catalogId: option<catalogIdString>
  ...
  type response = {
@as("Errors") errors: option<tableErrors>
}
...
@as("CatalogId") catalogId: option<catalogIdString>
  ...
  type response = {
@as("Errors") errors: option<partitionErrors>
}
...
@as("Name") name: nameString
  ...
  type response = {
@as("Crawler") crawler: option<crawler>
}
...
@as("CatalogId") catalogId: option<catalogIdString>
  ...
  type response = {
@as("Errors") errors: option<columnStatisticsErrors>
}
...
@as("CatalogId") catalogId: option<catalogIdString>
  ...
  type response = {
@as("TableVersion") tableVersion: option<tableVersion>
}
...
@as("CatalogId") catalogId: option<catalogIdString>
  ...
  type response = {
@as("NextToken") nextToken: option<token>,
@as("PartitionIndexDescriptorList") partitionIndexDescriptorList: option<partitionIndexDescriptorList>
}
...
@as("CatalogId") catalogId: option<catalogIdString>
  ...
  type response = {
@as("Errors") errors: option<batchUpdatePartitionFailureList>
}
