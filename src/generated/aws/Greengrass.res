...
@as("Execution") execution: option<functionDefaultExecutionConfig>
}
...
@as("GroupId") groupId: __string
  ...
  type response = {
@as("GroupCertificateAuthorities") groupCertificateAuthorities: option<__listOfGroupCertificateAuthorityProperties>
}
...
module DisassociateServiceRoleFromAccount = {
  ...
  type request = unit
  type response = {
@as("DisassociatedAt") disassociatedAt: option<__string>
}
