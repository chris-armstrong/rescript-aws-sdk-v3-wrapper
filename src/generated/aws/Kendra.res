...
@module("@aws-sdk/client-kendra") @new external createClient: unit => awsServiceClient = "KendraClient";
...
type thesaurusStatus = [@as("FAILED") #FAILED | @as("ACTIVE_BUT_UPDATE_FAILED") #ACTIVE_BUT_UPDATE_FAILED | @as("UPDATING") #UPDATING | @as("DELETING") #DELETING | @as("ACTIVE") #ACTIVE | @as("CREATING") #CREATING]
...
type scoreConfidence = [@as("LOW") #LOW | @as("MEDIUM") #MEDIUM | @as("HIGH") #HIGH | @as("VERY_HIGH") #VERY_HIGH]
type scanSchedule = string
type salesforceStandardObjectName = [@as("USER") #USER | @as("TASK") #TASK | @as("SOLUTION") #SOLUTION | @as("PROFILE") #PROFILE | @as("PRODUCT") #PRODUCT | @as("PRICEBOOK") #PRICEBOOK | @as("PARTNER") #PARTNER | @as("OPPORTUNITY") #OPPORTUNITY | @as("LEAD") #LEAD | @as("IDEA") #IDEA | @as("GROUP") #GROUP | @as("DOCUMENT") #DOCUMENT | @as("CONTRACT") #CONTRACT | @as("CONTACT") #CONTACT | @as("CASE") #CASE | @as("CAMPAIGN") #CAMPAIGN | @as("ACCOUNT") #ACCOUNT]
type salesforceKnowledgeArticleState = [@as("ARCHIVED") #ARCHIVED | @as("PUBLISHED") #PUBLISHED | @as("DRAFT") #DRAFT]
type salesforceCustomKnowledgeArticleTypeName = string
type salesforceChatterFeedIncludeFilterType = [@as("STANDARD_USER") #STANDARD_USER | @as("ACTIVE_USER") #ACTIVE_USER]
...
type querySuggestionsBlockListStatus = [@as("FAILED") #FAILED | @as("ACTIVE_BUT_UPDATE_FAILED") #ACTIVE_BUT_UPDATE_FAILED | @as("UPDATING") #UPDATING | @as("DELETING") #DELETING | @as("CREATING") #CREATING | @as("ACTIVE") #ACTIVE]
type querySuggestionsBlockListName = string
type querySuggestionsBlockListId = string
type queryResultType = [@as("ANSWER") #ANSWER | @as("QUESTION_ANSWER") #QUESTION_ANSWER | @as("DOCUMENT") #DOCUMENT]
...
type indexStatus = [@as("SYSTEM_UPDATING") #SYSTEM_UPDATING | @as("UPDATING") #UPDATING | @as("FAILED") #FAILED | @as("DELETING") #DELETING | @as("ACTIVE") #ACTIVE | @as("CREATING") #CREATING]
type indexName = string
type indexId = string
type indexFieldName = string
type indexEdition = [@as("ENTERPRISE_EDITION") #ENTERPRISE_EDITION | @as("DEVELOPER_EDITION") #DEVELOPER_EDITION]
type importance = int
...
type faqStatus = [@as("FAILED") #FAILED | @as("DELETING") #DELETING | @as("ACTIVE") #ACTIVE | @as("UPDATING") #UPDATING | @as("CREATING") #CREATING]
type faqName = string
type faqId = string
...
type documentAttributeValueType = [@as("DATE_VALUE") #DATE_VALUE | @as("LONG_VALUE") #LONG_VALUE | @as("STRING_LIST_VALUE") #STRING_LIST_VALUE | @as("STRING_VALUE") #STRING_VALUE]
...
type databaseEngineType = [@as("RDS_POSTGRESQL") #RDS_POSTGRESQL | @as("RDS_MYSQL") #RDS_MYSQL | @as("RDS_AURORA_POSTGRESQL") #RDS_AURORA_POSTGRESQL | @as("RDS_AURORA_MYSQL") #RDS_AURORA_MYSQL]
type dataSourceType = [@as("GOOGLEDRIVE") #GOOGLEDRIVE | @as("CONFLUENCE") #CONFLUENCE | @as("CUSTOM") #CUSTOM | @as("SERVICENOW") #SERVICENOW | @as("ONEDRIVE") #ONEDRIVE | @as("SALESFORCE") #SALESFORCE | @as("DATABASE") #DATABASE | @as("SHAREPOINT") #SHAREPOINT | @as("S3") #S3]
type dataSourceSyncJobStatus = [@as("SYNCING_INDEXING") #SYNCING_INDEXING | @as("ABORTED") #ABORTED | @as("STOPPING") #STOPPING | @as("INCOMPLETE") #INCOMPLETE | @as("SYNCING") #SYNCING | @as("SUCCEEDED") #SUCCEEDED | @as("FAILED") #FAILED]
type dataSourceSyncJobId = string
type dataSourceStatus = [@as("ACTIVE") #ACTIVE | @as("UPDATING") #UPDATING | @as("FAILED") #FAILED | @as("DELETING") #DELETING | @as("CREATING") #CREATING]
...
type contentType = [@as("PPT") #PPT | @as("PLAIN_TEXT") #PLAIN_TEXT | @as("MS_WORD") #MS_WORD | @as("HTML") #HTML | @as("PDF") #PDF]
type confluenceVersion = [@as("SERVER") #SERVER | @as("CLOUD") #CLOUD]
type confluenceSpaceIdentifier = string
type confluenceSpaceFieldName = [@as("URL") #URL | @as("SPACE_KEY") #SPACE_KEY | @as("ITEM_TYPE") #ITEM_TYPE | @as("DISPLAY_URL") #DISPLAY_URL]
type confluencePageFieldName = [@as("VERSION") #VERSION | @as("URL") #URL | @as("SPACE_NAME") #SPACE_NAME | @as("SPACE_KEY") #SPACE_KEY | @as("PARENT_ID") #PARENT_ID | @as("MODIFIED_DATE") #MODIFIED_DATE | @as("LABELS") #LABELS | @as("ITEM_TYPE") #ITEM_TYPE | @as("DISPLAY_URL") #DISPLAY_URL | @as("CREATED_DATE") #CREATED_DATE | @as("CONTENT_STATUS") #CONTENT_STATUS | @as("AUTHOR") #AUTHOR]
type confluenceBlogFieldName = [@as("VERSION") #VERSION | @as("URL") #URL | @as("SPACE_NAME") #SPACE_NAME | @as("SPACE_KEY") #SPACE_KEY | @as("PUBLISH_DATE") #PUBLISH_DATE | @as("LABELS") #LABELS | @as("ITEM_TYPE") #ITEM_TYPE | @as("DISPLAY_URL") #DISPLAY_URL | @as("AUTHOR") #AUTHOR]
type confluenceAttachmentFieldName = [@as("VERSION") #VERSION | @as("URL") #URL | @as("SPACE_NAME") #SPACE_NAME | @as("SPACE_KEY") #SPACE_KEY | @as("PARENT_ID") #PARENT_ID | @as("ITEM_TYPE") #ITEM_TYPE | @as("FILE_SIZE") #FILE_SIZE | @as("DISPLAY_URL") #DISPLAY_URL | @as("CREATED_DATE") #CREATED_DATE | @as("CONTENT_TYPE") #CONTENT_TYPE | @as("AUTHOR") #AUTHOR]
...
type additionalResultAttributeValueType = [@as("TEXT_WITH_HIGHLIGHTS_VALUE") #TEXT_WITH_HIGHLIGHTS_VALUE]
...
@as("QueryIdentifiersEnclosingOption") queryIdentifiersEnclosingOption: option<queryIdentifiersEnclosingOption>
}
...
@as("ScoreConfidence") scoreConfidence: option<scoreConfidence>
}
...
@as("AllowedGroupsColumnName") allowedGroupsColumnName: columnName
}
type accessControlListConfiguration = {
@as("KeyPath") keyPath: option<s3ObjectKey>
}
...
@as("AccessControlListConfiguration") accessControlListConfiguration: option<accessControlListConfiguration>,
  @as("DocumentsMetadataConfiguration") documentsMetadataConfiguration: option<documentsMetadataConfiguration>,
...
@as("FieldMappings") fieldMappings: option<dataSourceToIndexFieldMappingList>,
  ...
  @as("ExcludeAttachmentFilePatterns") excludeAttachmentFilePatterns: option<dataSourceInclusionsExclusionsStrings>,
  @as("IncludeAttachmentFilePatterns") includeAttachmentFilePatterns: option<dataSourceInclusionsExclusionsStrings>,
  @as("CrawlAttachments") crawlAttachments: option<boolean_>
}
...
@as("AttachmentFieldMappings") attachmentFieldMappings: option<confluenceAttachmentFieldMappingsList>,
  @as("CrawlAttachments") crawlAttachments: option<boolean_>
}
...
@as("Text") text: option<suggestionTextWithHighlights>
}
type serviceNowConfiguration = {
@as("AuthenticationType") authenticationType: option<serviceNowAuthenticationType>,
  @as("ServiceCatalogConfiguration") serviceCatalogConfiguration: option<serviceNowServiceCatalogConfiguration>,
  @as("KnowledgeArticleConfiguration") knowledgeArticleConfiguration: option<serviceNowKnowledgeArticleConfiguration>,
...
type salesforceCustomKnowledgeArticleTypeConfigurationList = array<salesforceCustomKnowledgeArticleTypeConfiguration>
...
@as("CustomKnowledgeArticleTypeConfigurations") customKnowledgeArticleTypeConfigurations: option<salesforceCustomKnowledgeArticleTypeConfigurationList>,
  @as("StandardKnowledgeArticleTypeConfiguration") standardKnowledgeArticleTypeConfiguration: option<salesforceStandardKnowledgeArticleTypeConfiguration>,
  @as("IncludedStates") includedStates: salesforceKnowledgeArticleStateList
}
type facetResult = {
@as("DocumentAttributeValueCountPairs") documentAttributeValueCountPairs: option<documentAttributeValueCountPairList>,
...
@as("ExcludeAttachmentFilePatterns") excludeAttachmentFilePatterns: option<dataSourceInclusionsExclusionsStrings>,
  @as("IncludeAttachmentFilePatterns") includeAttachmentFilePatterns: option<dataSourceInclusionsExclusionsStrings>,
  @as("StandardObjectAttachmentConfiguration") standardObjectAttachmentConfiguration: option<salesforceStandardObjectAttachmentConfiguration>,
  @as("CrawlAttachments") crawlAttachments: option<boolean_>,
  @as("ChatterFeedConfiguration") chatterFeedConfiguration: option<salesforceChatterFeedConfiguration>,
  @as("KnowledgeArticleConfiguration") knowledgeArticleConfiguration: option<salesforceKnowledgeArticleConfiguration>,
  @as("StandardObjectConfigurations") standardObjectConfigurations: option<salesforceStandardObjectConfigurationList>,
  @as("SecretArn") secretArn: secretArn,
  @as("ServerUrl") serverUrl: url
}
...
@as("MinimumQueryCount") minimumQueryCount: option<minimumQueryCount>,
  @as("MinimumNumberOfQueryingUsers") minimumNumberOfQueryingUsers: option<minimumNumberOfQueryingUsers>,
  @as("IncludeQueriesWithoutUserInformation") includeQueriesWithoutUserInformation: option<objectBoolean>,
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "UpdateQuerySuggestionsConfigCommand";
...
@as("IndexId") indexId: indexId,
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "StopDataSourceSyncJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("ExecutionId") executionId: option<string_>
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "StartDataSourceSyncJobCommand";
...
@as("TotalSuggestionsCount") totalSuggestionsCount: option<integer_>,
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "DescribeQuerySuggestionsConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Id") id: querySuggestionsBlockListId,
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "DeleteQuerySuggestionsBlockListCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("IndexId") indexId: indexId
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "ClearQuerySuggestionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("RoleArn") roleArn: option<roleArn>,
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "UpdateQuerySuggestionsBlockListCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("RoleArn") roleArn: option<roleArn>,
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "DescribeQuerySuggestionsBlockListCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("MaxResults") maxResults: option<maxResultsIntegerForListQuerySuggestionsBlockLists>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("BlockListSummaryItems") blockListSummaryItems: option<querySuggestionsBlockListSummaryItems>
}
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "ListQuerySuggestionsBlockListsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("MaxResults") maxResults: option<maxResultsIntegerForListIndicesRequest>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("IndexConfigurationSummaryItems") indexConfigurationSummaryItems: option<indexConfigurationSummaryList>
}
...
@as("Id") id: option<querySuggestionsBlockListId>
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "CreateQuerySuggestionsBlockListCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
module BatchDeleteDocument = {
  type t;
  type request = {
@as("DataSourceSyncJobMetricTarget") dataSourceSyncJobMetricTarget: option<dataSourceSyncJobMetricTarget>,
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-kendra") @new external new_: (request) => t = "ListDataSourceSyncJobsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("UserContextPolicy") userContextPolicy: option<userContextPolicy>,
  ...
  @as("DocumentMetadataConfigurationUpdates") documentMetadataConfigurationUpdates: option<documentMetadataConfigurationList>,
  @as("Description") description: option<description>,
  @as("RoleArn") roleArn: option<roleArn>,
  @as("Name") name: option<indexName>,
  @as("Id") id: indexId
...
@as("UserContextPolicy") userContextPolicy: option<userContextPolicy>,
  ...
  @as("DocumentMetadataConfigurations") documentMetadataConfigurations: option<documentMetadataConfigurationList>,
  @as("UpdatedAt") updatedAt: option<timestamp_>,
  @as("CreatedAt") createdAt: option<timestamp_>,
  @as("Description") description: option<description>,
...
@as("VisitorId") visitorId: option<visitorId>,
  ...
  @as("DocumentRelevanceOverrideConfigurations") documentRelevanceOverrideConfigurations: option<documentRelevanceOverrideConfigurationList>,
  @as("QueryResultTypeFilter") queryResultTypeFilter: option<queryResultType>,
  @as("RequestedDocumentAttributes") requestedDocumentAttributes: option<documentAttributeKeyList>,
