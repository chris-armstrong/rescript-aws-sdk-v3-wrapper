...
type zeppelinMonitoringConfigurationUpdate = {@as("LogLevelUpdate") logLevelUpdate: logLevel}
type zeppelinMonitoringConfigurationDescription = {@as("LogLevel") logLevel: option<logLevel>}
type zeppelinMonitoringConfiguration = {@as("LogLevel") logLevel: logLevel}
...
type lambdaOutputUpdate = {@as("ResourceARNUpdate") resourceARNUpdate: resourceARN}
type lambdaOutputDescription = {
  @as("RoleARN") roleARN: option<roleARN>,
  @as("ResourceARN") resourceARN: resourceARN,
}
type lambdaOutput = {@as("ResourceARN") resourceARN: resourceARN}
type kinesisStreamsOutputUpdate = {@as("ResourceARNUpdate") resourceARNUpdate: resourceARN}
type kinesisStreamsOutputDescription = {
  @as("RoleARN") roleARN: option<roleARN>,
  @as("ResourceARN") resourceARN: resourceARN,
}
type kinesisStreamsOutput = {@as("ResourceARN") resourceARN: resourceARN}
type kinesisStreamsInputUpdate = {@as("ResourceARNUpdate") resourceARNUpdate: resourceARN}
type kinesisStreamsInputDescription = {
  @as("RoleARN") roleARN: option<roleARN>,
  @as("ResourceARN") resourceARN: resourceARN,
}
type kinesisStreamsInput = {@as("ResourceARN") resourceARN: resourceARN}
type kinesisFirehoseOutputUpdate = {@as("ResourceARNUpdate") resourceARNUpdate: resourceARN}
type kinesisFirehoseOutputDescription = {
  @as("RoleARN") roleARN: option<roleARN>,
  @as("ResourceARN") resourceARN: resourceARN,
}
type kinesisFirehoseOutput = {@as("ResourceARN") resourceARN: resourceARN}
type kinesisFirehoseInputUpdate = {@as("ResourceARNUpdate") resourceARNUpdate: resourceARN}
type kinesisFirehoseInputDescription = {
  @as("RoleARN") roleARN: option<roleARN>,
  @as("ResourceARN") resourceARN: resourceARN,
}
type kinesisFirehoseInput = {@as("ResourceARN") resourceARN: resourceARN}
...
type inputParallelismUpdate = {@as("CountUpdate") countUpdate: inputParallelismCount}
type inputParallelism = {@as("Count") count: option<inputParallelismCount>}
type inputLambdaProcessorUpdate = {@as("ResourceARNUpdate") resourceARNUpdate: resourceARN}
type inputLambdaProcessorDescription = {
  @as("RoleARN") roleARN: option<roleARN>,
  @as("ResourceARN") resourceARN: resourceARN,
}
type inputLambdaProcessor = {@as("ResourceARN") resourceARN: resourceARN}
...
type glueDataCatalogConfigurationDescription = {@as("DatabaseARN") databaseARN: databaseARN}
type glueDataCatalogConfiguration = {@as("DatabaseARN") databaseARN: databaseARN}
...
type cloudWatchLoggingOption = {@as("LogStreamARN") logStreamARN: logStreamARN}
...
type applicationSnapshotConfiguration = {@as("SnapshotsEnabled") snapshotsEnabled: booleanObject}
...
type environmentPropertyUpdates = {@as("PropertyGroups") propertyGroups: propertyGroups}
type environmentPropertyDescriptions = {
  @as("PropertyGroupDescriptions") propertyGroupDescriptions: option<propertyGroups>,
}
type environmentProperties = {@as("PropertyGroups") propertyGroups: propertyGroups}
...
module DeleteApplicationVpcConfiguration = {
  ...
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "DeleteApplicationVpcConfigurationCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module DeleteApplicationSnapshot = {
  ...
  type response = unit
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "DeleteApplicationSnapshotCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module CreateApplicationSnapshot = {
  ...
  type response = unit
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "CreateApplicationSnapshotCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module CreateApplicationPresignedUrl = {
  ...
  type response = {@as("AuthorizedUrl") authorizedUrl: option<authorizedUrl>}
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "CreateApplicationPresignedUrlCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module UpdateApplicationMaintenanceConfiguration = {
  ...
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "UpdateApplicationMaintenanceConfigurationCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module DescribeApplicationSnapshot = {
  ...
  type response = {@as("SnapshotDetails") snapshotDetails: snapshotDetails}
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "DescribeApplicationSnapshotCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module ListApplicationSnapshots = {
  ...
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "ListApplicationSnapshotsCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module AddApplicationVpcConfiguration = {
  ...
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "AddApplicationVpcConfigurationCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module RollbackApplication = {
  ...
  type response = {@as("ApplicationDetail") applicationDetail: applicationDetail}
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "RollbackApplicationCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module DescribeApplicationVersion = {
  ...
  @module("@aws-sdk/client-kinesisanalytics") @new
  external new_: request => t = "DescribeApplicationVersionCommand"
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
