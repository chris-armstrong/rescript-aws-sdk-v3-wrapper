...
type slotTypeRegexConfiguration = {pattern: regexPattern}
...
type inputContext = {name: inputContextName}
type codeHook = {
  messageVersion: messageVersion,
  uri: lambdaARN,
}
type channelConfigurationMap = Js.Dict.t<string_>
type builtinIntentSlot = {name: option<string_>}
...
type slotTypeConfiguration = {regexConfiguration: option<slotTypeRegexConfiguration>}
...
type slotDefaultValueSpec = {defaultValueList: slotDefaultValueList}
type prompt = {
  responseCard: option<responseCard>,
...
module GetBuiltinIntent = {
  type t
  type request = {signature: builtinIntentSignature}
  type response = {
