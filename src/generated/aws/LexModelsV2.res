...
type voiceSettings = {voiceId: voiceId}
type tagMap = Js.Dict.t<tagValue>
type tagKeyList = array<tagKey>
type slotValueRegexFilter = {pattern: regexPattern}
...
type slotDefaultValue = {defaultValue: slotDefaultValueString}
type sentimentAnalysisSettings = {detectSentiment: boolean_}
type sampleValue = {value: value}
type sampleUtterance = {utterance: utterance}
type ssmlmessage = {value: ssmlmessageValue}
...
type plainTextMessage = {value: plainTextMessageValue}
type outputContext = {
...
type obfuscationSetting = {obfuscationSettingType: obfuscationSettingType}
type lambdaCodeHook = {
...
type fulfillmentCodeHookSettings = {enabled: boolean_}
...
type dialogCodeHookSettings = {enabled: boolean_}
type dataPrivacy = {childDirected: childDirected}
type customPayload = {value: customPayloadValue}
...
type botVersionLocaleDetails = {sourceBotVersion: botVersion}
type botSummary = {
  lastUpdatedDateTime: option<timestamp_>,
...
type textLogDestination = {cloudWatch: cloudWatchLogGroupLogDestination}
...
type audioLogDestination = {s3Bucket: s3BucketLogDestination}
type textLogSetting = {
...
type slotDefaultValueSpecification = {defaultValueList: slotDefaultValueList}
type intentSummary = {
  lastUpdatedDateTime: option<timestamp_>,
...
type intentClosingSetting = {closingResponse: responseSpecification}
