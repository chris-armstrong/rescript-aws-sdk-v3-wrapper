...
type provisionalConfiguration = {@as("MaxTimeToLiveInMinutes") maxTimeToLiveInMinutes: boxInteger}
type principalArnList = array<arn>
type organizationConfiguration = {@as("EnableIntegration") enableIntegration: boolean_}
type metadata = {
  @as("Value") value: option<string_>,
...
type automatedDiscoveryInformation = {@as("LastRunTime") lastRunTime: option<dateTime>}
...
type reportContext = {licenseConfigurationArns: arnList}
...
type licenseUsage = {@as("EntitlementUsages") entitlementUsages: option<entitlementUsageList>}
...
type licenseConfiguration = {
  @as("AutomatedDiscoveryInformation")
...
module RejectGrant = {
  type t
  type request = {@as("GrantArn") grantArn: arn}
  type response = {
    @as("Version") version: option<string_>,
