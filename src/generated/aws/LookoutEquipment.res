...
type modelStatus = [@as("FAILED") #FAILED | @as("SUCCESS") #SUCCESS | @as("IN_PROGRESS") #INPROGRESS]
type modelName = string
type modelArn = string
type maxResults = int
type kmsKeyArn = string
type ingestionJobStatus = [@as("FAILED") #FAILED | @as("SUCCESS") #SUCCESS | @as("IN_PROGRESS") #INPROGRESS]
...
type inferenceExecutionStatus = [@as("FAILED") #FAILED | @as("SUCCESS") #SUCCESS | @as("IN_PROGRESS") #INPROGRESS]
type idempotenceToken = string
type iamRoleArn = string
type fileNameTimestampFormat = string
type datasetStatus = [@as("ACTIVE") #ACTIVE | @as("INGESTION_IN_PROGRESS") #INGESTIONINPROGRESS | @as("CREATED") #CREATED]
...
@as("ComponentTimestampDelimiter") componentTimestampDelimiter: option<componentTimestampDelimiter>,
...
@as("InferenceInputNameConfiguration") inferenceInputNameConfiguration: option<inferenceInputNameConfiguration>,
...
@module("@aws-sdk/client-lookoutequipment") @new external createClient: unit => awsServiceClient = "LookoutEquipmentClient";
...
module ListInferenceSchedulers = {
  ...
  type request = {
@as("ModelName") modelName: option<modelName>,
@as("InferenceSchedulerNameBeginsWith") inferenceSchedulerNameBeginsWith: option<inferenceSchedulerIdentifier>,
@as("MaxResults") maxResults: option<maxResults>,
@as("NextToken") nextToken: option<nextToken>
}
  type response = {
@as("InferenceSchedulerSummaries") inferenceSchedulerSummaries: option<inferenceSchedulerSummaries>,
@as("NextToken") nextToken: option<nextToken>
}
...
@as("Status") status: option<modelStatus>,
@as("DataPreProcessingConfiguration") dataPreProcessingConfiguration: option<dataPreProcessingConfiguration>,
@as("RoleArn") roleArn: option<iamRoleArn>,
...
@as("NextToken") nextToken: option<nextToken>
  ...
  type response = {
@as("InferenceExecutionSummaries") inferenceExecutionSummaries: option<inferenceExecutionSummaries>,
@as("NextToken") nextToken: option<nextToken>
}
