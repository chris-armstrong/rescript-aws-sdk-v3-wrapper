...
type boolean_ = bool
type arn = string
type anomalyDetectorStatus = [@as("BACK_TEST_COMPLETE") #BACKTESTCOMPLETE | @as("BACK_TEST_ACTIVE") #BACKTESTACTIVE | @as("BACK_TEST_ACTIVATING") #BACKTESTACTIVATING | @as("INACTIVE") #INACTIVE | @as("FAILED") #FAILED | @as("DELETING") #DELETING | @as("ACTIVATING") #ACTIVATING | @as("ACTIVE") #ACTIVE]
type anomalyDetectorName = string
type anomalyDetectorDescription = string
type anomalyDetectionTaskStatusMessage = string
type anomalyDetectionTaskStatus = [@as("FAILED_TO_SCHEDULE") #FAILEDTOSCHEDULE | @as("FAILED") #FAILED | @as("COMPLETED") #COMPLETED | @as("IN_PROGRESS") #INPROGRESS | @as("PENDING") #PENDING]
...
@as("DimensionValueContributionList") dimensionValueContributionList: option<dimensionValueContributionList>,
...
@module("@aws-sdk/client-lookoutmetrics") @new external createClient: unit => awsServiceClient = "LookoutMetricsClient";
...
module PutFeedback = {
  type t;
  type request = {
@as("AnomalyGroupTimeSeriesFeedback") anomalyGroupTimeSeriesFeedback: anomalyGroupTimeSeriesFeedback,
@as("AnomalyDetectorArn") anomalyDetectorArn: arn
}
  type response = unit
...
@as("AnomalyDetectorArn") anomalyDetectorArn: arn
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
@as("AnomalyGroupTimeSeriesFeedback") anomalyGroupTimeSeriesFeedback: option<timeSeriesFeedbackList>
}
...
@as("MaxResults") maxResults: option<maxResults>
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
@as("AnomalyDetectorSummaryList") anomalyDetectorSummaryList: option<anomalyDetectorSummaryList>
}
...
module GetSampleData = {
  type t;
  type request = {
@as("S3SourceConfig") s3SourceConfig: option<sampleDataS3SourceConfig>
}
  type response = {
...
@as("AnomalyGroupId") anomalyGroupId: uuid
  ...
  type response = {
@as("AnomalyGroup") anomalyGroup: option<anomalyGroup>
}
