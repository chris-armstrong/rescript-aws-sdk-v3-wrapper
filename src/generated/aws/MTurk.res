...
@module("@aws-sdk/client-mturk-requester") @new external createClient: unit => awsServiceClient = "MTurkClient";
...
@as("AssignmentId") assignmentId: entityId
  ...
  type response = {
@as("FileUploadURL") fileUploadURL: option<string_>
}
...
@as("QualificationTypeId") qualificationTypeId: entityId
  ...
  type response = {
@as("QualificationType") qualificationType: option<qualificationType>
}
...
@as("Subject") subject: string_
  ...
  type response = {
@as("NotifyWorkersFailureStatuses") notifyWorkersFailureStatuses: option<notifyWorkersFailureStatusList>
}
...
@as("QualificationTypeId") qualificationTypeId: entityId
  ...
  type response = {
@as("Qualification") qualification: option<qualification>
}
