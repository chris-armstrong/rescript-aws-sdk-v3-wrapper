...
type weeklySchedule = {dayOfWeek: option<dayOfWeek>}
...
type monthlySchedule = {dayOfMonth: option<__integer>}
type listJobsSortCriteria = {
  orderBy: option<orderBy>,
  attributeName: option<listJobsSortAttributeName>,
}
type lastRunErrorStatus = {code: option<lastRunErrorStatusCode>}
type keyValuePair = {
  value: option<__string>,
  key: option<__string>,
}
...
type ipCity = {name: option<__string>}
type invitation = {
...
type domainDetails = {domainName: option<__string>}
...
type awsService = {invokedBy: option<__string>}
type awsAccount = {
  principalId: option<__string>,
  accountId: option<__string>,
}
...
type classificationExportConfiguration = {s3Destination: option<s3Destination>}
...
type accountLevelPermissions = {blockPublicAccess: option<blockPublicAccess>}
...
type matchingResource = {matchingBucket: option<matchingBucket>}
type federatedUser = {
...
type findingCriteria = {criterion: option<criterion>}
type criteriaForJob = {
...
type searchResourcesCriteriaBlock = {@as("and") and_: option<__listOfSearchResourcesCriteria>}
...
type jobScopingBlock = {@as("and") and_: option<__listOfJobScopeTerm>}
type defaultDetections = array<defaultDetection>
type customDetections = array<customDetection>
type criteriaBlockForJob = {@as("and") and_: option<__listOfCriteriaForJob>}
...
module GetBucketStatistics = {
  type t
  type request = {accountId: option<__string>}
  type response = {
    unclassifiableObjectSizeInBytes: option<objectLevelStatistics>,
    unclassifiableObjectCount: option<objectLevelStatistics>,
    sizeInBytesCompressed: option<__long>,
...
module GetUsageTotals = {
  type t
  type request = {timeRange: option<__string>}
  type response = {
...
module BatchGetCustomDataIdentifiers = {
  type t
  type request = {ids: option<__listOf__string>}
  type response = {
