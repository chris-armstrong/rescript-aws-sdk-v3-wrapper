...
@as("Fabric") fabric: option<networkFabricConfiguration>
}
...
@as("Fabric") fabric: option<memberFabricConfiguration>
}
type memberFrameworkAttributes = {
@as("Fabric") fabric: option<memberFabricAttributes>
}
type logConfigurations = {
@as("Cloudwatch") cloudwatch: option<logConfiguration>
}
