...
type __integer = int
type __double = float
type tcs = [@as("DENSITY") #DENSITY | @as("ST428-1") #ST4281 | @as("ST2065-1") #ST20651 | @as("BT2100LINHLG") #BT2100LINHLG | @as("BT2100LINPQ") #BT2100LINPQ | @as("LINEAR") #LINEAR | @as("HLG") #HLG | @as("PQ") #PQ | @as("SDR") #SDR]
...
type scanMode = [@as("progressive-segmented-frame") #ProgressiveSegmentedFrame | @as("interlace") #Interlace | @as("progressive") #Progressive]
type resourceType = [@as("Mbps_Outbound_Bandwidth") #MbpsOutboundBandwidth]
...
type protocol = [@as("srt-listener") #SrtListener | @as("cdi") #Cdi | @as("st2110-jpegxs") #St2110Jpegxs | @as("rist") #Rist | @as("zixi-pull") #ZixiPull | @as("rtp") #Rtp | @as("rtp-fec") #RtpFec | @as("zixi-push") #ZixiPush]
type priceUnits = [@as("HOURLY") #HOURLY]
type networkInterfaceType = [@as("efa") #Efa | @as("ena") #Ena]
type mediaStreamType = [@as("ancillary-data") #AncillaryData | @as("audio") #Audio | @as("video") #Video]
type maxResults = int
type keyType = [@as("srt-password") #SrtPassword | @as("static-key") #StaticKey | @as("speke") #Speke]
...
type colorimetry = [@as("XYZ") #XYZ | @as("ST2065-3") #ST20653 | @as("ST2065-1") #ST20651 | @as("BT2100") #BT2100 | @as("BT2020") #BT2020 | @as("BT709") #BT709 | @as("BT601") #BT601]
...
type messages = {
@as("Errors") errors: __listOf__string
}
...
@as("EncodingName") encodingName: encodingName,
@as("DestinationConfigurations") destinationConfigurations: option<__listOfDestinationConfigurationRequest>
}
type mediaStreamOutputConfiguration = {
@as("MediaStreamName") mediaStreamName: __string,
@as("EncodingParameters") encodingParameters: option<encodingParameters>,
@as("EncodingName") encodingName: encodingName,
@as("DestinationConfigurations") destinationConfigurations: option<__listOfDestinationConfiguration>
}
...
@as("Name") name: __string,
@as("MediaStreamSourceConfigurations") mediaStreamSourceConfigurations: option<__listOfMediaStreamSourceConfiguration>,
...
@as("Name") name: option<__string>,
@as("MinLatency") minLatency: option<__integer>,
@as("MediaStreamSourceConfigurations") mediaStreamSourceConfigurations: option<__listOfMediaStreamSourceConfigurationRequest>,
@as("MaxSyncBuffer") maxSyncBuffer: option<__integer>,
@as("MaxLatency") maxLatency: option<__integer>,
@as("MaxBitrate") maxBitrate: option<__integer>,
@as("IngestPort") ingestPort: option<__integer>,
...
@as("Name") name: __string,
@as("MediaStreamOutputConfigurations") mediaStreamOutputConfigurations: option<__listOfMediaStreamOutputConfiguration>,
...
@as("Name") name: option<__string>,
@as("MinLatency") minLatency: option<__integer>,
@as("MediaStreamOutputConfigurations") mediaStreamOutputConfigurations: option<__listOfMediaStreamOutputConfigurationRequest>,
@as("MaxLatency") maxLatency: option<__integer>,
@as("Encryption") encryption: option<encryption>,
@as("Destination") destination: option<__string>,
@as("Description") description: option<__string>,
...
@module("@aws-sdk/client-mediaconnect") @new external createClient: unit => awsServiceClient = "MediaConnectClient";
module StopFlow = {
  type t;
  type request = {
@as("FlowArn") flowArn: __string
...
@as("OfferingArn") offeringArn: __string
  ...
  type response = {
@as("Offering") offering: option<offering>
}
