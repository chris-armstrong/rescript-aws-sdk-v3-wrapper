...
type vp9QualityTuningLevel = [@as("MULTI_PASS_HQ") #MULTIPASSHQ | @as("MULTI_PASS") #MULTIPASS]
type vp9ParControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type vp9FramerateConversionAlgorithm = [@as("FRAMEFORMER") #FRAMEFORMER | @as("INTERPOLATE") #INTERPOLATE | @as("DUPLICATE_DROP") #DUPLICATEDROP]
type vp9FramerateControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type vp8RateControlMode = [@as("VBR") #VBR]
type vp8QualityTuningLevel = [@as("MULTI_PASS_HQ") #MULTIPASSHQ | @as("MULTI_PASS") #MULTIPASS]
type vp8ParControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type vp8FramerateConversionAlgorithm = [@as("FRAMEFORMER") #FRAMEFORMER | @as("INTERPOLATE") #INTERPOLATE | @as("DUPLICATE_DROP") #DUPLICATEDROP]
type vp8FramerateControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type videoTimecodeInsertion = [@as("PIC_TIMING_SEI") #PICTIMINGSEI | @as("DISABLED") #DISABLED]
type videoCodec = [@as("VP9") #VP9 | @as("VP8") #VP8 | @as("VC3") #VC3 | @as("PRORES") #PRORES | @as("MPEG2") #MPEG2 | @as("H_265") #H265 | @as("H_264") #H264 | @as("FRAME_CAPTURE") #FRAMECAPTURE | @as("AVC_INTRA") #AVCINTRA | @as("AV1") #AV1]
type vc3Telecine = [@as("HARD") #HARD | @as("NONE") #NONE]
type vc3SlowPal = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type vc3ScanTypeConversionMode = [@as("INTERLACED_OPTIMIZE") #INTERLACEDOPTIMIZE | @as("INTERLACED") #INTERLACED]
type vc3InterlaceMode = [@as("PROGRESSIVE") #PROGRESSIVE | @as("INTERLACED") #INTERLACED]
type vc3FramerateConversionAlgorithm = [@as("FRAMEFORMER") #FRAMEFORMER | @as("INTERPOLATE") #INTERPOLATE | @as("DUPLICATE_DROP") #DUPLICATEDROP]
type vc3FramerateControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type vc3Class = [@as("CLASS_220_10BIT") #CLASS22010BIT | @as("CLASS_220_8BIT") #CLASS2208BIT | @as("CLASS_145_8BIT") #CLASS1458BIT]
...
type timecodeBurninPosition = [@as("BOTTOM_RIGHT") #BOTTOMRIGHT | @as("BOTTOM_CENTER") #BOTTOMCENTER | @as("BOTTOM_LEFT") #BOTTOMLEFT | @as("MIDDLE_RIGHT") #MIDDLERIGHT | @as("MIDDLE_CENTER") #MIDDLECENTER | @as("MIDDLE_LEFT") #MIDDLELEFT | @as("TOP_RIGHT") #TOPRIGHT | @as("TOP_LEFT") #TOPLEFT | @as("TOP_CENTER") #TOPCENTER]
type teletextPageType = [@as("PAGE_TYPE_HEARING_IMPAIRED_SUBTITLE") #PAGETYPEHEARINGIMPAIREDSUBTITLE | @as("PAGE_TYPE_PROGRAM_SCHEDULE") #PAGETYPEPROGRAMSCHEDULE | @as("PAGE_TYPE_ADDL_INFO") #PAGETYPEADDLINFO | @as("PAGE_TYPE_SUBTITLE") #PAGETYPESUBTITLE | @as("PAGE_TYPE_INITIAL") #PAGETYPEINITIAL]
type statusUpdateInterval = [@as("SECONDS_600") #SECONDS600 | @as("SECONDS_540") #SECONDS540 | @as("SECONDS_480") #SECONDS480 | @as("SECONDS_420") #SECONDS420 | @as("SECONDS_360") #SECONDS360 | @as("SECONDS_300") #SECONDS300 | @as("SECONDS_240") #SECONDS240 | @as("SECONDS_180") #SECONDS180 | @as("SECONDS_120") #SECONDS120 | @as("SECONDS_60") #SECONDS60 | @as("SECONDS_30") #SECONDS30 | @as("SECONDS_20") #SECONDS20 | @as("SECONDS_15") #SECONDS15 | @as("SECONDS_12") #SECONDS12 | @as("SECONDS_10") #SECONDS10]
type simulateReservedQueue = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type sccDestinationFramerate = [@as("FRAMERATE_29_97_NON_DROPFRAME") #FRAMERATE2997NONDROPFRAME | @as("FRAMERATE_29_97_DROPFRAME") #FRAMERATE2997DROPFRAME | @as("FRAMERATE_25") #FRAMERATE25 | @as("FRAMERATE_24") #FRAMERATE24 | @as("FRAMERATE_23_97") #FRAMERATE2397]
type scalingBehavior = [@as("STRETCH_TO_OUTPUT") #STRETCHTOOUTPUT | @as("DEFAULT") #DEFAULT]
type s3ServerSideEncryptionType = [@as("SERVER_SIDE_ENCRYPTION_KMS") #SERVERSIDEENCRYPTIONKMS | @as("SERVER_SIDE_ENCRYPTION_S3") #SERVERSIDEENCRYPTIONS3]
type s3ObjectCannedAcl = [@as("BUCKET_OWNER_FULL_CONTROL") #BUCKETOWNERFULLCONTROL | @as("BUCKET_OWNER_READ") #BUCKETOWNERREAD | @as("AUTHENTICATED_READ") #AUTHENTICATEDREAD | @as("PUBLIC_READ") #PUBLICREAD]
...
type renewalType = [@as("EXPIRE") #EXPIRE | @as("AUTO_RENEW") #AUTORENEW]
type queueStatus = [@as("PAUSED") #PAUSED | @as("ACTIVE") #ACTIVE]
type queueListBy = [@as("CREATION_DATE") #CREATIONDATE | @as("NAME") #NAME]
type proresTelecine = [@as("HARD") #HARD | @as("NONE") #NONE]
type proresSlowPal = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type proresScanTypeConversionMode = [@as("INTERLACED_OPTIMIZE") #INTERLACEDOPTIMIZE | @as("INTERLACED") #INTERLACED]
type proresParControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type proresInterlaceMode = [@as("FOLLOW_BOTTOM_FIELD") #FOLLOWBOTTOMFIELD | @as("FOLLOW_TOP_FIELD") #FOLLOWTOPFIELD | @as("BOTTOM_FIELD") #BOTTOMFIELD | @as("TOP_FIELD") #TOPFIELD | @as("PROGRESSIVE") #PROGRESSIVE]
type proresFramerateConversionAlgorithm = [@as("FRAMEFORMER") #FRAMEFORMER | @as("INTERPOLATE") #INTERPOLATE | @as("DUPLICATE_DROP") #DUPLICATEDROP]
type proresFramerateControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type proresCodecProfile = [@as("APPLE_PRORES_422_PROXY") #APPLEPRORES422PROXY | @as("APPLE_PRORES_422_LT") #APPLEPRORES422LT | @as("APPLE_PRORES_422_HQ") #APPLEPRORES422HQ | @as("APPLE_PRORES_422") #APPLEPRORES422]
type pricingPlan = [@as("RESERVED") #RESERVED | @as("ON_DEMAND") #ONDEMAND]
type presetListBy = [@as("SYSTEM") #SYSTEM | @as("CREATION_DATE") #CREATIONDATE | @as("NAME") #NAME]
type outputSdt = [@as("SDT_NONE") #SDTNONE | @as("SDT_MANUAL") #SDTMANUAL | @as("SDT_FOLLOW_IF_PRESENT") #SDTFOLLOWIFPRESENT | @as("SDT_FOLLOW") #SDTFOLLOW]
type outputGroupType = [@as("CMAF_GROUP_SETTINGS") #CMAFGROUPSETTINGS | @as("MS_SMOOTH_GROUP_SETTINGS") #MSSMOOTHGROUPSETTINGS | @as("FILE_GROUP_SETTINGS") #FILEGROUPSETTINGS | @as("DASH_ISO_GROUP_SETTINGS") #DASHISOGROUPSETTINGS | @as("HLS_GROUP_SETTINGS") #HLSGROUPSETTINGS]
...
type nielsenUniqueTicPerAudioTrackType = [@as("SAME_TICS_PER_TRACK") #SAMETICSPERTRACK | @as("RESERVE_UNIQUE_TICS_PER_TRACK") #RESERVEUNIQUETICSPERTRACK]
type nielsenSourceWatermarkStatusType = [@as("WATERMARKED") #WATERMARKED | @as("CLEAN") #CLEAN]
type nielsenActiveWatermarkProcessType = [@as("NAES2_AND_NW_AND_CBET") #NAES2ANDNWANDCBET | @as("CBET") #CBET | @as("NAES2_AND_NW") #NAES2ANDNW]
type mxfProfile = [@as("OP1A") #OP1A | @as("XDCAM") #XDCAM | @as("D_10") #D10]
type mxfAfdSignaling = [@as("COPY_FROM_VIDEO") #COPYFROMVIDEO | @as("NO_COPY") #NOCOPY]
type msSmoothManifestEncoding = [@as("UTF16") #UTF16 | @as("UTF8") #UTF8]
type msSmoothAudioDeduplication = [@as("NONE") #NONE | @as("COMBINE_DUPLICATE_STREAMS") #COMBINEDUPLICATESTREAMS]
...
type mpeg2Syntax = [@as("D_10") #D10 | @as("DEFAULT") #DEFAULT]
...
type mpeg2ScanTypeConversionMode = [@as("INTERLACED_OPTIMIZE") #INTERLACEDOPTIMIZE | @as("INTERLACED") #INTERLACED]
type mpeg2RateControlMode = [@as("CBR") #CBR | @as("VBR") #VBR]
type mpeg2QualityTuningLevel = [@as("MULTI_PASS") #MULTIPASS | @as("SINGLE_PASS") #SINGLEPASS]
type mpeg2ParControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type mpeg2IntraDcPrecision = [@as("INTRA_DC_PRECISION_11") #INTRADCPRECISION11 | @as("INTRA_DC_PRECISION_10") #INTRADCPRECISION10 | @as("INTRA_DC_PRECISION_9") #INTRADCPRECISION9 | @as("INTRA_DC_PRECISION_8") #INTRADCPRECISION8 | @as("AUTO") #AUTO]
type mpeg2InterlaceMode = [@as("FOLLOW_BOTTOM_FIELD") #FOLLOWBOTTOMFIELD | @as("FOLLOW_TOP_FIELD") #FOLLOWTOPFIELD | @as("BOTTOM_FIELD") #BOTTOMFIELD | @as("TOP_FIELD") #TOPFIELD | @as("PROGRESSIVE") #PROGRESSIVE]
type mpeg2GopSizeUnits = [@as("SECONDS") #SECONDS | @as("FRAMES") #FRAMES]
type mpeg2FramerateConversionAlgorithm = [@as("FRAMEFORMER") #FRAMEFORMER | @as("INTERPOLATE") #INTERPOLATE | @as("DUPLICATE_DROP") #DUPLICATEDROP]
type mpeg2FramerateControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type mpeg2DynamicSubGop = [@as("STATIC") #STATIC | @as("ADAPTIVE") #ADAPTIVE]
type mpeg2CodecProfile = [@as("PROFILE_422") #PROFILE422 | @as("MAIN") #MAIN]
...
type mpdCaptionContainerType = [@as("FRAGMENTED_MP4") #FRAGMENTEDMP4 | @as("RAW") #RAW]
type mpdAudioDuration = [@as("MATCH_VIDEO_DURATION") #MATCHVIDEODURATION | @as("DEFAULT_CODEC_DURATION") #DEFAULTCODECDURATION]
type mpdAccessibilityCaptionHints = [@as("EXCLUDE") #EXCLUDE | @as("INCLUDE") #INCLUDE]
type mp4MoovPlacement = [@as("NORMAL") #NORMAL | @as("PROGRESSIVE_DOWNLOAD") #PROGRESSIVEDOWNLOAD]
...
type movReference = [@as("EXTERNAL") #EXTERNAL | @as("SELF_CONTAINED") #SELFCONTAINED]
...
type m3u8PcrControl = [@as("CONFIGURED_PCR_PERIOD") #CONFIGUREDPCRPERIOD | @as("PCR_EVERY_PES_PACKET") #PCREVERYPESPACKET]
type m3u8NielsenId3 = [@as("NONE") #NONE | @as("INSERT") #INSERT]
type m3u8AudioDuration = [@as("MATCH_VIDEO_DURATION") #MATCHVIDEODURATION | @as("DEFAULT_CODEC_DURATION") #DEFAULTCODECDURATION]
type m2tsSegmentationStyle = [@as("RESET_CADENCE") #RESETCADENCE | @as("MAINTAIN_CADENCE") #MAINTAINCADENCE]
type m2tsSegmentationMarkers = [@as("EBP_LEGACY") #EBPLEGACY | @as("EBP") #EBP | @as("PSI_SEGSTART") #PSISEGSTART | @as("RAI_ADAPT") #RAIADAPT | @as("RAI_SEGSTART") #RAISEGSTART | @as("NONE") #NONE]
type m2tsScte35Source = [@as("NONE") #NONE | @as("PASSTHROUGH") #PASSTHROUGH]
type m2tsRateMode = [@as("CBR") #CBR | @as("VBR") #VBR]
type m2tsPcrControl = [@as("CONFIGURED_PCR_PERIOD") #CONFIGUREDPCRPERIOD | @as("PCR_EVERY_PES_PACKET") #PCREVERYPESPACKET]
...
type m2tsEbpPlacement = [@as("VIDEO_PID") #VIDEOPID | @as("VIDEO_AND_AUDIO_PIDS") #VIDEOANDAUDIOPIDS]
type m2tsEbpAudioInterval = [@as("VIDEO_INTERVAL") #VIDEOINTERVAL | @as("VIDEO_AND_FIXED_INTERVALS") #VIDEOANDFIXEDINTERVALS]
type m2tsBufferModel = [@as("NONE") #NONE | @as("MULTIPLEX") #MULTIPLEX]
type m2tsAudioDuration = [@as("MATCH_VIDEO_DURATION") #MATCHVIDEODURATION | @as("DEFAULT_CODEC_DURATION") #DEFAULTCODECDURATION]
...
type jobTemplateListBy = [@as("SYSTEM") #SYSTEM | @as("CREATION_DATE") #CREATIONDATE | @as("NAME") #NAME]
...
type inputSampleRange = [@as("LIMITED_RANGE") #LIMITEDRANGE | @as("FULL_RANGE") #FULLRANGE | @as("FOLLOW") #FOLLOW]
type inputRotate = [@as("AUTO") #AUTO | @as("DEGREES_270") #DEGREES270 | @as("DEGREES_180") #DEGREES180 | @as("DEGREES_90") #DEGREES90 | @as("DEGREE_0") #DEGREE0]
type inputPsiControl = [@as("USE_PSI") #USEPSI | @as("IGNORE_PSI") #IGNOREPSI]
...
type hlsSegmentControl = [@as("SEGMENTED_FILES") #SEGMENTEDFILES | @as("SINGLE_FILE") #SINGLEFILE]
type hlsProgramDateTime = [@as("EXCLUDE") #EXCLUDE | @as("INCLUDE") #INCLUDE]
type hlsOutputSelection = [@as("SEGMENTS_ONLY") #SEGMENTSONLY | @as("MANIFESTS_AND_SEGMENTS") #MANIFESTSANDSEGMENTS]
type hlsOfflineEncrypted = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED]
type hlsManifestDurationFormat = [@as("INTEGER") #INTEGER | @as("FLOATING_POINT") #FLOATINGPOINT]
type hlsManifestCompression = [@as("NONE") #NONE | @as("GZIP") #GZIP]
type hlsKeyProviderType = [@as("STATIC_KEY") #STATICKEY | @as("SPEKE") #SPEKE]
...
type hlsEncryptionType = [@as("SAMPLE_AES") #SAMPLEAES | @as("AES128") #AES128]
type hlsDirectoryStructure = [@as("SUBDIRECTORY_PER_STREAM") #SUBDIRECTORYPERSTREAM | @as("SINGLE_DIRECTORY") #SINGLEDIRECTORY]
type hlsDescriptiveVideoServiceFlag = [@as("FLAG") #FLAG | @as("DONT_FLAG") #DONTFLAG]
type hlsCodecSpecification = [@as("RFC_4281") #RFC4281 | @as("RFC_6381") #RFC6381]
...
type hlsAudioTrackType = [@as("AUDIO_ONLY_VARIANT_STREAM") #AUDIOONLYVARIANTSTREAM | @as("ALTERNATE_AUDIO_NOT_AUTO_SELECT") #ALTERNATEAUDIONOTAUTOSELECT | @as("ALTERNATE_AUDIO_AUTO_SELECT") #ALTERNATEAUDIOAUTOSELECT | @as("ALTERNATE_AUDIO_AUTO_SELECT_DEFAULT") #ALTERNATEAUDIOAUTOSELECTDEFAULT]
...
type hlsAdMarkers = [@as("ELEMENTAL_SCTE35") #ELEMENTALSCTE35 | @as("ELEMENTAL") #ELEMENTAL]
...
type h265SceneChangeDetect = [@as("TRANSITION_DETECTION") #TRANSITIONDETECTION | @as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type h265ScanTypeConversionMode = [@as("INTERLACED_OPTIMIZE") #INTERLACEDOPTIMIZE | @as("INTERLACED") #INTERLACED]
...
type h265QualityTuningLevel = [@as("MULTI_PASS_HQ") #MULTIPASSHQ | @as("SINGLE_PASS_HQ") #SINGLEPASSHQ | @as("SINGLE_PASS") #SINGLEPASS]
type h265ParControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type h265InterlaceMode = [@as("FOLLOW_BOTTOM_FIELD") #FOLLOWBOTTOMFIELD | @as("FOLLOW_TOP_FIELD") #FOLLOWTOPFIELD | @as("BOTTOM_FIELD") #BOTTOMFIELD | @as("TOP_FIELD") #TOPFIELD | @as("PROGRESSIVE") #PROGRESSIVE]
type h265GopSizeUnits = [@as("SECONDS") #SECONDS | @as("FRAMES") #FRAMES]
type h265GopBReference = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type h265FramerateConversionAlgorithm = [@as("FRAMEFORMER") #FRAMEFORMER | @as("INTERPOLATE") #INTERPOLATE | @as("DUPLICATE_DROP") #DUPLICATEDROP]
type h265FramerateControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
...
type h265CodecProfile = [@as("MAIN_422_10BIT_HIGH") #MAIN42210BITHIGH | @as("MAIN_422_10BIT_MAIN") #MAIN42210BITMAIN | @as("MAIN_422_8BIT_HIGH") #MAIN4228BITHIGH | @as("MAIN_422_8BIT_MAIN") #MAIN4228BITMAIN | @as("MAIN10_HIGH") #MAIN10HIGH | @as("MAIN10_MAIN") #MAIN10MAIN | @as("MAIN_HIGH") #MAINHIGH | @as("MAIN_MAIN") #MAINMAIN]
type h265CodecLevel = [@as("LEVEL_6_2") #LEVEL62 | @as("LEVEL_6_1") #LEVEL61 | @as("LEVEL_6") #LEVEL6 | @as("LEVEL_5_2") #LEVEL52 | @as("LEVEL_5_1") #LEVEL51 | @as("LEVEL_5") #LEVEL5 | @as("LEVEL_4_1") #LEVEL41 | @as("LEVEL_4") #LEVEL4 | @as("LEVEL_3_1") #LEVEL31 | @as("LEVEL_3") #LEVEL3 | @as("LEVEL_2_1") #LEVEL21 | @as("LEVEL_2") #LEVEL2 | @as("LEVEL_1") #LEVEL1 | @as("AUTO") #AUTO]
...
type h264SceneChangeDetect = [@as("TRANSITION_DETECTION") #TRANSITIONDETECTION | @as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type h264ScanTypeConversionMode = [@as("INTERLACED_OPTIMIZE") #INTERLACEDOPTIMIZE | @as("INTERLACED") #INTERLACED]
type h264RepeatPps = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type h264RateControlMode = [@as("QVBR") #QVBR | @as("CBR") #CBR | @as("VBR") #VBR]
type h264QualityTuningLevel = [@as("MULTI_PASS_HQ") #MULTIPASSHQ | @as("SINGLE_PASS_HQ") #SINGLEPASSHQ | @as("SINGLE_PASS") #SINGLEPASS]
type h264ParControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type h264InterlaceMode = [@as("FOLLOW_BOTTOM_FIELD") #FOLLOWBOTTOMFIELD | @as("FOLLOW_TOP_FIELD") #FOLLOWTOPFIELD | @as("BOTTOM_FIELD") #BOTTOMFIELD | @as("TOP_FIELD") #TOPFIELD | @as("PROGRESSIVE") #PROGRESSIVE]
type h264GopSizeUnits = [@as("SECONDS") #SECONDS | @as("FRAMES") #FRAMES]
type h264GopBReference = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type h264FramerateConversionAlgorithm = [@as("FRAMEFORMER") #FRAMEFORMER | @as("INTERPOLATE") #INTERPOLATE | @as("DUPLICATE_DROP") #DUPLICATEDROP]
type h264FramerateControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type h264FlickerAdaptiveQuantization = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type h264FieldEncoding = [@as("FORCE_FIELD") #FORCEFIELD | @as("PAFF") #PAFF]
type h264EntropyEncoding = [@as("CAVLC") #CAVLC | @as("CABAC") #CABAC]
type h264DynamicSubGop = [@as("STATIC") #STATIC | @as("ADAPTIVE") #ADAPTIVE]
type h264CodecProfile = [@as("MAIN") #MAIN | @as("HIGH_422_10BIT") #HIGH42210BIT | @as("HIGH_422") #HIGH422 | @as("HIGH_10BIT") #HIGH10BIT | @as("HIGH") #HIGH | @as("BASELINE") #BASELINE]
type h264CodecLevel = [@as("LEVEL_5_2") #LEVEL52 | @as("LEVEL_5_1") #LEVEL51 | @as("LEVEL_5") #LEVEL5 | @as("LEVEL_4_2") #LEVEL42 | @as("LEVEL_4_1") #LEVEL41 | @as("LEVEL_4") #LEVEL4 | @as("LEVEL_3_2") #LEVEL32 | @as("LEVEL_3_1") #LEVEL31 | @as("LEVEL_3") #LEVEL3 | @as("LEVEL_2_2") #LEVEL22 | @as("LEVEL_2_1") #LEVEL21 | @as("LEVEL_2") #LEVEL2 | @as("LEVEL_1_3") #LEVEL13 | @as("LEVEL_1_2") #LEVEL12 | @as("LEVEL_1_1") #LEVEL11 | @as("LEVEL_1") #LEVEL1 | @as("AUTO") #AUTO]
...
type f4vMoovPlacement = [@as("NORMAL") #NORMAL | @as("PROGRESSIVE_DOWNLOAD") #PROGRESSIVEDOWNLOAD]
type embeddedTerminateCaptions = [@as("DISABLED") #DISABLED | @as("END_OF_INPUT") #ENDOFINPUT]
type embeddedConvert608To708 = [@as("DISABLED") #DISABLED | @as("UPCONVERT") #UPCONVERT]
type eac3SurroundMode = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED | @as("NOT_INDICATED") #NOTINDICATED]
type eac3SurroundExMode = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED | @as("NOT_INDICATED") #NOTINDICATED]
type eac3StereoDownmix = [@as("DPL2") #DPL2 | @as("LT_RT") #LTRT | @as("LO_RO") #LORO | @as("NOT_INDICATED") #NOTINDICATED]
type eac3PhaseControl = [@as("NO_SHIFT") #NOSHIFT | @as("SHIFT_90_DEGREES") #SHIFT90DEGREES]
type eac3PassthroughControl = [@as("NO_PASSTHROUGH") #NOPASSTHROUGH | @as("WHEN_POSSIBLE") #WHENPOSSIBLE]
type eac3MetadataControl = [@as("USE_CONFIGURED") #USECONFIGURED | @as("FOLLOW_INPUT") #FOLLOWINPUT]
type eac3LfeFilter = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED]
type eac3LfeControl = [@as("NO_LFE") #NOLFE | @as("LFE") #LFE]
type eac3DynamicRangeCompressionRf = [@as("SPEECH") #SPEECH | @as("MUSIC_LIGHT") #MUSICLIGHT | @as("MUSIC_STANDARD") #MUSICSTANDARD | @as("FILM_LIGHT") #FILMLIGHT | @as("FILM_STANDARD") #FILMSTANDARD | @as("NONE") #NONE]
type eac3DynamicRangeCompressionLine = [@as("SPEECH") #SPEECH | @as("MUSIC_LIGHT") #MUSICLIGHT | @as("MUSIC_STANDARD") #MUSICSTANDARD | @as("FILM_LIGHT") #FILMLIGHT | @as("FILM_STANDARD") #FILMSTANDARD | @as("NONE") #NONE]
type eac3DcFilter = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED]
type eac3CodingMode = [@as("CODING_MODE_3_2") #CODINGMODE32 | @as("CODING_MODE_2_0") #CODINGMODE20 | @as("CODING_MODE_1_0") #CODINGMODE10]
type eac3BitstreamMode = [@as("VISUALLY_IMPAIRED") #VISUALLYIMPAIRED | @as("HEARING_IMPAIRED") #HEARINGIMPAIRED | @as("EMERGENCY") #EMERGENCY | @as("COMMENTARY") #COMMENTARY | @as("COMPLETE_MAIN") #COMPLETEMAIN]
type eac3AttenuationControl = [@as("NONE") #NONE | @as("ATTENUATE_3_DB") #ATTENUATE3DB]
type eac3AtmosSurroundExMode = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED | @as("NOT_INDICATED") #NOTINDICATED]
type eac3AtmosStereoDownmix = [@as("DPL2") #DPL2 | @as("SURROUND") #SURROUND | @as("STEREO") #STEREO | @as("NOT_INDICATED") #NOTINDICATED]
type eac3AtmosMeteringMode = [@as("ITU_BS_1770_4") #ITUBS17704 | @as("ITU_BS_1770_3") #ITUBS17703 | @as("ITU_BS_1770_2") #ITUBS17702 | @as("ITU_BS_1770_1") #ITUBS17701 | @as("LEQ_A") #LEQA]
type eac3AtmosDynamicRangeCompressionRf = [@as("SPEECH") #SPEECH | @as("MUSIC_LIGHT") #MUSICLIGHT | @as("MUSIC_STANDARD") #MUSICSTANDARD | @as("FILM_LIGHT") #FILMLIGHT | @as("FILM_STANDARD") #FILMSTANDARD | @as("NONE") #NONE]
type eac3AtmosDynamicRangeCompressionLine = [@as("SPEECH") #SPEECH | @as("MUSIC_LIGHT") #MUSICLIGHT | @as("MUSIC_STANDARD") #MUSICSTANDARD | @as("FILM_LIGHT") #FILMLIGHT | @as("FILM_STANDARD") #FILMSTANDARD | @as("NONE") #NONE]
type eac3AtmosDialogueIntelligence = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED]
type eac3AtmosCodingMode = [@as("CODING_MODE_9_1_6") #CODINGMODE916]
type eac3AtmosBitstreamMode = [@as("COMPLETE_MAIN") #COMPLETEMAIN]
type dvbddsHandling = [@as("NO_DISPLAY_WINDOW") #NODISPLAYWINDOW | @as("SPECIFIED") #SPECIFIED | @as("NONE") #NONE]
type dvbSubtitlingType = [@as("STANDARD") #STANDARD | @as("HEARING_IMPAIRED") #HEARINGIMPAIRED]
type dvbSubtitleTeletextSpacing = [@as("PROPORTIONAL") #PROPORTIONAL | @as("FIXED_GRID") #FIXEDGRID]
...
type dolbyVisionProfile = [@as("PROFILE_5") #PROFILE5]
type dolbyVisionLevel6Mode = [@as("SPECIFY") #SPECIFY | @as("RECALCULATE") #RECALCULATE | @as("PASSTHROUGH") #PASSTHROUGH]
type describeEndpointsMode = [@as("GET_ONLY") #GETONLY | @as("DEFAULT") #DEFAULT]
type deinterlacerMode = [@as("ADAPTIVE") #ADAPTIVE | @as("INVERSE_TELECINE") #INVERSETELECINE | @as("DEINTERLACE") #DEINTERLACE]
type deinterlacerControl = [@as("NORMAL") #NORMAL | @as("FORCE_ALL_FRAMES") #FORCEALLFRAMES]
type deinterlaceAlgorithm = [@as("BLEND_TICKER") #BLENDTICKER | @as("BLEND") #BLEND | @as("INTERPOLATE_TICKER") #INTERPOLATETICKER | @as("INTERPOLATE") #INTERPOLATE]
type decryptionMode = [@as("AES_GCM") #AESGCM | @as("AES_CBC") #AESCBC | @as("AES_CTR") #AESCTR]
type dashIsoWriteSegmentTimelineInRepresentation = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED]
type dashIsoSegmentControl = [@as("SEGMENTED_FILES") #SEGMENTEDFILES | @as("SINGLE_FILE") #SINGLEFILE]
type dashIsoPtsOffsetHandlingForBFrames = [@as("MATCH_INITIAL_PTS") #MATCHINITIALPTS | @as("ZERO_BASED") #ZEROBASED]
type dashIsoPlaybackDeviceCompatibility = [@as("UNENCRYPTED_SEI") #UNENCRYPTEDSEI | @as("CENC_V1") #CENCV1]
type dashIsoMpdProfile = [@as("ON_DEMAND_PROFILE") #ONDEMANDPROFILE | @as("MAIN_PROFILE") #MAINPROFILE]
type dashIsoHbbtvCompliance = [@as("NONE") #NONE | @as("HBBTV_1_5") #HBBTV15]
type dashIsoGroupAudioChannelConfigSchemeIdUri = [@as("DOLBY_CHANNEL_CONFIGURATION") #DOLBYCHANNELCONFIGURATION | @as("MPEG_CHANNEL_CONFIGURATION") #MPEGCHANNELCONFIGURATION]
...
type commitment = [@as("ONE_YEAR") #ONEYEAR]
type colorSpaceUsage = [@as("FALLBACK") #FALLBACK | @as("FORCE") #FORCE]
type colorSpaceConversion = [@as("FORCE_HLG_2020") #FORCEHLG2020 | @as("FORCE_HDR10") #FORCEHDR10 | @as("FORCE_709") #FORCE709 | @as("FORCE_601") #FORCE601 | @as("NONE") #NONE]
type colorSpace = [@as("HLG_2020") #HLG2020 | @as("HDR10") #HDR10 | @as("REC_709") #REC709 | @as("REC_601") #REC601 | @as("FOLLOW") #FOLLOW]
...
type cmfcDescriptiveVideoServiceFlag = [@as("FLAG") #FLAG | @as("DONT_FLAG") #DONTFLAG]
type cmfcAudioTrackType = [@as("ALTERNATE_AUDIO_NOT_AUTO_SELECT") #ALTERNATEAUDIONOTAUTOSELECT | @as("ALTERNATE_AUDIO_AUTO_SELECT") #ALTERNATEAUDIOAUTOSELECT | @as("ALTERNATE_AUDIO_AUTO_SELECT_DEFAULT") #ALTERNATEAUDIOAUTOSELECTDEFAULT]
type cmfcAudioDuration = [@as("MATCH_VIDEO_DURATION") #MATCHVIDEODURATION | @as("DEFAULT_CODEC_DURATION") #DEFAULTCODECDURATION]
...
type cmafSegmentControl = [@as("SEGMENTED_FILES") #SEGMENTEDFILES | @as("SINGLE_FILE") #SINGLEFILE]
type cmafPtsOffsetHandlingForBFrames = [@as("MATCH_INITIAL_PTS") #MATCHINITIALPTS | @as("ZERO_BASED") #ZEROBASED]
type cmafMpdProfile = [@as("ON_DEMAND_PROFILE") #ONDEMANDPROFILE | @as("MAIN_PROFILE") #MAINPROFILE]
type cmafManifestDurationFormat = [@as("INTEGER") #INTEGER | @as("FLOATING_POINT") #FLOATINGPOINT]
type cmafManifestCompression = [@as("NONE") #NONE | @as("GZIP") #GZIP]
type cmafKeyProviderType = [@as("STATIC_KEY") #STATICKEY | @as("SPEKE") #SPEKE]
type cmafInitializationVectorInManifest = [@as("EXCLUDE") #EXCLUDE | @as("INCLUDE") #INCLUDE]
type cmafEncryptionType = [@as("AES_CTR") #AESCTR | @as("SAMPLE_AES") #SAMPLEAES]
type cmafCodecSpecification = [@as("RFC_4281") #RFC4281 | @as("RFC_6381") #RFC6381]
type cmafClientCache = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type captionSourceType = [@as("WEBVTT") #WEBVTT | @as("IMSC") #IMSC | @as("NULL_SOURCE") #NULLSOURCE | @as("TELETEXT") #TELETEXT | @as("SMPTE_TT") #SMPTETT | @as("SMI") #SMI | @as("SRT") #SRT | @as("STL") #STL | @as("TTML") #TTML | @as("SCC") #SCC | @as("SCTE20") #SCTE20 | @as("EMBEDDED") #EMBEDDED | @as("DVB_SUB") #DVBSUB | @as("ANCILLARY") #ANCILLARY]
type captionDestinationType = [@as("WEBVTT") #WEBVTT | @as("TTML") #TTML | @as("TELETEXT") #TELETEXT | @as("SMI") #SMI | @as("SRT") #SRT | @as("SCC") #SCC | @as("SCTE20_PLUS_EMBEDDED") #SCTE20PLUSEMBEDDED | @as("IMSC") #IMSC | @as("EMBEDDED_PLUS_SCTE20") #EMBEDDEDPLUSSCTE20 | @as("EMBEDDED") #EMBEDDED | @as("DVB_SUB") #DVBSUB | @as("BURN_IN") #BURNIN]
type burninSubtitleTeletextSpacing = [@as("PROPORTIONAL") #PROPORTIONAL | @as("FIXED_GRID") #FIXEDGRID]
...
type billingTagsSource = [@as("JOB") #JOB | @as("JOB_TEMPLATE") #JOBTEMPLATE | @as("PRESET") #PRESET | @as("QUEUE") #QUEUE]
type avcIntraUhdQualityTuningLevel = [@as("MULTI_PASS") #MULTIPASS | @as("SINGLE_PASS") #SINGLEPASS]
type avcIntraTelecine = [@as("HARD") #HARD | @as("NONE") #NONE]
type avcIntraSlowPal = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type avcIntraScanTypeConversionMode = [@as("INTERLACED_OPTIMIZE") #INTERLACEDOPTIMIZE | @as("INTERLACED") #INTERLACED]
type avcIntraInterlaceMode = [@as("FOLLOW_BOTTOM_FIELD") #FOLLOWBOTTOMFIELD | @as("FOLLOW_TOP_FIELD") #FOLLOWTOPFIELD | @as("BOTTOM_FIELD") #BOTTOMFIELD | @as("TOP_FIELD") #TOPFIELD | @as("PROGRESSIVE") #PROGRESSIVE]
type avcIntraFramerateConversionAlgorithm = [@as("FRAMEFORMER") #FRAMEFORMER | @as("INTERPOLATE") #INTERPOLATE | @as("DUPLICATE_DROP") #DUPLICATEDROP]
type avcIntraFramerateControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type avcIntraClass = [@as("CLASS_4K_2K") #CLASS4K2K | @as("CLASS_200") #CLASS200 | @as("CLASS_100") #CLASS100 | @as("CLASS_50") #CLASS50]
type av1SpatialAdaptiveQuantization = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type av1RateControlMode = [@as("QVBR") #QVBR]
type av1FramerateConversionAlgorithm = [@as("FRAMEFORMER") #FRAMEFORMER | @as("INTERPOLATE") #INTERPOLATE | @as("DUPLICATE_DROP") #DUPLICATEDROP]
type av1FramerateControl = [@as("SPECIFIED") #SPECIFIED | @as("INITIALIZE_FROM_SOURCE") #INITIALIZEFROMSOURCE]
type av1AdaptiveQuantization = [@as("MAX") #MAX | @as("HIGHER") #HIGHER | @as("HIGH") #HIGH | @as("MEDIUM") #MEDIUM | @as("LOW") #LOW | @as("OFF") #OFF]
type audioTypeControl = [@as("USE_CONFIGURED") #USECONFIGURED | @as("FOLLOW_INPUT") #FOLLOWINPUT]
type audioSelectorType = [@as("LANGUAGE_CODE") #LANGUAGECODE | @as("TRACK") #TRACK | @as("PID") #PID]
type audioNormalizationPeakCalculation = [@as("NONE") #NONE | @as("TRUE_PEAK") #TRUEPEAK]
type audioNormalizationLoudnessLogging = [@as("DONT_LOG") #DONTLOG | @as("LOG") #LOG]
type audioNormalizationAlgorithmControl = [@as("MEASURE_ONLY") #MEASUREONLY | @as("CORRECT_AUDIO") #CORRECTAUDIO]
type audioNormalizationAlgorithm = [@as("ITU_BS_1770_4") #ITUBS17704 | @as("ITU_BS_1770_3") #ITUBS17703 | @as("ITU_BS_1770_2") #ITUBS17702 | @as("ITU_BS_1770_1") #ITUBS17701]
type audioLanguageCodeControl = [@as("USE_CONFIGURED") #USECONFIGURED | @as("FOLLOW_INPUT") #FOLLOWINPUT]
type audioDefaultSelection = [@as("NOT_DEFAULT") #NOTDEFAULT | @as("DEFAULT") #DEFAULT]
type audioCodec = [@as("PASSTHROUGH") #PASSTHROUGH | @as("OPUS") #OPUS | @as("VORBIS") #VORBIS | @as("EAC3_ATMOS") #EAC3ATMOS | @as("EAC3") #EAC3 | @as("AC3") #AC3 | @as("AIFF") #AIFF | @as("WAV") #WAV | @as("MP3") #MP3 | @as("MP2") #MP2 | @as("AAC") #AAC]
...
type ancillaryTerminateCaptions = [@as("DISABLED") #DISABLED | @as("END_OF_INPUT") #ENDOFINPUT]
type ancillaryConvert608To708 = [@as("DISABLED") #DISABLED | @as("UPCONVERT") #UPCONVERT]
type alphaBehavior = [@as("REMAP_TO_LUMA") #REMAPTOLUMA | @as("DISCARD") #DISCARD]
type afdSignaling = [@as("FIXED") #FIXED | @as("AUTO") #AUTO | @as("NONE") #NONE]
type accelerationStatus = [@as("NOT_ACCELERATED") #NOTACCELERATED | @as("ACCELERATED") #ACCELERATED | @as("IN_PROGRESS") #INPROGRESS | @as("NOT_APPLICABLE") #NOTAPPLICABLE]
type accelerationMode = [@as("PREFERRED") #PREFERRED | @as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type ac3MetadataControl = [@as("USE_CONFIGURED") #USECONFIGURED | @as("FOLLOW_INPUT") #FOLLOWINPUT]
type ac3LfeFilter = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED]
type ac3DynamicRangeCompressionRf = [@as("NONE") #NONE | @as("SPEECH") #SPEECH | @as("MUSIC_LIGHT") #MUSICLIGHT | @as("MUSIC_STANDARD") #MUSICSTANDARD | @as("FILM_LIGHT") #FILMLIGHT | @as("FILM_STANDARD") #FILMSTANDARD]
type ac3DynamicRangeCompressionProfile = [@as("NONE") #NONE | @as("FILM_STANDARD") #FILMSTANDARD]
type ac3DynamicRangeCompressionLine = [@as("NONE") #NONE | @as("SPEECH") #SPEECH | @as("MUSIC_LIGHT") #MUSICLIGHT | @as("MUSIC_STANDARD") #MUSICSTANDARD | @as("FILM_LIGHT") #FILMLIGHT | @as("FILM_STANDARD") #FILMSTANDARD]
type ac3CodingMode = [@as("CODING_MODE_3_2_LFE") #CODINGMODE32LFE | @as("CODING_MODE_2_0") #CODINGMODE20 | @as("CODING_MODE_1_1") #CODINGMODE11 | @as("CODING_MODE_1_0") #CODINGMODE10]
type ac3BitstreamMode = [@as("VOICE_OVER") #VOICEOVER | @as("VISUALLY_IMPAIRED") #VISUALLYIMPAIRED | @as("MUSIC_AND_EFFECTS") #MUSICANDEFFECTS | @as("HEARING_IMPAIRED") #HEARINGIMPAIRED | @as("EMERGENCY") #EMERGENCY | @as("DIALOGUE") #DIALOGUE | @as("COMMENTARY") #COMMENTARY | @as("COMPLETE_MAIN") #COMPLETEMAIN]
type aacVbrQuality = [@as("HIGH") #HIGH | @as("MEDIUM_HIGH") #MEDIUMHIGH | @as("MEDIUM_LOW") #MEDIUMLOW | @as("LOW") #LOW]
type aacSpecification = [@as("MPEG4") #MPEG4 | @as("MPEG2") #MPEG2]
type aacRawFormat = [@as("NONE") #NONE | @as("LATM_LOAS") #LATMLOAS]
type aacRateControlMode = [@as("VBR") #VBR | @as("CBR") #CBR]
type aacCodingMode = [@as("CODING_MODE_5_1") #CODINGMODE51 | @as("CODING_MODE_2_0") #CODINGMODE20 | @as("CODING_MODE_1_1") #CODINGMODE11 | @as("CODING_MODE_1_0") #CODINGMODE10 | @as("AD_RECEIVER_MIX") #ADRECEIVERMIX]
type aacCodecProfile = [@as("HEV2") #HEV2 | @as("HEV1") #HEV1 | @as("LC") #LC]
type aacAudioDescriptionBroadcasterMix = [@as("NORMAL") #NORMAL | @as("BROADCASTER_MIXED_AD") #BROADCASTERMIXEDAD]
...
@as("FramerateConversionAlgorithm") framerateConversionAlgorithm: option<vp9FramerateConversionAlgorithm>,
...
@as("FramerateNumerator") framerateNumerator: option<__integerMin1Max2147483647>,
@as("FramerateDenominator") framerateDenominator: option<__integerMin1Max2147483647>,
@as("FramerateConversionAlgorithm") framerateConversionAlgorithm: option<vp8FramerateConversionAlgorithm>,
...
@as("FramerateConversionAlgorithm") framerateConversionAlgorithm: option<vc3FramerateConversionAlgorithm>,
...
@as("TrackNumber") trackNumber: option<__integerMin1Max2147483647>
}
type timing = {
...
@as("Framerate") framerate: option<sccDestinationFramerate>
}
type s3EncryptionSettings = {
@as("KmsKeyArn") kmsKeyArn: option<__stringPatternArnAwsUsGovCnKmsAZ26EastWestCentralNorthSouthEastWest1912D12KeyAFAF098AFAF094AFAF094AFAF094AFAF0912>,
@as("EncryptionType") encryptionType: option<s3ServerSideEncryptionType>
}
type s3DestinationAccessControl = {
@as("CannedAcl") cannedAcl: option<s3ObjectCannedAcl>
}
...
@as("FramerateNumerator") framerateNumerator: option<__integerMin1Max2147483647>,
@as("FramerateDenominator") framerateDenominator: option<__integerMin1Max2147483647>,
@as("FramerateConversionAlgorithm") framerateConversionAlgorithm: option<proresFramerateConversionAlgorithm>,
...
@as("Strength") strength: option<__integerMin0Max3>
}
...
type mpeg2Settings = {
@as("TemporalAdaptiveQuantization") temporalAdaptiveQuantization: option<mpeg2TemporalAdaptiveQuantization>,
@as("Telecine") telecine: option<mpeg2Telecine>,
@as("Syntax") syntax: option<mpeg2Syntax>,
@as("SpatialAdaptiveQuantization") spatialAdaptiveQuantization: option<mpeg2SpatialAdaptiveQuantization>,
...
@as("NumberBFramesBetweenReferenceFrames") numberBFramesBetweenReferenceFrames: option<__integerMin0Max7>,
...
@as("FramerateNumerator") framerateNumerator: option<__integerMin24Max60000>,
@as("FramerateDenominator") framerateDenominator: option<__integerMin1Max1001>,
@as("FramerateConversionAlgorithm") framerateConversionAlgorithm: option<mpeg2FramerateConversionAlgorithm>,
...
type m2tsScte35Esam = {
@as("Scte35EsamPid") scte35EsamPid: option<__integerMin32Max8182>
}
...
@as("ImageY") imageY: option<__integerMin0Max2147483647>,
@as("ImageX") imageX: option<__integerMin0Max2147483647>,
@as("ImageInserterInput") imageInserterInput: option<__stringMin14PatternS3BmpBMPPngPNGTgaTGAHttpsBmpBMPPngPNGTgaTGA>,
...
@as("KmsKeyRegion") kmsKeyRegion: option<__stringMin9Max19PatternAZ26EastWestCentralNorthSouthEastWest1912>,
@as("InitializationVector") initializationVector: option<__stringMin16Max24PatternAZaZ0922AZaZ0916>,
...
@as("DescriptiveVideoServiceFlag") descriptiveVideoServiceFlag: option<hlsDescriptiveVideoServiceFlag>,
...
type f4vSettings = {
@as("MoovPlacement") moovPlacement: option<f4vMoovPlacement>
}
...
@as("DynamicRangeCompressionLine") dynamicRangeCompressionLine: option<eac3DynamicRangeCompressionLine>,
...
@as("DynamicRangeCompressionRf") dynamicRangeCompressionRf: option<eac3AtmosDynamicRangeCompressionRf>,
@as("DynamicRangeCompressionLine") dynamicRangeCompressionLine: option<eac3AtmosDynamicRangeCompressionLine>,
...
type dvbTdtSettings = {
@as("TdtInterval") tdtInterval: option<__integerMin1000Max30000>
}
...
@as("DescriptiveVideoServiceFlag") descriptiveVideoServiceFlag: option<cmfcDescriptiveVideoServiceFlag>,
...
type availBlanking = {
@as("AvailBlankingImage") availBlankingImage: option<__stringMin14PatternS3BmpBMPPngPNGHttpsBmpBMPPngPNG>
}
...
@as("ChannelTag") channelTag: option<audioChannelTag>
}
...
@as("DynamicRangeCompressionProfile") dynamicRangeCompressionProfile: option<ac3DynamicRangeCompressionProfile>,
@as("DynamicRangeCompressionLine") dynamicRangeCompressionLine: option<ac3DynamicRangeCompressionLine>,
@as("Dialnorm") dialnorm: option<__integerMin1Max31>,
...
@as("AudioDescriptionBroadcasterMix") audioDescriptionBroadcasterMix: option<aacAudioDescriptionBroadcasterMix>
}
...
@as("HlsSignaledSystemIds") hlsSignaledSystemIds: option<__listOf__stringMin36Max36Pattern09aFAF809aFAF409aFAF409aFAF409aFAF12>,
@as("DashSignaledSystemIds") dashSignaledSystemIds: option<__listOf__stringMin36Max36Pattern09aFAF809aFAF409aFAF409aFAF409aFAF12>,
...
@as("TemporalAdaptiveQuantization") temporalAdaptiveQuantization: option<h265TemporalAdaptiveQuantization>,
@as("Telecine") telecine: option<h265Telecine>,
@as("SpatialAdaptiveQuantization") spatialAdaptiveQuantization: option<h265SpatialAdaptiveQuantization>,
...
@as("SampleAdaptiveOffsetFilterMode") sampleAdaptiveOffsetFilterMode: option<h265SampleAdaptiveOffsetFilterMode>,
...
@as("FramerateNumerator") framerateNumerator: option<__integerMin1Max2147483647>,
@as("FramerateDenominator") framerateDenominator: option<__integerMin1Max2147483647>,
@as("FramerateConversionAlgorithm") framerateConversionAlgorithm: option<h265FramerateConversionAlgorithm>,
@as("FramerateControl") framerateControl: option<h265FramerateControl>,
@as("FlickerAdaptiveQuantization") flickerAdaptiveQuantization: option<h265FlickerAdaptiveQuantization>,
...
@as("AlternateTransferFunctionSei") alternateTransferFunctionSei: option<h265AlternateTransferFunctionSei>,
...
@as("TemporalAdaptiveQuantization") temporalAdaptiveQuantization: option<h264TemporalAdaptiveQuantization>,
@as("Telecine") telecine: option<h264Telecine>,
@as("Syntax") syntax: option<h264Syntax>,
@as("SpatialAdaptiveQuantization") spatialAdaptiveQuantization: option<h264SpatialAdaptiveQuantization>,
@as("Softness") softness: option<__integerMin0Max128>,
...
@as("FramerateNumerator") framerateNumerator: option<__integerMin1Max2147483647>,
@as("FramerateDenominator") framerateDenominator: option<__integerMin1Max2147483647>,
@as("FramerateConversionAlgorithm") framerateConversionAlgorithm: option<h264FramerateConversionAlgorithm>,
@as("FramerateControl") framerateControl: option<h264FramerateControl>,
@as("FlickerAdaptiveQuantization") flickerAdaptiveQuantization: option<h264FlickerAdaptiveQuantization>,
...
@as("SourceFile") sourceFile: option<__stringMin14PatternS3SccSCCTtmlTTMLDfxpDFXPStlSTLSrtSRTXmlXMLSmiSMIVttVTTHttpsSccSCCTtmlTTMLDfxpDFXPStlSTLSrtSRTXmlXMLSmiSMIVttVTT>,
@as("Framerate") framerate: option<captionSourceFramerate>,
@as("Convert608To708") convert608To708: option<fileSourceConvert608To708>
}
type esamSettings = {
@as("SignalProcessingNotification") signalProcessingNotification: option<esamSignalProcessingNotification>,
@as("ResponseSignalPreroll") responseSignalPreroll: option<__integerMin0Max30000>,
@as("ManifestConfirmConditionNotification") manifestConfirmConditionNotification: option<esamManifestConfirmConditionNotification>
}
type dolbyVision = {
...
@as("FramerateNumerator") framerateNumerator: option<__integerMin24Max60000>,
@as("FramerateDenominator") framerateDenominator: option<__integerMin1Max1001>,
@as("FramerateConversionAlgorithm") framerateConversionAlgorithm: option<avcIntraFramerateConversionAlgorithm>,
...
type av1Settings = {
@as("SpatialAdaptiveQuantization") spatialAdaptiveQuantization: option<av1SpatialAdaptiveQuantization>,
@as("Slices") slices: option<__integerMin1Max32>,
@as("RateControlMode") rateControlMode: option<av1RateControlMode>,
@as("QvbrSettings") qvbrSettings: option<av1QvbrSettings>,
@as("NumberBFramesBetweenReferenceFrames") numberBFramesBetweenReferenceFrames: option<__integerMin0Max15>,
@as("MaxBitrate") maxBitrate: option<__integerMin1000Max1152000000>,
@as("GopSize") gopSize: option<__doubleMin0>,
@as("FramerateNumerator") framerateNumerator: option<__integerMin1Max2147483647>,
@as("FramerateDenominator") framerateDenominator: option<__integerMin1Max2147483647>,
@as("FramerateConversionAlgorithm") framerateConversionAlgorithm: option<av1FramerateConversionAlgorithm>,
...
@as("AbrSettings") abrSettings: option<automatedAbrSettings>
}
...
@as("Id3Insertions") id3Insertions: option<__listOfId3Insertion>
}
type msSmoothEncryptionSettings = {
@as("SpekeKeyProvider") spekeKeyProvider: option<spekeKeyProvider>
}
type imageInserter = {
@as("InsertableImages") insertableImages: option<__listOfInsertableImage>
}
...
@as("InitializationVectorInManifest") initializationVectorInManifest: option<hlsInitializationVectorInManifest>,
@as("EncryptionMethod") encryptionMethod: option<hlsEncryptionType>,
@as("ConstantInitializationVector") constantInitializationVector: option<__stringMin32Max32Pattern09aFAF32>
}
type destinationSettings = {
@as("S3Settings") s3Settings: option<s3DestinationSettings>
}
type dashIsoEncryptionSettings = {
@as("SpekeKeyProvider") spekeKeyProvider: option<spekeKeyProvider>,
@as("PlaybackDeviceCompatibility") playbackDeviceCompatibility: option<dashIsoPlaybackDeviceCompatibility>
}
...
@as("InitializationVectorInManifest") initializationVectorInManifest: option<cmafInitializationVectorInManifest>,
...
@as("TeletextDestinationSettings") teletextDestinationSettings: option<teletextDestinationSettings>,
...
@as("EmbeddedDestinationSettings") embeddedDestinationSettings: option<embeddedDestinationSettings>,
...
@as("OutputDetails") outputDetails: option<__listOfOutputDetail>
}
...
@as("TimestampDeltaMilliseconds") timestampDeltaMilliseconds: option<__integerMinNegative2147483648Max2147483647>,
@as("TimedMetadataId3Period") timedMetadataId3Period: option<__integerMinNegative2147483648Max2147483647>,
...
@as("WriteSegmentTimelineInRepresentation") writeSegmentTimelineInRepresentation: option<dashIsoWriteSegmentTimelineInRepresentation>,
@as("SegmentLength") segmentLength: option<__integerMin1Max2147483647>,
@as("SegmentControl") segmentControl: option<dashIsoSegmentControl>,
@as("PtsOffsetHandlingForBFrames") ptsOffsetHandlingForBFrames: option<dashIsoPtsOffsetHandlingForBFrames>,
...
@as("Destination") destination: option<__stringPatternS3>,
@as("BaseUrl") baseUrl: option<__string>,
@as("AudioChannelConfigSchemeIdUri") audioChannelConfigSchemeIdUri: option<dashIsoGroupAudioChannelConfigSchemeIdUri>,
@as("AdditionalManifests") additionalManifests: option<__listOfDashAdditionalManifest>
}
type cmafGroupSettings = {
@as("WriteSegmentTimelineInRepresentation") writeSegmentTimelineInRepresentation: option<cmafWriteSegmentTimelineInRepresentation>,
...
@as("PtsOffsetHandlingForBFrames") ptsOffsetHandlingForBFrames: option<cmafPtsOffsetHandlingForBFrames>,
...
type channelMapping = {
@as("OutputChannels") outputChannels: option<__listOfOutputChannelMapping>
}
...
@as("LanguageCode") languageCode: option<languageCode>,
@as("ExternalAudioFileInput") externalAudioFileInput: option<__>,
...
@as("AudioChannelTaggingSettings") audioChannelTaggingSettings: option<audioChannelTaggingSettings>
}
...
@as("FilterStrength") filterStrength: option<__integerMinNegative5Max5>,
@as("FilterEnable") filterEnable: option<inputFilterEnable>,
@as("FileInput") fileInput: option<__>,
@as("DenoiseFilter") denoiseFilter: option<inputDenoiseFilter>,
...
@as("NielsenNonLinearWatermark") nielsenNonLinearWatermark: option<nielsenNonLinearWatermarkSettings>,
...
@module("@aws-sdk/client-mediaconvert") @new external createClient: unit => awsServiceClient = "MediaConvertClient";
...
@as("AccelerationSettings") accelerationSettings: option<accelerationSettings>
  ...
  type response = {
@as("JobTemplate") jobTemplate: option<jobTemplate>
}
