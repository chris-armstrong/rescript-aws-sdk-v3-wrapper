...
type wavCodingMode = [@as("CODING_MODE_8_0") #CODINGMODE80 | @as("CODING_MODE_4_0") #CODINGMODE40 | @as("CODING_MODE_2_0") #CODINGMODE20 | @as("CODING_MODE_1_0") #CODINGMODE10]
type videoSelectorColorSpaceUsage = [@as("FORCE") #FORCE | @as("FALLBACK") #FALLBACK]
type videoSelectorColorSpace = [@as("REC_709") #REC709 | @as("REC_601") #REC601 | @as("HLG_2020") #HLG2020 | @as("HDR10") #HDR10 | @as("FOLLOW") #FOLLOW]
type videoDescriptionScalingBehavior = [@as("STRETCH_TO_OUTPUT") #STRETCHTOOUTPUT | @as("DEFAULT") #DEFAULT]
...
type ttmlDestinationStyleControl = [@as("USE_CONFIGURED") #USECONFIGURED | @as("PASSTHROUGH") #PASSTHROUGH]
type timecodeConfigSource = [@as("ZEROBASED") #ZEROBASED | @as("SYSTEMCLOCK") #SYSTEMCLOCK | @as("EMBEDDED") #EMBEDDED]
type temporalFilterStrength = [@as("STRENGTH_16") #STRENGTH16 | @as("STRENGTH_15") #STRENGTH15 | @as("STRENGTH_14") #STRENGTH14 | @as("STRENGTH_13") #STRENGTH13 | @as("STRENGTH_12") #STRENGTH12 | @as("STRENGTH_11") #STRENGTH11 | @as("STRENGTH_10") #STRENGTH10 | @as("STRENGTH_9") #STRENGTH9 | @as("STRENGTH_8") #STRENGTH8 | @as("STRENGTH_7") #STRENGTH7 | @as("STRENGTH_6") #STRENGTH6 | @as("STRENGTH_5") #STRENGTH5 | @as("STRENGTH_4") #STRENGTH4 | @as("STRENGTH_3") #STRENGTH3 | @as("STRENGTH_2") #STRENGTH2 | @as("STRENGTH_1") #STRENGTH1 | @as("AUTO") #AUTO]
...
type smoothGroupTimestampOffsetMode = [@as("USE_EVENT_START_DATE") #USEEVENTSTARTDATE | @as("USE_CONFIGURED_OFFSET") #USECONFIGUREDOFFSET]
type smoothGroupStreamManifestBehavior = [@as("SEND") #SEND | @as("DO_NOT_SEND") #DONOTSEND]
type smoothGroupSparseTrackType = [@as("SCTE_35_WITHOUT_SEGMENTATION") #SCTE35WITHOUTSEGMENTATION | @as("SCTE_35") #SCTE35 | @as("NONE") #NONE]
type smoothGroupSegmentationMode = [@as("USE_SEGMENT_DURATION") #USESEGMENTDURATION | @as("USE_INPUT_SEGMENTATION") #USEINPUTSEGMENTATION]
type smoothGroupEventStopBehavior = [@as("SEND_EOS") #SENDEOS | @as("NONE") #NONE]
type smoothGroupEventIdMode = [@as("USE_TIMESTAMP") #USETIMESTAMP | @as("USE_CONFIGURED") #USECONFIGURED | @as("NO_EVENT_ID") #NOEVENTID]
type smoothGroupCertificateMode = [@as("VERIFY_AUTHENTICITY") #VERIFYAUTHENTICITY | @as("SELF_SIGNED") #SELFSIGNED]
type smoothGroupAudioOnlyTimecodeControl = [@as("USE_CONFIGURED_CLOCK") #USECONFIGUREDCLOCK | @as("PASSTHROUGH") #PASSTHROUGH]
type scte35WebDeliveryAllowedFlag = [@as("WEB_DELIVERY_ALLOWED") #WEBDELIVERYALLOWED | @as("WEB_DELIVERY_NOT_ALLOWED") #WEBDELIVERYNOTALLOWED]
...
type scte35SegmentationCancelIndicator = [@as("SEGMENTATION_EVENT_CANCELED") #SEGMENTATIONEVENTCANCELED | @as("SEGMENTATION_EVENT_NOT_CANCELED") #SEGMENTATIONEVENTNOTCANCELED]
type scte35NoRegionalBlackoutFlag = [@as("NO_REGIONAL_BLACKOUT") #NOREGIONALBLACKOUT | @as("REGIONAL_BLACKOUT") #REGIONALBLACKOUT]
type scte35DeviceRestrictions = [@as("RESTRICT_GROUP2") #RESTRICTGROUP2 | @as("RESTRICT_GROUP1") #RESTRICTGROUP1 | @as("RESTRICT_GROUP0") #RESTRICTGROUP0 | @as("NONE") #NONE]
type scte35ArchiveAllowedFlag = [@as("ARCHIVE_ALLOWED") #ARCHIVEALLOWED | @as("ARCHIVE_NOT_ALLOWED") #ARCHIVENOTALLOWED]
...
type s3CannedAcl = [@as("PUBLIC_READ") #PUBLICREAD | @as("BUCKET_OWNER_READ") #BUCKETOWNERREAD | @as("BUCKET_OWNER_FULL_CONTROL") #BUCKETOWNERFULLCONTROL | @as("AUTHENTICATED_READ") #AUTHENTICATEDREAD]
type rtmpOutputCertificateMode = [@as("VERIFY_AUTHENTICITY") #VERIFYAUTHENTICITY | @as("SELF_SIGNED") #SELFSIGNED]
type rtmpCaptionInfoDestinationSettings = unit
type rtmpCaptionData = [@as("FIELD1_AND_FIELD2_608") #FIELD1ANDFIELD2608 | @as("FIELD1_608") #FIELD1608 | @as("ALL") #ALL]
type rtmpCacheFullBehavior = [@as("WAIT_FOR_SERVER") #WAITFORSERVER | @as("DISCONNECT_IMMEDIATELY") #DISCONNECTIMMEDIATELY]
type rtmpAdMarkers = [@as("ON_CUE_POINT_SCTE35") #ONCUEPOINTSCTE35]
...
type reservationSpecialFeature = [@as("AUDIO_NORMALIZATION") #AUDIONORMALIZATION | @as("ADVANCED_AUDIO") #ADVANCEDAUDIO]
...
type reservationMaximumFramerate = [@as("MAX_60_FPS") #MAX60FPS | @as("MAX_30_FPS") #MAX30FPS]
type reservationMaximumBitrate = [@as("MAX_50_MBPS") #MAX50MBPS | @as("MAX_20_MBPS") #MAX20MBPS | @as("MAX_10_MBPS") #MAX10MBPS]
...
type preferredChannelPipeline = [@as("PIPELINE_1") #PIPELINE1 | @as("PIPELINE_0") #PIPELINE0 | @as("CURRENTLY_ACTIVE") #CURRENTLYACTIVE]
type pipelineId = [@as("PIPELINE_1") #PIPELINE1 | @as("PIPELINE_0") #PIPELINE0]
type passThroughSettings = unit
type offeringType = [@as("NO_UPFRONT") #NOUPFRONT]
type offeringDurationUnits = [@as("MONTHS") #MONTHS]
type nielsenPcmToId3TaggingState = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type networkInputServerValidation = [@as("CHECK_CRYPTOGRAPHY_ONLY") #CHECKCRYPTOGRAPHYONLY | @as("CHECK_CRYPTOGRAPHY_AND_VALIDATE_NAME") #CHECKCRYPTOGRAPHYANDVALIDATENAME]
type multiplexState = [@as("DELETED") #DELETED | @as("DELETING") #DELETING | @as("STOPPING") #STOPPING | @as("RECOVERING") #RECOVERING | @as("RUNNING") #RUNNING | @as("STARTING") #STARTING | @as("IDLE") #IDLE | @as("CREATE_FAILED") #CREATEFAILED | @as("CREATING") #CREATING]
type multiplexGroupSettings = unit
type msSmoothH265PackagingType = [@as("HVC1") #HVC1 | @as("HEV1") #HEV1]
type mpeg2TimecodeInsertionBehavior = [@as("GOP_TIMECODE") #GOPTIMECODE | @as("DISABLED") #DISABLED]
...
type mp2CodingMode = [@as("CODING_MODE_2_0") #CODINGMODE20 | @as("CODING_MODE_1_0") #CODINGMODE10]
...
type maxResults = int
type m3u8TimedMetadataBehavior = [@as("PASSTHROUGH") #PASSTHROUGH | @as("NO_PASSTHROUGH") #NOPASSTHROUGH]
type m3u8Scte35Behavior = [@as("PASSTHROUGH") #PASSTHROUGH | @as("NO_PASSTHROUGH") #NOPASSTHROUGH]
type m3u8PcrControl = [@as("PCR_EVERY_PES_PACKET") #PCREVERYPESPACKET | @as("CONFIGURED_PCR_PERIOD") #CONFIGUREDPCRPERIOD]
type m3u8NielsenId3Behavior = [@as("PASSTHROUGH") #PASSTHROUGH | @as("NO_PASSTHROUGH") #NOPASSTHROUGH]
type m2tsTimedMetadataBehavior = [@as("PASSTHROUGH") #PASSTHROUGH | @as("NO_PASSTHROUGH") #NOPASSTHROUGH]
type m2tsSegmentationStyle = [@as("RESET_CADENCE") #RESETCADENCE | @as("MAINTAIN_CADENCE") #MAINTAINCADENCE]
type m2tsSegmentationMarkers = [@as("RAI_SEGSTART") #RAISEGSTART | @as("RAI_ADAPT") #RAIADAPT | @as("PSI_SEGSTART") #PSISEGSTART | @as("NONE") #NONE | @as("EBP_LEGACY") #EBPLEGACY | @as("EBP") #EBP]
type m2tsScte35Control = [@as("PASSTHROUGH") #PASSTHROUGH | @as("NONE") #NONE]
type m2tsRateMode = [@as("VBR") #VBR | @as("CBR") #CBR]
type m2tsPcrControl = [@as("PCR_EVERY_PES_PACKET") #PCREVERYPESPACKET | @as("CONFIGURED_PCR_PERIOD") #CONFIGUREDPCRPERIOD]
type m2tsNielsenId3Behavior = [@as("PASSTHROUGH") #PASSTHROUGH | @as("NO_PASSTHROUGH") #NOPASSTHROUGH]
...
type m2tsAudioInterval = [@as("VIDEO_INTERVAL") #VIDEOINTERVAL | @as("VIDEO_AND_FIXED_INTERVALS") #VIDEOANDFIXEDINTERVALS]
type m2tsAudioBufferModel = [@as("DVB") #DVB | @as("ATSC") #ATSC]
type m2tsAribCaptionsPidControl = [@as("USE_CONFIGURED") #USECONFIGURED | @as("AUTO") #AUTO]
type m2tsArib = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type m2tsAbsentInputAudioBehavior = [@as("ENCODE_SILENCE") #ENCODESILENCE | @as("DROP") #DROP]
type logLevel = [@as("DISABLED") #DISABLED | @as("DEBUG") #DEBUG | @as("INFO") #INFO | @as("WARNING") #WARNING | @as("ERROR") #ERROR]
type lastFrameClippingBehavior = [@as("INCLUDE_LAST_FRAME") #INCLUDELASTFRAME | @as("EXCLUDE_LAST_FRAME") #EXCLUDELASTFRAME]
type inputType = [@as("AWS_CDI") #AWSCDI | @as("INPUT_DEVICE") #INPUTDEVICE | @as("MEDIACONNECT") #MEDIACONNECT | @as("MP4_FILE") #MP4FILE | @as("URL_PULL") #URLPULL | @as("RTMP_PULL") #RTMPPULL | @as("RTMP_PUSH") #RTMPPUSH | @as("RTP_PUSH") #RTPPUSH | @as("UDP_PUSH") #UDPPUSH]
...
type inputSecurityGroupState = [@as("DELETED") #DELETED | @as("UPDATING") #UPDATING | @as("IN_USE") #INUSE | @as("IDLE") #IDLE]
type inputResolution = [@as("UHD") #UHD | @as("HD") #HD | @as("SD") #SD]
type inputPreference = [@as("PRIMARY_INPUT_PREFERRED") #PRIMARYINPUTPREFERRED | @as("EQUAL_INPUT_PREFERENCE") #EQUALINPUTPREFERENCE]
type inputMaximumBitrate = [@as("MAX_50_MBPS") #MAX50MBPS | @as("MAX_20_MBPS") #MAX20MBPS | @as("MAX_10_MBPS") #MAX10MBPS]
type inputLossImageType = [@as("SLATE") #SLATE | @as("COLOR") #COLOR]
type inputLossActionForUdpOut = [@as("EMIT_PROGRAM") #EMITPROGRAM | @as("DROP_TS") #DROPTS | @as("DROP_PROGRAM") #DROPPROGRAM]
type inputLossActionForRtmpOut = [@as("PAUSE_OUTPUT") #PAUSEOUTPUT | @as("EMIT_OUTPUT") #EMITOUTPUT]
type inputLossActionForMsSmoothOut = [@as("PAUSE_OUTPUT") #PAUSEOUTPUT | @as("EMIT_OUTPUT") #EMITOUTPUT]
type inputLossActionForHlsOut = [@as("PAUSE_OUTPUT") #PAUSEOUTPUT | @as("EMIT_OUTPUT") #EMITOUTPUT]
...
type inputClass = [@as("SINGLE_PIPELINE") #SINGLEPIPELINE | @as("STANDARD") #STANDARD]
...
type hlsWebdavHttpTransferMode = [@as("NON_CHUNKED") #NONCHUNKED | @as("CHUNKED") #CHUNKED]
type hlsTsFileMode = [@as("SINGLE_FILE") #SINGLEFILE | @as("SEGMENTED_FILES") #SEGMENTEDFILES]
...
type hlsSegmentationMode = [@as("USE_SEGMENT_DURATION") #USESEGMENTDURATION | @as("USE_INPUT_SEGMENTATION") #USEINPUTSEGMENTATION]
...
type hlsOutputSelection = [@as("VARIANT_MANIFESTS_AND_SEGMENTS") #VARIANTMANIFESTSANDSEGMENTS | @as("SEGMENTS_ONLY") #SEGMENTSONLY | @as("MANIFESTS_AND_SEGMENTS") #MANIFESTSANDSEGMENTS]
...
type hlsIvSource = [@as("FOLLOWS_SEGMENT_NUMBER") #FOLLOWSSEGMENTNUMBER | @as("EXPLICIT") #EXPLICIT]
...
type hlsDiscontinuityTags = [@as("NEVER_INSERT") #NEVERINSERT | @as("INSERT") #INSERT]
type hlsDirectoryStructure = [@as("SUBDIRECTORY_PER_STREAM") #SUBDIRECTORYPERSTREAM | @as("SINGLE_DIRECTORY") #SINGLEDIRECTORY]
type hlsCodecSpecification = [@as("RFC_6381") #RFC6381 | @as("RFC_4281") #RFC4281]
...
type hlsAkamaiHttpTransferMode = [@as("NON_CHUNKED") #NONCHUNKED | @as("CHUNKED") #CHUNKED]
type hlsAdMarkers = [@as("ELEMENTAL_SCTE35") #ELEMENTALSCTE35 | @as("ELEMENTAL") #ELEMENTAL | @as("ADOBE") #ADOBE]
type h265TimecodeInsertionBehavior = [@as("PIC_TIMING_SEI") #PICTIMINGSEI | @as("DISABLED") #DISABLED]
...
type h265Profile = [@as("MAIN_10BIT") #MAIN10BIT | @as("MAIN") #MAIN]
type h265LookAheadRateControl = [@as("MEDIUM") #MEDIUM | @as("LOW") #LOW | @as("HIGH") #HIGH]
type h265Level = [@as("H265_LEVEL_AUTO") #H265LEVELAUTO | @as("H265_LEVEL_6_2") #H265LEVEL62 | @as("H265_LEVEL_6_1") #H265LEVEL61 | @as("H265_LEVEL_6") #H265LEVEL6 | @as("H265_LEVEL_5_2") #H265LEVEL52 | @as("H265_LEVEL_5_1") #H265LEVEL51 | @as("H265_LEVEL_5") #H265LEVEL5 | @as("H265_LEVEL_4_1") #H265LEVEL41 | @as("H265_LEVEL_4") #H265LEVEL4 | @as("H265_LEVEL_3_1") #H265LEVEL31 | @as("H265_LEVEL_3") #H265LEVEL3 | @as("H265_LEVEL_2_1") #H265LEVEL21 | @as("H265_LEVEL_2") #H265LEVEL2 | @as("H265_LEVEL_1") #H265LEVEL1]
...
type h264TimecodeInsertionBehavior = [@as("PIC_TIMING_SEI") #PICTIMINGSEI | @as("DISABLED") #DISABLED]
...
type h264QualityLevel = [@as("STANDARD_QUALITY") #STANDARDQUALITY | @as("ENHANCED_QUALITY") #ENHANCEDQUALITY]
type h264Profile = [@as("MAIN") #MAIN | @as("HIGH_422_10BIT") #HIGH42210BIT | @as("HIGH_422") #HIGH422 | @as("HIGH_10BIT") #HIGH10BIT | @as("HIGH") #HIGH | @as("BASELINE") #BASELINE]
...
type h264Level = [@as("H264_LEVEL_AUTO") #H264LEVELAUTO | @as("H264_LEVEL_5_2") #H264LEVEL52 | @as("H264_LEVEL_5_1") #H264LEVEL51 | @as("H264_LEVEL_5") #H264LEVEL5 | @as("H264_LEVEL_4_2") #H264LEVEL42 | @as("H264_LEVEL_4_1") #H264LEVEL41 | @as("H264_LEVEL_4") #H264LEVEL4 | @as("H264_LEVEL_3_2") #H264LEVEL32 | @as("H264_LEVEL_3_1") #H264LEVEL31 | @as("H264_LEVEL_3") #H264LEVEL3 | @as("H264_LEVEL_2_2") #H264LEVEL22 | @as("H264_LEVEL_2_1") #H264LEVEL21 | @as("H264_LEVEL_2") #H264LEVEL2 | @as("H264_LEVEL_1_3") #H264LEVEL13 | @as("H264_LEVEL_1_2") #H264LEVEL12 | @as("H264_LEVEL_1_1") #H264LEVEL11 | @as("H264_LEVEL_1") #H264LEVEL1]
...
type globalConfigurationOutputTimingSource = [@as("SYSTEM_CLOCK") #SYSTEMCLOCK | @as("INPUT_CLOCK") #INPUTCLOCK]
type globalConfigurationOutputLockingMode = [@as("PIPELINE_LOCKING") #PIPELINELOCKING | @as("EPOCH_LOCKING") #EPOCHLOCKING]
type globalConfigurationLowFramerateInputs = [@as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type globalConfigurationInputEndAction = [@as("SWITCH_AND_LOOP_INPUTS") #SWITCHANDLOOPINPUTS | @as("NONE") #NONE]
...
type fmp4TimedMetadataBehavior = [@as("PASSTHROUGH") #PASSTHROUGH | @as("NO_PASSTHROUGH") #NOPASSTHROUGH]
type fmp4NielsenId3Behavior = [@as("PASSTHROUGH") #PASSTHROUGH | @as("NO_PASSTHROUGH") #NOPASSTHROUGH]
type fixedAfd = [@as("AFD_1111") #AFD1111 | @as("AFD_1110") #AFD1110 | @as("AFD_1101") #AFD1101 | @as("AFD_1011") #AFD1011 | @as("AFD_1010") #AFD1010 | @as("AFD_1001") #AFD1001 | @as("AFD_1000") #AFD1000 | @as("AFD_0100") #AFD0100 | @as("AFD_0011") #AFD0011 | @as("AFD_0010") #AFD0010 | @as("AFD_0000") #AFD0000]
type fecOutputIncludeFec = [@as("COLUMN_AND_ROW") #COLUMNANDROW | @as("COLUMN") #COLUMN]
...
type eac3SurroundMode = [@as("NOT_INDICATED") #NOTINDICATED | @as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type eac3SurroundExMode = [@as("NOT_INDICATED") #NOTINDICATED | @as("ENABLED") #ENABLED | @as("DISABLED") #DISABLED]
type eac3StereoDownmix = [@as("NOT_INDICATED") #NOTINDICATED | @as("LT_RT") #LTRT | @as("LO_RO") #LORO | @as("DPL2") #DPL2]
type eac3PhaseControl = [@as("SHIFT_90_DEGREES") #SHIFT90DEGREES | @as("NO_SHIFT") #NOSHIFT]
type eac3PassthroughControl = [@as("WHEN_POSSIBLE") #WHENPOSSIBLE | @as("NO_PASSTHROUGH") #NOPASSTHROUGH]
...
type eac3DrcRf = [@as("SPEECH") #SPEECH | @as("NONE") #NONE | @as("MUSIC_STANDARD") #MUSICSTANDARD | @as("MUSIC_LIGHT") #MUSICLIGHT | @as("FILM_STANDARD") #FILMSTANDARD | @as("FILM_LIGHT") #FILMLIGHT]
type eac3DrcLine = [@as("SPEECH") #SPEECH | @as("NONE") #NONE | @as("MUSIC_STANDARD") #MUSICSTANDARD | @as("MUSIC_LIGHT") #MUSICLIGHT | @as("FILM_STANDARD") #FILMSTANDARD | @as("FILM_LIGHT") #FILMLIGHT]
...
type eac3BitstreamMode = [@as("VISUALLY_IMPAIRED") #VISUALLYIMPAIRED | @as("HEARING_IMPAIRED") #HEARINGIMPAIRED | @as("EMERGENCY") #EMERGENCY | @as("COMPLETE_MAIN") #COMPLETEMAIN | @as("COMMENTARY") #COMMENTARY]
...
type dvbSdtOutputSdt = [@as("SDT_NONE") #SDTNONE | @as("SDT_MANUAL") #SDTMANUAL | @as("SDT_FOLLOW_IF_PRESENT") #SDTFOLLOWIFPRESENT | @as("SDT_FOLLOW") #SDTFOLLOW]
type deviceUpdateStatus = [@as("NOT_UP_TO_DATE") #NOTUPTODATE | @as("UP_TO_DATE") #UPTODATE]
type deviceSettingsSyncState = [@as("SYNCING") #SYNCING | @as("SYNCED") #SYNCED]
type contentType = [@as("image/jpeg") #ImageJpeg]
type colorSpacePassthroughSettings = unit
type channelState = [@as("UPDATE_FAILED") #UPDATEFAILED | @as("UPDATING") #UPDATING | @as("DELETED") #DELETED | @as("DELETING") #DELETING | @as("STOPPING") #STOPPING | @as("RECOVERING") #RECOVERING | @as("RUNNING") #RUNNING | @as("STARTING") #STARTING | @as("IDLE") #IDLE | @as("CREATE_FAILED") #CREATEFAILED | @as("CREATING") #CREATING]
type channelClass = [@as("SINGLE_PIPELINE") #SINGLEPIPELINE | @as("STANDARD") #STANDARD]
...
type audioType = [@as("VISUAL_IMPAIRED_COMMENTARY") #VISUALIMPAIREDCOMMENTARY | @as("UNDEFINED") #UNDEFINED | @as("HEARING_IMPAIRED") #HEARINGIMPAIRED | @as("CLEAN_EFFECTS") #CLEANEFFECTS]
type audioOnlyHlsTrackType = [@as("AUDIO_ONLY_VARIANT_STREAM") #AUDIOONLYVARIANTSTREAM | @as("ALTERNATE_AUDIO_NOT_AUTO_SELECT") #ALTERNATEAUDIONOTAUTOSELECT | @as("ALTERNATE_AUDIO_AUTO_SELECT_DEFAULT") #ALTERNATEAUDIOAUTOSELECTDEFAULT | @as("ALTERNATE_AUDIO_AUTO_SELECT") #ALTERNATEAUDIOAUTOSELECT]
type audioOnlyHlsSegmentType = [@as("FMP4") #FMP4 | @as("AAC") #AAC]
type audioNormalizationAlgorithmControl = [@as("CORRECT_AUDIO") #CORRECTAUDIO]
type audioNormalizationAlgorithm = [@as("ITU_1770_2") #ITU17702 | @as("ITU_1770_1") #ITU17701]
type audioLanguageSelectionPolicy = [@as("STRICT") #STRICT | @as("LOOSE") #LOOSE]
type audioDescriptionLanguageCodeControl = [@as("USE_CONFIGURED") #USECONFIGURED | @as("FOLLOW_INPUT") #FOLLOWINPUT]
type audioDescriptionAudioTypeControl = [@as("USE_CONFIGURED") #USECONFIGURED | @as("FOLLOW_INPUT") #FOLLOWINPUT]
type aribSourceSettings = unit
type aribDestinationSettings = unit
type afdSignaling = [@as("NONE") #NONE | @as("FIXED") #FIXED | @as("AUTO") #AUTO]
type acceptHeader = [@as("image/jpeg") #ImageJpeg]
...
type ac3DrcProfile = [@as("NONE") #NONE | @as("FILM_STANDARD") #FILMSTANDARD]
...
type ac3BitstreamMode = [@as("VOICE_OVER") #VOICEOVER | @as("VISUALLY_IMPAIRED") #VISUALLYIMPAIRED | @as("MUSIC_AND_EFFECTS") #MUSICANDEFFECTS | @as("HEARING_IMPAIRED") #HEARINGIMPAIRED | @as("EMERGENCY") #EMERGENCY | @as("DIALOGUE") #DIALOGUE | @as("COMPLETE_MAIN") #COMPLETEMAIN | @as("COMMENTARY") #COMMENTARY]
type aacVbrQuality = [@as("MEDIUM_LOW") #MEDIUMLOW | @as("MEDIUM_HIGH") #MEDIUMHIGH | @as("LOW") #LOW | @as("HIGH") #HIGH]
...
type aacInputType = [@as("NORMAL") #NORMAL | @as("BROADCASTER_MIXED_AD") #BROADCASTERMIXEDAD]
...
@as("ProgramId") programId: option<__integerMin0Max65536>
}
...
@as("WebDeliveryAllowedFlag") webDeliveryAllowedFlag: option<scte35AposWebDeliveryAllowedBehavior>,
@as("NoRegionalBlackoutFlag") noRegionalBlackoutFlag: option<scte35AposNoRegionalBlackoutBehavior>,
...
@as("WebDeliveryAllowedFlag") webDeliveryAllowedFlag: option<scte35SpliceInsertWebDeliveryAllowedBehavior>,
@as("NoRegionalBlackoutFlag") noRegionalBlackoutFlag: option<scte35SpliceInsertNoRegionalBlackoutBehavior>,
@as("AdAvailOffset") adAvailOffset: option<__integerMinNegative1000Max1000>
}
...
@as("Pid") pid: option<__integerMin1>
}
...
@as("PipelineId") pipelineId: pipelineId
}
type pipelineDetail = {
...
@as("DestinationRefId") destinationRefId: option<__string>
}
...
@as("TransportStreamReservedBitrate") transportStreamReservedBitrate: option<__integerMin0Max100000000>,
...
@as("MaximumVideoBufferDelayMilliseconds") maximumVideoBufferDelayMilliseconds: option<__integerMin800Max3000>
}
...
@as("ChannelId") channelId: option<__stringMin1>
}
...
type hlsS3Settings = {
@as("CannedAcl") cannedAcl: option<s3CannedAcl>
}
...
@as("ColorSpacePassthroughSettings") colorSpacePassthroughSettings: option<colorSpacePassthroughSettings>
}
...
@as("InputPrepareScheduleActions") inputPrepareScheduleActions: option<featureActivationsInputPrepareScheduleActions>
}
...
type dvbTdtSettings = {
@as("RepInterval") repInterval: option<__integerMin1000Max30000>
}
...
@as("Resolution") resolution: option<cdiInputResolution>
}
...
@as("ImmediateModeScheduleActionStartSettings") immediateModeScheduleActionStartSettings: option<immediateModeScheduleActionStartSettings>,
@as("FollowModeScheduleActionStartSettings") followModeScheduleActionStartSettings: option<followModeScheduleActionStartSettings>,
@as("FixedModeScheduleActionStartSettings") fixedModeScheduleActionStartSettings: option<fixedModeScheduleActionStartSettings>
}
...
@as("MediaConnectSettings") mediaConnectSettings: option<multiplexMediaConnectOutputDestinationSettings>
}
...
@as("AudioOnlyTimecodeControl") audioOnlyTimecodeControl: option<smoothGroupAudioOnlyTimecodeControl>,
...
@as("ActionNames") actionNames: __listOf__string
}
type availSettings = {
...
@as("ArchiveS3Settings") archiveS3Settings: option<archiveS3Settings>
}
...
@as("SegmentationDescriptorScte35DescriptorSettings") segmentationDescriptorScte35DescriptorSettings: scte35SegmentationDescriptor
}
...
@as("MediaPackageSettings") mediaPackageSettings: option<__listOfMediaPackageOutputDestinationSettings>,
@as("Id") id: option<__string>
}
...
@as("StaticKeySettings") staticKeySettings: option<staticKeySettings>
}
...
@as("AlternativeTransferFunction") alternativeTransferFunction: option<h265AlternativeTransferFunction>,
@as("AfdSignaling") afdSignaling: option<afdSignaling>,
...
@as("SupportLowFramerateInputs") supportLowFramerateInputs: option<globalConfigurationLowFramerateInputs>,
...
@as("Scte20PlusEmbeddedDestinationSettings") scte20PlusEmbeddedDestinationSettings: option<scte20PlusEmbeddedDestinationSettings>,
@as("RtmpCaptionInfoDestinationSettings") rtmpCaptionInfoDestinationSettings: option<rtmpCaptionInfoDestinationSettings>,
@as("EmbeddedPlusScte20DestinationSettings") embeddedPlusScte20DestinationSettings: option<embeddedPlusScte20DestinationSettings>,
...
@as("AvailSettings") availSettings: option<availSettings>
}
type audioTrackSelection = {
@as("Tracks") tracks: __listOfAudioTrack
}
...
@as("StaticImageDeactivateSettings") staticImageDeactivateSettings: option<staticImageDeactivateScheduleActionSettings>,
@as("StaticImageActivateSettings") staticImageActivateSettings: option<staticImageActivateScheduleActionSettings>,
@as("Scte35TimeSignalSettings") scte35TimeSignalSettings: option<scte35TimeSignalScheduleActionSettings>,
@as("Scte35SpliceInsertSettings") scte35SpliceInsertSettings: option<scte35SpliceInsertScheduleActionSettings>,
@as("Scte35ReturnToNetworkSettings") scte35ReturnToNetworkSettings: option<scte35ReturnToNetworkScheduleActionSettings>,
@as("PauseStateSettings") pauseStateSettings: option<pauseStateScheduleActionSettings>,
@as("MotionGraphicsImageDeactivateSettings") motionGraphicsImageDeactivateSettings: option<motionGraphicsDeactivateScheduleActionSettings>,
@as("MotionGraphicsImageActivateSettings") motionGraphicsImageActivateSettings: option<motionGraphicsActivateScheduleActionSettings>,
...
@as("HlsTimedMetadataSettings") hlsTimedMetadataSettings: option<hlsTimedMetadataScheduleActionSettings>,
@as("HlsId3SegmentTaggingSettings") hlsId3SegmentTaggingSettings: option<hlsId3SegmentTaggingScheduleActionSettings>
}
type inputSettings = {
...
@as("AutomaticInputFailoverSettings") automaticInputFailoverSettings: option<automaticInputFailoverSettings>
}
...
@as("MotionGraphicsConfiguration") motionGraphicsConfiguration: option<motionGraphicsConfiguration>,
...
@module("@aws-sdk/client-medialive") @new external createClient: unit => awsServiceClient = "MediaLiveClient";
...
@as("Name") name: option<__string>
  ...
  type response = {
@as("Reservation") reservation: option<reservation>
}
...
@as("MaxResults") maxResults: option<maxResults>
  ...
  type response = {
@as("NextToken") nextToken: option<__string>,
@as("InputDeviceTransfers") inputDeviceTransfers: option<__listOfTransferringInputDeviceSummary>
}
...
@as("InputSecurityGroupId") inputSecurityGroupId: __string
  ...
  type response = {
@as("SecurityGroup") securityGroup: option<inputSecurityGroup>
}
...
@as("MultiplexId") multiplexId: __string
  ...
  type response = {
@as("MultiplexProgram") multiplexProgram: option<multiplexProgram>
}
...
@as("MultiplexId") multiplexId: __string
  ...
  type response = {
@as("Multiplex") multiplex: option<multiplex>
}
