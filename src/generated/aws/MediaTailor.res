...
type httpConfiguration = {@as("BaseUrl") baseUrl: __string}
type hlsPlaylistSettings = {@as("ManifestWindowSeconds") manifestWindowSeconds: option<__integer>}
type hlsConfiguration = {@as("ManifestEndpointPrefix") manifestEndpointPrefix: option<__string>}
type defaultSegmentDeliveryConfiguration = {@as("BaseUrl") baseUrl: option<__string>}
...
type adMarkerPassthrough = {@as("Enabled") enabled: option<__boolean>}
type accessConfiguration = {@as("AccessType") accessType: option<accessType>}
...
type scheduleConfiguration = {@as("Transition") transition: transition}
