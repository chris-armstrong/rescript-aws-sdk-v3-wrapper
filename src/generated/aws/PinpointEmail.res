...
type eventType = [@as("RENDERING_FAILURE") #RENDERINGFAILURE | @as("CLICK") #CLICK | @as("OPEN") #OPEN | @as("DELIVERY") #DELIVERY | @as("COMPLAINT") #COMPLAINT | @as("BOUNCE") #BOUNCE | @as("REJECT") #REJECT | @as("SEND") #SEND]
...
@module("@aws-sdk/client-ses") @new external createClient: unit => awsServiceClient = "PinpointEmailClient";
