...
type targetType = [@as("TRACKED_CLUSTER") #TRACKEDCLUSTER | @as("RDS_SERVERLESS_ENDPOINT") #RDSSERVERLESSENDPOINT | @as("RDS_INSTANCE") #RDSINSTANCE]
type targetState = [@as("UNAVAILABLE") #UNAVAILABLE | @as("AVAILABLE") #AVAILABLE | @as("REGISTERING") #REGISTERING]
type targetRole = [@as("UNKNOWN") #UNKNOWN | @as("READ_ONLY") #READONLY | @as("READ_WRITE") #READWRITE]
type targetHealthReason = [@as("INVALID_REPLICATION_STATE") #INVALIDREPLICATIONSTATE | @as("PENDING_PROXY_CAPACITY") #PENDINGPROXYCAPACITY | @as("AUTH_FAILURE") #AUTHFAILURE | @as("CONNECTION_FAILED") #CONNECTIONFAILED | @as("UNREACHABLE") #UNREACHABLE]
...
type replicaMode = [@as("mounted") #Mounted | @as("open-read-only") #OpenReadOnly]
type maxRecords = int
...
type failoverStatus = [@as("cancelling") #Cancelling | @as("failing-over") #FailingOver | @as("pending") #Pending]
type exceptionMessage = string
type engineFamily = [@as("POSTGRESQL") #POSTGRESQL | @as("MYSQL") #MYSQL]
type doubleOptional = float
type double = float
type dbproxyStatus = [@as("reactivating") #Reactivating | @as("suspending") #Suspending | @as("suspended") #Suspended | @as("deleting") #Deleting | @as("creating") #Creating | @as("insufficient-resource-limits") #InsufficientResourceLimits | @as("incompatible-network") #IncompatibleNetwork | @as("modifying") #Modifying | @as("available") #Available]
type dbproxyName = string
type dbproxyEndpointTargetRole = [@as("READ_ONLY") #READONLY | @as("READ_WRITE") #READWRITE]
type dbproxyEndpointStatus = [@as("deleting") #Deleting | @as("creating") #Creating | @as("insufficient-resource-limits") #InsufficientResourceLimits | @as("incompatible-network") #IncompatibleNetwork | @as("modifying") #Modifying | @as("available") #Available]
...
type timezone = {
@as("TimezoneName") timezoneName: option<string_>
}
type targetHealth = {
@as("Description") description: option<string_>,
...
type sourceRegion = {
@as("SupportsDBInstanceAutomatedBackupsReplication") supportsDBInstanceAutomatedBackupsReplication: option<boolean_>,
@as("Status") status: option<string_>,
...
@as("SupportedEngineModes") supportedEngineModes: option<engineModeList>,
@as("AvailableProcessorFeatures") availableProcessorFeatures: option<availableProcessorFeatureList>,
...
@as("MinimumEngineVersionPerAllowedValue") minimumEngineVersionPerAllowedValue: option<minimumEngineVersionPerAllowedValueList>,
...
type option = {
@as("VpcSecurityGroupMemberships") vpcSecurityGroupMemberships: option<vpcSecurityGroupMembershipList>,
@as("DBSecurityGroupMemberships") dbsecurityGroupMemberships: option<dbsecurityGroupMembershipList>,
...
@as("DBInstanceAutomatedBackupsReplications") dbinstanceAutomatedBackupsReplications: option<dbinstanceAutomatedBackupsReplicationList>,
@as("DBInstanceAutomatedBackupsArn") dbinstanceAutomatedBackupsArn: option<string_>,
@as("BackupRetentionPeriod") backupRetentionPeriod: option<integerOptional>,
@as("IAMDatabaseAuthenticationEnabled") iamdatabaseAuthenticationEnabled: option<boolean_>,
@as("Timezone") timezone: option<string_>,
...
@as("SupportedNcharCharacterSets") supportedNcharCharacterSets: option<supportedCharacterSetsList>,
...
@as("DBClusterOptionGroupMemberships") dbclusterOptionGroupMemberships: option<dbclusterOptionGroupMemberships>,
@as("MasterUsername") masterUsername: option<string_>,
@as("Port") port: option<integerOptional>,
...
@as("RequiresAutoMinorEngineVersionUpgrade") requiresAutoMinorEngineVersionUpgrade: option<boolean_>,
@as("Permanent") permanent: option<boolean_>,
@as("Persistent") persistent: option<boolean_>,
...
@as("VpcId") vpcId: option<string_>,
@as("AllowsVpcAndNonVpcInstanceMemberships") allowsVpcAndNonVpcInstanceMemberships: option<boolean_>,
...
@as("ProcessorFeatures") processorFeatures: option<processorFeatureList>,
@as("EnabledCloudwatchLogsExports") enabledCloudwatchLogsExports: option<logTypeList>,
@as("PerformanceInsightsRetentionPeriod") performanceInsightsRetentionPeriod: option<integerOptional>,
...
@as("ReadReplicaDBClusterIdentifiers") readReplicaDBClusterIdentifiers: option<readReplicaDBClusterIdentifierList>,
@as("ReadReplicaDBInstanceIdentifiers") readReplicaDBInstanceIdentifiers: option<readReplicaDBInstanceIdentifierList>,
@as("ReadReplicaSourceDBInstanceIdentifier") readReplicaSourceDBInstanceIdentifier: option<string_>,
...
module BacktrackDBCluster = {
  type t;
  type request = {
@as("UseEarliestTimeOnPointInTimeUnavailable") useEarliestTimeOnPointInTimeUnavailable: option<booleanOptional>,
...
module DeleteInstallationMedia = {
  type t;
  type request = {
@as("InstallationMediaId") installationMediaId: string_
}
  type response = installationMedia;
...
@as("DBProxyEndpointName") dbproxyEndpointName: dbproxyEndpointName
  ...
  type response = {
@as("DBProxyEndpoint") dbproxyEndpoint: option<dbproxyEndpoint>
}
...
@as("DBParameterGroupName") dbparameterGroupName: string_
  ...
  type response = {
@as("DBParameterGroup") dbparameterGroup: option<dbparameterGroup>
}
...
@as("DBSecurityGroupName") dbsecurityGroupName: string_
  ...
  type response = {
@as("DBSecurityGroup") dbsecurityGroup: option<dbsecurityGroup>
}
...
@as("DBProxyName") dbproxyName: string_
  ...
  type response = {
@as("DBProxyTargets") dbproxyTargets: option<targetList>
}
...
@as("ReservedDBInstancesOfferingId") reservedDBInstancesOfferingId: string_
  ...
  type response = {
@as("ReservedDBInstance") reservedDBInstance: option<reservedDBInstance>
}
...
@as("DBSnapshotIdentifier") dbsnapshotIdentifier: string_
  ...
  type response = {
@as("DBSnapshot") dbsnapshot: option<dbsnapshot>
}
...
@as("TargetGroupName") targetGroupName: string_
  ...
  type response = {
@as("DBProxyTargetGroup") dbproxyTargetGroup: option<dbproxyTargetGroup>
}
...
@as("DBProxyName") dbproxyName: string_
  ...
  type response = {
@as("DBProxy") dbproxy: option<dbproxy>
}
...
@as("GlobalClusterIdentifier") globalClusterIdentifier: option<string_>
  ...
  type response = {
@as("GlobalCluster") globalCluster: option<globalCluster>
}
...
@as("DBSnapshotIdentifier") dbsnapshotIdentifier: string_
  ...
  type response = {
@as("DBSnapshotAttributesResult") dbsnapshotAttributesResult: option<dbsnapshotAttributesResult>
}
...
@as("ReservedDBInstancesOfferingId") reservedDBInstancesOfferingId: option<string_>
  ...
  type response = {
@as("ReservedDBInstancesOfferings") reservedDBInstancesOfferings: option<reservedDBInstancesOfferingList>,
@as("Marker") marker: option<string_>
}
...
@as("DbiResourceId") dbiResourceId: option<string_>
  ...
  type response = {
@as("DBInstanceAutomatedBackups") dbinstanceAutomatedBackups: option<dbinstanceAutomatedBackupList>,
@as("Marker") marker: option<string_>
}
...
module DeleteGlobalCluster = {
  type t;
  type request = {
@as("GlobalClusterIdentifier") globalClusterIdentifier: string_
}
  type response = {
@as("GlobalCluster") globalCluster: option<globalCluster>
}
...
@as("OptionGroupName") optionGroupName: string_
  ...
  type response = {
@as("OptionGroup") optionGroup: option<optionGroup>
}
...
@as("DBInstanceIdentifier") dbinstanceIdentifier: string_
  ...
  type response = {
@as("ValidDBInstanceModificationsMessage") validDBInstanceModificationsMessage: option<validDBInstanceModificationsMessage>
}
