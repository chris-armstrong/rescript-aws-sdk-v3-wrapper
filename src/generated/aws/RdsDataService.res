...
@module("@aws-sdk/client-rds-data") @new external createClient: unit => awsServiceClient = "RdsDataServiceClient";
type baseString = string
type baseBoolean = bool
type baseInteger = int
type baseTimestamp = Js.Date.t;
type baseLong = float
type typeHint = [@as("DECIMAL") #DECIMAL | @as("TIME") #TIME | @as("DATE") #DATE | @as("TIMESTAMP") #TIMESTAMP | @as("UUID") #UUID | @as("JSON") #JSON]
...
attributes: option<arrayValueList>
} and arrayValueList = array<value> and arrayValue = {
...
transactionStatus: option<transactionStatus>
  ...
  @module("@aws-sdk/client-rds-data") @new external new_: (request) => t = "RollbackTransactionCommand";
...
updateResults: option<updateResults>
  ...
  @module("@aws-sdk/client-rds-data") @new external new_: (request) => t = "BatchExecuteStatementCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
