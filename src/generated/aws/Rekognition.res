...
type parent = {@as("Name") name: option<string_>}
type outputConfig = {
...
type kinesisVideoStream = {@as("Arn") arn: option<kinesisVideoArn>}
type kinesisDataStream = {@as("Arn") arn: option<kinesisDataArn>}
type imageQuality = {
...
type video = {@as("S3Object") s3Object: option<s3Object>}
type summary = {@as("S3Object") s3Object: option<s3Object>}
type streamProcessorSettings = {@as("FaceSearch") faceSearch: option<faceSearchSettings>}
type streamProcessorOutput = {@as("KinesisDataStream") kinesisDataStream: option<kinesisDataStream>}
...
type regionOfInterest = {@as("BoundingBox") boundingBox: option<boundingBox>}
...
type validationData = {@as("Assets") assets: option<assets>}
type unindexedFaces = array<unindexedFace>
type trainingData = {@as("Assets") assets: option<assets>}
...
module GetCelebrityInfo = {
  type t
  type request = {@as("Id") id: rekognitionUniqueId}
  type response = {
    @as("Name") name: option<string_>,
    @as("Urls") urls: option<urls>,
  }
...
module RecognizeCelebrities = {
  type t
  type request = {@as("Image") image: image}
  type response = {
    @as("OrientationCorrection") orientationCorrection: option<orientationCorrection>,
