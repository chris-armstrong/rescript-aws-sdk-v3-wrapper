...
type event = [@as("s3:Replication:OperationReplicatedAfterThreshold") #S3_Replication_OperationReplicatedAfterThreshold | @as("s3:Replication:OperationMissedThreshold") #S3_Replication_OperationMissedThreshold | @as("s3:Replication:OperationNotTracked") #S3_Replication_OperationNotTracked | @as("s3:Replication:OperationFailedReplication") #S3_Replication_OperationFailedReplication | @as("s3:Replication:*") #S3_Replication_Star | @as("s3:ObjectRestore:Completed") #S3_ObjectRestore_Completed | @as("s3:ObjectRestore:Post") #S3_ObjectRestore_Post | @as("s3:ObjectRestore:*") #S3_ObjectRestore_Star | @as("s3:ObjectRemoved:DeleteMarkerCreated") #S3_ObjectRemoved_DeleteMarkerCreated | @as("s3:ObjectRemoved:Delete") #S3_ObjectRemoved_Delete | @as("s3:ObjectRemoved:*") #S3_ObjectRemoved_Star | @as("s3:ObjectCreated:CompleteMultipartUpload") #S3_ObjectCreated_CompleteMultipartUpload | @as("s3:ObjectCreated:Copy") #S3_ObjectCreated_Copy | @as("s3:ObjectCreated:Post") #S3_ObjectCreated_Post | @as("s3:ObjectCreated:Put") #S3_ObjectCreated_Put | @as("s3:ObjectCreated:*") #S3_ObjectCreated_Star | @as("s3:ReducedRedundancyLostObject") #S3_ReducedRedundancyLostObject]
