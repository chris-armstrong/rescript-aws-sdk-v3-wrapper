...
type stepExecutionFilterKey = [@as("Action") #Action | @as("StepName") #StepName | @as("StepExecutionId") #StepExecutionId | @as("StepExecutionStatus") #StepExecutionStatus | @as("StartTimeAfter") #StartTimeAfter | @as("StartTimeBefore") #StartTimeBefore]
...
type signalType = [@as("Resume") #Resume | @as("StopStep") #StopStep | @as("StartStep") #StartStep | @as("Reject") #Reject | @as("Approve") #Approve]
type sharedDocumentVersion = string
type sessionTarget = string
type sessionStatus = [@as("Failed") #Failed | @as("Terminating") #Terminating | @as("Terminated") #Terminated | @as("Disconnected") #Disconnected | @as("Connecting") #Connecting | @as("Connected") #Connected]
...
type sessionFilterKey = [@as("SessionId") #SessionId | @as("Status") #Status | @as("Owner") #Owner | @as("Target") #Target | @as("InvokedBefore") #InvokedBefore | @as("InvokedAfter") #InvokedAfter]
...
type reviewStatus = [@as("REJECTED") #REJECTED | @as("PENDING") #PENDING | @as("NOT_REVIEWED") #NOT_REVIEWED | @as("APPROVED") #APPROVED]
type responseCode = int
type resourceTypeForTagging = [@as("OpsMetadata") #OpsMetadata | @as("OpsItem") #OpsItem | @as("PatchBaseline") #PatchBaseline | @as("Parameter") #Parameter | @as("MaintenanceWindow") #MaintenanceWindow | @as("ManagedInstance") #ManagedInstance | @as("Document") #Document]
type resourceType = [@as("EC2Instance") #EC2Instance | @as("Document") #Document | @as("ManagedInstance") #ManagedInstance]
...
type pingStatus = [@as("Inactive") #Inactive | @as("ConnectionLost") #ConnectionLost | @as("Online") #Online]
...
type patchProperty = [@as("SEVERITY") #SEVERITY | @as("PRIORITY") #PRIORITY | @as("MSRC_SEVERITY") #MSRC_SEVERITY | @as("CLASSIFICATION") #CLASSIFICATION | @as("PRODUCT_FAMILY") #PRODUCT_FAMILY | @as("PRODUCT") #PRODUCT]
...
type patchFilterKey = [@as("VERSION") #VERSION | @as("SECURITY") #SECURITY | @as("SEVERITY") #SEVERITY | @as("RELEASE") #RELEASE | @as("REPOSITORY") #REPOSITORY | @as("PRIORITY") #PRIORITY | @as("SECTION") #SECTION | @as("PATCH_ID") #PATCH_ID | @as("NAME") #NAME | @as("MSRC_SEVERITY") #MSRC_SEVERITY | @as("EPOCH") #EPOCH | @as("CVE_ID") #CVE_ID | @as("CLASSIFICATION") #CLASSIFICATION | @as("PRODUCT_FAMILY") #PRODUCT_FAMILY | @as("PRODUCT") #PRODUCT | @as("PATCH_SET") #PATCH_SET | @as("BUGZILLA_ID") #BUGZILLA_ID | @as("ADVISORY_ID") #ADVISORY_ID | @as("ARCH") #ARCH]
type patchFailedCount = int
type patchEpoch = int
type patchDescription = string
type patchDeploymentStatus = [@as("EXPLICIT_REJECTED") #EXPLICIT_REJECTED | @as("EXPLICIT_APPROVED") #EXPLICIT_APPROVED | @as("PENDING_APPROVAL") #PENDING_APPROVAL | @as("APPROVED") #APPROVED]
type patchCriticalNonCompliantCount = int
type patchContentUrl = string
type patchComplianceMaxResults = int
type patchComplianceLevel = [@as("UNSPECIFIED") #UNSPECIFIED | @as("INFORMATIONAL") #INFORMATIONAL | @as("LOW") #LOW | @as("MEDIUM") #MEDIUM | @as("HIGH") #HIGH | @as("CRITICAL") #CRITICAL]
type patchComplianceDataState = [@as("FAILED") #FAILED | @as("NOT_APPLICABLE") #NOT_APPLICABLE | @as("MISSING") #MISSING | @as("INSTALLED_REJECTED") #INSTALLED_REJECTED | @as("INSTALLED_PENDING_REBOOT") #INSTALLED_PENDING_REBOOT | @as("INSTALLED_OTHER") #INSTALLED_OTHER | @as("INSTALLED") #INSTALLED]
...
type parameterType = [@as("SecureString") #SecureString | @as("StringList") #StringList | @as("String") #String]
type parameterTier = [@as("Intelligent-Tiering") #Intelligent_Tiering | @as("Advanced") #Advanced | @as("Standard") #Standard]
...
type opsItemStatus = [@as("Rejected") #Rejected | @as("Approved") #Approved | @as("PendingApproval") #PendingApproval | @as("ChangeCalendarOverrideRejected") #ChangeCalendarOverrideRejected | @as("ChangeCalendarOverrideApproved") #ChangeCalendarOverrideApproved | @as("PendingChangeCalendarOverride") #PendingChangeCalendarOverride | @as("RunbookInProgress") #RunbookInProgress | @as("Scheduled") #Scheduled | @as("CompletedWithFailure") #CompletedWithFailure | @as("CompletedWithSuccess") #CompletedWithSuccess | @as("Failed") #Failed | @as("Cancelled") #Cancelled | @as("Cancelling") #Cancelling | @as("TimedOut") #TimedOut | @as("Pending") #Pending | @as("Resolved") #Resolved | @as("InProgress") #InProgress | @as("Open") #Open]
...
type opsItemRelatedItemsFilterKey = [@as("ResourceUri") #ResourceUri | @as("AssociationId") #AssociationId | @as("ResourceType") #ResourceType]
...
type opsItemFilterOperator = [@as("LessThan") #LessThan | @as("GreaterThan") #GreaterThan | @as("Contains") #Contains | @as("Equal") #Equal]
type opsItemFilterKey = [@as("ChangeRequestByTargetsResourceGroup") #ChangeRequestByTargetsResourceGroup | @as("ChangeRequestByTemplate") #ChangeRequestByTemplate | @as("ChangeRequestByApproverName") #ChangeRequestByApproverName | @as("ChangeRequestByApproverArn") #ChangeRequestByApproverArn | @as("ChangeRequestByRequesterName") #ChangeRequestByRequesterName | @as("ChangeRequestByRequesterArn") #ChangeRequestByRequesterArn | @as("OpsItemType") #OpsItemType | @as("Severity") #Severity | @as("Category") #Category | @as("AutomationId") #AutomationId | @as("ResourceId") #ResourceId | @as("OperationalDataValue") #OperationalDataValue | @as("OperationalDataKey") #OperationalDataKey | @as("OperationalData") #OperationalData | @as("PlannedEndTime") #PlannedEndTime | @as("PlannedStartTime") #PlannedStartTime | @as("ActualEndTime") #ActualEndTime | @as("ActualStartTime") #ActualStartTime | @as("LastModifiedTime") #LastModifiedTime | @as("CreatedTime") #CreatedTime | @as("OpsItemId") #OpsItemId | @as("Title") #Title | @as("Priority") #Priority | @as("Source") #Source | @as("CreatedBy") #CreatedBy | @as("Status") #Status]
...
type opsFilterOperatorType = [@as("Exists") #Exists | @as("GreaterThan") #GreaterThan | @as("LessThan") #LessThan | @as("BeginWith") #BeginWith | @as("NotEqual") #NotEqual | @as("Equal") #Equal]
...
type operatingSystem = [@as("MACOS") #MACOS | @as("DEBIAN") #DEBIAN | @as("ORACLE_LINUX") #ORACLE_LINUX | @as("CENTOS") #CENTOS | @as("SUSE") #SUSE | @as("REDHAT_ENTERPRISE_LINUX") #REDHAT_ENTERPRISE_LINUX | @as("UBUNTU") #UBUNTU | @as("AMAZON_LINUX_2") #AMAZON_LINUX_2 | @as("AMAZON_LINUX") #AMAZON_LINUX | @as("WINDOWS") #WINDOWS]
type notificationType = [@as("Invocation") #Invocation | @as("Command") #Command]
type notificationEvent = [@as("Failed") #Failed | @as("Cancelled") #Cancelled | @as("TimedOut") #TimedOut | @as("Success") #Success | @as("InProgress") #InProgress | @as("All") #All]
...
type maintenanceWindowTaskType = [@as("LAMBDA") #LAMBDA | @as("STEP_FUNCTIONS") #STEP_FUNCTIONS | @as("AUTOMATION") #AUTOMATION | @as("RUN_COMMAND") #RUN_COMMAND]
...
type maintenanceWindowResourceType = [@as("RESOURCE_GROUP") #RESOURCE_GROUP | @as("INSTANCE") #INSTANCE]
...
type maintenanceWindowExecutionStatus = [@as("SKIPPED_OVERLAPPING") #SKIPPED_OVERLAPPING | @as("CANCELLED") #CANCELLED | @as("CANCELLING") #CANCELLING | @as("TIMED_OUT") #TIMED_OUT | @as("FAILED") #FAILED | @as("SUCCESS") #SUCCESS | @as("IN_PROGRESS") #IN_PROGRESS | @as("PENDING") #PENDING]
...
type lastResourceDataSyncStatus = [@as("InProgress") #InProgress | @as("Failed") #Failed | @as("Successful") #Successful]
...
type inventorySchemaDeleteOption = [@as("DeleteSchema") #DeleteSchema | @as("DisableSchema") #DisableSchema]
type inventoryResultItemKey = string
type inventoryResultEntityId = string
type inventoryQueryOperatorType = [@as("Exists") #Exists | @as("GreaterThan") #GreaterThan | @as("LessThan") #LessThan | @as("BeginWith") #BeginWith | @as("NotEqual") #NotEqual | @as("Equal") #Equal]
...
type instancePatchStateOperatorType = [@as("GreaterThan") #GreaterThan | @as("LessThan") #LessThan | @as("NotEqual") #NotEqual | @as("Equal") #Equal]
...
type instanceInformationFilterKey = [@as("AssociationStatus") #AssociationStatus | @as("ResourceType") #ResourceType | @as("IamRole") #IamRole | @as("ActivationIds") #ActivationIds | @as("PlatformTypes") #PlatformTypes | @as("PingStatus") #PingStatus | @as("AgentVersion") #AgentVersion | @as("InstanceIds") #InstanceIds]
...
type documentType = [@as("ProblemAnalysisTemplate") #ProblemAnalysisTemplate | @as("ProblemAnalysis") #ProblemAnalysis | @as("Automation.ChangeTemplate") #Automation_ChangeTemplate | @as("ChangeCalendar") #ChangeCalendar | @as("DeploymentStrategy") #DeploymentStrategy | @as("ApplicationConfigurationSchema") #ApplicationConfigurationSchema | @as("ApplicationConfiguration") #ApplicationConfiguration | @as("Package") #Package | @as("Session") #Session | @as("Automation") #Automation | @as("Policy") #Policy | @as("Command") #Command]
type documentStatusInformation = string
type documentStatus = [@as("Failed") #Failed | @as("Deleting") #Deleting | @as("Updating") #Updating | @as("Active") #Active | @as("Creating") #Creating]
...
type documentReviewAction = [@as("Reject") #Reject | @as("Approve") #Approve | @as("UpdateReview") #UpdateReview | @as("SendForReview") #SendForReview]
...
type documentFilterKey = [@as("DocumentType") #DocumentType | @as("PlatformTypes") #PlatformTypes | @as("Owner") #Owner | @as("Name") #Name]
type documentDisplayName = string
type documentContent = string
type documentAuthor = string
type documentARN = string
type descriptionInDocument = string
type describeActivationsFilterKeys = [@as("IamRole") #IamRole | @as("DefaultInstanceName") #DefaultInstanceName | @as("ActivationIds") #ActivationIds]
...
type complianceSeverity = [@as("UNSPECIFIED") #UNSPECIFIED | @as("INFORMATIONAL") #INFORMATIONAL | @as("LOW") #LOW | @as("MEDIUM") #MEDIUM | @as("HIGH") #HIGH | @as("CRITICAL") #CRITICAL]
type complianceResourceType = string
type complianceResourceId = string
type complianceQueryOperatorType = [@as("GREATER_THAN") #GREATER_THAN | @as("LESS_THAN") #LESS_THAN | @as("BEGIN_WITH") #BEGIN_WITH | @as("NOT_EQUAL") #NOT_EQUAL | @as("EQUAL") #EQUAL]
...
type comment = string
type commandStatus = [@as("Cancelling") #Cancelling | @as("TimedOut") #TimedOut | @as("Failed") #Failed | @as("Cancelled") #Cancelled | @as("Success") #Success | @as("InProgress") #InProgress | @as("Pending") #Pending]
type commandPluginStatus = [@as("Failed") #Failed | @as("Cancelled") #Cancelled | @as("TimedOut") #TimedOut | @as("Success") #Success | @as("InProgress") #InProgress | @as("Pending") #Pending]
type commandPluginOutput = string
type commandPluginName = string
type commandMaxResults = int
type commandInvocationStatus = [@as("Cancelling") #Cancelling | @as("Failed") #Failed | @as("TimedOut") #TimedOut | @as("Cancelled") #Cancelled | @as("Success") #Success | @as("Delayed") #Delayed | @as("InProgress") #InProgress | @as("Pending") #Pending]
type commandId = string
type commandFilterValue = string
type commandFilterKey = [@as("DocumentName") #DocumentName | @as("ExecutionStage") #ExecutionStage | @as("Status") #Status | @as("InvokedBefore") #InvokedBefore | @as("InvokedAfter") #InvokedAfter]
...
type automationExecutionStatus = [@as("CompletedWithFailure") #CompletedWithFailure | @as("CompletedWithSuccess") #CompletedWithSuccess | @as("ChangeCalendarOverrideRejected") #ChangeCalendarOverrideRejected | @as("ChangeCalendarOverrideApproved") #ChangeCalendarOverrideApproved | @as("PendingChangeCalendarOverride") #PendingChangeCalendarOverride | @as("RunbookInProgress") #RunbookInProgress | @as("Scheduled") #Scheduled | @as("Rejected") #Rejected | @as("Approved") #Approved | @as("PendingApproval") #PendingApproval | @as("Failed") #Failed | @as("Cancelled") #Cancelled | @as("Cancelling") #Cancelling | @as("TimedOut") #TimedOut | @as("Success") #Success | @as("Waiting") #Waiting | @as("InProgress") #InProgress | @as("Pending") #Pending]
type automationExecutionId = string
type automationExecutionFilterValue = string
type automationExecutionFilterKey = [@as("OpsItemId") #OpsItemId | @as("AutomationSubtype") #AutomationSubtype | @as("TargetResourceGroup") #TargetResourceGroup | @as("TagKey") #TagKey | @as("AutomationType") #AutomationType | @as("StartTimeAfter") #StartTimeAfter | @as("StartTimeBefore") #StartTimeBefore | @as("CurrentAction") #CurrentAction | @as("ParentExecutionId") #ParentExecutionId | @as("ExecutionId") #ExecutionId | @as("ExecutionStatus") #ExecutionStatus | @as("DocumentNamePrefix") #DocumentNamePrefix]
type automationActionName = string
type attributeValue = string
type attributeName = string
type attachmentsSourceValue = string
type attachmentsSourceKey = [@as("AttachmentReference") #AttachmentReference | @as("S3FileUrl") #S3FileUrl | @as("SourceUrl") #SourceUrl]
...
type associationStatusName = [@as("Failed") #Failed | @as("Success") #Success | @as("Pending") #Pending]
...
type associationFilterOperatorType = [@as("GREATER_THAN") #GREATER_THAN | @as("LESS_THAN") #LESS_THAN | @as("EQUAL") #EQUAL]
type associationFilterKey = [@as("ResourceGroupName") #ResourceGroupName | @as("AssociationName") #AssociationName | @as("LastExecutedAfter") #LastExecutedAfter | @as("LastExecutedBefore") #LastExecutedBefore | @as("AssociationStatusName") #AssociationStatusName | @as("AssociationId") #AssociationId | @as("Name") #Name | @as("InstanceId") #InstanceId]
type associationExecutionTargetsFilterValue = string
type associationExecutionTargetsFilterKey = [@as("ResourceType") #ResourceType | @as("ResourceId") #ResourceId | @as("Status") #Status]
type associationExecutionId = string
type associationExecutionFilterValue = string
type associationExecutionFilterKey = [@as("CreatedTime") #CreatedTime | @as("Status") #Status | @as("ExecutionId") #ExecutionId]
type associationComplianceSeverity = [@as("UNSPECIFIED") #UNSPECIFIED | @as("LOW") #LOW | @as("MEDIUM") #MEDIUM | @as("HIGH") #HIGH | @as("CRITICAL") #CRITICAL]
...
type s3OutputUrl = {
@as("OutputUrl") outputUrl: option<url>
}
...
@as("DestinationDataSharingType") destinationDataSharingType: option<resourceDataSyncDestinationDataSharingType>
}
type relatedOpsItem = {
@as("OpsItemId") opsItemId: string_
}
...
@as("TypeName") typeName: opsDataTypeName
}
...
type metadataValue = {
@as("Value") value: option<metadataValueString>
}
...
@as("OtherNonCompliantCount") otherNonCompliantCount: option<patchOtherNonCompliantCount>,
  @as("SecurityNonCompliantCount") securityNonCompliantCount: option<patchSecurityNonCompliantCount>,
  @as("CriticalNonCompliantCount") criticalNonCompliantCount: option<patchCriticalNonCompliantCount>,
  ...
  @as("UnreportedNotApplicableCount") unreportedNotApplicableCount: option<patchUnreportedNotApplicableCount>,
  ...
  @as("InstalledPendingRebootCount") installedPendingRebootCount: option<patchInstalledPendingRebootCount>,
...
@as("DestinationDataSharing") destinationDataSharing: option<resourceDataSyncDestinationDataSharing>,
...
@as("S3OutputUrl") s3OutputUrl: option<s3OutputUrl>
}
type instanceAssociationOutputLocation = {
@as("S3Location") s3Location: option<s3OutputLocation>
}
type instanceAssociationList = array<instanceAssociation>
type instanceAggregatedAssociationOverview = {
@as("InstanceAssociationStatusAggregatedCount") instanceAssociationStatusAggregatedCount: option<instanceAssociationStatusAggregatedCount>,
  @as("DetailedStatus") detailedStatus: option<statusName>
}
...
@as("AssociationStatusAggregatedCount") associationStatusAggregatedCount: option<associationStatusAggregatedCount>,
  @as("DetailedStatus") detailedStatus: option<statusName>,
  @as("Status") status: option<statusName>
}
...
@as("AssociationOverview") associationOverview: option<instanceAggregatedAssociationOverview>,
  @as("LastSuccessfulAssociationExecutionDate") lastSuccessfulAssociationExecutionDate: option<dateTime>,
...
@as("EnableAllOpsDataSources") enableAllOpsDataSources: option<resourceDataSyncEnableAllOpsDataSources>,
  ...
  @as("AwsOrganizationsSource") awsOrganizationsSource: option<resourceDataSyncAwsOrganizationsSource>,
...
@as("PatchFilters") patchFilters: patchFilterList
}
...
@as("TargetLocations") targetLocations: option<targetLocations>,
  ...
  @as("Targets") targets: option<targets>,
  @as("DocumentVersion") documentVersion: option<documentVersion>,
  @as("AutomationTargetParameterName") automationTargetParameterName: option<automationTargetParameterName>,
  @as("Parameters") parameters: option<parameters>,
  @as("InstanceId") instanceId: option<instanceId>,
  @as("Name") name: documentARN
}
...
type patchRuleGroup = {
@as("PatchRules") patchRules: patchRuleList
}
...
@as("Sources") sources: option<patchSourceList>,
  ...
  @as("ApprovedPatchesComplianceLevel") approvedPatchesComplianceLevel: option<patchComplianceLevel>,
...
type rec opsAggregatorList = array<opsAggregator> and opsAggregator = {
...
} and inventoryAggregatorList = array<inventoryAggregator> and inventoryAggregator = {
...
@as("IamRole") iamRole: iamRole,
  ...
  type response = unit
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "UpdateManagedInstanceRoleCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Replace") replace: option<boolean_>,
  @as("Enabled") enabled: option<maintenanceWindowEnabled>,
  @as("AllowUnassociatedTargets") allowUnassociatedTargets: option<maintenanceWindowAllowUnassociatedTargets>,
  @as("Cutoff") cutoff: option<maintenanceWindowCutoff>,
  @as("Duration") duration: option<maintenanceWindowDurationHours>,
  @as("ScheduleOffset") scheduleOffset: option<maintenanceWindowOffset>,
  @as("ScheduleTimezone") scheduleTimezone: option<maintenanceWindowTimezone>,
...
@as("PatchGroup") patchGroup: option<patchGroup>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "RegisterPatchBaselineForPatchGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("BaselineId") baselineId: option<baselineId>
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "RegisterDefaultPatchBaselineCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("OperatingSystem") operatingSystem: option<operatingSystem>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "GetPatchBaselineForPatchGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("WindowTargetId") windowTargetId: option<maintenanceWindowTaskTargetId>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "GetMaintenanceWindowExecutionTaskInvocationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("PatchGroup") patchGroup: patchGroup
  ...
  type response = {
@as("InstancesWithOtherNonCompliantPatches") instancesWithOtherNonCompliantPatches: option<instancesCount>,
  @as("InstancesWithSecurityNonCompliantPatches") instancesWithSecurityNonCompliantPatches: option<instancesCount>,
  @as("InstancesWithCriticalNonCompliantPatches") instancesWithCriticalNonCompliantPatches: option<instancesCount>,
  @as("InstancesWithUnreportedNotApplicablePatches") instancesWithUnreportedNotApplicablePatches: option<integer_>,
  ...
  @as("InstancesWithInstalledRejectedPatches") instancesWithInstalledRejectedPatches: option<instancesCount>,
  @as("InstancesWithInstalledPendingRebootPatches") instancesWithInstalledPendingRebootPatches: option<instancesCount>,
...
@as("WindowTaskId") windowTaskId: option<maintenanceWindowTaskId>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DeregisterTaskFromMaintenanceWindowCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("WindowTargetId") windowTargetId: option<maintenanceWindowTargetId>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DeregisterTargetFromMaintenanceWindowCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("PatchGroup") patchGroup: option<patchGroup>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DeregisterPatchBaselineForPatchGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("InstanceId") instanceId: managedInstanceId
  ...
  type response = unit
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DeregisterManagedInstanceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
module DeleteActivation = {
  type t;
  type request = {
@as("ActivationId") activationId: activationId
}
  type response = unit
...
@as("WindowExecutionId") windowExecutionId: option<maintenanceWindowExecutionId>
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "CancelMaintenanceWindowExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("DocumentVersion") documentVersion: documentVersionNumber,
  ...
  type response = {
@as("Description") description: option<documentDefaultVersionDescription>
}
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "UpdateDocumentDefaultVersionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("SettingId") settingId: serviceSettingId
  ...
  type response = {
@as("ServiceSetting") serviceSetting: option<serviceSetting>
}
...
@as("SharedDocumentVersion") sharedDocumentVersion: option<sharedDocumentVersion>,
  ...
  type response = unit
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "ModifyDocumentPermissionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("WithDecryption") withDecryption: option<boolean_>,
  ...
  type response = {
@as("Parameter") parameter: option<parameter>
}
...
@as("EndTime") endTime: option<dateTime>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "GetMaintenanceWindowExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("AssociationId") associationId: opsItemRelatedItemAssociationId,
  ...
  type response = unit
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DisassociateOpsItemRelatedItemCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("AssociationId") associationId: option<opsItemRelatedItemAssociationId>
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "AssociateOpsItemRelatedItemCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeInstancePatchStatesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeEffectiveInstanceAssociationsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeDocumentPermissionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeAssociationExecutionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Tags") tags: option<tagList_>,
  ...
  @as("AllowUnassociatedTargets") allowUnassociatedTargets: maintenanceWindowAllowUnassociatedTargets,
...
@as("Description") description: option<maintenanceWindowDescription>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "UpdateMaintenanceWindowTargetCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TargetType") targetType: option<targetType>,
  ...
  type response = {
@as("DocumentDescription") documentDescription: option<documentDescription>
}
...
@as("AutomationExecutionId") automationExecutionId: option<automationExecutionId>
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "StartAutomationExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("WindowTargetId") windowTargetId: option<maintenanceWindowTargetId>
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "RegisterTargetWithMaintenanceWindowCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("OpsItemId") opsItemId: opsItemId
  ...
  type response = {
@as("OpsItem") opsItem: option<opsItem>
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeMaintenanceWindowsForTargetCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeMaintenanceWindowsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("ScheduledWindowExecutions") scheduledWindowExecutions: option<scheduledWindowExecutionList>
}
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeMaintenanceWindowScheduleCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeMaintenanceWindowExecutionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("WindowExecutionTaskIdentities") windowExecutionTaskIdentities: option<maintenanceWindowExecutionTaskIdentityList>
}
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeMaintenanceWindowExecutionTasksCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("WindowExecutionTaskInvocationIdentities") windowExecutionTaskInvocationIdentities: option<maintenanceWindowExecutionTaskInvocationIdentityList>
}
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeMaintenanceWindowExecutionTaskInvocationsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeInstancePatchStatesForPatchGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("VersionName") versionName: option<documentVersionName>,
  ...
  type response = {
@as("Document") document: option<documentDescription>
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeAvailablePatchesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("AssociationExecutionTargets") associationExecutionTargets: option<associationExecutionTargetsList>
}
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeAssociationExecutionTargetsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Replace") replace: option<boolean_>,
  ...
  @as("MaxConcurrency") maxConcurrency: option<maxConcurrency>,
  @as("Priority") priority: option<maintenanceWindowTaskPriority>,
  @as("TaskInvocationParameters") taskInvocationParameters: option<maintenanceWindowTaskInvocationParameters>,
  @as("TaskParameters") taskParameters: option<maintenanceWindowTaskParameters>,
  @as("ServiceRoleArn") serviceRoleArn: option<serviceRole>,
  @as("TaskArn") taskArn: option<maintenanceWindowTaskArn>,
  @as("Targets") targets: option<targets>,
...
@as("Description") description: option<maintenanceWindowDescription>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "UpdateMaintenanceWindowTaskCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CloudWatchOutputConfig") cloudWatchOutputConfig: option<cloudWatchOutputConfig>,
  ...
  type response = {
@as("Command") command: option<command>
}
...
@as("WindowTaskId") windowTaskId: option<maintenanceWindowTaskId>
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "RegisterTaskWithMaintenanceWindowCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Items") items: inventoryItemList,
  ...
  type response = {
@as("Message") message: option<putInventoryMessage>
}
...
@as("MaxResults") maxResults: option<maxResults>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("ResourceComplianceSummaryItems") resourceComplianceSummaryItems: option<resourceComplianceSummaryItemList>
}
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "ListResourceComplianceSummariesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Description") description: option<maintenanceWindowDescription>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "GetMaintenanceWindowTaskCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("EndTime") endTime: option<dateTime>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "GetMaintenanceWindowExecutionTaskCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @as("InstanceInformationFilterList") instanceInformationFilterList: option<instanceInformationFilterList>
}
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("InstanceInformationList") instanceInformationList: option<instanceInformationList>
}
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeInstanceInformationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("InstanceAssociationStatusInfos") instanceAssociationStatusInfos: option<instanceAssociationStatusInfos>
}
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeInstanceAssociationsStatusCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeEffectivePatchesForPatchBaselineCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("AutomationExecutionId") automationExecutionId: option<automationExecutionId>
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "StartChangeRequestExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "ListDocumentMetadataHistoryCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeMaintenanceWindowTasksCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeMaintenanceWindowTargetsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeInventoryDeletionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeAutomationStepExecutionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("AutomationExecutionId") automationExecutionId: automationExecutionId
  ...
  type response = {
@as("AutomationExecution") automationExecution: option<automationExecution>
}
...
module CreateAssociationBatch = {
  type t;
  type request = {
@as("Entries") entries: createAssociationBatchRequestEntries
}
  type response = {
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("AutomationExecutionMetadataList") automationExecutionMetadataList: option<automationExecutionMetadataList>
}
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "DescribeAutomationExecutionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Product") product: option<product>,
  ...
  @module("@aws-sdk/client-ssm") @new external new_: (request) => t = "GetDeployablePatchSnapshotForInstanceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
