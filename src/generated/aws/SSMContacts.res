...
type contactChannelAddress = {@as("SimpleAddress") simpleAddress: option<simpleAddress>}
type contact = {
...
type plan = {@as("Stages") stages: stagesList}
...
module GetContactPolicy = {
  type t
  type request = {@as("ContactArn") contactArn: ssmContactsArn}
  type response = {
...
module DescribePage = {
  type t
  type request = {@as("PageId") pageId: ssmContactsArn}
  type response = {
    @as("DeliveryTime") deliveryTime: option<dateTime>,
    @as("ReadTime") readTime: option<dateTime>,
    @as("SentTime") sentTime: option<dateTime>,
...
module DescribeEngagement = {
  type t
  type request = {@as("EngagementId") engagementId: ssmContactsArn}
  type response = {
    @as("StopTime") stopTime: option<dateTime>,
    @as("StartTime") startTime: option<dateTime>,
    @as("IncidentId") incidentId: option<incidentId>,
