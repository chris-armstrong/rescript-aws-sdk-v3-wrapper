...
type workflowExecutionFilter = {workflowId: workflowId}
...
type taskList = {name: name}
type tagList_ = array<tag>
type tagFilter = {tag: tag}
...
type requestCancelActivityTaskDecisionAttributes = {activityId: activityId}
...
type lambdaFunctionStartedEventAttributes = {scheduledEventId: eventId}
...
type domainConfiguration = {workflowExecutionRetentionPeriodInDays: durationInDays}
...
type completeWorkflowExecutionDecisionAttributes = {result: option<data>}
type closeStatusFilter = {status: closeStatus}
type cancelWorkflowExecutionFailedEventAttributes = {
  decisionTaskCompletedEventId: eventId,
  cause: cancelWorkflowExecutionFailedCause,
}
type cancelWorkflowExecutionDecisionAttributes = {details: option<data>}
type cancelTimerFailedEventAttributes = {
  decisionTaskCompletedEventId: eventId,
  cause: cancelTimerFailedCause,
  timerId: timerId,
}
type cancelTimerDecisionAttributes = {timerId: timerId}
type activityType = {
  version: version,
  name: name,
}
