...
@module("@aws-sdk/client-sagemaker") @new external createClient: unit => awsServiceClient = "SageMakerClient";
...
type variantPropertyType = [@as("DataCaptureConfig") #DataCaptureConfig | @as("DesiredWeight") #DesiredWeight | @as("DesiredInstanceCount") #DesiredInstanceCount]
type variantName = string
type userProfileStatus = [@as("Delete_Failed") #Delete_Failed | @as("Update_Failed") #Update_Failed | @as("Updating") #Updating | @as("Pending") #Pending | @as("InService") #InService | @as("Failed") #Failed | @as("Deleting") #Deleting]
type userProfileSortKey = [@as("LastModifiedTime") #LastModifiedTime | @as("CreationTime") #CreationTime]
...
type trialComponentPrimaryStatus = [@as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress]
...
type transformJobStatus = [@as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress]
type transformJobName = string
type transformJobArn = string
type transformInstanceType = [@as("ml.m5.24xlarge") #Ml_M5_24xlarge | @as("ml.m5.12xlarge") #Ml_M5_12xlarge | @as("ml.m5.4xlarge") #Ml_M5_4xlarge | @as("ml.m5.2xlarge") #Ml_M5_2xlarge | @as("ml.m5.xlarge") #Ml_M5_Xlarge | @as("ml.m5.large") #Ml_M5_Large | @as("ml.c5.18xlarge") #Ml_C5_18xlarge | @as("ml.c5.9xlarge") #Ml_C5_9xlarge | @as("ml.c5.4xlarge") #Ml_C5_4xlarge | @as("ml.c5.2xlarge") #Ml_C5_2xlarge | @as("ml.c5.xlarge") #Ml_C5_Xlarge | @as("ml.p3.16xlarge") #Ml_P3_16xlarge | @as("ml.p3.8xlarge") #Ml_P3_8xlarge | @as("ml.p3.2xlarge") #Ml_P3_2xlarge | @as("ml.p2.16xlarge") #Ml_P2_16xlarge | @as("ml.p2.8xlarge") #Ml_P2_8xlarge | @as("ml.p2.xlarge") #Ml_P2_Xlarge | @as("ml.c4.8xlarge") #Ml_C4_8xlarge | @as("ml.c4.4xlarge") #Ml_C4_4xlarge | @as("ml.c4.2xlarge") #Ml_C4_2xlarge | @as("ml.c4.xlarge") #Ml_C4_Xlarge | @as("ml.m4.16xlarge") #Ml_M4_16xlarge | @as("ml.m4.10xlarge") #Ml_M4_10xlarge | @as("ml.m4.4xlarge") #Ml_M4_4xlarge | @as("ml.m4.2xlarge") #Ml_M4_2xlarge | @as("ml.m4.xlarge") #Ml_M4_Xlarge]
...
type trainingJobStatus = [@as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress]
type trainingJobSortByOptions = [@as("FinalObjectiveMetricValue") #FinalObjectiveMetricValue | @as("Status") #Status | @as("CreationTime") #CreationTime | @as("Name") #Name]
type trainingJobName = string
type trainingJobEarlyStoppingType = [@as("Auto") #Auto | @as("Off") #Off]
type trainingJobArn = string
type trainingInstanceType = [@as("ml.c5n.18xlarge") #Ml_C5n_18xlarge | @as("ml.c5n.9xlarge") #Ml_C5n_9xlarge | @as("ml.c5n.4xlarge") #Ml_C5n_4xlarge | @as("ml.c5n.2xlarge") #Ml_C5n_2xlarge | @as("ml.c5n.xlarge") #Ml_C5n_Xlarge | @as("ml.c5.18xlarge") #Ml_C5_18xlarge | @as("ml.c5.9xlarge") #Ml_C5_9xlarge | @as("ml.c5.4xlarge") #Ml_C5_4xlarge | @as("ml.c5.2xlarge") #Ml_C5_2xlarge | @as("ml.c5.xlarge") #Ml_C5_Xlarge | @as("ml.p4d.24xlarge") #Ml_P4d_24xlarge | @as("ml.p3dn.24xlarge") #Ml_P3dn_24xlarge | @as("ml.p3.16xlarge") #Ml_P3_16xlarge | @as("ml.p3.8xlarge") #Ml_P3_8xlarge | @as("ml.p3.2xlarge") #Ml_P3_2xlarge | @as("ml.p2.16xlarge") #Ml_P2_16xlarge | @as("ml.p2.8xlarge") #Ml_P2_8xlarge | @as("ml.p2.xlarge") #Ml_P2_Xlarge | @as("ml.c4.8xlarge") #Ml_C4_8xlarge | @as("ml.c4.4xlarge") #Ml_C4_4xlarge | @as("ml.c4.2xlarge") #Ml_C4_2xlarge | @as("ml.c4.xlarge") #Ml_C4_Xlarge | @as("ml.m5.24xlarge") #Ml_M5_24xlarge | @as("ml.m5.12xlarge") #Ml_M5_12xlarge | @as("ml.m5.4xlarge") #Ml_M5_4xlarge | @as("ml.m5.2xlarge") #Ml_M5_2xlarge | @as("ml.m5.xlarge") #Ml_M5_Xlarge | @as("ml.m5.large") #Ml_M5_Large | @as("ml.g4dn.16xlarge") #Ml_G4dn_16xlarge | @as("ml.g4dn.12xlarge") #Ml_G4dn_12xlarge | @as("ml.g4dn.8xlarge") #Ml_G4dn_8xlarge | @as("ml.g4dn.4xlarge") #Ml_G4dn_4xlarge | @as("ml.g4dn.2xlarge") #Ml_G4dn_2xlarge | @as("ml.g4dn.xlarge") #Ml_G4dn_Xlarge | @as("ml.m4.16xlarge") #Ml_M4_16xlarge | @as("ml.m4.10xlarge") #Ml_M4_10xlarge | @as("ml.m4.4xlarge") #Ml_M4_4xlarge | @as("ml.m4.2xlarge") #Ml_M4_2xlarge | @as("ml.m4.xlarge") #Ml_M4_Xlarge]
...
type targetPlatformArch = [@as("ARM_EABIHF") #ARM_EABIHF | @as("ARM_EABI") #ARM_EABI | @as("ARM64") #ARM64 | @as("X86") #X86 | @as("X86_64") #X86_64]
type targetPlatformAccelerator = [@as("NVIDIA") #NVIDIA | @as("MALI") #MALI | @as("INTEL_GRAPHICS") #INTEL_GRAPHICS]
type targetObjectiveMetricValue = float
type targetDevice = [@as("jacinto_tda4vm") #Jacinto_Tda4vm | @as("coreml") #Coreml | @as("x86_win64") #X86_Win64 | @as("x86_win32") #X86_Win32 | @as("amba_cv22") #Amba_Cv22 | @as("sitara_am57x") #Sitara_Am57x | @as("qcs603") #Qcs603 | @as("qcs605") #Qcs605 | @as("sbe_c") #Sbe_C | @as("aisage") #Aisage | @as("rk3288") #Rk3288 | @as("rk3399") #Rk3399 | @as("deeplens") #Deeplens | @as("imx8qm") #Imx8qm | @as("rasp3b") #Rasp3b | @as("jetson_xavier") #Jetson_Xavier | @as("jetson_nano") #Jetson_Nano | @as("jetson_tx2") #Jetson_Tx2 | @as("jetson_tx1") #Jetson_Tx1 | @as("ml_eia2") #Ml_Eia2 | @as("ml_inf1") #Ml_Inf1 | @as("ml_g4dn") #Ml_G4dn | @as("ml_p3") #Ml_P3 | @as("ml_p2") #Ml_P2 | @as("ml_c5") #Ml_C5 | @as("ml_c4") #Ml_C4 | @as("ml_m5") #Ml_M5 | @as("ml_m4") #Ml_M4 | @as("lambda") #Lambda]
...
type string_ = string
type stepStatus = [@as("Succeeded") #Succeeded | @as("Failed") #Failed | @as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Executing") #Executing | @as("Starting") #Starting]
type stepName = string
type statusMessage = string
type statusDetails = string
type splitType = [@as("TFRecord") #TFRecord | @as("RecordIO") #RecordIO | @as("Line") #Line | @as("None") #None]
...
type sortPipelineExecutionsBy = [@as("PipelineExecutionArn") #PipelineExecutionArn | @as("CreationTime") #CreationTime]
...
type sortAssociationsBy = [@as("CreationTime") #CreationTime | @as("DestinationType") #DestinationType | @as("SourceType") #SourceType | @as("DestinationArn") #DestinationArn | @as("SourceArn") #SourceArn]
...
type secondaryStatus = [@as("Restarting") #Restarting | @as("Updating") #Updating | @as("MaxWaitTimeExceeded") #MaxWaitTimeExceeded | @as("Interrupted") #Interrupted | @as("Failed") #Failed | @as("Completed") #Completed | @as("MaxRuntimeExceeded") #MaxRuntimeExceeded | @as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Uploading") #Uploading | @as("Training") #Training | @as("DownloadingTrainingImage") #DownloadingTrainingImage | @as("Downloading") #Downloading | @as("PreparingTrainingStack") #PreparingTrainingStack | @as("LaunchingMLInstances") #LaunchingMLInstances | @as("Starting") #Starting]
type searchSortOrder = [@as("Descending") #Descending | @as("Ascending") #Ascending]
type scheduleStatus = [@as("Stopped") #Stopped | @as("Scheduled") #Scheduled | @as("Failed") #Failed | @as("Pending") #Pending]
type scheduleExpression = string
type samplingPercentage = int
type sagemakerServicecatalogStatus = [@as("Disabled") #Disabled | @as("Enabled") #Enabled]
type s3Uri = string
type s3DataType = [@as("AugmentedManifestFile") #AugmentedManifestFile | @as("S3Prefix") #S3Prefix | @as("ManifestFile") #ManifestFile]
type s3DataDistribution = [@as("ShardedByS3Key") #ShardedByS3Key | @as("FullyReplicated") #FullyReplicated]
type ruleEvaluationStatus = [@as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Error") #Error | @as("IssuesFound") #IssuesFound | @as("NoIssuesFound") #NoIssuesFound | @as("InProgress") #InProgress]
...
type resourceType = [@as("FeatureGroup") #FeatureGroup | @as("PipelineExecution") #PipelineExecution | @as("Pipeline") #Pipeline | @as("ModelPackageGroup") #ModelPackageGroup | @as("ModelPackage") #ModelPackage | @as("Endpoint") #Endpoint | @as("ExperimentTrialComponent") #ExperimentTrialComponent | @as("ExperimentTrial") #ExperimentTrial | @as("Experiment") #Experiment | @as("TrainingJob") #TrainingJob]
...
type redshiftResultCompressionType = [@as("SNAPPY") #SNAPPY | @as("ZSTD") #ZSTD | @as("BZIP2") #BZIP2 | @as("GZIP") #GZIP | @as("None") #None]
...
type projectStatus = [@as("DeleteCompleted") #DeleteCompleted | @as("DeleteFailed") #DeleteFailed | @as("DeleteInProgress") #DeleteInProgress | @as("CreateFailed") #CreateFailed | @as("CreateCompleted") #CreateCompleted | @as("CreateInProgress") #CreateInProgress | @as("Pending") #Pending]
...
type productionVariantInstanceType = [@as("ml.inf1.24xlarge") #Ml_Inf1_24xlarge | @as("ml.inf1.6xlarge") #Ml_Inf1_6xlarge | @as("ml.inf1.2xlarge") #Ml_Inf1_2xlarge | @as("ml.inf1.xlarge") #Ml_Inf1_Xlarge | @as("ml.r5d.24xlarge") #Ml_R5d_24xlarge | @as("ml.r5d.12xlarge") #Ml_R5d_12xlarge | @as("ml.r5d.4xlarge") #Ml_R5d_4xlarge | @as("ml.r5d.2xlarge") #Ml_R5d_2xlarge | @as("ml.r5d.xlarge") #Ml_R5d_Xlarge | @as("ml.r5d.large") #Ml_R5d_Large | @as("ml.r5.24xlarge") #Ml_R5_24xlarge | @as("ml.r5.12xlarge") #Ml_R5_12xlarge | @as("ml.r5.4xlarge") #Ml_R5_4xlarge | @as("ml.r5.2xlarge") #Ml_R5_2xlarge | @as("ml.r5.xlarge") #Ml_R5_Xlarge | @as("ml.r5.large") #Ml_R5_Large | @as("ml.g4dn.16xlarge") #Ml_G4dn_16xlarge | @as("ml.g4dn.12xlarge") #Ml_G4dn_12xlarge | @as("ml.g4dn.8xlarge") #Ml_G4dn_8xlarge | @as("ml.g4dn.4xlarge") #Ml_G4dn_4xlarge | @as("ml.g4dn.2xlarge") #Ml_G4dn_2xlarge | @as("ml.g4dn.xlarge") #Ml_G4dn_Xlarge | @as("ml.c5d.18xlarge") #Ml_C5d_18xlarge | @as("ml.c5d.9xlarge") #Ml_C5d_9xlarge | @as("ml.c5d.4xlarge") #Ml_C5d_4xlarge | @as("ml.c5d.2xlarge") #Ml_C5d_2xlarge | @as("ml.c5d.xlarge") #Ml_C5d_Xlarge | @as("ml.c5d.large") #Ml_C5d_Large | @as("ml.c5.18xlarge") #Ml_C5_18xlarge | @as("ml.c5.9xlarge") #Ml_C5_9xlarge | @as("ml.c5.4xlarge") #Ml_C5_4xlarge | @as("ml.c5.2xlarge") #Ml_C5_2xlarge | @as("ml.c5.xlarge") #Ml_C5_Xlarge | @as("ml.c5.large") #Ml_C5_Large | @as("ml.p3.16xlarge") #Ml_P3_16xlarge | @as("ml.p3.8xlarge") #Ml_P3_8xlarge | @as("ml.p3.2xlarge") #Ml_P3_2xlarge | @as("ml.p2.16xlarge") #Ml_P2_16xlarge | @as("ml.p2.8xlarge") #Ml_P2_8xlarge | @as("ml.p2.xlarge") #Ml_P2_Xlarge | @as("ml.c4.8xlarge") #Ml_C4_8xlarge | @as("ml.c4.4xlarge") #Ml_C4_4xlarge | @as("ml.c4.2xlarge") #Ml_C4_2xlarge | @as("ml.c4.xlarge") #Ml_C4_Xlarge | @as("ml.c4.large") #Ml_C4_Large | @as("ml.m5d.24xlarge") #Ml_M5d_24xlarge | @as("ml.m5d.12xlarge") #Ml_M5d_12xlarge | @as("ml.m5d.4xlarge") #Ml_M5d_4xlarge | @as("ml.m5d.2xlarge") #Ml_M5d_2xlarge | @as("ml.m5d.xlarge") #Ml_M5d_Xlarge | @as("ml.m5d.large") #Ml_M5d_Large | @as("ml.m5.24xlarge") #Ml_M5_24xlarge | @as("ml.m5.12xlarge") #Ml_M5_12xlarge | @as("ml.m5.4xlarge") #Ml_M5_4xlarge | @as("ml.m5.2xlarge") #Ml_M5_2xlarge | @as("ml.m5.xlarge") #Ml_M5_Xlarge | @as("ml.m5.large") #Ml_M5_Large | @as("ml.m4.16xlarge") #Ml_M4_16xlarge | @as("ml.m4.10xlarge") #Ml_M4_10xlarge | @as("ml.m4.4xlarge") #Ml_M4_4xlarge | @as("ml.m4.2xlarge") #Ml_M4_2xlarge | @as("ml.m4.xlarge") #Ml_M4_Xlarge | @as("ml.t2.2xlarge") #Ml_T2_2xlarge | @as("ml.t2.xlarge") #Ml_T2_Xlarge | @as("ml.t2.large") #Ml_T2_Large | @as("ml.t2.medium") #Ml_T2_Medium]
type productionVariantAcceleratorType = [@as("ml.eia2.xlarge") #Ml_Eia2_Xlarge | @as("ml.eia2.large") #Ml_Eia2_Large | @as("ml.eia2.medium") #Ml_Eia2_Medium | @as("ml.eia1.xlarge") #Ml_Eia1_Xlarge | @as("ml.eia1.large") #Ml_Eia1_Large | @as("ml.eia1.medium") #Ml_Eia1_Medium]
...
type processingS3DataDistributionType = [@as("ShardedByS3Key") #ShardedByS3Key | @as("FullyReplicated") #FullyReplicated]
...
type processingJobStatus = [@as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress]
type processingJobName = string
type processingJobArn = string
type processingInstanceType = [@as("ml.r5.24xlarge") #Ml_R5_24xlarge | @as("ml.r5.16xlarge") #Ml_R5_16xlarge | @as("ml.r5.12xlarge") #Ml_R5_12xlarge | @as("ml.r5.8xlarge") #Ml_R5_8xlarge | @as("ml.r5.4xlarge") #Ml_R5_4xlarge | @as("ml.r5.2xlarge") #Ml_R5_2xlarge | @as("ml.r5.xlarge") #Ml_R5_Xlarge | @as("ml.r5.large") #Ml_R5_Large | @as("ml.m5.24xlarge") #Ml_M5_24xlarge | @as("ml.m5.12xlarge") #Ml_M5_12xlarge | @as("ml.m5.4xlarge") #Ml_M5_4xlarge | @as("ml.m5.2xlarge") #Ml_M5_2xlarge | @as("ml.m5.xlarge") #Ml_M5_Xlarge | @as("ml.m5.large") #Ml_M5_Large | @as("ml.c5.18xlarge") #Ml_C5_18xlarge | @as("ml.c5.9xlarge") #Ml_C5_9xlarge | @as("ml.c5.4xlarge") #Ml_C5_4xlarge | @as("ml.c5.2xlarge") #Ml_C5_2xlarge | @as("ml.c5.xlarge") #Ml_C5_Xlarge | @as("ml.p3.16xlarge") #Ml_P3_16xlarge | @as("ml.p3.8xlarge") #Ml_P3_8xlarge | @as("ml.p3.2xlarge") #Ml_P3_2xlarge | @as("ml.p2.16xlarge") #Ml_P2_16xlarge | @as("ml.p2.8xlarge") #Ml_P2_8xlarge | @as("ml.p2.xlarge") #Ml_P2_Xlarge | @as("ml.c4.8xlarge") #Ml_C4_8xlarge | @as("ml.c4.4xlarge") #Ml_C4_4xlarge | @as("ml.c4.2xlarge") #Ml_C4_2xlarge | @as("ml.c4.xlarge") #Ml_C4_Xlarge | @as("ml.m4.16xlarge") #Ml_M4_16xlarge | @as("ml.m4.10xlarge") #Ml_M4_10xlarge | @as("ml.m4.4xlarge") #Ml_M4_4xlarge | @as("ml.m4.2xlarge") #Ml_M4_2xlarge | @as("ml.m4.xlarge") #Ml_M4_Xlarge | @as("ml.t3.2xlarge") #Ml_T3_2xlarge | @as("ml.t3.xlarge") #Ml_T3_Xlarge | @as("ml.t3.large") #Ml_T3_Large | @as("ml.t3.medium") #Ml_T3_Medium]
type processingInstanceCount = int
type processingEnvironmentValue = string
type processingEnvironmentKey = string
type problemType = [@as("Regression") #Regression | @as("MulticlassClassification") #MulticlassClassification | @as("BinaryClassification") #BinaryClassification]
...
type pipelineExecutionStatus = [@as("Succeeded") #Succeeded | @as("Failed") #Failed | @as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Executing") #Executing]
...
type parameterType = [@as("FreeText") #FreeText | @as("Categorical") #Categorical | @as("Continuous") #Continuous | @as("Integer") #Integer]
...
type operator = [@as("In") #In | @as("NotExists") #NotExists | @as("Exists") #Exists | @as("Contains") #Contains | @as("LessThanOrEqualTo") #LessThanOrEqualTo | @as("LessThan") #LessThan | @as("GreaterThanOrEqualTo") #GreaterThanOrEqualTo | @as("GreaterThan") #GreaterThan | @as("NotEquals") #NotEquals | @as("Equals") #Equals]
type oidcEndpoint = string
type offlineStoreStatusValue = [@as("Disabled") #Disabled | @as("Blocked") #Blocked | @as("Active") #Active]
type objectiveStatusCounter = int
type objectiveStatus = [@as("Failed") #Failed | @as("Pending") #Pending | @as("Succeeded") #Succeeded]
...
type notebookInstanceStatus = [@as("Updating") #Updating | @as("Deleting") #Deleting | @as("Failed") #Failed | @as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("InService") #InService | @as("Pending") #Pending]
type notebookInstanceSortOrder = [@as("Descending") #Descending | @as("Ascending") #Ascending]
type notebookInstanceSortKey = [@as("Status") #Status | @as("CreationTime") #CreationTime | @as("Name") #Name]
type notebookInstanceNameContains = string
type notebookInstanceName = string
type notebookInstanceLifecycleConfigSortOrder = [@as("Descending") #Descending | @as("Ascending") #Ascending]
type notebookInstanceLifecycleConfigSortKey = [@as("LastModifiedTime") #LastModifiedTime | @as("CreationTime") #CreationTime | @as("Name") #Name]
...
type notebookInstanceAcceleratorType = [@as("ml.eia2.xlarge") #Ml_Eia2_Xlarge | @as("ml.eia2.large") #Ml_Eia2_Large | @as("ml.eia2.medium") #Ml_Eia2_Medium | @as("ml.eia1.xlarge") #Ml_Eia1_Xlarge | @as("ml.eia1.large") #Ml_Eia1_Large | @as("ml.eia1.medium") #Ml_Eia1_Medium]
type nextToken = string
type networkInterfaceId = string
type nameContains = string
type mountPath = string
type monitoringType = [@as("ModelExplainability") #ModelExplainability | @as("ModelBias") #ModelBias | @as("ModelQuality") #ModelQuality | @as("DataQuality") #DataQuality]
type monitoringTimeOffsetString = string
type monitoringScheduleSortKey = [@as("Status") #Status | @as("CreationTime") #CreationTime | @as("Name") #Name]
type monitoringScheduleName = string
type monitoringScheduleArn = string
type monitoringS3Uri = string
type monitoringProblemType = [@as("Regression") #Regression | @as("MulticlassClassification") #MulticlassClassification | @as("BinaryClassification") #BinaryClassification]
...
type monitoringExecutionSortKey = [@as("Status") #Status | @as("ScheduledTime") #ScheduledTime | @as("CreationTime") #CreationTime]
type modelSortKey = [@as("CreationTime") #CreationTime | @as("Name") #Name]
type modelPackageVersion = int
type modelPackageType = [@as("Both") #Both | @as("Unversioned") #Unversioned | @as("Versioned") #Versioned]
type modelPackageStatus = [@as("Deleting") #Deleting | @as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress | @as("Pending") #Pending]
type modelPackageSortBy = [@as("CreationTime") #CreationTime | @as("Name") #Name]
type modelPackageGroupStatus = [@as("DeleteFailed") #DeleteFailed | @as("Deleting") #Deleting | @as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress | @as("Pending") #Pending]
...
type modelApprovalStatus = [@as("PendingManualApproval") #PendingManualApproval | @as("Rejected") #Rejected | @as("Approved") #Approved]
...
type listEdgePackagingJobsSortBy = [@as("STATUS") #STATUS | @as("LAST_MODIFIED_TIME") #LAST_MODIFIED_TIME | @as("CREATION_TIME") #CREATION_TIME | @as("MODEL_NAME") #MODEL_NAME | @as("NAME") #NAME]
type listDeviceFleetsSortBy = [@as("LAST_MODIFIED_TIME") #LAST_MODIFIED_TIME | @as("CREATION_TIME") #CREATION_TIME | @as("NAME") #NAME]
type listCompilationJobsSortBy = [@as("Status") #Status | @as("CreationTime") #CreationTime | @as("Name") #Name]
type lastModifiedTime = Js.Date.t;
type lambdaFunctionArn = string
type labelingJobStatus = [@as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress | @as("Initializing") #Initializing]
...
type integer_ = int
type instanceType = [@as("ml.p3.16xlarge") #Ml_P3_16xlarge | @as("ml.p3.8xlarge") #Ml_P3_8xlarge | @as("ml.p3.2xlarge") #Ml_P3_2xlarge | @as("ml.p2.16xlarge") #Ml_P2_16xlarge | @as("ml.p2.8xlarge") #Ml_P2_8xlarge | @as("ml.p2.xlarge") #Ml_P2_Xlarge | @as("ml.c5d.18xlarge") #Ml_C5d_18xlarge | @as("ml.c5d.9xlarge") #Ml_C5d_9xlarge | @as("ml.c5d.4xlarge") #Ml_C5d_4xlarge | @as("ml.c5d.2xlarge") #Ml_C5d_2xlarge | @as("ml.c5d.xlarge") #Ml_C5d_Xlarge | @as("ml.c5.18xlarge") #Ml_C5_18xlarge | @as("ml.c5.9xlarge") #Ml_C5_9xlarge | @as("ml.c5.4xlarge") #Ml_C5_4xlarge | @as("ml.c5.2xlarge") #Ml_C5_2xlarge | @as("ml.c5.xlarge") #Ml_C5_Xlarge | @as("ml.c4.8xlarge") #Ml_C4_8xlarge | @as("ml.c4.4xlarge") #Ml_C4_4xlarge | @as("ml.c4.2xlarge") #Ml_C4_2xlarge | @as("ml.c4.xlarge") #Ml_C4_Xlarge | @as("ml.m5.24xlarge") #Ml_M5_24xlarge | @as("ml.m5.12xlarge") #Ml_M5_12xlarge | @as("ml.m5.4xlarge") #Ml_M5_4xlarge | @as("ml.m5.2xlarge") #Ml_M5_2xlarge | @as("ml.m5.xlarge") #Ml_M5_Xlarge | @as("ml.m4.16xlarge") #Ml_M4_16xlarge | @as("ml.m4.10xlarge") #Ml_M4_10xlarge | @as("ml.m4.4xlarge") #Ml_M4_4xlarge | @as("ml.m4.2xlarge") #Ml_M4_2xlarge | @as("ml.m4.xlarge") #Ml_M4_Xlarge | @as("ml.t3.2xlarge") #Ml_T3_2xlarge | @as("ml.t3.xlarge") #Ml_T3_Xlarge | @as("ml.t3.large") #Ml_T3_Large | @as("ml.t3.medium") #Ml_T3_Medium | @as("ml.t2.2xlarge") #Ml_T2_2xlarge | @as("ml.t2.xlarge") #Ml_T2_Xlarge | @as("ml.t2.large") #Ml_T2_Large | @as("ml.t2.medium") #Ml_T2_Medium]
type inputMode = [@as("File") #File | @as("Pipe") #Pipe]
type inferenceExecutionMode = [@as("Direct") #Direct | @as("Serial") #Serial]
type imageVersionStatus = [@as("DELETE_FAILED") #DELETE_FAILED | @as("DELETING") #DELETING | @as("CREATE_FAILED") #CREATE_FAILED | @as("CREATED") #CREATED | @as("CREATING") #CREATING]
type imageVersionSortOrder = [@as("DESCENDING") #DESCENDING | @as("ASCENDING") #ASCENDING]
type imageVersionSortBy = [@as("VERSION") #VERSION | @as("LAST_MODIFIED_TIME") #LAST_MODIFIED_TIME | @as("CREATION_TIME") #CREATION_TIME]
type imageVersionNumber = int
type imageVersionArn = string
type imageUri = string
type imageStatus = [@as("DELETE_FAILED") #DELETE_FAILED | @as("DELETING") #DELETING | @as("UPDATE_FAILED") #UPDATE_FAILED | @as("UPDATING") #UPDATING | @as("CREATE_FAILED") #CREATE_FAILED | @as("CREATED") #CREATED | @as("CREATING") #CREATING]
type imageSortOrder = [@as("DESCENDING") #DESCENDING | @as("ASCENDING") #ASCENDING]
type imageSortBy = [@as("IMAGE_NAME") #IMAGE_NAME | @as("LAST_MODIFIED_TIME") #LAST_MODIFIED_TIME | @as("CREATION_TIME") #CREATION_TIME]
...
type hyperParameterTuningJobWarmStartType = [@as("TransferLearning") #TransferLearning | @as("IdenticalDataAndAlgorithm") #IdenticalDataAndAlgorithm]
type hyperParameterTuningJobStrategyType = [@as("Random") #Random | @as("Bayesian") #Bayesian]
type hyperParameterTuningJobStatus = [@as("Stopping") #Stopping | @as("Stopped") #Stopped | @as("Failed") #Failed | @as("InProgress") #InProgress | @as("Completed") #Completed]
type hyperParameterTuningJobSortByOptions = [@as("CreationTime") #CreationTime | @as("Status") #Status | @as("Name") #Name]
...
type hyperParameterScalingType = [@as("ReverseLogarithmic") #ReverseLogarithmic | @as("Logarithmic") #Logarithmic | @as("Linear") #Linear | @as("Auto") #Auto]
...
type framework = [@as("SKLEARN") #SKLEARN | @as("DARKNET") #DARKNET | @as("TFLITE") #TFLITE | @as("XGBOOST") #XGBOOST | @as("PYTORCH") #PYTORCH | @as("ONNX") #ONNX | @as("MXNET") #MXNET | @as("KERAS") #KERAS | @as("TENSORFLOW") #TENSORFLOW]
...
type flowDefinitionStatus = [@as("Deleting") #Deleting | @as("Failed") #Failed | @as("Active") #Active | @as("Initializing") #Initializing]
...
type featureType = [@as("String") #String | @as("Fractional") #Fractional | @as("Integral") #Integral]
type featureName = string
type featureGroupStatus = [@as("DeleteFailed") #DeleteFailed | @as("Deleting") #Deleting | @as("CreateFailed") #CreateFailed | @as("Created") #Created | @as("Creating") #Creating]
type featureGroupSortOrder = [@as("Descending") #Descending | @as("Ascending") #Ascending]
type featureGroupSortBy = [@as("CreationTime") #CreationTime | @as("OfflineStoreStatus") #OfflineStoreStatus | @as("FeatureGroupStatus") #FeatureGroupStatus | @as("Name") #Name]
...
type executionStatus = [@as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Failed") #Failed | @as("InProgress") #InProgress | @as("CompletedWithViolations") #CompletedWithViolations | @as("Completed") #Completed | @as("Pending") #Pending]
type environmentValue = string
type environmentKey = string
type entityName = string
type entityDescription = string
type endpointStatus = [@as("Failed") #Failed | @as("Deleting") #Deleting | @as("InService") #InService | @as("RollingBack") #RollingBack | @as("SystemUpdating") #SystemUpdating | @as("Updating") #Updating | @as("Creating") #Creating | @as("OutOfService") #OutOfService]
type endpointSortKey = [@as("Status") #Status | @as("CreationTime") #CreationTime | @as("Name") #Name]
...
type edgePackagingJobStatus = [@as("STOPPED") #STOPPED | @as("STOPPING") #STOPPING | @as("FAILED") #FAILED | @as("COMPLETED") #COMPLETED | @as("INPROGRESS") #INPROGRESS | @as("STARTING") #STARTING]
type edgePackagingJobArn = string
type doubleParameterValue = float
type domainStatus = [@as("Delete_Failed") #Delete_Failed | @as("Update_Failed") #Update_Failed | @as("Updating") #Updating | @as("Pending") #Pending | @as("InService") #InService | @as("Failed") #Failed | @as("Deleting") #Deleting]
...
type detailedModelPackageStatus = [@as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress | @as("NotStarted") #NotStarted]
type detailedAlgorithmStatus = [@as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress | @as("NotStarted") #NotStarted]
...
type dataDistributionType = [@as("ShardedByS3Key") #ShardedByS3Key | @as("FullyReplicated") #FullyReplicated]
...
type compilationJobStatus = [@as("STOPPED") #STOPPED | @as("STOPPING") #STOPPING | @as("STARTING") #STARTING | @as("FAILED") #FAILED | @as("COMPLETED") #COMPLETED | @as("INPROGRESS") #INPROGRESS]
...
type codeRepositorySortBy = [@as("LastModifiedTime") #LastModifiedTime | @as("CreationTime") #CreationTime | @as("Name") #Name]
...
type capacitySizeType = [@as("CAPACITY_PERCENT") #CAPACITY_PERCENT | @as("INSTANCE_COUNT") #INSTANCE_COUNT]
type candidateStepType = [@as("AWS::SageMaker::ProcessingJob") #AWS_SageMaker_ProcessingJob | @as("AWS::SageMaker::TransformJob") #AWS_SageMaker_TransformJob | @as("AWS::SageMaker::TrainingJob") #AWS_SageMaker_TrainingJob]
type candidateStepName = string
type candidateStepArn = string
type candidateStatus = [@as("Stopping") #Stopping | @as("Stopped") #Stopped | @as("Failed") #Failed | @as("InProgress") #InProgress | @as("Completed") #Completed]
type candidateSortBy = [@as("FinalObjectiveMetricValue") #FinalObjectiveMetricValue | @as("Status") #Status | @as("CreationTime") #CreationTime]
...
type awsManagedHumanLoopRequestSource = [@as("AWS/Textract/AnalyzeDocument/Forms/V1") #AWS_Textract_AnalyzeDocument_Forms_V1 | @as("AWS/Rekognition/DetectModerationLabels/Image/V3") #AWS_Rekognition_DetectModerationLabels_Image_V3]
...
type autoMLMetricEnum = [@as("AUC") #AUC | @as("F1macro") #F1macro | @as("F1") #F1 | @as("MSE") #MSE | @as("Accuracy") #Accuracy]
type autoMLMaxResults = int
type autoMLJobStatus = [@as("Stopping") #Stopping | @as("Stopped") #Stopped | @as("Failed") #Failed | @as("InProgress") #InProgress | @as("Completed") #Completed]
type autoMLJobSecondaryStatus = [@as("ModelDeploymentError") #ModelDeploymentError | @as("DeployingModel") #DeployingModel | @as("ExplainabilityError") #ExplainabilityError | @as("Completed") #Completed | @as("GeneratingExplainabilityReport") #GeneratingExplainabilityReport | @as("CandidateDefinitionsGenerated") #CandidateDefinitionsGenerated | @as("Stopping") #Stopping | @as("MaxAutoMLJobRuntimeReached") #MaxAutoMLJobRuntimeReached | @as("Stopped") #Stopped | @as("Failed") #Failed | @as("MaxCandidatesReached") #MaxCandidatesReached | @as("ModelTuning") #ModelTuning | @as("FeatureEngineering") #FeatureEngineering | @as("AnalyzingData") #AnalyzingData | @as("Starting") #Starting]
...
type athenaResultFormat = [@as("TEXTFILE") #TEXTFILE | @as("JSON") #JSON | @as("AVRO") #AVRO | @as("ORC") #ORC | @as("PARQUET") #PARQUET]
...
type associationEdgeType = [@as("Produced") #Produced | @as("DerivedFrom") #DerivedFrom | @as("AssociatedWith") #AssociatedWith | @as("ContributedTo") #ContributedTo]
type assemblyType = [@as("Line") #Line | @as("None") #None]
type artifactSourceIdType = [@as("Custom") #Custom | @as("S3Version") #S3Version | @as("S3ETag") #S3ETag | @as("MD5Hash") #MD5Hash]
type artifactDigest = string
type artifactArn = string
type arnOrName = string
type approvalDescription = string
type appType = [@as("TensorBoard") #TensorBoard | @as("KernelGateway") #KernelGateway | @as("JupyterServer") #JupyterServer]
type appStatus = [@as("Pending") #Pending | @as("InService") #InService | @as("Failed") #Failed | @as("Deleting") #Deleting | @as("Deleted") #Deleted]
type appSortKey = [@as("CreationTime") #CreationTime]
type appNetworkAccessType = [@as("VpcOnly") #VpcOnly | @as("PublicInternetOnly") #PublicInternetOnly]
type appName = string
type appManaged = bool
type appInstanceType = [@as("ml.g4dn.16xlarge") #Ml_G4dn_16xlarge | @as("ml.g4dn.12xlarge") #Ml_G4dn_12xlarge | @as("ml.g4dn.8xlarge") #Ml_G4dn_8xlarge | @as("ml.g4dn.4xlarge") #Ml_G4dn_4xlarge | @as("ml.g4dn.2xlarge") #Ml_G4dn_2xlarge | @as("ml.g4dn.xlarge") #Ml_G4dn_Xlarge | @as("ml.p3.16xlarge") #Ml_P3_16xlarge | @as("ml.p3.8xlarge") #Ml_P3_8xlarge | @as("ml.p3.2xlarge") #Ml_P3_2xlarge | @as("ml.c5.24xlarge") #Ml_C5_24xlarge | @as("ml.c5.18xlarge") #Ml_C5_18xlarge | @as("ml.c5.12xlarge") #Ml_C5_12xlarge | @as("ml.c5.9xlarge") #Ml_C5_9xlarge | @as("ml.c5.4xlarge") #Ml_C5_4xlarge | @as("ml.c5.2xlarge") #Ml_C5_2xlarge | @as("ml.c5.xlarge") #Ml_C5_Xlarge | @as("ml.c5.large") #Ml_C5_Large | @as("ml.m5.24xlarge") #Ml_M5_24xlarge | @as("ml.m5.16xlarge") #Ml_M5_16xlarge | @as("ml.m5.12xlarge") #Ml_M5_12xlarge | @as("ml.m5.8xlarge") #Ml_M5_8xlarge | @as("ml.m5.4xlarge") #Ml_M5_4xlarge | @as("ml.m5.2xlarge") #Ml_M5_2xlarge | @as("ml.m5.xlarge") #Ml_M5_Xlarge | @as("ml.m5.large") #Ml_M5_Large | @as("ml.t3.2xlarge") #Ml_T3_2xlarge | @as("ml.t3.xlarge") #Ml_T3_Xlarge | @as("ml.t3.large") #Ml_T3_Large | @as("ml.t3.medium") #Ml_T3_Medium | @as("ml.t3.small") #Ml_T3_Small | @as("ml.t3.micro") #Ml_T3_Micro | @as("system") #System]
type appImageConfigSortKey = [@as("Name") #Name | @as("LastModifiedTime") #LastModifiedTime | @as("CreationTime") #CreationTime]
type appImageConfigName = string
type appImageConfigArn = string
type appArn = string
type algorithmStatus = [@as("Deleting") #Deleting | @as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress | @as("Pending") #Pending]
type algorithmSortBy = [@as("CreationTime") #CreationTime | @as("Name") #Name]
type algorithmImage = string
type algorithmArn = string
type alarmName = string
type actionStatus = [@as("Stopped") #Stopped | @as("Stopping") #Stopping | @as("Failed") #Failed | @as("Completed") #Completed | @as("InProgress") #InProgress | @as("Unknown") #Unknown]
type actionArn = string
type accountId = string
type accept = string
type vpcSecurityGroupIds = array<securityGroupId>
type variantProperty = {
@as("VariantPropertyType") variantPropertyType: variantPropertyType
}
...
type uiTemplate = {
@as("Content") content: templateContent
}
type uiConfig = {
...
@as("Arn") arn: option<transformJobArn>
}
...
@as("Arn") arn: option<trainingJobArn>
}
...
@as("ProvisionedProductStatusMessage") provisionedProductStatusMessage: option<provisionedProductStatusMessage>,
...
@as("HomeEfsFileSystem") homeEfsFileSystem: option<retentionType>
}
...
@as("RepositoryCredentialsProviderArn") repositoryCredentialsProviderArn: repositoryCredentialsProviderArn
}
type renderingError = {
...
type renderableTask = {
@as("Input") input: taskInput
}
type registerModelStepMetadata = {
@as("Arn") arn: option<string256>
}
...
@as("PropertyName") propertyName: option<resourcePropertyName>
}
type propertyNameQuery = {
@as("PropertyNameHint") propertyNameHint: propertyNameHint
}
type projectSummary = {
...
@as("Arn") arn: option<processingJobArn>
}
...
@as("PipelineExecutionDisplayName") pipelineExecutionDisplayName: option<pipelineExecutionName>,
  @as("PipelineExecutionDescription") pipelineExecutionDescription: option<pipelineExecutionDescription>,
...
@as("HyperParameterTuningJobName") hyperParameterTuningJobName: option<hyperParameterTuningJobName>
}
type parent = {
...
@as("LastModifiedTime") lastModifiedTime: option<lastModifiedTime>,
  @as("CreationTime") creationTime: option<creationTime>,
  @as("NotebookInstanceLifecycleConfigArn") notebookInstanceLifecycleConfigArn: notebookInstanceLifecycleConfigArn,
  @as("NotebookInstanceLifecycleConfigName") notebookInstanceLifecycleConfigName: notebookInstanceLifecycleConfigName
}
type notebookInstanceAcceleratorTypes = array<notebookInstanceAcceleratorType>
type multiModelConfig = {
@as("ModelCacheSetting") modelCacheSetting: option<modelCacheSetting>
}
...
@as("MonitoringType") monitoringType: option<monitoringType>,
  @as("MonitoringJobDefinitionName") monitoringJobDefinitionName: option<monitoringJobDefinitionName>,
...
@as("S3Uri") s3Uri: option<monitoringS3Uri>
}
...
type modelDigests = {
@as("ArtifactDigest") artifactDigest: option<artifactDigest>
}
...
@as("InvocationsMaxRetries") invocationsMaxRetries: option<invocationsMaxRetries>,
  @as("InvocationsTimeoutInSeconds") invocationsTimeoutInSeconds: option<invocationsTimeoutInSeconds>
}
type modelArtifacts = {
@as("S3ModelArtifacts") s3ModelArtifacts: s3Uri
}
type metricsSource = {
@as("S3Uri") s3Uri: s3Uri,
...
@as("MaxPercentageOfInputDatasetLabeled") maxPercentageOfInputDatasetLabeled: option<maxPercentageOfInputDatasetLabeled>,
...
@as("ManifestS3Uri") manifestS3Uri: s3Uri
}
...
@as("Mode") mode: inferenceExecutionMode
}
type imageVersion = {
...
@as("AwsManagedHumanLoopRequestSource") awsManagedHumanLoopRequestSource: awsManagedHumanLoopRequestSource
}
type humanLoopActivationConditionsConfig = {
@as("HumanLoopActivationConditions") humanLoopActivationConditions: synthesizedJsonHumanLoopActivationConditions
}
...
@as("EndTimeOffset") endTimeOffset: option<monitoringTimeOffsetString>,
  ...
  @as("ProbabilityThresholdAttribute") probabilityThresholdAttribute: option<probabilityThresholdAttribute>,
...
@as("Outcome") outcome: option<conditionOutcome>
}
...
@as("CompilationJobStatus") compilationJobStatus: compilationJobStatus,
  @as("LastModifiedTime") lastModifiedTime: option<lastModifiedTime>,
  @as("CompilationTargetPlatformAccelerator") compilationTargetPlatformAccelerator: option<targetPlatformAccelerator>,
...
type captureOption = {
@as("CaptureMode") captureMode: captureMode
}
type capacitySize = {
...
@as("Explainability") explainability: explainabilityLocation
}
type cacheHitResult = {
...
@as("MaxAutoMLJobRuntimeInSeconds") maxAutoMLJobRuntimeInSeconds: option<maxAutoMLJobRuntimeInSeconds>,
  @as("MaxRuntimePerTrainingJobInSeconds") maxRuntimePerTrainingJobInSeconds: option<maxRuntimePerTrainingJobInSeconds>,
  @as("MaxCandidates") maxCandidates: option<maxCandidates>
}
type autoMLJobArtifacts = {
@as("DataExplorationNotebookLocation") dataExplorationNotebookLocation: option<dataExplorationNotebookLocation>,
  @as("CandidateDefinitionNotebookLocation") candidateDefinitionNotebookLocation: option<candidateDefinitionNotebookLocation>
}
...
@as("S3DataSource") s3DataSource: transformS3DataSource
}
...
@as("PropertyNameQuery") propertyNameQuery: option<propertyNameQuery>
}
...
@as("AmountInUsd") amountInUsd: option<usd>
}
...
@as("DisableProfiler") disableProfiler: option<disableProfiler>,
  ...
  @as("ProfilingIntervalInMilliseconds") profilingIntervalInMilliseconds: option<profilingIntervalInMilliseconds>,
  @as("S3OutputPath") s3OutputPath: option<s3Uri>
}
type profilerConfig = {
@as("ProfilingParameters") profilingParameters: option<profilingParameters>,
...
@as("ClusterConfig") clusterConfig: processingClusterConfig
}
...
@as("AdditionalCodeRepositories") additionalCodeRepositories: option<additionalCodeRepositoryNamesOrUrls>,
  @as("DefaultCodeRepository") defaultCodeRepository: option<codeRepositoryNameOrUrl>,
  @as("NotebookInstanceLifecycleConfigName") notebookInstanceLifecycleConfigName: option<notebookInstanceLifecycleConfigName>,
  @as("LastModifiedTime") lastModifiedTime: option<lastModifiedTime>,
  @as("CreationTime") creationTime: option<creationTime>,
...
@as("ClusterConfig") clusterConfig: monitoringClusterConfig
}
type monitoringOutput = {
@as("S3Output") s3Output: monitoringS3Output
}
...
@as("NumberOfHumanWorkersPerDataObject") numberOfHumanWorkersPerDataObject: option<numberOfHumanWorkersPerDataObject>,
...
@as("LabelingJobResourceConfig") labelingJobResourceConfig: option<labelingJobResourceConfig>,
  ...
  @as("LabelingJobAlgorithmSpecificationArn") labelingJobAlgorithmSpecificationArn: labelingJobAlgorithmSpecificationArn
}
...
@as("ObjectiveStatus") objectiveStatus: option<objectiveStatus>,
  @as("FinalHyperParameterTuningJobObjectiveMetric") finalHyperParameterTuningJobObjectiveMetric: option<finalHyperParameterTuningJobObjectiveMetric>,
  @as("FailureReason") failureReason: option<failureReason>,
  ...
  @as("TrainingJobArn") trainingJobArn: trainingJobArn,
  @as("TrainingJobName") trainingJobName: trainingJobName,
  @as("TrainingJobDefinitionName") trainingJobDefinitionName: option<hyperParameterTrainingJobDefinitionName>
}
type humanTaskUiSummaries = array<humanTaskUiSummary>
type humanLoopActivationConfig = {
@as("HumanLoopActivationConditionsConfig") humanLoopActivationConditionsConfig: humanLoopActivationConditionsConfig
}
...
type explainability = {
@as("Report") report: option<metricsSource>
}
...
@as("S3DataSource") s3DataSource: autoMLS3DataSource
}
...
@as("SourceAlgorithms") sourceAlgorithms: sourceAlgorithmList
}
...
type parameterRange = {
@as("CategoricalParameterRangeSpecification") categoricalParameterRangeSpecification: option<categoricalParameterRangeSpecification>,
  @as("ContinuousParameterRangeSpecification") continuousParameterRangeSpecification: option<continuousParameterRangeSpecification>,
  @as("IntegerParameterRangeSpecification") integerParameterRangeSpecification: option<integerParameterRangeSpecification>
}
...
@as("VpcConfig") vpcConfig: option<vpcConfig>,
  ...
  @as("EnableInterContainerTrafficEncryption") enableInterContainerTrafficEncryption: option<boolean_>
}
type nestedFilters = {
...
@as("SupportedResponseMIMETypes") supportedResponseMIMETypes: responseMIMETypes,
  @as("SupportedContentTypes") supportedContentTypes: contentTypes,
  @as("SupportedRealtimeInferenceInstanceTypes") supportedRealtimeInferenceInstanceTypes: option<realtimeInferenceInstanceTypes>,
  @as("SupportedTransformInstanceTypes") supportedTransformInstanceTypes: option<transformInstanceTypes>,
...
@as("WarmStartType") warmStartType: hyperParameterTuningJobWarmStartType,
  @as("ParentHyperParameterTuningJobs") parentHyperParameterTuningJobs: parentHyperParameterTuningJobs
}
...
@as("PublicWorkforceTaskPrice") publicWorkforceTaskPrice: option<publicWorkforceTaskPrice>,
  ...
  @as("TaskAvailabilityLifetimeInSeconds") taskAvailabilityLifetimeInSeconds: option<taskAvailabilityLifetimeInSeconds>,
  @as("TaskTimeLimitInSeconds") taskTimeLimitInSeconds: taskTimeLimitInSeconds,
  @as("NumberOfHumanWorkersPerDataObject") numberOfHumanWorkersPerDataObject: numberOfHumanWorkersPerDataObject,
...
@as("PublicWorkforceTaskPrice") publicWorkforceTaskPrice: option<publicWorkforceTaskPrice>,
  ...
  @as("TaskTimeLimitInSeconds") taskTimeLimitInSeconds: option<flowDefinitionTaskTimeLimitInSeconds>,
  @as("TaskAvailabilityLifetimeInSeconds") taskAvailabilityLifetimeInSeconds: option<flowDefinitionTaskAvailabilityLifetimeInSeconds>,
...
@as("MaximumExecutionTimeoutInSeconds") maximumExecutionTimeoutInSeconds: option<maximumExecutionTimeoutInSeconds>,
...
@as("Alarms") alarms: option<alarmList>
}
...
@as("InputConfig") inputConfig: option<labelingJobInputConfig>,
  ...
  @as("FailureReason") failureReason: option<failureReason>,
  @as("AnnotationConsolidationLambdaArn") annotationConsolidationLambdaArn: option<lambdaFunctionArn>,
  @as("PreHumanTaskLambdaArn") preHumanTaskLambdaArn: lambdaFunctionArn,
  @as("WorkteamArn") workteamArn: workteamArn,
...
@as("CandidateProperties") candidateProperties: option<candidateProperties>,
  ...
  @as("FinalAutoMLJobObjectiveMetric") finalAutoMLJobObjectiveMetric: option<finalAutoMLJobObjectiveMetric>,
...
@as("TuningJobCompletionCriteria") tuningJobCompletionCriteria: option<tuningJobCompletionCriteria>,
  @as("TrainingJobEarlyStoppingType") trainingJobEarlyStoppingType: option<trainingJobEarlyStoppingType>,
  @as("ParameterRanges") parameterRanges: option<parameterRanges>,
  @as("ResourceLimits") resourceLimits: resourceLimits,
  @as("HyperParameterTuningJobObjective") hyperParameterTuningJobObjective: option<hyperParameterTuningJobObjective>,
  @as("Strategy") strategy: hyperParameterTuningJobStrategyType
}
...
@as("SupportedTuningJobObjectiveMetrics") supportedTuningJobObjectiveMetrics: option<hyperParameterTuningJobObjectives>,
...
@as("Tags") tags: option<tagList_>,
  ...
  @as("DebugRuleEvaluationStatuses") debugRuleEvaluationStatuses: option<debugRuleEvaluationStatuses>,
...
@as("Tags") tags: option<tagList_>,
  @as("LastMonitoringExecutionSummary") lastMonitoringExecutionSummary: option<monitoringExecutionSummary>,
  @as("EndpointName") endpointName: option<endpointName>,
...
@as("Tags") tags: option<tagList_>,
  ...
  @as("ValidationSpecification") validationSpecification: option<modelPackageValidationSpecification>,
  @as("SourceAlgorithmSpecification") sourceAlgorithmSpecification: option<sourceAlgorithmSpecification>,
...
module EnableSagemakerServicecatalogPortfolio = {
  ...
  type request = unit
  type response = unit
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "EnableSagemakerServicecatalogPortfolioCommand";
...
module DisableSagemakerServicecatalogPortfolio = {
  ...
  type request = unit
  type response = unit
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DisableSagemakerServicecatalogPortfolioCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("PipelineExecutionArn") pipelineExecutionArn: option<pipelineExecutionArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "UpdatePipelineExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ModelPackageArn") modelPackageArn: modelPackageArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "UpdateModelPackageCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("PipelineExecutionArn") pipelineExecutionArn: option<pipelineExecutionArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "StopPipelineExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NotebookInstanceName") notebookInstanceName: notebookInstanceName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "StopNotebookInstanceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("MonitoringScheduleName") monitoringScheduleName: monitoringScheduleName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "StopMonitoringScheduleCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("HyperParameterTuningJobName") hyperParameterTuningJobName: hyperParameterTuningJobName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "StopHyperParameterTuningJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("EdgePackagingJobName") edgePackagingJobName: entityName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "StopEdgePackagingJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("CompilationJobName") compilationJobName: entityName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "StopCompilationJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("NotebookInstanceName") notebookInstanceName: notebookInstanceName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "StartNotebookInstanceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("MonitoringScheduleName") monitoringScheduleName: monitoringScheduleName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "StartMonitoringScheduleCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("ModelPackageGroupArn") modelPackageGroupArn: modelPackageGroupArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "PutModelPackageGroupPolicyCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
module GetSagemakerServicecatalogPortfolioStatus = {
  ...
  type request = unit
  type response = {
@as("Status") status: option<sagemakerServicecatalogStatus>
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "GetSagemakerServicecatalogPortfolioStatusCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ResourcePolicy") resourcePolicy: policyString
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "GetModelPackageGroupPolicyCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TrialArn") trialArn: option<trialArn>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DisassociateTrialComponentCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CreationTime") creationTime: option<timestamp_>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribePipelineDefinitionForExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Version") version: option<imageVersionNumber>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeImageVersionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TrialComponentArn") trialComponentArn: option<trialComponentArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteTrialComponentCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NotebookInstanceLifecycleConfigName") notebookInstanceLifecycleConfigName: notebookInstanceLifecycleConfigName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteNotebookInstanceLifecycleConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("NotebookInstanceName") notebookInstanceName: notebookInstanceName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteNotebookInstanceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("MonitoringScheduleName") monitoringScheduleName: monitoringScheduleName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteMonitoringScheduleCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("JobDefinitionName") jobDefinitionName: monitoringJobDefinitionName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteModelQualityJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("ModelPackageGroupName") modelPackageGroupName: entityName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteModelPackageGroupPolicyCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
module DeleteModelPackageGroup = {
  type t;
  type request = {
@as("ModelPackageGroupName") modelPackageGroupName: arnOrName
}
  
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteModelPackageGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
module DeleteModelPackage = {
  type t;
  type request = {
@as("ModelPackageName") modelPackageName: versionedArnOrName
}
  
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteModelPackageCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("JobDefinitionName") jobDefinitionName: monitoringJobDefinitionName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteModelExplainabilityJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("JobDefinitionName") jobDefinitionName: monitoringJobDefinitionName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteModelBiasJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("Version") version: imageVersionNumber,
  ...
  type response = unit
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteImageVersionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("FlowDefinitionName") flowDefinitionName: flowDefinitionName
  ...
  type response = unit
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteFlowDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("FeatureGroupName") featureGroupName: featureGroupName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteFeatureGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("EndpointConfigName") endpointConfigName: endpointConfigName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteEndpointConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("JobDefinitionName") jobDefinitionName: monitoringJobDefinitionName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteDataQualityJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("CodeRepositoryName") codeRepositoryName: entityName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteCodeRepositoryCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("AppImageConfigName") appImageConfigName: appImageConfigName
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DeleteAppImageConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("SessionExpirationDurationInSeconds") sessionExpirationDurationInSeconds: option<sessionExpirationDurationInSeconds>,
  ...
  type response = {
@as("AuthorizedUrl") authorizedUrl: option<notebookInstanceUrl>
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreatePresignedNotebookInstanceUrlCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ExpiresInSeconds") expiresInSeconds: option<expiresInSeconds>,
  ...
  type response = {
@as("AuthorizedUrl") authorizedUrl: option<presignedDomainUrl>
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreatePresignedDomainUrlCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ImageVersionArn") imageVersionArn: option<imageVersionArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateImageVersionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TrialArn") trialArn: option<trialArn>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "AssociateTrialComponentCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("RootAccess") rootAccess: option<rootAccess>,
  @as("DisassociateAdditionalCodeRepositories") disassociateAdditionalCodeRepositories: option<disassociateAdditionalCodeRepositories>,
  @as("DisassociateDefaultCodeRepository") disassociateDefaultCodeRepository: option<disassociateDefaultCodeRepository>,
  @as("DisassociateAcceleratorTypes") disassociateAcceleratorTypes: option<disassociateNotebookInstanceAcceleratorTypes>,
  ...
  @as("DisassociateLifecycleConfig") disassociateLifecycleConfig: option<disassociateNotebookInstanceLifecycleConfig>,
  ...
  type response = unit
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "UpdateNotebookInstanceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CodeRepositoryArn") codeRepositoryArn: codeRepositoryArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "UpdateCodeRepositoryCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("WorkteamArn") workteamArn: workteamArn
  ...
  type response = {
@as("SubscribedWorkteam") subscribedWorkteam: subscribedWorkteam
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeSubscribedWorkteamCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("LastModifiedBy") lastModifiedBy: option<userContext>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribePipelineExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("RootAccess") rootAccess: option<rootAccess>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeNotebookInstanceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ModelPackageGroupStatus") modelPackageGroupStatus: modelPackageGroupStatus,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeModelPackageGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("UiTemplate") uiTemplate: uiTemplateInfo,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeHumanTaskUiCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("LastModifiedBy") lastModifiedBy: option<userContext>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeExperimentCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ModelSignature") modelSignature: option<string_>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeEdgePackagingJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("IotRoleAlias") iotRoleAlias: option<iotRoleAlias>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeDeviceFleetCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("GitConfig") gitConfig: option<gitConfig>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeCodeRepositoryCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TrialComponentArn") trialComponentArn: option<trialComponentArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "UpdateTrialComponentCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("OnStart") onStart: option<notebookInstanceLifecycleConfigList>,
  ...
  type response = unit
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "UpdateNotebookInstanceLifecycleConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("EndpointArn") endpointArn: endpointArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "UpdateEndpointWeightsAndCapacitiesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("PipelineExecutionArn") pipelineExecutionArn: option<pipelineExecutionArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "StartPipelineExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListSubscribedWorkteamsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListProcessingJobsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListPipelineParametersForExecutionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("MaxResults") maxResults: option<maxResults>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("PipelineExecutionSummaries") pipelineExecutionSummaries: option<pipelineExecutionSummaryList>
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListPipelineExecutionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("LastModifiedTimeAfter") lastModifiedTimeAfter: option<lastModifiedTime>,
  ...
  type response = {
@as("NotebookInstanceLifecycleConfigs") notebookInstanceLifecycleConfigs: option<notebookInstanceLifecycleConfigSummaryList>,
  @as("NextToken") nextToken: option<nextToken>
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListNotebookInstanceLifecycleConfigsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListMonitoringSchedulesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("MonitoringTypeEquals") monitoringTypeEquals: option<monitoringType>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("MonitoringExecutionSummaries") monitoringExecutionSummaries: monitoringExecutionSummaryList
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListMonitoringExecutionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListModelQualityJobDefinitionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListModelPackageGroupsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListModelExplainabilityJobDefinitionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListModelBiasJobDefinitionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListFlowDefinitionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<paginationToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListEndpointConfigsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListEdgePackagingJobsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListDataQualityJobDefinitionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListCompilationJobsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("PropertyNameSuggestions") propertyNameSuggestions: option<propertyNameSuggestionList>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "GetSearchSuggestionsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ModelStats") modelStats: option<edgeModelStats>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "GetDeviceFleetReportCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Metrics") metrics: option<trialComponentMetricSummaries>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeTrialComponentCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CreationTime") creationTime: option<creationTime>,
  ...
  @as("OnCreate") onCreate: option<notebookInstanceLifecycleConfigList>,
  @as("NotebookInstanceLifecycleConfigName") notebookInstanceLifecycleConfigName: option<notebookInstanceLifecycleConfigName>,
  @as("NotebookInstanceLifecycleConfigArn") notebookInstanceLifecycleConfigArn: option<notebookInstanceLifecycleConfigArn>
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeNotebookInstanceLifecycleConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: nextToken,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeFeatureGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("OutputConfig") outputConfig: outputConfig,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeCompilationJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TrialComponentArn") trialComponentArn: option<trialComponentArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateTrialComponentCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NotebookInstanceLifecycleConfigArn") notebookInstanceLifecycleConfigArn: option<notebookInstanceLifecycleConfigArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateNotebookInstanceLifecycleConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NotebookInstanceArn") notebookInstanceArn: option<notebookInstanceArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateNotebookInstanceCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ModelPackageGroupArn") modelPackageGroupArn: modelPackageGroupArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateModelPackageGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("FeatureGroupArn") featureGroupArn: featureGroupArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateFeatureGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Tags") tags: option<tagList_>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateEdgePackagingJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<unit> = "send";
}
...
@as("CompilationJobArn") compilationJobArn: compilationJobArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateCompilationJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CodeRepositoryArn") codeRepositoryArn: codeRepositoryArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateCodeRepositoryCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("OidcConfig") oidcConfig: option<oidcConfig>,
  ...
  type response = {
@as("Workforce") workforce: workforce
}
...
module UpdateTrainingJob = {
  type t;
  type request = {
@as("ProfilerRuleConfigurations") profilerRuleConfigurations: option<profilerRuleConfigurations>,
...
@as("AppImageConfigArn") appImageConfigArn: option<appImageConfigArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "UpdateAppImageConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListTrialComponentsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListTrainingJobsForHyperParameterTuningJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
module ListNotebookInstances = {
  type t;
  type request = {
@as("AdditionalCodeRepositoryEquals") additionalCodeRepositoryEquals: option<codeRepositoryNameOrUrl>,
  @as("DefaultCodeRepositoryContains") defaultCodeRepositoryContains: option<codeRepositoryContains>,
  @as("NotebookInstanceLifecycleConfigNameContains") notebookInstanceLifecycleConfigNameContains: option<notebookInstanceLifecycleConfigName>,
...
@as("NotebookInstances") notebookInstances: option<notebookInstanceSummaryList>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListNotebookInstancesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListLabelingJobsForWorkteamCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StatusEquals") statusEquals: option<hyperParameterTuningJobStatus>,
  ...
  type response = {
@as("NextToken") nextToken: option<nextToken>,
  @as("HyperParameterTuningJobSummaries") hyperParameterTuningJobSummaries: hyperParameterTuningJobSummaries
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListHyperParameterTuningJobsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListCodeRepositoriesCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ExperimentConfig") experimentConfig: option<experimentConfig>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeTransformJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CreationTime") creationTime: timestamp_,
  @as("CreatedBy") createdBy: option<userContext>,
  @as("ProjectStatus") projectStatus: projectStatus,
  @as("ServiceCatalogProvisionedProductDetails") serviceCatalogProvisionedProductDetails: option<serviceCatalogProvisionedProductDetails>,
  @as("ServiceCatalogProvisioningDetails") serviceCatalogProvisioningDetails: serviceCatalogProvisioningDetails,
  @as("ProjectDescription") projectDescription: option<entityDescription>,
  @as("ProjectId") projectId: projectId,
  @as("ProjectName") projectName: projectEntityName,
  @as("ProjectArn") projectArn: projectArn
...
@as("LabelingJobOutput") labelingJobOutput: option<labelingJobOutput>,
  ...
  @as("LabelingJobAlgorithmsConfig") labelingJobAlgorithmsConfig: option<labelingJobAlgorithmsConfig>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeLabelingJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("FailureReason") failureReason: option<failureReason>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeFlowDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CreationTime") creationTime: timestamp_,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeEndpointConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("KernelGatewayImageConfig") kernelGatewayImageConfig: option<kernelGatewayImageConfig>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeAppImageConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TransformJobArn") transformJobArn: transformJobArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateTransformJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("FlowDefinitionArn") flowDefinitionArn: flowDefinitionArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateFlowDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("EndpointConfigArn") endpointConfigArn: endpointConfigArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateEndpointConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("AppImageConfigArn") appImageConfigArn: option<appImageConfigArn>
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateAppImageConfigCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("DeploymentConfig") deploymentConfig: option<deploymentConfig>,
  @as("ExcludeRetainedVariantProperties") excludeRetainedVariantProperties: option<variantPropertyList>,
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListPipelineExecutionStepsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("UserSettings") userSettings: option<userSettings>,
  ...
  @as("SingleSignOnUserIdentifier") singleSignOnUserIdentifier: option<singleSignOnUserIdentifier>,
  @as("FailureReason") failureReason: option<failureReason>,
  @as("CreationTime") creationTime: option<creationTime>,
  @as("LastModifiedTime") lastModifiedTime: option<lastModifiedTime>,
  @as("Status") status: option<userProfileStatus>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeUserProfileCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("TrainingJobArn") trainingJobArn: option<trainingJobArn>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeProcessingJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StoppingCondition") stoppingCondition: option<monitoringStoppingCondition>,
  ...
  @as("ModelQualityBaselineConfig") modelQualityBaselineConfig: option<modelQualityBaselineConfig>,
  @as("CreationTime") creationTime: timestamp_,
  @as("JobDefinitionName") jobDefinitionName: monitoringJobDefinitionName,
  @as("JobDefinitionArn") jobDefinitionArn: monitoringJobDefinitionArn
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeModelQualityJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StoppingCondition") stoppingCondition: option<monitoringStoppingCondition>,
  ...
  @as("NetworkConfig") networkConfig: option<monitoringNetworkConfig>,
  @as("JobResources") jobResources: monitoringResources,
  @as("ModelExplainabilityJobOutputConfig") modelExplainabilityJobOutputConfig: monitoringOutputConfig,
  @as("ModelExplainabilityJobInput") modelExplainabilityJobInput: modelExplainabilityJobInput,
  @as("ModelExplainabilityAppSpecification") modelExplainabilityAppSpecification: modelExplainabilityAppSpecification,
  @as("ModelExplainabilityBaselineConfig") modelExplainabilityBaselineConfig: option<modelExplainabilityBaselineConfig>,
  @as("CreationTime") creationTime: timestamp_,
  @as("JobDefinitionName") jobDefinitionName: monitoringJobDefinitionName,
  @as("JobDefinitionArn") jobDefinitionArn: monitoringJobDefinitionArn
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeModelExplainabilityJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("StoppingCondition") stoppingCondition: option<monitoringStoppingCondition>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeModelBiasJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("KmsKeyId") kmsKeyId: option<kmsKeyId>,
  ...
  @as("CreationTime") creationTime: option<creationTime>,
  @as("Status") status: option<domainStatus>,
  @as("SingleSignOnManagedApplicationInstanceId") singleSignOnManagedApplicationInstanceId: option<string256>,
...
@as("StoppingCondition") stoppingCondition: option<monitoringStoppingCondition>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeDataQualityJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ModelDeployResult") modelDeployResult: option<modelDeployResult>,
  ...
  @as("GenerateCandidateDefinitionsOnly") generateCandidateDefinitionsOnly: option<generateCandidateDefinitionsOnly>,
  @as("AutoMLJobSecondaryStatus") autoMLJobSecondaryStatus: autoMLJobSecondaryStatus,
  @as("AutoMLJobStatus") autoMLJobStatus: autoMLJobStatus,
...
@as("Tags") tags: option<tagList_>,
  ...
  type response = {
@as("WorkteamArn") workteamArn: option<workteamArn>
}
...
@as("ProcessingJobArn") processingJobArn: processingJobArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateProcessingJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("JobDefinitionArn") jobDefinitionArn: monitoringJobDefinitionArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateModelQualityJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("JobDefinitionArn") jobDefinitionArn: monitoringJobDefinitionArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateModelExplainabilityJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("JobDefinitionArn") jobDefinitionArn: monitoringJobDefinitionArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateModelBiasJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("JobDefinitionArn") jobDefinitionArn: monitoringJobDefinitionArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateDataQualityJobDefinitionCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextToken") nextToken: option<nextToken>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListCandidatesForAutoMLJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("AppImageConfigs") appImageConfigs: option<appImageConfigList>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "ListAppImageConfigsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Environment") environment: option<trainingEnvironmentMap>,
  ...
  @as("ProfilerRuleEvaluationStatuses") profilerRuleEvaluationStatuses: option<profilerRuleEvaluationStatuses>,
  @as("ProfilerRuleConfigurations") profilerRuleConfigurations: option<profilerRuleConfigurations>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeTrainingJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("MonitoringScheduleArn") monitoringScheduleArn: monitoringScheduleArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "UpdateMonitoringScheduleCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("LastMonitoringExecutionSummary") lastMonitoringExecutionSummary: option<monitoringExecutionSummary>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeMonitoringScheduleCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("MonitoringScheduleArn") monitoringScheduleArn: monitoringScheduleArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateMonitoringScheduleCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ApprovalDescription") approvalDescription: option<approvalDescription>,
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeModelPackageCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("FailureReason") failureReason: option<failureReason>,
  ...
  @as("CreationTime") creationTime: timestamp_,
  @as("HyperParameterTuningJobStatus") hyperParameterTuningJobStatus: hyperParameterTuningJobStatus,
  @as("TrainingJobDefinitions") trainingJobDefinitions: option<hyperParameterTrainingJobDefinitions>,
  @as("TrainingJobDefinition") trainingJobDefinition: option<hyperParameterTrainingJobDefinition>,
  @as("HyperParameterTuningJobConfig") hyperParameterTuningJobConfig: hyperParameterTuningJobConfig,
  @as("HyperParameterTuningJobArn") hyperParameterTuningJobArn: hyperParameterTuningJobArn,
  @as("HyperParameterTuningJobName") hyperParameterTuningJobName: hyperParameterTuningJobName
}
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "DescribeHyperParameterTuningJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ModelPackageArn") modelPackageArn: modelPackageArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateModelPackageCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("HyperParameterTuningJobArn") hyperParameterTuningJobArn: hyperParameterTuningJobArn
  ...
  @module("@aws-sdk/client-sagemaker") @new external new_: (request) => t = "CreateHyperParameterTuningJobCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CertifyForMarketplace") certifyForMarketplace: option<certifyForMarketplace>,
  ...
  @as("AlgorithmStatus") algorithmStatus: algorithmStatus,
  @as("ValidationSpecification") validationSpecification: option<algorithmValidationSpecification>,
  @as("InferenceSpecification") inferenceSpecification: option<inferenceSpecification>,
