...
type workflowState = [@as("RESOLVED") #RESOLVED | @as("DEFERRED") #DEFERRED | @as("IN_PROGRESS") #INPROGRESS | @as("ASSIGNED") #ASSIGNED | @as("NEW") #NEW]
type verificationState = [@as("BENIGN_POSITIVE") #BENIGNPOSITIVE | @as("FALSE_POSITIVE") #FALSEPOSITIVE | @as("TRUE_POSITIVE") #TRUEPOSITIVE | @as("UNKNOWN") #UNKNOWN]
type timestamp_ = Js.Date.t;
type threatIntelIndicatorType = [@as("URL") #URL | @as("PROCESS") #PROCESS | @as("MUTEX") #MUTEX | @as("IPV6_ADDRESS") #IPV6ADDRESS | @as("IPV4_ADDRESS") #IPV4ADDRESS | @as("HASH_SHA512") #HASHSHA512 | @as("HASH_SHA256") #HASHSHA256 | @as("HASH_SHA1") #HASHSHA1 | @as("HASH_MD5") #HASHMD5 | @as("EMAIL_ADDRESS") #EMAILADDRESS | @as("DOMAIN") #DOMAIN]
type threatIntelIndicatorCategory = [@as("KEYLOGGER") #KEYLOGGER | @as("EXPLOIT_SITE") #EXPLOITSITE | @as("DROP_SITE") #DROPSITE | @as("COMMAND_AND_CONTROL") #COMMANDANDCONTROL | @as("CARD_STEALER") #CARDSTEALER | @as("BACKDOOR") #BACKDOOR]
type tagValue = string
type tagKey = string
type stringFilterComparison = [@as("PREFIX_NOT_EQUALS") #PREFIXNOTEQUALS | @as("NOT_EQUALS") #NOTEQUALS | @as("PREFIX") #PREFIX | @as("EQUALS") #EQUALS]
...
type ratioScale = int
type partition = [@as("aws-us-gov") #AwsUsGov | @as("aws-cn") #AwsCn | @as("aws") #Aws]
type nonEmptyString = string
type nextToken = string
type networkDirection = [@as("OUT") #OUT | @as("IN") #IN]
type maxResults = int
type mapFilterComparison = [@as("NOT_EQUALS") #NOTEQUALS | @as("EQUALS") #EQUALS]
type malwareType = [@as("WORM") #WORM | @as("VIRUS") #VIRUS | @as("TROJAN") #TROJAN | @as("ROOTKIT") #ROOTKIT | @as("REMOTE_ACCESS") #REMOTEACCESS | @as("RANSOMWARE") #RANSOMWARE | @as("SPYWARE") #SPYWARE | @as("POTENTIALLY_UNWANTED") #POTENTIALLYUNWANTED | @as("MACRO") #MACRO | @as("KEYLOGGER") #KEYLOGGER | @as("EXPLOIT_KIT") #EXPLOITKIT | @as("COIN_MINER") #COINMINER | @as("BOTNET_AGENT") #BOTNETAGENT | @as("BLENDED_THREAT") #BLENDEDTHREAT | @as("ADWARE") #ADWARE]
type malwareState = [@as("REMOVED") #REMOVED | @as("REMOVAL_FAILED") #REMOVALFAILED | @as("OBSERVED") #OBSERVED]
type long = float
type integrationType = [@as("UPDATE_FINDINGS_IN_SECURITY_HUB") #UPDATEFINDINGSINSECURITYHUB | @as("RECEIVE_FINDINGS_FROM_SECURITY_HUB") #RECEIVEFINDINGSFROMSECURITYHUB | @as("SEND_FINDINGS_TO_SECURITY_HUB") #SENDFINDINGSTOSECURITYHUB]
type integer_ = int
type double = float
type dateRangeUnit = [@as("DAYS") #DAYS]
type crossAccountMaxResults = int
type controlStatus = [@as("DISABLED") #DISABLED | @as("ENABLED") #ENABLED]
type complianceStatus = [@as("NOT_AVAILABLE") #NOTAVAILABLE | @as("FAILED") #FAILED | @as("WARNING") #WARNING | @as("PASSED") #PASSED]
type boolean_ = bool
