...
type workflowUpdate = {@as("Status") status: option<workflowStatus>}
type workflow = {@as("Status") status: option<workflowStatus>}
type wafOverrideAction = {@as("Type") type_: option<nonEmptyString>}
type wafExcludedRule = {@as("RuleId") ruleId: option<nonEmptyString>}
type wafAction = {@as("Type") type_: option<nonEmptyString>}
...
type keywordFilter = {@as("Value") value: option<nonEmptyString>}
...
type ipFilter = {@as("Cidr") cidr: option<nonEmptyString>}
type invitation = {
  @as("MemberStatus") memberStatus: option<nonEmptyString>,
  @as("InvitedAt") invitedAt: option<timestamp_>,
...
type city = {@as("CityName") cityName: option<nonEmptyString>}
...
type awsRdsDbSubnetGroupSubnetAvailabilityZone = {@as("Name") name: option<nonEmptyString>}
...
type awsLambdaFunctionTracingConfig = {@as("Mode") mode: option<nonEmptyString>}
...
type awsLambdaFunctionDeadLetterConfig = {@as("TargetArn") targetArn: option<nonEmptyString>}
...
type awsIamUserPolicy = {@as("PolicyName") policyName: option<nonEmptyString>}
type awsIamRolePolicy = {@as("PolicyName") policyName: option<nonEmptyString>}
...
type awsIamGroupPolicy = {@as("PolicyName") policyName: option<nonEmptyString>}
...
type awsElbLoadBalancerInstance = {@as("InstanceId") instanceId: option<nonEmptyString>}
...
type awsElbLoadBalancerCrossZoneLoadBalancing = {@as("Enabled") enabled: option<boolean_>}
type awsElbLoadBalancerConnectionSettings = {@as("IdleTimeout") idleTimeout: option<integer_>}
...
type awsElasticsearchDomainNodeToNodeEncryptionOptions = {@as("Enabled") enabled: option<boolean_>}
...
type awsEc2SecurityGroupPrefixListId = {@as("PrefixListId") prefixListId: option<nonEmptyString>}
type awsEc2SecurityGroupIpv6Range = {@as("CidrIpv6") cidrIpv6: option<nonEmptyString>}
type awsEc2SecurityGroupIpRange = {@as("CidrIp") cidrIp: option<nonEmptyString>}
...
type awsCertificateManagerCertificateKeyUsage = {@as("Name") name: option<nonEmptyString>}
...
type awsApiCallActionDomainDetails = {@as("Domain") domain: option<nonEmptyString>}
...
type actionLocalIpDetails = {@as("IpAddressV4") ipAddressV4: option<nonEmptyString>}
...
type remediation = {@as("Recommendation") recommendation: option<recommendation>}
...
type awsSsmPatch = {@as("ComplianceSummary") complianceSummary: option<awsSsmComplianceSummary>}
...
type awsApiGatewayEndpointConfiguration = {@as("Types") types: option<nonEmptyStringList>}
...
type awsSsmPatchComplianceDetails = {@as("Patch") patch: option<awsSsmPatch>}
...
type resourceDetails = {
  ...
  @as("AwsAutoScalingAutoScalingGroup")
...
module DescribeHub = {
  type t
  type request = {@as("HubArn") hubArn: option<nonEmptyString>}
  type response = {
...
module BatchImportFindings = {
  type t
  type request = {@as("Findings") findings: batchImportFindingsRequestFindingList}
  type response = {
