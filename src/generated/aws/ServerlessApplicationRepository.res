...
type maxItems = int
type capability = [@as("CAPABILITY_RESOURCE_POLICY") #CAPABILITYRESOURCEPOLICY | @as("CAPABILITY_AUTO_EXPAND") #CAPABILITYAUTOEXPAND | @as("CAPABILITY_NAMED_IAM") #CAPABILITYNAMEDIAM | @as("CAPABILITY_IAM") #CAPABILITYIAM]
...
@module("@aws-sdk/client-serverlessrepo") @new external createClient: unit => awsServiceClient = "ServerlessApplicationRepositoryClient";
