...
type cloudWatchDashboard = {@as("Name") name: option<cloudWatchDashboardName>}
type budgetDetail = {@as("BudgetName") budgetName: option<budgetName>}
...
module DescribeProvisioningParameters = {
  ...
  type response = {
    @as("ProvisioningArtifactOutputs")
...
module DescribePortfolioShareStatus = {
  type t
  type request = {@as("PortfolioShareToken") portfolioShareToken: id}
  type response = {
...
module DescribeProvisionedProductPlan = {
  ...
  type response = {
    ...
    @as("ProvisionedProductPlanDetails")
