...
type wirelessConnection = {@as("IsWifiEnabled") isWifiEnabled: option<boolean_>}
type shipment = {
...
type indtaxDocuments = {@as("GSTIN") gstin: option<gstin>}
type eventTriggerDefinition = {@as("EventResourceARN") eventResourceARN: option<resourceARN>}
type ec2AmiResource = {
