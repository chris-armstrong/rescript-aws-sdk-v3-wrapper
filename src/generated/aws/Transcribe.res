...
type modelSettings = {@as("LanguageModelName") languageModelName: option<modelName>}
...
type medicalTranscript = {@as("TranscriptFileUri") transcriptFileUri: option<uri>}
type media = {@as("MediaFileUri") mediaFileUri: option<uri>}
