...
type audioEvent = {@as("AudioChunk") audioChunk: option<audioChunk>}
...
type transcript = {@as("Results") results: option<resultList>}
type medicalTranscript = {@as("Results") results: option<medicalResultList>}
type transcriptEvent = {@as("Transcript") transcript: option<transcript>}
type medicalTranscriptEvent = {@as("Transcript") transcript: option<medicalTranscript>}
