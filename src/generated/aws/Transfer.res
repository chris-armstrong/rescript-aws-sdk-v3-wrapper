...
@as("SecurityPolicyName") securityPolicyName: securityPolicyName
  ...
  type response = {
@as("SecurityPolicy") securityPolicy: describedSecurityPolicy
}
  @module("@aws-sdk/client-transfer") @new external new_: (request) => t = "DescribeSecurityPolicyCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ServerId") serverId: serverId
  ...
  type response = {
@as("Server") server: describedServer
}
