...
type jobStatus = [@as("STOPPED") #STOPPED | @as("STOP_REQUESTED") #STOPREQUESTED | @as("FAILED") #FAILED | @as("COMPLETED_WITH_ERROR") #COMPLETEDWITHERROR | @as("COMPLETED") #COMPLETED | @as("IN_PROGRESS") #INPROGRESS | @as("SUBMITTED") #SUBMITTED]
type jobName = string
type jobId = string
type integer_ = int
