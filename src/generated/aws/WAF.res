...
module GetPermissionPolicy = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetPermissionPolicyCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetChangeTokenStatus = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetChangeTokenStatusCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetRuleGroup = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetRuleGroupCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetRegexPatternSet = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetRegexPatternSetCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module PutLoggingConfiguration = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "PutLoggingConfigurationCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetRule = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetRuleCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetRateBasedRule = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetRateBasedRuleCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetLoggingConfiguration = {
  ...
  type request = {@as("ResourceArn") resourceArn: resourceArn}
  type response = {@as("LoggingConfiguration") loggingConfiguration: option<loggingConfiguration>}
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetLoggingConfigurationCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetIPSet = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetIPSetCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetGeoMatchSet = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetGeoMatchSetCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetXssMatchSet = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetXssMatchSetCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetSqlInjectionMatchSet = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetSqlInjectionMatchSetCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetSizeConstraintSet = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetSizeConstraintSetCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetRegexMatchSet = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetRegexMatchSetCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetByteMatchSet = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetByteMatchSetCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
...
module GetWebACL = {
  ...
  @module("@aws-sdk/client-waf") @new external new: request => t = "GetWebACLCommand"
  @send external send: (awsServiceClient, t) => Js.Promise.t<response> = "send"
}
