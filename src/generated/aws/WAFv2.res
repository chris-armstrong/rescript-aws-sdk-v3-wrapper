...
@module("@aws-sdk/client-wafv2") @new external createClient: unit => awsServiceClient = "WAFv2Client";
...
type textTransformationType = [@as("URL_DECODE") #URL_DECODE | @as("CMD_LINE") #CMD_LINE | @as("LOWERCASE") #LOWERCASE | @as("HTML_ENTITY_DECODE") #HTML_ENTITY_DECODE | @as("COMPRESS_WHITE_SPACE") #COMPRESS_WHITE_SPACE | @as("NONE") #NONE]
...
type responseContentType = [@as("APPLICATION_JSON") #APPLICATION_JSON | @as("TEXT_HTML") #TEXT_HTML | @as("TEXT_PLAIN") #TEXT_PLAIN]
type responseContent = string
type resourceType = [@as("APPSYNC") #APPSYNC | @as("API_GATEWAY") #API_GATEWAY | @as("APPLICATION_LOAD_BALANCER") #APPLICATION_LOAD_BALANCER]
...
type parameterExceptionField = [@as("FILTER_CONDITION") #FILTER_CONDITION | @as("LOGGING_FILTER") #LOGGING_FILTER | @as("BODY_PARSING_FALLBACK_BEHAVIOR") #BODY_PARSING_FALLBACK_BEHAVIOR | @as("JSON_MATCH_SCOPE") #JSON_MATCH_SCOPE | @as("JSON_MATCH_PATTERN") #JSON_MATCH_PATTERN | @as("CUSTOM_RESPONSE_BODY") #CUSTOM_RESPONSE_BODY | @as("CUSTOM_RESPONSE") #CUSTOM_RESPONSE | @as("RESPONSE_CONTENT_TYPE") #RESPONSE_CONTENT_TYPE | @as("CUSTOM_REQUEST_HANDLING") #CUSTOM_REQUEST_HANDLING | @as("HEADER_NAME") #HEADER_NAME | @as("IP_SET_FORWARDED_IP_CONFIG") #IP_SET_FORWARDED_IP_CONFIG | @as("FORWARDED_IP_CONFIG") #FORWARDED_IP_CONFIG | @as("POSITION") #POSITION | @as("FALLBACK_BEHAVIOR") #FALLBACK_BEHAVIOR | @as("FIREWALL_MANAGER_STATEMENT") #FIREWALL_MANAGER_STATEMENT | @as("METRIC_NAME") #METRIC_NAME | @as("TAG_KEYS") #TAG_KEYS | @as("TAGS") #TAGS | @as("RESOURCE_TYPE") #RESOURCE_TYPE | @as("RESOURCE_ARN") #RESOURCE_ARN | @as("SCOPE_VALUE") #SCOPE_VALUE | @as("OVERRIDE_ACTION") #OVERRIDE_ACTION | @as("ENTITY_LIMIT") #ENTITY_LIMIT | @as("RULE_ACTION") #RULE_ACTION | @as("DEFAULT_ACTION") #DEFAULT_ACTION | @as("SINGLE_HEADER") #SINGLE_HEADER | @as("SINGLE_QUERY_ARGUMENT") #SINGLE_QUERY_ARGUMENT | @as("TEXT_TRANSFORMATION") #TEXT_TRANSFORMATION | @as("FIELD_TO_MATCH") #FIELD_TO_MATCH | @as("IP_ADDRESS_VERSION") #IP_ADDRESS_VERSION | @as("IP_ADDRESS") #IP_ADDRESS | @as("NOT_STATEMENT") #NOT_STATEMENT | @as("OR_STATEMENT") #OR_STATEMENT | @as("AND_STATEMENT") #AND_STATEMENT | @as("LABEL_MATCH_STATEMENT") #LABEL_MATCH_STATEMENT | @as("MANAGED_RULE_SET_STATEMENT") #MANAGED_RULE_SET_STATEMENT | @as("IP_SET_REFERENCE_STATEMENT") #IP_SET_REFERENCE_STATEMENT | @as("REGEX_PATTERN_REFERENCE_STATEMENT") #REGEX_PATTERN_REFERENCE_STATEMENT | @as("RULE_GROUP_REFERENCE_STATEMENT") #RULE_GROUP_REFERENCE_STATEMENT | @as("RATE_BASED_STATEMENT") #RATE_BASED_STATEMENT | @as("GEO_MATCH_STATEMENT") #GEO_MATCH_STATEMENT | @as("SIZE_CONSTRAINT_STATEMENT") #SIZE_CONSTRAINT_STATEMENT | @as("XSS_MATCH_STATEMENT") #XSS_MATCH_STATEMENT | @as("SQLI_MATCH_STATEMENT") #SQLI_MATCH_STATEMENT | @as("BYTE_MATCH_STATEMENT") #BYTE_MATCH_STATEMENT | @as("STATEMENT") #STATEMENT | @as("EXCLUDED_RULE") #EXCLUDED_RULE | @as("RULE") #RULE | @as("MANAGED_RULE_SET") #MANAGED_RULE_SET | @as("IP_SET") #IP_SET | @as("REGEX_PATTERN_SET") #REGEX_PATTERN_SET | @as("RULE_GROUP") #RULE_GROUP | @as("WEB_ACL") #WEB_ACL]
...
type boolean_ = bool
type bodyParsingFallbackBehavior = [@as("EVALUATE_AS_STRING") #EVALUATE_AS_STRING | @as("NO_MATCH") #NO_MATCH | @as("MATCH") #MATCH]
type body = unit
...
type regex = {
@as("RegexString") regexString: option<regexPatternString>
}
...
type labelSummary = {
@as("Name") name: option<labelName>
}
type labelNameCondition = {
@as("LabelName") labelName: labelName
}
...
@as("InsertHeaders") insertHeaders: customHTTPHeaders
}
...
type blockAction = {
@as("CustomResponse") customResponse: option<customResponse>
}
type allowAction = {
@as("CustomRequestHandling") customRequestHandling: option<customRequestHandling>
}
...
@as("LabelMatchStatement") labelMatchStatement: option<labelMatchStatement>,
  ...
  @as("RegexPatternSetReferenceStatement") regexPatternSetReferenceStatement: option<regexPatternSetReferenceStatement>,
  @as("IPSetReferenceStatement") ipsetReferenceStatement: option<ipsetReferenceStatement>,
  @as("RuleGroupReferenceStatement") ruleGroupReferenceStatement: option<ruleGroupReferenceStatement>,
...
} and statements = array<statement> and notStatement = {
...
@as("CustomResponseBodies") customResponseBodies: option<customResponseBodies>,
  @as("LabelNamespace") labelNamespace: option<labelName>,
  @as("ManagedByFirewallManager") managedByFirewallManager: option<boolean_>,
  @as("PostProcessFirewallManagerRuleGroups") postProcessFirewallManagerRuleGroups: option<firewallManagerRuleGroups>,
  @as("PreProcessFirewallManagerRuleGroups") preProcessFirewallManagerRuleGroups: option<firewallManagerRuleGroups>,
...
@as("ResourceArn") resourceArn: resourceArn
  ...
  type response = unit
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "DeletePermissionPolicyCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ResourceArn") resourceArn: resourceArn
  ...
  type response = unit
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "DeleteLoggingConfigurationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("WebACLLockToken") webACLLockToken: lockToken,
  ...
  type response = {
@as("NextWebACLLockToken") nextWebACLLockToken: option<lockToken>
}
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "DeleteFirewallManagerRuleGroupsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("LockToken") lockToken: lockToken,
  ...
  type response = {
@as("NextLockToken") nextLockToken: option<lockToken>
}
...
@as("ResourceArns") resourceArns: option<resourceArns>
  ...
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "ListResourcesForWebACLCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ManagedRuleGroups") managedRuleGroups: option<managedRuleGroupSummaries>,
  ...
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "ListAvailableManagedRuleGroupsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ManagedKeysIPV6") managedKeysIPV6: option<rateBasedStatementManagedKeysIPSet>,
  ...
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "GetRateBasedStatementManagedKeysCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("Tags") tags: option<tagList_>,
  ...
  type response = {
@as("Summary") summary: option<regexPatternSetSummary>
}
...
@as("Tags") tags: option<tagList_>,
  ...
  type response = {
@as("Summary") summary: option<ipsetSummary>
}
...
@as("LoggingConfiguration") loggingConfiguration: option<loggingConfiguration>
  ...
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "PutLoggingConfigurationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("LoggingConfiguration") loggingConfiguration: option<loggingConfiguration>
  ...
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "GetLoggingConfigurationCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("ConsumedLabels") consumedLabels: option<labelSummaries>,
  ...
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "DescribeManagedRuleGroupCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("NextMarker") nextMarker: option<nextMarker>,
  ...
  @module("@aws-sdk/client-wafv2") @new external new_: (request) => t = "ListLoggingConfigurationsCommand";
  @send external rawSend: (awsServiceClient, t) => Js.Promise.t<response> = "send";
}
...
@as("CustomResponseBodies") customResponseBodies: option<customResponseBodies>,
  ...
  type response = {
@as("Summary") summary: option<webACLSummary>
}
...
@as("CustomResponseBodies") customResponseBodies: option<customResponseBodies>,
  ...
  type response = {
@as("Summary") summary: option<ruleGroupSummary>
}
