...
type userStorage = {@as("Capacity") capacity: option<nonEmptyString>}
type terminateRequest = {@as("WorkspaceId") workspaceId: workspaceId}
...
type stopRequest = {@as("WorkspaceId") workspaceId: option<workspaceId>}
type startRequest = {@as("WorkspaceId") workspaceId: option<workspaceId>}
type snapshot = {@as("SnapshotTime") snapshotTime: option<timestamp_>}
...
type rootStorage = {@as("Capacity") capacity: option<nonEmptyString>}
type resourceIdList = array<nonEmptyString>
type rebuildRequest = {@as("WorkspaceId") workspaceId: workspaceId}
type rebootRequest = {@as("WorkspaceId") workspaceId: workspaceId}
type operatingSystem = {@as("Type") type_: option<operatingSystemType>}
...
type imagePermission = {@as("SharedAccountId") sharedAccountId: option<awsAccount>}
...
type computeType = {@as("Name") name: option<compute>}
type clientProperties = {@as("ReconnectEnabled") reconnectEnabled: option<reconnectEnum>}
...
module DescribeAccountModifications = {
  type t
  type request = {@as("NextToken") nextToken: option<paginationToken>}
  type response = {
    @as("NextToken") nextToken: option<paginationToken>,
...
module CreateWorkspaces = {
  type t
  type request = {@as("Workspaces") workspaces: workspaceRequestList}
  type response = {
