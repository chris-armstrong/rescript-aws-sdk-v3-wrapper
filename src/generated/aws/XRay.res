...
type resourceARNDetail = {@as("ARN") arn: option<string_>}
...
type instanceIdDetail = {@as("Id") id: option<string_>}
...
type insightImpactGraphEdge = {@as("ReferenceId") referenceId: option<nullableInteger>}
...
type availabilityZoneDetail = {@as("Name") name: option<string_>}
...
module PutTraceSegments = {
  type t
  type request = {@as("TraceSegmentDocuments") traceSegmentDocuments: traceSegmentDocumentList}
  type response = {
...
module GetGroups = {
  type t
  type request = {@as("NextToken") nextToken: option<getGroupsNextToken>}
  type response = {
    @as("NextToken") nextToken: option<string_>,
...
module GetTimeSeriesServiceStatistics = {
  ...
  type response = {
    ...
    @as("TimeSeriesServiceStatistics")
