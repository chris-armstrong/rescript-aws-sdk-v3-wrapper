...
var UnknownTrait = /* @__PURE__ */Caml_exceptions.create("Read.UnknownTrait");
...
var x = Fs.readFileSync("aws-sdk-js-v3/codegen/sdk-codegen/aws-models/sqs.2012-11-05.json", undefined);

var parsed = Json.Decode.parseJson(x.toString(), parseModel);
