...
/*  */
/* @scope("JSON") @val */
/* external parseRecord: string => record = "parse"; */
/*  */
/* let y = parseRecord(NodeJs.Buffer.toString(x)) */
let x = NodeJs.Fs.readFileSync(
  "aws-sdk-js-v3/codegen/sdk-codegen/aws-models/sqs.2012-11-05.json",
  (),
)

let parsed = parseJson(NodeJs.Buffer.toString(x), parseModel)
